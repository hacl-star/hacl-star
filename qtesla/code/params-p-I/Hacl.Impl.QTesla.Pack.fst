...
let encode_pk pk t seedA =
	...
	pt (i+.size 20) ((tj22 >>^ 2ul)   |^ (tj23 <<^ 27ul)); pt (i+.size 21)  ((tj23 >>^  5ul)  |^ (tj24 <<^ 24ul));
...
let encode_sig sm c z =
	...
	pt (i+.size  4) UI64.( (((t_ (j +.size  5)) >>^ 18ul) &^ ((1uL <<^  4ul) -^ 1uL)) |^ (((t_ (j+.size  6)) &^ ((1uL <<^ 22ul) -^ 1uL)) <<^ 4ul) |^ ((t_ (j+.size  7)) <<^ 26ul) );
	pt (i+.size  5) UI64.( (((t_ (j +.size  7)) >>^  6ul) &^ ((1uL <<^ 16ul) -^ 1uL)) |^ ((t_ (j+.size  8)) <<^ 16ul) );
	pt (i+.size  6) UI64.( (((t_ (j +.size  8)) >>^ 16ul) &^ ((1uL <<^  6ul) -^ 1uL)) |^ (((t_ (j+.size  9)) &^ ((1uL <<^ 22ul) -^ 1uL)) <<^ 6ul) |^ ((t_ (j+.size 10)) <<^ 28ul) );
	pt (i+.size  7) UI64.( (((t_ (j +.size 10)) >>^  4ul) &^ ((1uL <<^ 18ul) -^ 1uL)) |^ ((t_ (j+.size 11)) <<^ 18ul) );
	pt (i+.size  8) UI64.( (((t_ (j +.size 11)) >>^ 14ul) &^ ((1uL <<^  8ul) -^ 1uL)) |^ (((t_ (j+.size 12)) &^ ((1uL <<^ 22ul) -^ 1uL)) <<^ 8ul) |^ ((t_ (j+.size 13)) <<^ 30ul) );
	pt (i+.size  9) UI64.( (((t_ (j +.size 13)) >>^  2ul) &^ ((1uL <<^ 20ul) -^ 1uL)) |^ ((t_ (j+.size 14)) <<^ 20ul) );
	pt (i+.size 10) UI64.( (((t_ (j +.size 14)) >>^ 12ul) &^ ((1uL <<^ 10ul) -^ 1uL)) |^ ((t_ (j+.size 15)) <<^ 10ul) );
