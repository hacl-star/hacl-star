...
int32_t test_poly()
{
  ...
  Hacl_MAC_Poly1305_64_crypto_onetimeauth(mac, plaintext1, len_, key);
  TestLib_compare_and_print("HACL Poly1305", expected1, mac, macsize);
  Hacl_MAC_Poly1305_64_crypto_onetimeauth(mac, plaintext1, len_, key);
  TestLib_compare_and_print("Sodium Poly1305", expected1, mac, macsize);
  return exit_success;
}
