...
#[inline] pub(crate) fn sha256_init(hash: &mut [u32])
{
    krml::unroll_for!(
        8,
        "i",
...
#[inline] fn sha256_update(b: &[u8], hash: &mut [u32])
{
...
#[inline] pub(crate) fn sha256_update_nblocks(len: u32, b: &[u8], st: &mut [u32])
{
...
#[inline] pub(crate) fn sha256_update_last(totlen: u64, len: u32, b: &[u8], hash: &mut [u32])
{
...
#[inline] pub(crate) fn sha256_finish(st: &[u32], h: &mut [u8])
{
...
#[inline] pub(crate) fn sha224_init(hash: &mut [u32])
{
    krml::unroll_for!(
        8,
        "i",
...
#[inline] pub(crate) fn sha224_update_nblocks(len: u32, b: &[u8], st: &mut [u32])
...
#[inline] pub(crate) fn sha224_finish(st: &[u32], h: &mut [u8])
{
    let mut hbuf: [u8; 32] = [0u8; 32usize];
    krml::unroll_for!(
        8,
...
#[inline] fn sha512_update(b: &[u8], hash: &mut [u64])
{
...
#[inline] pub(crate) fn sha512_update_nblocks(len: u32, b: &[u8], st: &mut [u64])
{
...
#[inline] pub(crate) fn sha512_update_last(
...
#[inline] pub(crate) fn sha512_finish(st: &[u64], h: &mut [u8])
{
...
#[inline] pub(crate) fn sha384_init(hash: &mut [u64])
{
    krml::unroll_for!(
        8,
        "i",
...
#[inline] pub(crate) fn sha384_update_nblocks(len: u32, b: &[u8], st: &mut [u64])
...
#[inline] pub(crate) fn sha384_finish(st: &[u64], h: &mut [u8])
{
    let mut hbuf: [u8; 64] = [0u8; 64usize];
    krml::unroll_for!(
        8,
        ...
        crate::streaming_types::optional_32::Some { v: ref mut block_state1 } =>
          {
              ...
              match k·
              {
                  ...
                  crate::streaming_types::optional::Some =>
                    {
                        crate::hash_sha2::sha256_init(block_state2);
...
pub fn
copy_256
<'a>(state: &'a [crate::streaming_types::state_32]) ->
    Box<[crate::streaming_types::state_32]>
{
    ...
    match block_state
    {
        ...
        crate::streaming_types::optional_32::Some { v: ref mut block_state1 } =>
          {
              let block_state2: &mut [u32] = *block_state1;
              (block_state2[0usize..8usize]).copy_from_slice(&block_state0[0usize..8usize]);
              let k·: crate::streaming_types::optional = crate::streaming_types::optional::Some;
              match k·
              {
                  crate::streaming_types::optional::None => [].into(),
...
*/
pub fn
update_256(state: &mut [crate::streaming_types::state_32], input: &[u8], input_len: u32) ->
    crate::streaming_types::error_code
...
*/
pub fn
digest_256(state: &[crate::streaming_types::state_32], output: &mut [u8])
{
...
pub fn malloc_224 <'a>() -> Box<[crate::streaming_types::state_32]>
{
    let buf: Box<[u8]> = vec![0u8; 64usize].into_boxed_slice();
    let buf1: &[u8] = &buf;
    let mut b: Box<[u32]> = vec![0u32; 8usize].into_boxed_slice();
        ...
        crate::streaming_types::optional_32::Some { v: ref mut block_state1 } =>
          {
              ...
              match k·
              {
                  ...
                  crate::streaming_types::optional::Some =>
                    {
                        crate::hash_sha2::sha224_init(block_state2);
                        let s: crate::streaming_types::state_32 =
                            crate::streaming_types::state_32
                            {
                                block_state: (*block_state2).into(),
...
pub fn update_224(state: &mut [crate::streaming_types::state_32], input: &[u8], input_len: u32) ->
    crate::streaming_types::error_code
{ crate::hash_sha2::update_224_256(state, input, input_len) }
...
*/
pub fn
digest_224(state: &[crate::streaming_types::state_32], output: &mut [u8])
{
    let block_state: &[u32] = &(state[0usize]).block_state;
    let buf_: &[u8] = &(state[0usize]).buf;
    let total_len: u64 = (state[0usize]).total_len;
...
pub fn malloc_512 <'a>() -> Box<[crate::streaming_types::state_64]>
{
    let buf: Box<[u8]> = vec![0u8; 128usize].into_boxed_slice();
    let buf1: &[u8] = &buf;
    let mut b: Box<[u64]> = vec![0u64; 8usize].into_boxed_slice();
    let mut block_state: crate::streaming_types::optional_64 =
        crate::streaming_types::optional_64::Some { v: &mut b };
    match block_state
    {
        crate::streaming_types::optional_64::None => { [].into() },
        crate::streaming_types::optional_64::Some { v: ref mut block_state1 } =>
          {
              let block_state2: &mut [u64] = *block_state1;
              let k·: crate::streaming_types::optional = crate::streaming_types::optional::Some;
              match k·
              {
                  crate::streaming_types::optional::None => [].into(),
                  crate::streaming_types::optional::Some =>
                    {
                        crate::hash_sha2::sha512_init(block_state2);
...
pub fn
copy_512
<'a>(state: &'a [crate::streaming_types::state_64]) ->
...
*/
pub fn
update_512(state: &mut [crate::streaming_types::state_64], input: &[u8], input_len: u32) ->
    crate::streaming_types::error_code
...
*/
pub fn
digest_512(state: &[crate::streaming_types::state_64], output: &mut [u8])
{
...
pub fn malloc_384 <'a>() -> Box<[crate::streaming_types::state_64]>
{
    let buf: Box<[u8]> = vec![0u8; 128usize].into_boxed_slice();
    let buf1: &[u8] = &buf;
    let mut b: Box<[u64]> = vec![0u64; 8usize].into_boxed_slice();
        ...
        crate::streaming_types::optional_64::Some { v: ref mut block_state1 } =>
          {
              ...
              match k·
              {
                  ...
                  crate::streaming_types::optional::Some =>
                    {
                        crate::hash_sha2::sha384_init(block_state2);
                        let s: crate::streaming_types::state_64 =
                            crate::streaming_types::state_64
                            {
                                block_state: (*block_state2).into(),
...
pub fn update_384(state: &mut [crate::streaming_types::state_64], input: &[u8], input_len: u32) ->
    crate::streaming_types::error_code
{ crate::hash_sha2::update_384_512(state, input, input_len) }
...
*/
pub fn
digest_384(state: &[crate::streaming_types::state_64], output: &mut [u8])
{
    let block_state: &[u64] = &(state[0usize]).block_state;
    let buf_: &[u8] = &(state[0usize]).buf;
    let total_len: u64 = (state[0usize]).total_len;
