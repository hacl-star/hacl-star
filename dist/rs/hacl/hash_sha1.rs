...
{
    krml::unroll_for!(5, "i", 0u32, 1u32, s[i as usize] = (&mut crate::hash_sha1::_h0)[i as usize])
}
...
pub(crate) fn hash_oneshot(output: &mut [u8], input: &mut [u8], input_len: u32)
{
    ...
    crate::hash_sha1::finish(&mut s, output)
}
...
pub fn digest(state: &mut [crate::streaming_types::state_32], output: &mut [u8])
{
    ...
    crate::hash_sha1::finish(&mut tmp_block_state, output)
}
