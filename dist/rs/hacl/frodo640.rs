...
pub fn crypto_kem_keypair(pk: &mut [u8], sk: &mut [u8]) -> u32
{
    ...
    crate::hash_sha3::shake128(&mut r, 20480u32, &shake_input_seed_se, 17u32);
    lib::memzero0::memzero::<u8>(&mut shake_input_seed_se, 17u32);
    crate::frodo_kem::frodo_sample_matrix640(640u32, 8u32, &(&r)[0usize..], &mut s_matrix);
    crate::frodo_kem::frodo_sample_matrix640(640u32, 8u32, &(&r)[10240usize..], &mut e_matrix);
    ...
    crate::frodo_kem::matrix_mul_s(640u32, 640u32, 8u32, &a_matrix, &s_matrix, &mut b_matrix);
    crate::frodo_kem::matrix_add(640u32, 8u32, &mut b_matrix, &e_matrix);
    crate::frodo_kem::frodo_pack(640u32, 8u32, 15u32, &b_matrix, b_bytes.1);
    crate::frodo_kem::matrix_to_lbytes(640u32, 8u32, &s_matrix, s_bytes.1);
...
pub fn crypto_kem_enc(ct: &mut [u8], ss: &mut [u8], pk: &[u8]) -> u32
{
    ...
    crate::hash_sha3::shake128(&mut r, 20608u32, &shake_input_seed_se, 17u32);
    lib::memzero0::memzero::<u8>(&mut shake_input_seed_se, 17u32);
    crate::frodo_kem::frodo_sample_matrix640(8u32, 640u32, &(&r)[0usize..], &mut sp_matrix);
    crate::frodo_kem::frodo_sample_matrix640(8u32, 640u32, &(&r)[10240usize..], &mut ep_matrix);
    crate::frodo_kem::frodo_sample_matrix640(8u32, 8u32, &(&r)[20480usize..], &mut epp_matrix);
    ...
    crate::frodo_kem::matrix_mul(8u32, 640u32, 640u32, &sp_matrix, &a_matrix, &mut bp_matrix);
    crate::frodo_kem::matrix_add(8u32, 640u32, &mut bp_matrix, &ep_matrix);
    crate::frodo_kem::frodo_pack(8u32, 640u32, 15u32, &bp_matrix, c2.0);
    let mut v_matrix: [u16; 64] = [0u16; 64usize];
    let mut b_matrix: [u16; 5120] = [0u16; 5120usize];
    crate::frodo_kem::frodo_unpack(640u32, 8u32, 15u32, b.1, &mut b_matrix);
    crate::frodo_kem::matrix_mul(8u32, 640u32, 8u32, &sp_matrix, &b_matrix, &mut v_matrix);
...
pub fn crypto_kem_dec(ss: &mut [u8], ct: &[u8], sk: &[u8]) -> u32
{
    ...
    crate::frodo_kem::matrix_mul_s(8u32, 640u32, 8u32, &bp_matrix, &s_matrix, &mut m_matrix);
    ...
    crate::frodo_kem::matrix_mul(8u32, 640u32, 640u32, &sp_matrix, &a_matrix, &mut bpp_matrix);
    crate::frodo_kem::matrix_add(8u32, 640u32, &mut bpp_matrix, &ep_matrix);
    let mut b_matrix: [u16; 5120] = [0u16; 5120usize];
    crate::frodo_kem::frodo_unpack(640u32, 8u32, 15u32, b.1, &mut b_matrix);
    crate::frodo_kem::matrix_mul(8u32, 640u32, 8u32, &sp_matrix, &b_matrix, &mut cp_matrix);
    ...
    lib::memzero0::memzero::<u16>(&mut ep_matrix, 5120u32);
    lib::memzero0::memzero::<u16>(&mut epp_matrix, 64u32);
    let b1: u16 = crate::frodo_kem::matrix_eq(8u32, 640u32, &bp_matrix, &bpp_matrix);
