...
)
{
    ...
    let mkey: (&mut [u8], &mut [u8]) = xkeys.split_at_mut(32usize);
    ...
    u32
{
    ...
    krml::unroll_for!(
        ...
        1u32,
        {
            let uu____0: u8 = fstar::uint8::eq_mask(tag[i as usize], (&mut tag·)[i as usize]);
...
#[inline] fn box_beforenm(k: &mut [u8], pk: &mut [u8], sk: &mut [u8]) -> u32
{
    ...
    if r
    {
        crate::salsa20::hsalsa200(k, k, &mut n0);
        0u32
    }
    else
    { 0xffffffffu32 }
    ...
    u32
{
    ...
    if r == 0u32
    { crate::nacl::box_detached_afternm(mlen, c, tag, &mut k, n, m) }
    else
    { 0xffffffffu32 }
}
    ...
    u32
{
    ...
    let r: u32 = crate::nacl::box_beforenm(&mut k, pk, sk);
    if r == 0u32
    { crate::nacl::box_open_detached_afternm(mlen, m, &mut k, n, c, tag) }
    else
    { 0xffffffffu32 }
}
...
*/
pub fn
crypto_secretbox_easy(c: &mut [u8], m: &mut [u8], mlen: u32, n: &mut [u8], k: &mut [u8]) ->
    u32
{
...
*/
pub fn
crypto_secretbox_open_easy(m: &mut [u8], c: &mut [u8], clen: u32, n: &mut [u8], k: &mut [u8]) ->
    u32
...
*/
pub fn
crypto_box_beforenm(k: &mut [u8], pk: &mut [u8], sk: &mut [u8]) ->
    u32
...
*/
pub fn
crypto_box_easy_afternm(c: &mut [u8], m: &mut [u8], mlen: u32, n: &mut [u8], k: &mut [u8]) ->
    u32
...
*/
pub fn
crypto_box_open_easy_afternm(m: &mut [u8], c: &mut [u8], clen: u32, n: &mut [u8], k: &mut [u8]) ->
    u32
