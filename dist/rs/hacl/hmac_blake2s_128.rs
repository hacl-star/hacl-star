...
)
{
    ...
    { crate::hash_blake2s_simd128::hash_with_key(zeroes.0, 32u32, key, key_len, &mut [], 0u32) };
    ...
    if data_len == 0u32
    {
        let mut wv: [lib::intvector_intrinsics::vec128; 4] =
            [lib::intvector_intrinsics::vec128_zero; 4usize];
        crate::hash_blake2s_simd128::update_last(64u32, &mut wv, s0, false, 0u64, 64u32, &mut ipad)
    }
    else
    {
        ...
        let mut wv: [lib::intvector_intrinsics::vec128; 4] =
            [lib::intvector_intrinsics::vec128_zero; 4usize];
        crate::hash_blake2s_simd128::update_multi(64u32, &mut wv, s0, 0u64, &mut ipad, 1u32);
    ...
    let mut wv: [lib::intvector_intrinsics::vec128; 4] =
        [lib::intvector_intrinsics::vec128_zero; 4usize];
    crate::hash_blake2s_simd128::update_multi(64u32, &mut wv, s0, 0u64, &mut opad, 1u32);
    let mut wv0: [lib::intvector_intrinsics::vec128; 4] =
        [lib::intvector_intrinsics::vec128_zero; 4usize];
    crate::hash_blake2s_simd128::update_multi(
        n_blocks0.wrapping_mul(64u32),
