...
{ pub fst: &'a mut [crate::hash_blake2b::blake2_params <'a>], pub snd: &'a mut [u8] }
...
fn update_key(wv: &mut [u64], hash: &mut [u64], kk: u32, k: &mut [u8], ll: u32)
{
    ...
    if ll == 0u32
    { crate::hash_blake2b::update_block(wv, hash, true, false, lb, &mut b) }
    else
    { crate::hash_blake2b::update_block(wv, hash, false, false, lb, &mut b) };
...
)
{
    ...
    crate::hash_blake2b::update_block(wv, hash, true, last_node, totlen, &mut b);
    lib::memzero0::memzero::<u8>(&mut b, 128u32)
}
...
pub(crate) fn finish(nn: u32, output: &mut [u8], hash: &mut [u64])
{
    ...
    Box<[crate::hash_blake2b::state_t]>
{
    ...
    let mut wv: Box<[u64]> = vec![0u64; 16usize].into_boxed_slice();
    let mut b: Box<[u64]> = vec![0u64; 16usize].into_boxed_slice();
    ...
    let mut s: crate::hash_blake2b::state_t =
        crate::hash_blake2b::state_t { block_state, buf, total_len: ite as u64 };
    let mut p0: Box<[crate::hash_blake2b::state_t]> = vec![s].into_boxed_slice();
    p0
}

fn index_of_state(s: &mut [crate::hash_blake2b::state_t]) -> crate::hash_blake2b::index
{
    let mut block_state: &mut crate::hash_blake2b::block_state_t = &mut (s[0usize]).block_state;
    match *block_state
    {
...
{
    let mut block_state: &mut crate::hash_blake2b::block_state_t =
...
*/
pub fn
reset_with_key(s: &mut [crate::hash_blake2b::state_t], k: &mut [u8])
{
    ...
    crate::hash_blake2b::reset_raw(s, crate::hash_blake2b::params_and_key { fst: &mut p0, snd: k })
}
...
{ crate::hash_blake2b::reset_with_key(s, &mut []) }

/**
Update function; 0 = success, 1 = max length exceeded
*/
pub fn
update0(state: &mut [crate::hash_blake2b::state_t], chunk: &mut [u8], chunk_len: u32) ->
    ...
    else
    {
        ...
        else if sz == 0u32
        {
            ...
            if sz1 != 0u32
            {
                ...
                match *block_state
                {
                    crate::hash_blake2b::block_state_t { f3: wv, f4: hash, .. } =>
                      {
                          let nb: u32 = 1u32;
...
*/
pub fn
digest(s: &mut [crate::hash_blake2b::state_t], dst: &mut [u8]) ->
    u8
{
    let mut block_state: &mut crate::hash_blake2b::block_state_t = &mut (s[0usize]).block_state;
    let i1: crate::hash_blake2b::index =
    ...
    let mut block_state0: &mut crate::hash_blake2b::block_state_t = &mut (s[0usize]).block_state;
    ...
    match *block_state0
    {
        crate::hash_blake2b::block_state_t { f4: src_b, .. } =>
          match tmp_block_state
          {
              crate::hash_blake2b::block_state_t { f4: dst_b, .. } =>
    ...
    match tmp_block_state
    {
        crate::hash_blake2b::block_state_t { f3: wv0, f4: hash, .. } =>
          {
              let nb: u32 = 0u32;
              crate::hash_blake2b::update_multi(
                  0u32,
    ...
    match tmp_block_state
    {
        crate::hash_blake2b::block_state_t { thd: last_node, f3: wv0, f4: hash, .. } =>
    ...
    match tmp_block_state
    {
        crate::hash_blake2b::block_state_t { snd: nn, .. } =>
          crate::hash_blake2b::finish(nn as u32, dst, &mut tmp_block_state.f4)
    };
    let mut block_state1: &mut crate::hash_blake2b::block_state_t = &mut (s[0usize]).block_state;
    match *block_state1
    {
        crate::hash_blake2b::block_state_t { fst: kk, snd: nn, thd: last_node, .. } =>
          crate::hash_blake2b::index { key_length: kk, digest_length: nn, last_node }
...
pub fn info(s: &mut [crate::hash_blake2b::state_t]) -> crate::hash_blake2b::index
{
    let mut block_state: &mut crate::hash_blake2b::block_state_t = &mut (s[0usize]).block_state;
    match *block_state
    {
...
*/
pub fn
copy(state: &mut [crate::hash_blake2b::state_t]) ->
    Box<[crate::hash_blake2b::state_t]>
{
    let mut block_state0: &mut crate::hash_blake2b::block_state_t =
        &mut (state[0usize]).block_state;
    let buf0: &mut [u8] = &mut (state[0usize]).buf;
    ...
    let mut p: Box<[crate::hash_blake2b::state_t]> = vec![s].into_boxed_slice();
    p
}
...
)
{
    ...
    crate::hash_blake2b::finish(output_len, output, &mut b);
...
)
{
    ...
    crate::hash_blake2b::finish(params.digest_length as u32, output, &mut b);
    lib::memzero0::memzero::<u64>(&mut b1, 16u32);
    lib::memzero0::memzero::<u64>(&mut b, 16u32)
}
