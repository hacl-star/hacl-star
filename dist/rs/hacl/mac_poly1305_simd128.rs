...
pub(crate) fn load_acc2(acc: &mut [lib::intvector_intrinsics::vec128], b: &mut [u8])
{
    ...
    let b1: lib::intvector_intrinsics::vec128 =
        lib::intvector_intrinsics::vec128_load64_le(&mut b[0usize..]);
    let b2: lib::intvector_intrinsics::vec128 =
        lib::intvector_intrinsics::vec128_load64_le(&mut b[16usize..]);
    ...
    let e0: lib::intvector_intrinsics::vec128 = (&mut e)[0usize];
    let e1: lib::intvector_intrinsics::vec128 = (&mut e)[1usize];
    let e2: lib::intvector_intrinsics::vec128 = (&mut e)[2usize];
    let e3: lib::intvector_intrinsics::vec128 = (&mut e)[3usize];
    let e4: lib::intvector_intrinsics::vec128 = (&mut e)[4usize];
...
pub(crate) fn fmul_r2_normalize(
    ...
    p: &mut [lib::intvector_intrinsics::vec128]
)
{
...
pub(crate) fn poly1305_init(ctx: &mut [lib::intvector_intrinsics::vec128], key: &mut [u8])
{
...
fn poly1305_update(ctx: &mut [lib::intvector_intrinsics::vec128], len: u32, text: &mut [u8])
{
    let pre: (&mut [lib::intvector_intrinsics::vec128], &mut [lib::intvector_intrinsics::vec128]) =
    ...
    for i in 0u32..nb
    {
        ...
        (&mut e)[4usize] = lib::intvector_intrinsics::vec128_or(f41, mask);
        let
        r: (&mut [lib::intvector_intrinsics::vec128], &mut [lib::intvector_intrinsics::vec128])
        =
            pre.1.split_at_mut(0usize);
        let
...
pub fn malloc(key: &mut [u8]) -> Box<[crate::mac_poly1305_simd128::state_t]>
{
    let mut buf: Box<[u8]> = vec![0u8; 32usize].into_boxed_slice();
    ...
    let mut s: crate::mac_poly1305_simd128::state_t =
        crate::mac_poly1305_simd128::state_t
        { block_state: (*block_state).into(), buf, total_len: 0u32 as u64, p_key: (*k·0).into() };
    let mut p: Box<[crate::mac_poly1305_simd128::state_t]> = vec![s].into_boxed_slice();
    p
}

pub fn reset(state: &mut [crate::mac_poly1305_simd128::state_t], key: &mut [u8])
{
...
*/
pub fn
update(state: &mut [crate::mac_poly1305_simd128::state_t], chunk: &mut [u8], chunk_len: u32) ->
...
pub fn digest(state: &mut [crate::mac_poly1305_simd128::state_t], output: &mut [u8])
{
    let block_state: &mut [lib::intvector_intrinsics::vec128] = &mut (state[0usize]).block_state;
