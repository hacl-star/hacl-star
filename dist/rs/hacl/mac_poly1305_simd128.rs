...
pub(crate) fn load_acc2(acc: &mut [crate::lib::intvector_intrinsics::vec128], b: &[u8])
{
    ...
    let b1: crate::lib::intvector_intrinsics::vec128 =
        crate::lib::intvector_intrinsics::vec128_load64_le(&b[0usize..]);
    let b2: crate::lib::intvector_intrinsics::vec128 =
        crate::lib::intvector_intrinsics::vec128_load64_le(&b[16usize..]);
    ...
    let e0: crate::lib::intvector_intrinsics::vec128 = (&e)[0usize];
    let e1: crate::lib::intvector_intrinsics::vec128 = (&e)[1usize];
    let e2: crate::lib::intvector_intrinsics::vec128 = (&e)[2usize];
    let e3: crate::lib::intvector_intrinsics::vec128 = (&e)[3usize];
    let e4: crate::lib::intvector_intrinsics::vec128 = (&e)[4usize];
...
pub(crate) fn fmul_r2_normalize(
    ...
    p: &[crate::lib::intvector_intrinsics::vec128]
)
{
    let
    ...
    =
        p.split_at(0usize);
    let
    r2: (&[crate::lib::intvector_intrinsics::vec128], &[crate::lib::intvector_intrinsics::vec128])
    =
...
pub(crate) fn poly1305_init(ctx: &mut [crate::lib::intvector_intrinsics::vec128], key: &[u8])
{
    let
    acc:
...
fn poly1305_update(ctx: &mut [crate::lib::intvector_intrinsics::vec128], len: u32, text: &[u8])
{
    let
    pre:
    (&mut [crate::lib::intvector_intrinsics::vec128],
...
pub struct state_t
{
    pub block_state: Box<[crate::lib::intvector_intrinsics::vec128]>,
    pub buf: Box<[u8]>,
    pub total_len: u64,
    pub p_key: Box<[u8]>
}
...
pub fn malloc(key: &[u8]) -> Box<[state_t]>
{
    ...
    let mut r1: Box<[crate::lib::intvector_intrinsics::vec128]> =
        vec![crate::lib::intvector_intrinsics::vec128_zero; 25usize].into_boxed_slice();
...
{
    let block_state: &[crate::lib::intvector_intrinsics::vec128] = &(state[0usize]).block_state;
