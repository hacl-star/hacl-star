...
pub fn crypto_kem_enc(ct: &mut [u8], ss: &mut [u8], pk: &[u8]) -> u32
{
    ...
    crate::hash_sha3::shake256(&mut seed_se_k, 64u32, &pkh_mu, 64u32);
    ...
    crate::frodo_kem::matrix_mul(8u32, 1344u32, 8u32, &sp_matrix, &b_matrix, &mut v_matrix);
    crate::frodo_kem::matrix_add(8u32, 8u32, &mut v_matrix, &epp_matrix);
    let mut mu_encode: [u16; 64] = [0u16; 64usize];
    crate::frodo_kem::frodo_key_encode(16u32, 4u32, 8u32, &coins, &mut mu_encode);
    ...
    crate::hash_sha3::shake256(ss, 32u32, &shake_input_ss, ss_init_len);
...
pub fn crypto_kem_dec(ss: &mut [u8], ct: &[u8], sk: &[u8]) -> u32
{
    ...
    crate::frodo_kem::matrix_mul_s(8u32, 1344u32, 8u32, &bp_matrix, &s_matrix, &mut m_matrix);
    crate::frodo_kem::matrix_sub(8u32, 8u32, &c_matrix, &mut m_matrix);
    crate::frodo_kem::frodo_key_decode(16u32, 4u32, 8u32, &m_matrix, &mut mu_decode);
    lib::memzero0::memzero::<u16>(&mut s_matrix, 10752u32);
    ...
    crate::hash_sha3::shake256(&mut seed_se_k, 64u32, &pkh_mu_decode, pkh_mu_decode_len);
    let seed_se: (&[u8], &[u8]) = seed_se_k.split_at(0usize);
    ...
    let mut b_matrix: [u16; 10752] = [0u16; 10752usize];
    crate::frodo_kem::frodo_unpack(1344u32, 8u32, 16u32, b.1, &mut b_matrix);
    crate::frodo_kem::matrix_mul(8u32, 1344u32, 8u32, &sp_matrix, &b_matrix, &mut cp_matrix);
    crate::frodo_kem::matrix_add(8u32, 8u32, &mut cp_matrix, &epp_matrix);
    let mut mu_encode: [u16; 64] = [0u16; 64usize];
    crate::frodo_kem::frodo_key_encode(16u32, 4u32, 8u32, &mu_decode, &mut mu_encode);
    ...
    lib::memzero0::memzero::<u16>(&mut ep_matrix, 10752u32);
    lib::memzero0::memzero::<u16>(&mut epp_matrix, 64u32);
    let b1: u16 = crate::frodo_kem::matrix_eq(8u32, 1344u32, &bp_matrix, &bpp_matrix);
    ...
    crate::hash_sha3::shake256(ss, 32u32, &ss_init, ss_init_len);
