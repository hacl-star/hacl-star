...
pub fn crypto_kem_keypair(pk: &mut [u8], sk: &mut [u8]) -> u32
{
    ...
    crate::hash_sha3::shake256(&mut r, 31232u32, &shake_input_seed_se, 25u32);
    lib::memzero0::memzero::<u8>(&mut shake_input_seed_se, 25u32);
    crate::frodo_kem::frodo_sample_matrix976(976u32, 8u32, &(&r)[0usize..], &mut s_matrix);
    crate::frodo_kem::frodo_sample_matrix976(976u32, 8u32, &(&r)[15616usize..], &mut e_matrix);
    ...
    crate::frodo_kem::matrix_mul_s(976u32, 976u32, 8u32, &a_matrix, &s_matrix, &mut b_matrix);
    crate::frodo_kem::matrix_add(976u32, 8u32, &mut b_matrix, &e_matrix);
    crate::frodo_kem::frodo_pack(976u32, 8u32, 16u32, &b_matrix, b_bytes.1);
    crate::frodo_kem::matrix_to_lbytes(976u32, 8u32, &s_matrix, s_bytes.1);
...
pub fn crypto_kem_enc(ct: &mut [u8], ss: &mut [u8], pk: &[u8]) -> u32
{
    ...
    crate::hash_sha3::shake256(&mut r, 31360u32, &shake_input_seed_se, 25u32);
    lib::memzero0::memzero::<u8>(&mut shake_input_seed_se, 25u32);
    ...
    crate::frodo_kem::matrix_mul(8u32, 976u32, 976u32, &sp_matrix, &a_matrix, &mut bp_matrix);
    crate::frodo_kem::matrix_add(8u32, 976u32, &mut bp_matrix, &ep_matrix);
    crate::frodo_kem::frodo_pack(8u32, 976u32, 16u32, &bp_matrix, c2.0);
    let mut v_matrix: [u16; 64] = [0u16; 64usize];
    let mut b_matrix: [u16; 7808] = [0u16; 7808usize];
    crate::frodo_kem::frodo_unpack(976u32, 8u32, 16u32, b.1, &mut b_matrix);
    crate::frodo_kem::matrix_mul(8u32, 976u32, 8u32, &sp_matrix, &b_matrix, &mut v_matrix);
    crate::frodo_kem::matrix_add(8u32, 8u32, &mut v_matrix, &epp_matrix);
    let mut mu_encode: [u16; 64] = [0u16; 64usize];
    crate::frodo_kem::frodo_key_encode(16u32, 3u32, 8u32, &coins, &mut mu_encode);
    crate::frodo_kem::matrix_add(8u32, 8u32, &mut v_matrix, &mu_encode);
    lib::memzero0::memzero::<u16>(&mut mu_encode, 64u32);
    crate::frodo_kem::frodo_pack(8u32, 8u32, 16u32, &v_matrix, c2.1);
    ...
    crate::hash_sha3::shake256(ss, 24u32, &shake_input_ss, ss_init_len);
...
pub fn crypto_kem_dec(ss: &mut [u8], ct: &[u8], sk: &[u8]) -> u32
{
    ...
    crate::frodo_kem::matrix_mul_s(8u32, 976u32, 8u32, &bp_matrix, &s_matrix, &mut m_matrix);
    crate::frodo_kem::matrix_sub(8u32, 8u32, &c_matrix, &mut m_matrix);
    crate::frodo_kem::frodo_key_decode(16u32, 3u32, 8u32, &m_matrix, &mut mu_decode);
    lib::memzero0::memzero::<u16>(&mut s_matrix, 7808u32);
    ...
    crate::frodo_kem::matrix_mul(8u32, 976u32, 976u32, &sp_matrix, &a_matrix, &mut bpp_matrix);
    crate::frodo_kem::matrix_add(8u32, 976u32, &mut bpp_matrix, &ep_matrix);
    let mut b_matrix: [u16; 7808] = [0u16; 7808usize];
    crate::frodo_kem::frodo_unpack(976u32, 8u32, 16u32, b.1, &mut b_matrix);
    crate::frodo_kem::matrix_mul(8u32, 976u32, 8u32, &sp_matrix, &b_matrix, &mut cp_matrix);
    crate::frodo_kem::matrix_add(8u32, 8u32, &mut cp_matrix, &epp_matrix);
    let mut mu_encode: [u16; 64] = [0u16; 64usize];
    crate::frodo_kem::frodo_key_encode(16u32, 3u32, 8u32, &mu_decode, &mut mu_encode);
    ...
    lib::memzero0::memzero::<u16>(&mut ep_matrix, 7808u32);
    lib::memzero0::memzero::<u16>(&mut epp_matrix, 64u32);
    let b1: u16 = crate::frodo_kem::matrix_eq(8u32, 976u32, &bp_matrix, &bpp_matrix);
    ...
    crate::hash_sha3::shake256(ss, 24u32, &ss_init, ss_init_len);
