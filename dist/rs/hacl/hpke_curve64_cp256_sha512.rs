    ...
    u32
{
    ...
    let res: u32 =
        crate::hpke_curve64_cp256_sha512::setupBaseS(o_enc, o_ctx, skE, pkR, infolen, info);
    if res == 0u32
    {
    ...
    u32
{
    ...
    let res: u32 = crate::hpke_curve64_cp256_sha512::setupBaseR(o_ctx, pkE, skR, infolen, info);
    if res == 0u32
    {
        let mut nonce: [u8; 12] = [0u8; 12usize];
        let s: u64 = o_ctx.ctx_seq[0usize];
