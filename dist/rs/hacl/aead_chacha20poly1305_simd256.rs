...
)
{
    ...
    {
        let
        pre0: (&mut [lib::intvector_intrinsics::vec256], &mut [lib::intvector_intrinsics::vec256])
        =
            pre.1.split_at_mut(0usize);
        let
...
)
{
    ...
    crate::chacha20_vec256::chacha20_encrypt_256(64u32, &mut tmp, &mut tmp_copy, key, nonce, 0u32);
