...
#[inline] fn fmul(output: &mut [u64], input: &mut [u64], input2: &mut [u64])
{
    ...
    crate::bignum25519_51::fmul(output, input, input2, &mut tmp)
}
...
#[inline] fn times_d(out: &mut [u64], a: &mut [u64])
{
    ...
    crate::ed25519::fmul(out, &mut d, a)
}
...
#[inline] fn times_2d(out: &mut [u64], a: &mut [u64])
{
    ...
    crate::ed25519::fmul(out, &mut d2, a)
}
...
{
    let mut tmp: [fstar::uint128::uint128; 5] = [fstar::uint128::uint64_to_uint128(0u64); 5usize];
    crate::curve25519_51::fsquare_times(output, input, &mut tmp, count)
}
...
#[inline] fn fsquare_times_inplace(output: &mut [u64], count: u32)
{
    ...
    crate::curve25519_51::fsquare_times(output, &mut input, &mut tmp, count)
}

pub(crate) fn inverse(out: &mut [u64], a: &mut [u64])
{
    let mut tmp: [fstar::uint128::uint128; 10] =
        [fstar::uint128::uint64_to_uint128(0u64); 10usize];
    crate::curve25519_51::finv(out, a, &mut tmp)
}
...
pub(crate) fn load_51(output: &mut [u64], input: &mut [u8])
{
...
pub(crate) fn store_51(output: &mut [u8], input: &mut [u64])
{
    let mut u64s: [u64; 4] = [0u64; 4usize];
...
pub(crate) fn point_double(out: &mut [u64], p: &mut [u64])
{
    ...
    crate::ed25519::times_2(tmp2.0, &mut a_copy);
    ...
    crate::ed25519::fsquare(tmp20.1, &mut a_copy0);
    ...
    crate::ed25519::fdifference(tmp20.1, tmp30.1, &mut b_copy);
    ...
    crate::ed25519::fsum(tmp10.1, &mut a_copy1, tmp40.1);
...
pub(crate) fn point_add(out: &mut [u64], p: &mut [u64], q: &mut [u64])
{
    ...
    crate::ed25519::fmul(tmp10.1, &mut inp_copy, t2.1);
    ...
    crate::ed25519::fmul(tmp20.1, &mut inp_copy0, t2.0);
    ...
    crate::ed25519::fsum(tmp10.1, &mut a_copy, tmp20.1);
...
#[inline] fn pow2_252m2(out: &mut [u64], z: &mut [u64])
{
    ...
    crate::ed25519::fmul(c.0, &mut inp_copy1, b.0);
    ...
    crate::ed25519::fmul(b.0, &mut inp_copy2, c.1);
    ...
    crate::ed25519::fmul(c.0, &mut inp_copy3, b.0);
    ...
    crate::ed25519::fmul(t00.1, &mut inp_copy4, c0.1);
    ...
    crate::ed25519::fmul(t00.1, &mut inp_copy5, b0.1);
...
#[inline] fn mul_modp_sqrt_m1(x: &mut [u64])
{
    ...
    crate::ed25519::fmul(x, &mut inp_copy, &mut sqrt_m1)
}
...
#[inline] fn recover_x(x: &mut [u64], y: &mut [u64], sign: u64) -> bool
{
    ...
    let res: bool =
        ...
        else
        {
            ...
            crate::ed25519::fsum(dyy.1, &mut a_copy, y2.0);
            ...
            crate::ed25519::fmul(x2.1, &mut inp_copy, dyy.0);
            ...
            else
            {
                ...
                crate::ed25519::fdifference(t0.1, &mut a_copy0, x30.0);
                ...
                crate::ed25519::fdifference(t00.1, &mut a_copy1, x211.1);
                ...
                if z1
                {
                    ...
                    if x01 != sign
                    {
                        ...
                        crate::ed25519::fdifference(x32.1, t01.1, &mut b_copy);
...
pub(crate) fn point_decompress(out: &mut [u64], s: &mut [u8]) -> bool
{
...
pub(crate) fn point_compress(z: &mut [u8], p: &mut [u64])
{
    let mut tmp: [u64; 15] = [0u64; 15usize];
...
#[inline] fn mul_modq(out: &mut [u64], x: &mut [u64], y: &mut [u64])
{
    ...
    (&mut tmp)[8usize] = z80;
    (&mut tmp)[9usize] = z9;
    crate::ed25519::barrett_reduction(out, &mut tmp)
}
...
pub(crate) fn point_equal(p: &mut [u64], q: &mut [u64]) -> bool
{
    let mut tmp: [u64; 20] = [0u64; 20usize];
    let pxqz: (&mut [u64], &mut [u64]) = tmp.split_at_mut(0usize);
    let qxpz: (&mut [u64], &mut [u64]) = pxqz.1.split_at_mut(5usize);
    crate::ed25519::fmul(qxpz.0, &mut p[0usize..], &mut q[10usize..]);
    crate::ed25519::reduce(qxpz.0);
    crate::ed25519::fmul(qxpz.1, &mut q[0usize..], &mut p[10usize..]);
    ...
    if b
    {
        ...
        crate::ed25519::fmul(qypz.0, &mut p[5usize..], &mut q[10usize..]);
        crate::ed25519::reduce(qypz.0);
        crate::ed25519::fmul(qypz.1, &mut q[5usize..], &mut p[10usize..]);
...
pub(crate) fn point_negate(p: &mut [u64], out: &mut [u64])
{
    ...
    let z1: (&mut [u64], &mut [u64]) = y1.1.split_at_mut(5usize);
    let t1: (&mut [u64], &mut [u64]) = z1.1.split_at_mut(5usize);
    crate::ed25519::fdifference(y1.0, &mut zero, y.0);
    ...
    crate::ed25519::fdifference(t1.1, &mut zero, t.1);
    crate::ed25519::reduce_513(t1.1)
}

pub(crate) fn point_mul(out: &mut [u64], scalar: &mut [u8], q: &mut [u64])
{
    ...
    krml::unroll_for!(
        ...
        1u32,
        {
            ...
            crate::ed25519::point_double(&mut tmp, &mut p_copy);
            ...
            crate::ed25519::point_add(&mut tmp, &mut p_copy0, t2.1);
    ...
    for i in 0u32..64u32
    {
        krml::unroll_for!(
            ...
            1u32,
            {
                ...
                crate::ed25519::point_double(out, &mut p_copy)
            }
        );
        let k: u32 = 256u32.wrapping_sub(4u32.wrapping_mul(i)).wrapping_sub(4u32);
        let bits_l: u64 = bignum::bignum_base::bn_get_bits_u64(4u32, &mut bscalar, k, 4u32);
        lowstar::ignore::ignore::<&mut [u64]>(&mut table);
        ...
        krml::unroll_for!(
            ...
            1u32,
            {
                ...
                let res_j: (&mut [u64], &mut [u64]) =
                    table.split_at_mut(i0.wrapping_add(1u32).wrapping_mul(20u32) as usize);
                krml::unroll_for!(
                    20,
                    "i1",
                    0u32,
        ...
        let mut p_copy: [u64; 20] = [0u64; 20usize];
        ((&mut p_copy)[0usize..20usize]).copy_from_slice(&out[0usize..20usize]);
        crate::ed25519::point_add(out, &mut p_copy, &mut tmp0)
    }
}

#[inline] fn precomp_get_consttime(table: &mut [u64], bits_l: u64, tmp: &mut [u64])
{
    (tmp[0usize..20usize]).copy_from_slice(&(&mut table[0usize..])[0usize..20usize]);
    krml::unroll_for!(
        15,
        "i",
        0u32,
...
#[inline] fn point_mul_g(out: &mut [u64], scalar: &mut [u8])
{
    ...
    let r1: (&mut [u64], &mut [u64]) = bscalar.split_at_mut(0usize);
    ...
    krml::unroll_for!(
        ...
        1u32,
        {
            ...
            lowstar::ignore::ignore::<&mut [u64]>(
                &mut crate::ed25519_precomptable::precomp_g_pow2_192_table_w4
            );
            ...
            let mut p_copy: [u64; 20] = [0u64; 20usize];
            ((&mut p_copy)[0usize..20usize]).copy_from_slice(&out[0usize..20usize]);
            crate::ed25519::point_add(out, &mut p_copy, &mut tmp);
            ...
            lowstar::ignore::ignore::<&mut [u64]>(
                &mut crate::ed25519_precomptable::precomp_g_pow2_128_table_w4
            );
            crate::ed25519::precomp_get_consttime(
                &mut crate::ed25519_precomptable::precomp_g_pow2_128_table_w4,
                bits_l0,
            ...
            crate::ed25519::point_add(out, &mut p_copy0, &mut tmp);
            ...
            lowstar::ignore::ignore::<&mut [u64]>(
                &mut crate::ed25519_precomptable::precomp_g_pow2_64_table_w4
            );
            crate::ed25519::precomp_get_consttime(
                &mut crate::ed25519_precomptable::precomp_g_pow2_64_table_w4,
                bits_l1,
            ...
            crate::ed25519::point_add(out, &mut p_copy1, &mut tmp);
            ...
            lowstar::ignore::ignore::<&mut [u64]>(
                &mut crate::ed25519_precomptable::precomp_basepoint_table_w4
            );
            crate::ed25519::precomp_get_consttime(
                &mut crate::ed25519_precomptable::precomp_basepoint_table_w4,
                bits_l2,
            ...
            crate::ed25519::point_add(out, &mut p_copy2, &mut tmp)
        }
    );
...
)
{
    ...
    krml::unroll_for!(
        ...
        {
            let t11: (&mut [u64], &mut [u64]) =
                table2.split_at_mut(i.wrapping_add(1u32).wrapping_mul(20u32) as usize);
            let mut p_copy: [u64; 20] = [0u64; 20usize];
            ((&mut p_copy)[0usize..20usize]).copy_from_slice(&t11.1[0usize..20usize]);
            crate::ed25519::point_double(&mut tmp1, &mut p_copy);
            ...
            crate::ed25519::point_add(&mut tmp1, &mut p_copy0, t2.1);
    ...
    let a_bits_l: &mut [u64] =
        &mut
        (&mut crate::ed25519_precomptable::precomp_basepoint_table_w5)[bits_l32.wrapping_mul(20u32)
        as
        usize..];
    ...
    let a_bits_l0: (&mut [u64], &mut [u64]) =
        table2.split_at_mut(bits_l320.wrapping_mul(20u32) as usize);
    ((&mut tmp10)[0usize..20usize]).copy_from_slice(&a_bits_l0.1[0usize..20usize]);
    let mut p_copy: [u64; 20] = [0u64; 20usize];
    ((&mut p_copy)[0usize..20usize]).copy_from_slice(&out[0usize..20usize]);
    crate::ed25519::point_add(out, &mut p_copy, &mut tmp10);
    ...
    for i1 in 0u32..51u32
    {
        krml::unroll_for!(
            ...
            1u32,
            {
                let mut p_copy0: [u64; 20] = [0u64; 20usize];
                ((&mut p_copy0)[0usize..20usize]).copy_from_slice(&out[0usize..20usize]);
                crate::ed25519::point_double(out, &mut p_copy0)
            }
        );
        ...
        let a_bits_l1: (&mut [u64], &mut [u64]) =
            table2.split_at_mut(bits_l321.wrapping_mul(20u32) as usize);
        ((&mut tmp11)[0usize..20usize]).copy_from_slice(&a_bits_l1.1[0usize..20usize]);
        let mut p_copy0: [u64; 20] = [0u64; 20usize];
        ((&mut p_copy0)[0usize..20usize]).copy_from_slice(&out[0usize..20usize]);
        crate::ed25519::point_add(out, &mut p_copy0, &mut tmp11);
        ...
        lowstar::ignore::ignore::<&mut [u64]>(
            &mut crate::ed25519_precomptable::precomp_basepoint_table_w5
        );
        let bits_l322: u32 = bits_l0 as u32;
        let a_bits_l2: &mut [u64] =
            &mut
            (&mut crate::ed25519_precomptable::precomp_basepoint_table_w5)[bits_l322.wrapping_mul(
                20u32
            )
            as
            usize..];
        ...
        let mut p_copy1: [u64; 20] = [0u64; 20usize];
        ((&mut p_copy1)[0usize..20usize]).copy_from_slice(&out[0usize..20usize]);
        crate::ed25519::point_add(out, &mut p_copy1, &mut tmp11)
    }
}
...
)
{
    ...
    crate::ed25519::point_mul_g_double_vartime(out, scalar1, scalar2, &mut q2_neg)
}
...
#[inline] fn load_32_bytes(out: &mut [u64], b: &mut [u8])
{
    ...
    let z2: u64 = u2;
    let b3: u64 = z2 & 0xffffffffffffffu64;
    let u3: u32 = lowstar::endianness::load32_le(&mut b[28usize..]);
    let b4: u32 = u3;
...
#[inline] fn sha512_pre_msg(hash: &mut [u8], prefix: &mut [u8], len: u32, input: &mut [u8])
{
    ...
    let mut s: crate::streaming_types::state_64 =
...
#[inline] fn sha512_modq_pre(out: &mut [u64], prefix: &mut [u8], len: u32, input: &mut [u8])
{
    ...
    crate::ed25519::load_64_bytes(&mut tmp, &mut hash);
    crate::ed25519::barrett_reduction(out, &mut tmp)
}
...
#[inline] fn point_mul_g_compress(out: &mut [u8], s: &mut [u8])
{
    ...
    crate::ed25519::point_compress(out, &mut tmp)
}
...
secret_to_public(public_key: &mut [u8], private_key: &mut [u8])
{
    ...
    let a: (&mut [u8], &mut [u8]) = expanded_secret.split_at_mut(0usize);
...
*/
pub fn
expand_keys(expanded_keys: &mut [u8], private_key: &mut [u8])
{
...
*/
pub fn
sign_expanded(signature: &mut [u8], expanded_keys: &mut [u8], msg_len: u32, msg: &mut [u8])
{
    ...
    crate::ed25519::store_56(&mut rb, &mut rq);
    crate::ed25519::point_mul_g_compress(ss.0, &mut rb);
    ...
    crate::ed25519::mul_modq(&mut aq, &mut hq, &mut y_copy);
    let mut y_copy0: [u64; 5] = [0u64; 5usize];
    ((&mut y_copy0)[0usize..5usize]).copy_from_slice(&(&mut aq)[0usize..5usize]);
    crate::ed25519::add_modq(&mut aq, &mut rq, &mut y_copy0);
    crate::ed25519::store_56(ss.1, &mut aq)
}
...
*/
pub fn
sign(signature: &mut [u8], private_key: &mut [u8], msg_len: u32, msg: &mut [u8])
{
    let mut expanded_keys: [u8; 96] = [0u8; 96usize];
    crate::ed25519::expand_keys(&mut expanded_keys, private_key);
    crate::ed25519::sign_expanded(signature, &mut expanded_keys, msg_len, msg)
}
...
*/
pub fn
verify(public_key: &mut [u8], msg_len: u32, msg: &mut [u8], signature: &mut [u8]) ->
    bool
{
    ...
    if b
    {
        ...
        if b·
        {
            ...
            let b1: bool = crate::ed25519::gte_q(&mut tmp);
            let b10: bool = b1;
            if b10
            { false }
            else
            {
                ...
                crate::ed25519::store_56(&mut hb, &mut tmp0);
                let mut exp_d: [u64; 20] = [0u64; 20usize];
                crate::ed25519::point_negate_mul_double_g_vartime(
                    &mut exp_d,
                    sb.1,
                    &mut hb,
                    &mut a·
                );
                let b2: bool = crate::ed25519::point_equal(&mut exp_d, &mut r·);
                b2
            }
        }
        else
