...
#[inline] fn load_point_vartime(p: &mut [u64], b: &[u8]) -> bool
{
    ...
    if res { crate::p256::to_proj_point(p, &p_aff) };
    res
}
...
#[inline] fn point_double(res: &mut [u64], p: &[u64])
{
    ...
    crate::p256::fadd(t4.0, &x_copy1, &x_copy);
    ...
    crate::p256::fsub(y3.0, &x_copy18, z3.1);
    ...
    crate::p256::fadd(z3.1, &x_copy110, &x_copy19);
    ...
    crate::p256::fadd(z3.1, &x_copy111, &x_copy20)
}
...
#[inline] fn point_add(res: &mut [u64], p: &[u64], q: &[u64])
{
    ...
    let mut x_copy4: [u64; 4] = [0u64; 4usize];
    ((&mut x_copy4)[0usize..4usize]).copy_from_slice(&y3.0[0usize..4usize]);
    crate::p256::fadd(z3.1, &x_copy4, y3.0);
    let mut x_copy5: [u64; 4] = [0u64; 4usize];
    ((&mut x_copy5)[0usize..4usize]).copy_from_slice(&y3.0[0usize..4usize]);
    crate::p256::fadd(y3.0, &x_copy5, z3.1);
    ...
    crate::p256::fmul_by_b_coeff(z3.0, &x_copy6);
    let mut x_copy7: [u64; 4] = [0u64; 4usize];
    ((&mut x_copy7)[0usize..4usize]).copy_from_slice(&t3.0[0usize..4usize]);
    crate::p256::fadd(t2.0, &x_copy7, t3.0);
    let mut y_copy1: [u64; 4] = [0u64; 4usize];
    ...
    crate::p256::fadd(t2.0, &x_copy11, t11.0);
    let mut y_copy3: [u64; 4] = [0u64; 4usize];
    ...
    crate::p256::fsub(t11.0, &x_copy12, t3.0);
    ...
    crate::p256::fadd(z3.0, &x_copy13, t3.0);
    ...
    crate::p256::fsub(y3.0, &x_copy14, t2.0);
    ...
    crate::p256::fadd(z3.1, &x_copy15, t2.0);
...
#[inline] fn point_mul_double_g(res: &mut [u64], scalar1: &[u64], scalar2: &[u64], q2: &[u64])
{
    ...
    for i1 in 0u32..51u32
    {
        ...
        let a_bits_l2: &[u64] =
            &(&crate::p256_precomptable::precomp_basepoint_table_w5)[bits_l322.wrapping_mul(12u32)
            as
            usize..];
