...
#[inline] fn load_qelem_check(f: &mut [u64], b: &mut [u8]) -> u64
{
    ...
    krml::unroll_for!(
        ...
        1u32,
        {
            let beq: u64 = fstar::uint64::eq_mask(f[i as usize], (&mut n)[i as usize]);
            let blt: u64 = ! fstar::uint64::gte_mask(f[i as usize], (&mut n)[i as usize]);
...
#[inline] fn modq_short(out: &mut [u64], a: &mut [u64])
{
    ...
    let c: u64 = crate::k256_ecdsa::add4(a, &mut tmp, out);
...
#[inline] fn load_qelem_modq(f: &mut [u64], b: &mut [u8])
{
    ...
    crate::k256_ecdsa::modq_short(f, &mut tmp)
}
...
#[inline] fn qadd(out: &mut [u64], f1: &mut [u64], f2: &mut [u64])
{
    ...
    (&mut n)[2usize] = 0xfffffffffffffffeu64;
    (&mut n)[3usize] = 0xffffffffffffffffu64;
    crate::k256_ecdsa::add_mod4(&mut n, f1, f2, out)
}
    ...
    u64
{
    ...
    lowstar::ignore::ignore::<u64>(
        crate::k256_ecdsa::bn_add_sa(resLen, len.wrapping_add(2u32), &mut tmp, res)
    );
...
#[inline] fn qmul(out: &mut [u64], f1: &mut [u64], f2: &mut [u64])
{
    ...
    crate::k256_ecdsa::modq(out, &mut tmp)
}
...
#[inline] fn qnegate_conditional_vartime(f: &mut [u64], is_negate: bool)
{
    ...
    if is_negate
    {
        ...
        crate::k256_ecdsa::sub_mod4(&mut n, &mut zero, &mut b_copy, f)
    }
}
...
#[inline] fn qmul_shift_384(res: &mut [u64], a: &mut [u64], b: &mut [u64])
{
    ...
    let a1: (&mut [u64], &mut [u64]) = res_b_padded.split_at_mut(1usize);
    ...
    krml::unroll_for!(
        ...
        1u32,
        {
            ...
            let res_i: (&mut [u64], &mut [u64]) = res1.1.split_at_mut(i as usize);
            (&mut c)[0usize] =
                lib::inttypes_intrinsics::add_carry_u64((&mut c)[0usize], t1, 0u64, res_i.1)
        }
    );
...
#[inline] fn qsquare_times_in_place(out: &mut [u64], b: u32)
{
    for _i in 0u32..b
    {
        ...
        crate::k256_ecdsa::qsqr(out, &mut f_copy)
    }
}
...
#[inline] fn qinv(out: &mut [u64], f: &mut [u64])
{
    ...
    crate::k256_ecdsa::qmul(&mut x_11, &mut x_10, f);
    crate::k256_ecdsa::qmul(&mut x_101, &mut x_10, &mut x_11);
    crate::k256_ecdsa::qmul(&mut x_111, &mut x_10, &mut x_101);
    crate::k256_ecdsa::qmul(&mut x_1001, &mut x_10, &mut x_111);
    crate::k256_ecdsa::qmul(&mut x_1011, &mut x_10, &mut x_1001);
    crate::k256_ecdsa::qmul(&mut x_1101, &mut x_10, &mut x_1011);
    let mut x6: [u64; 4] = [0u64; 4usize];
    let mut x8: [u64; 4] = [0u64; 4usize];
    let mut x14: [u64; 4] = [0u64; 4usize];
    crate::k256_ecdsa::qsquare_times(&mut x6, &mut x_1101, 2u32);
    let mut f1_copy: [u64; 4] = [0u64; 4usize];
    ((&mut f1_copy)[0usize..4usize]).copy_from_slice(&(&mut x6)[0usize..4usize]);
    crate::k256_ecdsa::qmul(&mut x6, &mut f1_copy, &mut x_1011);
    crate::k256_ecdsa::qsquare_times(&mut x8, &mut x6, 2u32);
    let mut f1_copy0: [u64; 4] = [0u64; 4usize];
    ((&mut f1_copy0)[0usize..4usize]).copy_from_slice(&(&mut x8)[0usize..4usize]);
    crate::k256_ecdsa::qmul(&mut x8, &mut f1_copy0, &mut x_11);
    crate::k256_ecdsa::qsquare_times(&mut x14, &mut x8, 6u32);
    let mut f1_copy1: [u64; 4] = [0u64; 4usize];
    ((&mut f1_copy1)[0usize..4usize]).copy_from_slice(&(&mut x14)[0usize..4usize]);
    crate::k256_ecdsa::qmul(&mut x14, &mut f1_copy1, &mut x6);
    let mut x56: [u64; 4] = [0u64; 4usize];
    crate::k256_ecdsa::qsquare_times(out, &mut x14, 14u32);
    let mut f1_copy2: [u64; 4] = [0u64; 4usize];
    ((&mut f1_copy2)[0usize..4usize]).copy_from_slice(&out[0usize..4usize]);
    crate::k256_ecdsa::qmul(out, &mut f1_copy2, &mut x14);
    ...
    crate::k256_ecdsa::qmul(&mut x56, &mut f1_copy3, out);
    crate::k256_ecdsa::qsquare_times(out, &mut x56, 56u32);
    let mut f1_copy4: [u64; 4] = [0u64; 4usize];
    ((&mut f1_copy4)[0usize..4usize]).copy_from_slice(&out[0usize..4usize]);
    crate::k256_ecdsa::qmul(out, &mut f1_copy4, &mut x56);
    ...
    crate::k256_ecdsa::qmul(out, &mut f1_copy5, &mut x14);
    ...
    crate::k256_ecdsa::qmul(out, &mut f1_copy6, &mut x_101);
    ...
    crate::k256_ecdsa::qmul(out, &mut f1_copy7, &mut x_111);
    crate::k256_ecdsa::qsquare_times_in_place(out, 4u32);
    let mut f1_copy8: [u64; 4] = [0u64; 4usize];
    ((&mut f1_copy8)[0usize..4usize]).copy_from_slice(&out[0usize..4usize]);
    crate::k256_ecdsa::qmul(out, &mut f1_copy8, &mut x_101);
    ...
    crate::k256_ecdsa::qmul(out, &mut f1_copy18, &mut x_111);
    crate::k256_ecdsa::qsquare_times_in_place(out, 4u32);
    let mut f1_copy19: [u64; 4] = [0u64; 4usize];
    ((&mut f1_copy19)[0usize..4usize]).copy_from_slice(&out[0usize..4usize]);
    crate::k256_ecdsa::qmul(out, &mut f1_copy19, &mut x_111);
    ...
    crate::k256_ecdsa::qmul(out, &mut f1_copy29, &mut x6)
}
...
#[inline] fn to_aff_point_x(x: &mut [u64], p: &mut [u64])
{
    ...
    let mut zinv: [u64; 5] = [0u64; 5usize];
    crate::bignum_k256::finv(&mut zinv, z1.1);
    crate::bignum_k256::fmul(x, z1.0, &mut zinv);
    let mut f_copy: [u64; 5] = [0u64; 5usize];
    ((&mut f_copy)[0usize..5usize]).copy_from_slice(&x[0usize..5usize]);
    crate::bignum_k256::fnormalize(x, &mut f_copy)
}
...
#[inline] fn is_on_curve_vartime(p: &mut [u64]) -> bool
{
    ...
    crate::bignum_k256::fnormalize(&mut y2_comp, &mut f_copy0);
    let res: bool = crate::bignum_k256::is_felem_eq_vartime(&mut y2_exp, &mut y2_comp);
    let res0: bool = res;
    res0
}

pub(crate) fn point_negate(out: &mut [u64], p: &mut [u64])
{
    let px: (&mut [u64], &mut [u64]) = p.split_at_mut(0usize);
    let py: (&mut [u64], &mut [u64]) = px.1.split_at_mut(5usize);
    let pz: (&mut [u64], &mut [u64]) = py.1.split_at_mut(5usize);
    ...
    crate::bignum_k256::fnormalize_weak(oz.0, &mut f_copy)
}
...
#[inline] fn point_negate_conditional_vartime(p: &mut [u64], is_negate: bool)
{
    if is_negate
    {
        ...
        crate::k256_ecdsa::point_negate(p, &mut p_copy)
    }
}
...
pub(crate) fn point_store(out: &mut [u8], p: &mut [u64])
{
    let mut p_aff: [u64; 10] = [0u64; 10usize];
    crate::k256_ecdsa::to_aff_point(&mut p_aff, p);
    crate::k256_ecdsa::aff_point_store(out, &mut p_aff)
}

pub(crate) fn aff_point_load_vartime(p: &mut [u64], b: &mut [u8]) -> bool
{
...
#[inline] fn aff_point_decompress_vartime(x: &mut [u64], y: &mut [u64], s: &mut [u8]) -> bool
{
    ...
    else
    {
        ...
        else
        {
            ...
            crate::bignum_k256::fmul(&mut y2, &mut f1_copy, x);
            let mut f1_copy0: [u64; 5] = [0u64; 5usize];
            ((&mut f1_copy0)[0usize..5usize]).copy_from_slice(&(&mut y2)[0usize..5usize]);
            crate::bignum_k256::fadd(&mut y2, &mut f1_copy0, &mut b);
            let mut f_copy: [u64; 5] = [0u64; 5usize];
            ((&mut f_copy)[0usize..5usize]).copy_from_slice(&(&mut y2)[0usize..5usize]);
            crate::bignum_k256::fnormalize(&mut y2, &mut f_copy);
            crate::bignum_k256::fsqrt(y, &mut y2);
            let mut f_copy0: [u64; 5] = [0u64; 5usize];
            ((&mut f_copy0)[0usize..5usize]).copy_from_slice(&y[0usize..5usize]);
            crate::bignum_k256::fnormalize(y, &mut f_copy0);
            let mut y2_comp: [u64; 5] = [0u64; 5usize];
            ...
            crate::bignum_k256::fnormalize(&mut y2_comp, &mut f_copy1);
            let res: bool = crate::bignum_k256::is_felem_eq_vartime(&mut y2, &mut y2_comp);
...
pub(crate) fn point_double(out: &mut [u64], p: &mut [u64])
{
    ...
    crate::bignum_k256::fmul(y3.0, &mut f1_copy, z1.0);
    ...
    crate::bignum_k256::fsub(tmp1.0, zz.0, &mut f2_copy, 6u64);
...
pub(crate) fn point_add(out: &mut [u64], p: &mut [u64], q: &mut [u64])
{
    ...
    crate::bignum_k256::fmul(yz_pairs.0, &mut f1_copy, tmp1.1);
    crate::bignum_k256::fadd(tmp1.1, yy.0, zz.0);
    let mut f1_copy0: [u64; 5] = [0u64; 5usize];
    ((&mut f1_copy0)[0usize..5usize]).copy_from_slice(&yz_pairs.0[0usize..5usize]);
    crate::bignum_k256::fsub(yz_pairs.0, &mut f1_copy0, tmp1.1, 4u64);
    ...
    crate::bignum_k256::fmul(xz_pairs.0, &mut f1_copy1, tmp1.1);
    ...
    crate::bignum_k256::fsub(xz_pairs.0, &mut f1_copy2, tmp1.1, 4u64);
    ...
    crate::bignum_k256::fmul(yy_m_bzz3.0, &mut f1_copy3, tmp1.1);
    ...
    crate::bignum_k256::fnormalize_weak(y3.0, &mut f_copy0);
    ...
    crate::bignum_k256::fnormalize_weak(z3.0, &mut f_copy1);
    ...
    crate::bignum_k256::fmul(y3.0, &mut f1_copy5, yy_m_bzz3.0);
    let mut f2_copy: [u64; 5] = [0u64; 5usize];
    ((&mut f2_copy)[0usize..5usize]).copy_from_slice(&y3.0[0usize..5usize]);
    crate::bignum_k256::fsub(y3.0, tmp1.1, &mut f2_copy, 2u64);
    let mut f_copy2: [u64; 5] = [0u64; 5usize];
    ((&mut f_copy2)[0usize..5usize]).copy_from_slice(&y3.0[0usize..5usize]);
    crate::bignum_k256::fnormalize_weak(y3.0, &mut f_copy2);
    ...
    crate::bignum_k256::fmul(z3.0, &mut f1_copy6, yy_m_bzz3.0);
    let mut f2_copy0: [u64; 5] = [0u64; 5usize];
    ((&mut f2_copy0)[0usize..5usize]).copy_from_slice(&z3.0[0usize..5usize]);
    crate::bignum_k256::fadd(z3.0, tmp1.1, &mut f2_copy0);
    let mut f_copy3: [u64; 5] = [0u64; 5usize];
    ((&mut f_copy3)[0usize..5usize]).copy_from_slice(&z3.0[0usize..5usize]);
    crate::bignum_k256::fnormalize_weak(z3.0, &mut f_copy3);
...
#[inline] fn scalar_split_lambda(r1: &mut [u64], r2: &mut [u64], k: &mut [u64])
{
    ...
    crate::k256_ecdsa::qmul_shift_384(r1, k, &mut tmp1);
    crate::k256_ecdsa::qmul_shift_384(r2, k, &mut tmp2);
    ...
    crate::k256_ecdsa::qmul(r1, &mut f1_copy, &mut tmp1);
    let mut f1_copy0: [u64; 4] = [0u64; 4usize];
    ((&mut f1_copy0)[0usize..4usize]).copy_from_slice(&r2[0usize..4usize]);
    crate::k256_ecdsa::qmul(r2, &mut f1_copy0, &mut tmp2);
    ...
    crate::k256_ecdsa::qadd(r2, r1, &mut f2_copy);
    crate::k256_ecdsa::qmul(&mut tmp2, r2, &mut tmp1);
    crate::k256_ecdsa::qadd(r1, k, &mut tmp2)
}
...
#[inline] fn point_mul_lambda(res: &mut [u64], p: &mut [u64])
{
    ...
    crate::bignum_k256::fmul(ry.0, &mut beta, py.0);
...
#[inline] fn point_mul_lambda_inplace(res: &mut [u64])
{
    ...
    crate::bignum_k256::fmul(rx.1, &mut beta, &mut f2_copy)
}
...
pub(crate) fn point_mul(out: &mut [u64], scalar: &mut [u64], q: &mut [u64])
{
    ...
    krml::unroll_for!(
        ...
        1u32,
        {
            let t11: (&mut [u64], &mut [u64]) =
                table.split_at_mut(i.wrapping_add(1u32).wrapping_mul(15u32) as usize);
            let mut p_copy: [u64; 15] = [0u64; 15usize];
            ((&mut p_copy)[0usize..15usize]).copy_from_slice(&t11.1[0usize..15usize]);
            crate::k256_ecdsa::point_double(&mut tmp, &mut p_copy);
            ...
            crate::k256_ecdsa::point_add(&mut tmp, &mut p_copy0, t2.1);
    ...
    for i in 0u32..64u32
    {
        krml::unroll_for!(
            ...
            1u32,
            {
                ...
                crate::k256_ecdsa::point_double(out, &mut p_copy)
            }
        );
        ...
        krml::unroll_for!(
            ...
            1u32,
            {
                ...
                let res_j: (&mut [u64], &mut [u64]) =
                    table.split_at_mut(i0.wrapping_add(1u32).wrapping_mul(15u32) as usize);
                krml::unroll_for!(
                    15,
                    "i1",
                    0u32,
        ...
        let mut p_copy: [u64; 15] = [0u64; 15usize];
        ((&mut p_copy)[0usize..15usize]).copy_from_slice(&out[0usize..15usize]);
        crate::k256_ecdsa::point_add(out, &mut p_copy, &mut tmp0)
    }
}
    ...
    krml::unroll_for!(
        ...
        1u32,
        {
            ...
            lowstar::ignore::ignore::<&mut [u64]>(
                &mut crate::k256_precomptable::precomp_g_pow2_192_table_w4
            );
            ...
            let mut p_copy: [u64; 15] = [0u64; 15usize];
            ((&mut p_copy)[0usize..15usize]).copy_from_slice(&out[0usize..15usize]);
            crate::k256_ecdsa::point_add(out, &mut p_copy, &mut tmp);
            ...
            lowstar::ignore::ignore::<&mut [u64]>(
                &mut crate::k256_precomptable::precomp_g_pow2_128_table_w4
            );
            crate::k256_ecdsa::precomp_get_consttime(
                &mut crate::k256_precomptable::precomp_g_pow2_128_table_w4,
                bits_l0,
            ...
            crate::k256_ecdsa::point_add(out, &mut p_copy0, &mut tmp);
            ...
            lowstar::ignore::ignore::<&mut [u64]>(
                &mut crate::k256_precomptable::precomp_g_pow2_64_table_w4
            );
            crate::k256_ecdsa::precomp_get_consttime(
                &mut crate::k256_precomptable::precomp_g_pow2_64_table_w4,
                bits_l1,
            ...
            crate::k256_ecdsa::point_add(out, &mut p_copy1, &mut tmp);
            ...
            lowstar::ignore::ignore::<&mut [u64]>(
                &mut crate::k256_precomptable::precomp_basepoint_table_w4
            );
            crate::k256_ecdsa::precomp_get_consttime(
                &mut crate::k256_precomptable::precomp_basepoint_table_w4,
                bits_l2,
            ...
            crate::k256_ecdsa::point_add(out, &mut p_copy2, &mut tmp)
        }
    )
}
...
)
{
    ...
    krml::unroll_for!(
        ...
        {
            let t11: (&mut [u64], &mut [u64]) =
                table2.split_at_mut(i.wrapping_add(1u32).wrapping_mul(15u32) as usize);
            let mut p_copy: [u64; 15] = [0u64; 15usize];
            ((&mut p_copy)[0usize..15usize]).copy_from_slice(&t11.1[0usize..15usize]);
            crate::k256_ecdsa::point_double(&mut tmp, &mut p_copy);
    ...
    let a_bits_l: &mut [u64] =
        &mut
        (&mut crate::k256_precomptable::precomp_basepoint_table_w5)[bits_l32.wrapping_mul(15u32)
        as
        usize..];
    ...
    let a_bits_l0: (&mut [u64], &mut [u64]) =
        table2.split_at_mut(bits_l320.wrapping_mul(15u32) as usize);
    ...
    for i1 in 0u32..51u32
    {
        krml::unroll_for!(
            ...
            1u32,
            {
                let mut p_copy0: [u64; 15] = [0u64; 15usize];
                ((&mut p_copy0)[0usize..15usize]).copy_from_slice(&out[0usize..15usize]);
                crate::k256_ecdsa::point_double(out, &mut p_copy0)
            }
        );
        ...
        let a_bits_l1: (&mut [u64], &mut [u64]) =
            table2.split_at_mut(bits_l321.wrapping_mul(15u32) as usize);
        ((&mut tmp1)[0usize..15usize]).copy_from_slice(&a_bits_l1.1[0usize..15usize]);
        let mut p_copy0: [u64; 15] = [0u64; 15usize];
        ((&mut p_copy0)[0usize..15usize]).copy_from_slice(&out[0usize..15usize]);
        crate::k256_ecdsa::point_add(out, &mut p_copy0, &mut tmp1);
        ...
        lowstar::ignore::ignore::<&mut [u64]>(
            &mut crate::k256_precomptable::precomp_basepoint_table_w5
        );
        let bits_l322: u32 = bits_l0 as u32;
        let a_bits_l2: &mut [u64] =
            &mut
            (&mut crate::k256_precomptable::precomp_basepoint_table_w5)[bits_l322.wrapping_mul(
                15u32
            )
            as
            usize..];
        ...
        let mut p_copy1: [u64; 15] = [0u64; 15usize];
        ((&mut p_copy1)[0usize..15usize]).copy_from_slice(&out[0usize..15usize]);
        crate::k256_ecdsa::point_add(out, &mut p_copy1, &mut tmp1)
    }
}
...
)
{
    ...
    let bits_l320: u32 = bits_c0 as u32;
    let a_bits_l0: &mut [u64] =
        &mut
        (&mut crate::k256_precomptable::precomp_basepoint_table_w5)[bits_l320.wrapping_mul(15u32)
        as
        usize..];
    ...
    let mut p_copy: [u64; 15] = [0u64; 15usize];
    ((&mut p_copy)[0usize..15usize]).copy_from_slice(&out[0usize..15usize]);
    crate::k256_ecdsa::point_add(out, &mut p_copy, &mut tmp1);
    ...
    let a_bits_l2: (&mut [u64], &mut [u64]) =
        a_bits_l1.1.split_at_mut(
    ...
    crate::k256_ecdsa::point_add(&mut tmp0, &mut p_copy0, &mut tmp10);
    let mut p_copy1: [u64; 15] = [0u64; 15usize];
    ((&mut p_copy1)[0usize..15usize]).copy_from_slice(&out[0usize..15usize]);
    crate::k256_ecdsa::point_add(out, &mut p_copy1, &mut tmp0);
        ...
        1u32,
        {
            krml::unroll_for!(
                ...
                1u32,
                {
                    let mut p_copy2: [u64; 15] = [0u64; 15usize];
                    ((&mut p_copy2)[0usize..15usize]).copy_from_slice(&out[0usize..15usize]);
                    crate::k256_ecdsa::point_double(out, &mut p_copy2)
                }
            );
            ...
            let a_bits_l3: (&mut [u64], &mut [u64]) =
                table2.split_at_mut(bits_l323.wrapping_mul(15u32) as usize);
            ...
            let mut p_copy2: [u64; 15] = [0u64; 15usize];
            ((&mut p_copy2)[0usize..15usize]).copy_from_slice(&out[0usize..15usize]);
            crate::k256_ecdsa::point_add(out, &mut p_copy2, &mut tmp2);
            ...
            let a_bits_l4: (&mut [u64], &mut [u64]) =
                table2.split_at_mut(bits_l324.wrapping_mul(15u32) as usize);
            ...
            crate::k256_ecdsa::point_add(out, &mut p_copy3, &mut tmp2);
            ...
            let a_bits_l5: &mut [u64] =
                &mut
                (&mut crate::k256_precomptable::precomp_basepoint_table_w5)[bits_l325.wrapping_mul(
                    15u32
                )
                as
                usize..];
            ...
            crate::k256_ecdsa::point_add(out, &mut p_copy4, &mut tmp2);
            ...
            let a_bits_l6: &mut [u64] =
                &mut
                (&mut crate::k256_precomptable::precomp_basepoint_table_w5)[bits_l326.wrapping_mul(
                    15u32
                )
                as
                usize..];
            ...
            crate::k256_ecdsa::point_add(out, &mut p_copy5, &mut tmp2)
        }
    )
}
...
)
{
    ...
    let scrut: crate::k256_ecdsa::__bool_bool =
        crate::k256_ecdsa::ecmult_endo_split(r2.0, r3.0, q2.0, q3.0, scalar1, &mut g);
...
#[inline] fn fmul_eq_vartime(r: &mut [u64], z: &mut [u64], x: &mut [u64]) -> bool
{
    ...
    crate::bignum_k256::fnormalize(&mut tmp, &mut f_copy);
    let b: bool = crate::bignum_k256::is_felem_eq_vartime(&mut tmp, x);
    b
}
    ...
    bool
{
    ...
    lowstar::ignore::ignore::<&mut [u64]>(&mut oneq);
    ...
    crate::k256_ecdsa::to_aff_point_x(&mut tmp, &mut p);
    crate::bignum_k256::store_felem(&mut x_bytes, &mut tmp);
    crate::k256_ecdsa::load_qelem_modq(s_q.0, &mut x_bytes);
    ...
    bool
{
    ...
    let b: bool =
        crate::k256_ecdsa::ecdsa_sign_hashed_msg(signature, &mut msgHash, private_key, nonce);
    b
}
...
*/
pub fn
ecdsa_verify_hashed_msg(m: &mut [u8], public_key: &mut [u8], signature: &mut [u8]) ->
    bool
{
    ...
    let is_r_valid: bool = crate::k256_ecdsa::load_qelem_vartime(s_q.0, &mut signature[0usize..]);
    let is_s_valid: bool = crate::k256_ecdsa::load_qelem_vartime(u1.0, &mut signature[32usize..]);
    ...
    else
    {
        ...
        crate::k256_ecdsa::qmul(u2.0, m_q.1, &mut sinv);
        crate::k256_ecdsa::qmul(m_q.0, s_q.0, &mut sinv);
        ...
        let pz: (&mut [u64], &mut [u64]) = res.split_at_mut(10usize);
        crate::bignum_k256::fnormalize(&mut tmp1, pz.1);
        let b: bool = crate::bignum_k256::is_felem_zero_vartime(&mut tmp1);
        if b
        { false }
        else
        {
            ...
            crate::bignum_k256::load_felem(&mut r_fe, &mut r_bytes);
            crate::bignum_k256::fnormalize(&mut tmp_x, x.1);
            let is_rz_x: bool = crate::k256_ecdsa::fmul_eq_vartime(&mut r_fe, z.1, &mut tmp_x);
            if ! is_rz_x
            {
                let is_r_lt_p_m_q: bool =
                    crate::bignum_k256::is_felem_lt_prime_minus_order_vartime(&mut r_fe);
                if is_r_lt_p_m_q
                {
                    ...
                    crate::bignum_k256::fadd(&mut tmp_q, &mut r_fe, &mut f2_copy);
                    crate::k256_ecdsa::fmul_eq_vartime(&mut tmp_q, z.1, &mut tmp_x)
                }
                else
                { false }
            }
...
*/
pub fn
ecdsa_verify_sha256(msg_len: u32, msg: &mut [u8], public_key: &mut [u8], signature: &mut [u8]) ->
    bool
{
    let mut mHash: [u8; 32] = [0u8; 32usize];
    crate::hash_sha2::hash_256(&mut mHash, msg, msg_len);
    let b: bool = crate::k256_ecdsa::ecdsa_verify_hashed_msg(&mut mHash, public_key, signature);
    b
}
    ...
    bool
{
    ...
    {
        let is_sk_lt_q_halved: bool = crate::k256_ecdsa::is_qelem_le_q_halved_vartime(&mut s_q);
        crate::k256_ecdsa::qnegate_conditional_vartime(&mut s_q, ! is_sk_lt_q_halved);
        crate::k256_ecdsa::store_qelem(&mut signature[32usize..], &mut s_q);
        true
    }
}
...
*/
pub fn
secp256k1_ecdsa_is_signature_normalized(signature: &mut [u8]) ->
    bool
{
    let mut s_q: [u64; 4] = [0u64; 4usize];
    let s: (&mut [u8], &mut [u8]) = signature.split_at_mut(32usize);
    let is_s_valid: bool = crate::k256_ecdsa::load_qelem_vartime(&mut s_q, s.1);
    let is_s_lt_q_halved: bool = crate::k256_ecdsa::is_qelem_le_q_halved_vartime(&mut s_q);
    ...
    bool
{
    ...
    crate::hash_sha2::hash_256(&mut msgHash, msg, msg_len);
    let b: bool =
        crate::k256_ecdsa::secp256k1_ecdsa_sign_hashed_msg(
            signature,
            &mut msgHash,
            private_key,
            nonce
    ...
    bool
{
    ...
    crate::hash_sha2::hash_256(&mut mHash, msg, msg_len);
    let b: bool =
        crate::k256_ecdsa::secp256k1_ecdsa_verify_hashed_msg(&mut mHash, public_key, signature);
    b
}
...
*/
pub fn
public_key_uncompressed_to_raw(pk_raw: &mut [u8], pk: &mut [u8]) ->
    bool
{
...
*/
pub fn
public_key_uncompressed_from_raw(pk: &mut [u8], pk_raw: &mut [u8])
{
    pk[0usize] = 0x04u8;
...
*/
pub fn
public_key_compressed_to_raw(pk_raw: &mut [u8], pk: &mut [u8]) ->
    bool
{
    ...
    if b
    {
        ...
        crate::bignum_k256::store_felem(&mut pk_raw[32usize..], &mut ya)
    };
    b
}
...
*/
pub fn
public_key_compressed_from_raw(pk: &mut [u8], pk_raw: &mut [u8])
{
...
*/
pub fn
is_public_key_valid(public_key: &mut [u8]) ->
    bool
{
    let mut p: [u64; 15] = [0u64; 15usize];
...
*/
pub fn
is_private_key_valid(private_key: &mut [u8]) ->
    bool
{
    let mut s_q: [u64; 4] = [0u64; 4usize];
...
*/
pub fn
secret_to_public(public_key: &mut [u8], private_key: &mut [u8]) ->
    bool
{
...
*/
pub fn
ecdh(shared_secret: &mut [u8], their_pubkey: &mut [u8], private_key: &mut [u8]) ->
    bool
{
