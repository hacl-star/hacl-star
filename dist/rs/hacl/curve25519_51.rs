...
fn point_add_and_double(
    q: &mut [u64],
    p01_tmp1: &mut [u64],
    tmp2: &mut [fstar::uint128::uint128]
)
{
    ...
    crate::bignum25519_51::fmul2(dc.1, &mut f1_copy, ab1.1, tmp2);
    ...
    crate::bignum25519_51::fsqr2(tmp1.0, &mut f1_copy0, tmp2);
    ...
    crate::bignum25519_51::fsub(c0.1, c0.0, &mut f2_copy);
    ...
    crate::bignum25519_51::fadd(b1.1, &mut f1_copy1, c0.0);
    ...
    crate::bignum25519_51::fmul(z310.1, &mut f1_copy2, x1.1, tmp2)
}

fn point_double(nq: &mut [u64], tmp1: &mut [u64], tmp2: &mut [fstar::uint128::uint128])
{
    ...
    crate::bignum25519_51::fsub(c.1, c.0, &mut f2_copy);
    ...
    crate::bignum25519_51::fadd(b1.1, &mut f1_copy, c.0);
...
{
    let mut tmp2: [fstar::uint128::uint128; 10] =
    ...
    crate::curve25519_51::point_add_and_double(init, p01_tmp11.1, &mut tmp2);
    swap.1[0usize] = 1u64;
    for i in 0u32..251u32
    {
        ...
        crate::curve25519_51::point_add_and_double(init, p01_tmp12.1, &mut tmp2);
        swap1.1[0usize] = bit
    };
    ...
    crate::curve25519_51::point_double(tmp1.0, tmp1.1, &mut tmp2);
    crate::curve25519_51::point_double(tmp1.0, tmp1.1, &mut tmp2);
    crate::curve25519_51::point_double(tmp1.0, tmp1.1, &mut tmp2);
...
)
{
    ...
    for _i in 0u32..n.wrapping_sub(1u32)
    {
        ...
        crate::bignum25519_51::fsqr(o, &mut f1_copy, tmp)
    }
}

pub(crate) fn finv(o: &mut [u64], i: &mut [u64], tmp: &mut [fstar::uint128::uint128])
{
    ...
    let tmp1: (&mut [fstar::uint128::uint128], &mut [fstar::uint128::uint128]) =
    ...
    crate::bignum25519_51::fmul(b1.0, t01.0, &mut f2_copy, tmp);
    let tmp11: (&mut [fstar::uint128::uint128], &mut [fstar::uint128::uint128]) =
        tmp.split_at_mut(0usize);
    ...
    crate::bignum25519_51::fmul(t01.0, t01.1, &mut f2_copy0, tmp);
    let tmp12: (&mut [fstar::uint128::uint128], &mut [fstar::uint128::uint128]) =
        tmp.split_at_mut(0usize);
    ...
    crate::bignum25519_51::fmul(t01.0, t01.1, &mut f2_copy1, tmp);
    ...
    let tmp10: (&mut [fstar::uint128::uint128], &mut [fstar::uint128::uint128]) =
        tmp.split_at_mut(0usize);
    crate::curve25519_51::fsquare_times(t010.1, c1.0, tmp10.1, 10u32);
    crate::bignum25519_51::fmul(c1.1, t010.1, c1.0, tmp);
    let tmp110: (&mut [fstar::uint128::uint128], &mut [fstar::uint128::uint128]) =
        tmp.split_at_mut(0usize);
    ...
    crate::bignum25519_51::fmul(t010.1, &mut f1_copy, c1.1, tmp);
    let tmp120: (&mut [fstar::uint128::uint128], &mut [fstar::uint128::uint128]) =
        tmp.split_at_mut(0usize);
    let mut i_copy: [u64; 5] = [0u64; 5usize];
    ((&mut i_copy)[0usize..5usize]).copy_from_slice(&t010.1[0usize..5usize]);
    crate::curve25519_51::fsquare_times(t010.1, &mut i_copy, tmp120.1, 10u32);
    let mut f2_copy2: [u64; 5] = [0u64; 5usize];
    ((&mut f2_copy2)[0usize..5usize]).copy_from_slice(&c1.0[0usize..5usize]);
    crate::bignum25519_51::fmul(c1.0, t010.1, &mut f2_copy2, tmp);
    let tmp13: (&mut [fstar::uint128::uint128], &mut [fstar::uint128::uint128]) =
        tmp.split_at_mut(0usize);
    ...
    let tmp14: (&mut [fstar::uint128::uint128], &mut [fstar::uint128::uint128]) =
        tmp.split_at_mut(0usize);
    ...
    crate::bignum25519_51::fmul(t011.1, &mut f1_copy0, c10.1, tmp);
    let tmp111: (&mut [fstar::uint128::uint128], &mut [fstar::uint128::uint128]) =
        tmp.split_at_mut(0usize);
    let mut i_copy0: [u64; 5] = [0u64; 5usize];
    ((&mut i_copy0)[0usize..5usize]).copy_from_slice(&t011.1[0usize..5usize]);
    crate::curve25519_51::fsquare_times(t011.1, &mut i_copy0, tmp111.1, 50u32);
    let mut f1_copy1: [u64; 5] = [0u64; 5usize];
    ((&mut f1_copy1)[0usize..5usize]).copy_from_slice(&t011.1[0usize..5usize]);
    crate::bignum25519_51::fmul(t011.1, &mut f1_copy1, b11.1, tmp);
    let tmp121: (&mut [fstar::uint128::uint128], &mut [fstar::uint128::uint128]) =
        tmp.split_at_mut(0usize);
    let mut i_copy1: [u64; 5] = [0u64; 5usize];
    ((&mut i_copy1)[0usize..5usize]).copy_from_slice(&t011.1[0usize..5usize]);
    crate::curve25519_51::fsquare_times(t011.1, &mut i_copy1, tmp121.1, 5u32);
...
fn encode_point(o: &mut [u8], i: &mut [u64])
{
    ...
    let mut tmp_w: [fstar::uint128::uint128; 10] =
        [fstar::uint128::uint64_to_uint128(0u64); 10usize];
    crate::curve25519_51::finv(&mut tmp, z.1, &mut tmp_w);
    let mut f1_copy: [u64; 5] = [0u64; 5usize];
    ((&mut f1_copy)[0usize..5usize]).copy_from_slice(&(&mut tmp)[0usize..5usize]);
    crate::bignum25519_51::fmul(&mut tmp, &mut f1_copy, z.0, &mut tmp_w);
    crate::bignum25519_51::store_felem(&mut u64s, &mut tmp);
    krml::unroll_for!(
        4,
        "i0",
        0u32,
...
scalarmult(out: &mut [u8], r#priv: &mut [u8], r#pub: &mut [u8])
{
    ...
    crate::curve25519_51::montgomery_ladder(&mut init, r#priv, &mut init_copy);
    crate::curve25519_51::encode_point(out, &mut init)
}
...
secret_to_public(r#pub: &mut [u8], r#priv: &mut [u8])
{
    ...
    krml::unroll_for!(
        ...
        1u32,
        {
            let x: u8 = (&mut crate::curve25519_51::g25519)[i as usize];
            let os: (&mut [u8], &mut [u8]) = basepoint.split_at_mut(0usize);
            os.1[i as usize] = x
        }
    );
    crate::curve25519_51::scalarmult(r#pub, r#priv, &mut basepoint)
}
