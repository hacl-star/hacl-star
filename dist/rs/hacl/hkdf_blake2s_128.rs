...
)
{
    ...
    for i in 0u32..n
    {
        ...
        if i == 0u32
        {
            crate::hmac_blake2s_128::compute_blake2s_128(
                &mut tag,
                prk,
                prklen,
                text0.1,
...
*/
pub fn
extract_blake2s_128(prk: &mut [u8], salt: &mut [u8], saltlen: u32, ikm: &mut [u8], ikmlen: u32)
{ crate::hmac_blake2s_128::compute_blake2s_128(prk, salt, saltlen, ikm, ikmlen) }
