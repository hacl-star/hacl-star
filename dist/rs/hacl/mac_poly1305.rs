...
#[derive(PartialEq)]
pub(crate) enum option__·uint8_t· <'a>
{
    None,
    Some { v: &'a mut [u8] }
}

pub fn malloc <'a>(key: &'a [u8]) -> Box<[crate::mac_poly1305::state_t]>
{
    ...
    let mut block_state: crate::streaming_types::optional_64 =
        crate::streaming_types::optional_64::Some { v: &mut r1 };
    match block_state
    {
        ...
        crate::streaming_types::optional_64::Some { v: ref mut block_state1 } =>
          {
              ...
              match k·0
              {
                  ...
                  crate::mac_poly1305::option__·uint8_t·::Some { v: ref k·1 } =>
                    {
                        crate::mac_poly1305::poly1305_init(block_state2, key);
