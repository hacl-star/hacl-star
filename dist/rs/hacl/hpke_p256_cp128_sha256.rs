    ...
    u32
{
    ...
    if res0 == 0u32
    {
        ...
        crate::hacl::hkdf::extract_sha2_256(&mut o_psk_id_hash, empty.1, 0u32, &tmp, len);
        ...
        crate::hacl::hkdf::extract_sha2_256(&mut o_info_hash, empty.1, 0u32, &tmp0, len0);
        ...
        crate::hacl::hkdf::extract_sha2_256(&mut o_secret, &o_shared, 32u32, &tmp1, len1);
        ...
        crate::hacl::hkdf::expand_sha2_256(o_ctx.ctx_exporter, &o_secret, 32u32, &tmp2, len2, 32u32);
        ...
        crate::hacl::hkdf::expand_sha2_256(o_ctx.ctx_key, &o_secret, 32u32, &tmp3, len3, 32u32);
        ...
        crate::hacl::hkdf::expand_sha2_256(o_ctx.ctx_nonce, &o_secret, 32u32, &tmp4, len4, 12u32);
    ...
    u32
{
    ...
    if res1 == 0u32
    {
        ...
        if res2 == 0u32
        {
            ...
            crate::hacl::hkdf::extract_sha2_256(&mut o_psk_id_hash, empty.1, 0u32, &tmp0, len);
            let label_info_hash: [u8; 9] =
                [0x69u8, 0x6eu8, 0x66u8, 0x6fu8, 0x5fu8, 0x68u8, 0x61u8, 0x73u8, 0x68u8];
            let mut o_info_hash: [u8; 32] = [0u8; 32usize];
            let len0: u32 = 26u32.wrapping_add(infolen);
            ...
            crate::hacl::hkdf::extract_sha2_256(&mut o_info_hash, empty.1, 0u32, &tmp1, len0);
            (&mut (&mut o_context)[0usize..])[0usize] = 0u8;
            ((&mut (&mut o_context)[1usize..])[0usize..32usize]).copy_from_slice(
                &(&o_psk_id_hash)[0usize..32usize]
            );
            ...
            crate::hacl::hkdf::extract_sha2_256(&mut o_secret, &shared, 32u32, &tmp2, len1);
            let label_exp: [u8; 3] = [0x65u8, 0x78u8, 0x70u8];
            let len2: u32 = 87u32;
            ...
            crate::hacl::hkdf::expand_sha2_256(o_ctx.ctx_key, &o_secret, 32u32, &tmp4, len3, 32u32);
            let label_base_nonce: [u8; 10] =
                [0x62u8, 0x61u8, 0x73u8, 0x65u8, 0x5fu8, 0x6eu8, 0x6fu8, 0x6eu8, 0x63u8, 0x65u8];
            let len4: u32 = 94u32;
    ...
    u32
{
    ...
    if res == 0u32
    {
        ...
        crate::hacl::aead_chacha20poly1305_simd128::encrypt(
            tag.0,
            tag.1,
            plain,
            plainlen,
    ...
    u32
{
    ...
    if res == 0u32
    {
        ...
        let res1: u32 =
            crate::hacl::aead_chacha20poly1305_simd128::decrypt(
                o_pt,
                tag.0,
