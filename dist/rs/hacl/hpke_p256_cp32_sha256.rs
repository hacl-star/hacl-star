    ...
    u32
{
    ...
    let res: u32 = crate::hpke_p256_cp32_sha256::setupBaseS(o_enc, o_ctx, skE, pkR, infolen, info);
    if res == 0u32
    {
        ...
        crate::aead_chacha20poly1305::encrypt(
            tag.0,
            tag.1,
            plain,
            plainlen,
    ...
    u32
{
    ...
    let o_ctx: crate::hpke_interface_hacl_impl_hpke_hacl_meta_hpke::context_s =
        crate::hpke_interface_hacl_impl_hpke_hacl_meta_hpke::context_s
        { ctx_key: &ctx_key, ctx_nonce: &ctx_nonce, ctx_seq: &ctx_seq, ctx_exporter: &ctx_exporter };
    let res: u32 = crate::hpke_p256_cp32_sha256::setupBaseR(o_ctx, pkE, skR, infolen, info);
    if res == 0u32
    {
        let mut nonce: [u8; 12] = [0u8; 12usize];
        let s: u64 = o_ctx.ctx_seq[0usize];
        ...
        let res1: u32 =
            crate::aead_chacha20poly1305::decrypt(
                o_pt,
                tag.0,
