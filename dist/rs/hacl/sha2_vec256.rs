...
#[inline] fn sha224_init8(hash: &mut [lib::intvector_intrinsics::vec256])
{
    krml::unroll_for!(
        ...
        1u32,
        {
            let hi: u32 = (&mut crate::hash_sha2::h224)[i as usize];
...
)
{
    ...
    match b
    {
                ...
                crate::sha2_types::uint8_6p
                {
                    ...
                    crate::sha2_types::uint8_5p
                    {
                        ...
                        crate::sha2_types::uint8_4p
                        {
                            ...
                            { fst: b5, snd: crate::sha2_types::uint8_2p { fst: b6, snd: b7 } }
                        }
                    }
                }
            }
        ...
        =>
          {
              (&mut ws)[0usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b0[0usize..]);
              (&mut ws)[1usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b1[0usize..]);
              (&mut ws)[2usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b2[0usize..]);
              (&mut ws)[3usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b3[0usize..]);
              (&mut ws)[4usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b4[0usize..]);
              (&mut ws)[5usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b5[0usize..]);
              (&mut ws)[6usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b6[0usize..]);
              (&mut ws)[7usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b7[0usize..]);
              (&mut ws)[8usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b0[32usize..]);
              (&mut ws)[9usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b1[32usize..]);
              (&mut ws)[10usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b2[32usize..]);
              (&mut ws)[11usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b3[32usize..]);
              (&mut ws)[12usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b4[32usize..]);
              (&mut ws)[13usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b5[32usize..]);
              (&mut ws)[14usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b6[32usize..]);
              (&mut ws)[15usize] = lib::intvector_intrinsics::vec256_load32_be(&mut b7[32usize..])
          }
    };
    ...
    let v4: lib::intvector_intrinsics::vec256 = (&mut ws)[4usize];
    let v5: lib::intvector_intrinsics::vec256 = (&mut ws)[5usize];
    let v6: lib::intvector_intrinsics::vec256 = (&mut ws)[6usize];
    let v7: lib::intvector_intrinsics::vec256 = (&mut ws)[7usize];
    ...
    let v00: lib::intvector_intrinsics::vec256 = (&mut ws)[8usize];
    let v10: lib::intvector_intrinsics::vec256 = (&mut ws)[9usize];
    let v20: lib::intvector_intrinsics::vec256 = (&mut ws)[10usize];
    let v30: lib::intvector_intrinsics::vec256 = (&mut ws)[11usize];
    let v40: lib::intvector_intrinsics::vec256 = (&mut ws)[12usize];
    let v50: lib::intvector_intrinsics::vec256 = (&mut ws)[13usize];
    let v60: lib::intvector_intrinsics::vec256 = (&mut ws)[14usize];
    let v70: lib::intvector_intrinsics::vec256 = (&mut ws)[15usize];
    ...
    krml::unroll_for!(
        ...
        1u32,
        {
            krml::unroll_for!(
                ...
                {
                    let k_t: u32 =
                        (&mut crate::hash_sha2::k224_256)[16u32.wrapping_mul(i).wrapping_add(i0)
                        as
                        usize];
                    let ws_t: lib::intvector_intrinsics::vec256 = (&mut ws)[i0 as usize];
            ...
            if i < 3u32
            {
                krml::unroll_for!(
                    ...
                    1u32,
                    {
                        let t16: lib::intvector_intrinsics::vec256 = (&mut ws)[i0 as usize];
                        ...
                        crate::sha2_types::uint8_6p
                        {
                            ...
                            crate::sha2_types::uint8_5p
                            {
                                ...
                                crate::sha2_types::uint8_4p
                                {
                                    ...
                                    {
                                        fst: b5,
                                        snd: crate::sha2_types::uint8_2p { fst: b6, snd: b7 }
                                    }
                                }
                            }
                        }
        ...
        =>
          {
              ...
              (b4[0usize..28usize]).copy_from_slice(
                  &(&mut (&mut hbuf)[128usize..])[0usize..28usize]
              );
              (b5[0usize..28usize]).copy_from_slice(
                  &(&mut (&mut hbuf)[160usize..])[0usize..28usize]
              );
              (b6[0usize..28usize]).copy_from_slice(
                  &(&mut (&mut hbuf)[192usize..])[0usize..28usize]
              );
              (b7[0usize..28usize]).copy_from_slice(
                  &(&mut (&mut hbuf)[224usize..])[0usize..28usize]
              )
          }
    }
}
...
#[inline] fn sha256_init8(hash: &mut [lib::intvector_intrinsics::vec256])
{
    krml::unroll_for!(
        ...
        1u32,
        {
            let hi: u32 = (&mut crate::hash_sha2::h256)[i as usize];
            let x: lib::intvector_intrinsics::vec256 = lib::intvector_intrinsics::vec256_load32(hi);
            let
            os: (&mut [lib::intvector_intrinsics::vec256], &mut [lib::intvector_intrinsics::vec256])
            =
        ...
        =>
          {
              ...
              (b4[0usize..32usize]).copy_from_slice(
                  &(&mut (&mut hbuf)[128usize..])[0usize..32usize]
              );
              (b5[0usize..32usize]).copy_from_slice(
                  &(&mut (&mut hbuf)[160usize..])[0usize..32usize]
              );
              (b6[0usize..32usize]).copy_from_slice(
                  &(&mut (&mut hbuf)[192usize..])[0usize..32usize]
              );
              (b7[0usize..32usize]).copy_from_slice(
                  &(&mut (&mut hbuf)[224usize..])[0usize..32usize]
              )
          }
    }
}
...
#[inline] fn sha384_init4(hash: &mut [lib::intvector_intrinsics::vec256])
{
    krml::unroll_for!(
        ...
        1u32,
        {
            let hi: u64 = (&mut crate::hash_sha2::h384)[i as usize];
...
)
{
    ...
    match b
    {
        ...
        =>
          {
              (&mut ws)[0usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b0[0usize..]);
              (&mut ws)[1usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b1[0usize..]);
              (&mut ws)[2usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b2[0usize..]);
              (&mut ws)[3usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b3[0usize..]);
              (&mut ws)[4usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b0[32usize..]);
              (&mut ws)[5usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b1[32usize..]);
              (&mut ws)[6usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b2[32usize..]);
              (&mut ws)[7usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b3[32usize..]);
              (&mut ws)[8usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b0[64usize..]);
              (&mut ws)[9usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b1[64usize..]);
              (&mut ws)[10usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b2[64usize..]);
              (&mut ws)[11usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b3[64usize..]);
              (&mut ws)[12usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b0[96usize..]);
              (&mut ws)[13usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b1[96usize..]);
              (&mut ws)[14usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b2[96usize..]);
              (&mut ws)[15usize] = lib::intvector_intrinsics::vec256_load64_be(&mut b3[96usize..])
          }
    };
    let v0: lib::intvector_intrinsics::vec256 = (&mut ws)[0usize];
    let v1: lib::intvector_intrinsics::vec256 = (&mut ws)[1usize];
    ...
    krml::unroll_for!(
        ...
        1u32,
        {
            krml::unroll_for!(
                ...
                {
                    let k_t: u64 =
                        (&mut crate::hash_sha2::k384_512)[16u32.wrapping_mul(i).wrapping_add(i0)
                        as
                        usize];
                    let ws_t: lib::intvector_intrinsics::vec256 = (&mut ws)[i0 as usize];
                    let a0: lib::intvector_intrinsics::vec256 = hash[0usize];
            ...
            =>
              {
                  ...
                  +
                  16usize]).copy_from_slice(&(&mut totlen_buf)[0usize..16usize]);
                  let last01: (&mut [u8], &mut [u8]) = last1.0.split_at_mut(0usize);
        ...
        =>
          {
              ...
              (b2[0usize..48usize]).copy_from_slice(
                  &(&mut (&mut hbuf)[128usize..])[0usize..48usize]
              );
              (b3[0usize..48usize]).copy_from_slice(
                  &(&mut (&mut hbuf)[192usize..])[0usize..48usize]
              )
          }
    }
}
...
#[inline] fn sha512_init4(hash: &mut [lib::intvector_intrinsics::vec256])
{
    krml::unroll_for!(
        ...
        1u32,
        {
            let hi: u64 = (&mut crate::hash_sha2::h512)[i as usize];
            let x: lib::intvector_intrinsics::vec256 = lib::intvector_intrinsics::vec256_load64(hi);
            let
            os: (&mut [lib::intvector_intrinsics::vec256], &mut [lib::intvector_intrinsics::vec256])
            =
        ...
        =>
          {
              ...
              (b2[0usize..64usize]).copy_from_slice(
                  &(&mut (&mut hbuf)[128usize..])[0usize..64usize]
              );
              (b3[0usize..64usize]).copy_from_slice(
                  &(&mut (&mut hbuf)[192usize..])[0usize..64usize]
              )
          }
    }
}
