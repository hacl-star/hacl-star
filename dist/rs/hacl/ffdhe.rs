...
#[inline] fn ffdhe_check_pk(a: crate::spec::ffdhe_alg, pk_n: &[u64], p_n: &[u64]) -> u64
{
    ...
    for i0 in 0u32..nLen
    {
        let beq: u64 = fstar::uint64::eq_mask((&b2)[i0 as usize], pk_n[i0 as usize]);
        let blt: u64 = ! fstar::uint64::gte_mask((&b2)[i0 as usize], pk_n[i0 as usize]);
    ...
    for i0 in 0u32..nLen
    {
        let beq: u64 = fstar::uint64::eq_mask(pk_n[i0 as usize], (&p_n1)[i0 as usize]);
        let blt: u64 = ! fstar::uint64::gte_mask(pk_n[i0 as usize], (&p_n1)[i0 as usize]);
...
)
{
    ...
    {
        let x: u8 = (&crate::impl_ffdhe_constants::ffdhe_g2)[0u32 as usize];
