...
pub fn crypto_kem_keypair(pk: &mut [u8], sk: &mut [u8]) -> u32
{
    ...
    crate::hash_sha3::shake128(&mut r, 2048u32, &mut shake_input_seed_se, 17u32);
    lib::memzero0::memzero::<u8>(&mut shake_input_seed_se, 17u32);
    crate::frodo_kem::frodo_sample_matrix64(64u32, 8u32, &mut (&mut r)[0usize..], &mut s_matrix);
    crate::frodo_kem::frodo_sample_matrix64(64u32, 8u32, &mut (&mut r)[1024usize..], &mut e_matrix);
    ...
    crate::frodo_kem::matrix_mul_s(64u32, 64u32, 8u32, &mut a_matrix, &mut s_matrix, &mut b_matrix);
    crate::frodo_kem::matrix_add(64u32, 8u32, &mut b_matrix, &mut e_matrix);
    crate::frodo_kem::frodo_pack(64u32, 8u32, 15u32, &mut b_matrix, b_bytes.1);
    crate::frodo_kem::matrix_to_lbytes(64u32, 8u32, &mut s_matrix, s_bytes.1);
...
pub fn crypto_kem_enc(ct: &mut [u8], ss: &mut [u8], pk: &mut [u8]) -> u32
{
    ...
    crate::hash_sha3::shake128(&mut r, 2176u32, &mut shake_input_seed_se, 17u32);
    lib::memzero0::memzero::<u8>(&mut shake_input_seed_se, 17u32);
    crate::frodo_kem::frodo_sample_matrix64(8u32, 64u32, &mut (&mut r)[0usize..], &mut sp_matrix);
    crate::frodo_kem::frodo_sample_matrix64(
        8u32,
        64u32,
        &mut (&mut r)[1024usize..],
        &mut ep_matrix
    ...
    crate::frodo_kem::matrix_mul(8u32, 64u32, 64u32, &mut sp_matrix, &mut a_matrix, &mut bp_matrix);
    crate::frodo_kem::matrix_add(8u32, 64u32, &mut bp_matrix, &mut ep_matrix);
    crate::frodo_kem::frodo_pack(8u32, 64u32, 15u32, &mut bp_matrix, c2.0);
    let mut v_matrix: [u16; 64] = [0u16; 64usize];
    let mut b_matrix: [u16; 512] = [0u16; 512usize];
    crate::frodo_kem::frodo_unpack(64u32, 8u32, 15u32, b.1, &mut b_matrix);
    crate::frodo_kem::matrix_mul(8u32, 64u32, 8u32, &mut sp_matrix, &mut b_matrix, &mut v_matrix);
...
pub fn crypto_kem_dec(ss: &mut [u8], ct: &mut [u8], sk: &mut [u8]) -> u32
{
    ...
    crate::frodo_kem::matrix_mul_s(8u32, 64u32, 8u32, &mut bp_matrix, &mut s_matrix, &mut m_matrix);
    ...
    crate::frodo_kem::matrix_add(8u32, 64u32, &mut bpp_matrix, &mut ep_matrix);
    let mut b_matrix: [u16; 512] = [0u16; 512usize];
    crate::frodo_kem::frodo_unpack(64u32, 8u32, 15u32, b.1, &mut b_matrix);
    crate::frodo_kem::matrix_mul(8u32, 64u32, 8u32, &mut sp_matrix, &mut b_matrix, &mut cp_matrix);
    ...
    lib::memzero0::memzero::<u16>(&mut ep_matrix, 512u32);
    lib::memzero0::memzero::<u16>(&mut epp_matrix, 64u32);
    let b1: u16 = crate::frodo_kem::matrix_eq(8u32, 64u32, &mut bp_matrix, &mut bpp_matrix);
