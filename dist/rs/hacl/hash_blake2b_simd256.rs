...
pub(crate) fn malloc_internal_state_with_key <'a>() -> Box<[lib::intvector_intrinsics::vec256]>
{
...
)
{
    let mut wv: [lib::intvector_intrinsics::vec256; 4] =
        [lib::intvector_intrinsics::vec256_zero; 4usize];
    crate::hash_blake2b_simd256::update_multi(n.wrapping_mul(128u32), &mut wv, s, ev, blocks, n)
}
...
)
{
    let mut wv: [lib::intvector_intrinsics::vec256; 4] =
        [lib::intvector_intrinsics::vec256_zero; 4usize];
    crate::hash_blake2b_simd256::update_last(input_len, &mut wv, s, false, prev, input_len, input)
}

pub(crate) fn copy_internal_state(
    src: &[lib::intvector_intrinsics::vec256],
    dst: &mut [lib::intvector_intrinsics::vec256]
)
...
pub(crate) struct
__uint8_t_uint8_t_bool_·Lib_IntVector_Intrinsics_vec256·_·Lib_IntVector_Intrinsics_vec256·
{
    pub fst: u8,
    pub snd: u8,
    pub thd: bool,
...
{
    pub block_state:
    crate::hash_blake2b_simd256::__uint8_t_uint8_t_bool_·Lib_IntVector_Intrinsics_vec256·_·Lib_IntVector_Intrinsics_vec256·,
    pub buf: Box<[u8]>,
    pub total_len: u64
}
...
#[derive(PartialEq, Clone)]
enum
option__·uint8_t···uint8_t···bool····Lib_IntVector_Intrinsics_vec256·····Lib_IntVector_Intrinsics_vec256··
{
    None,
    Some
    {
    ...
    Box<[crate::hash_blake2b_simd256::state_t]>
{
    ...
    let
    block_state:
    crate::hash_blake2b_simd256::option__·uint8_t···uint8_t···bool····Lib_IntVector_Intrinsics_vec256·····Lib_IntVector_Intrinsics_vec256··
    =
        {
            let b: Box<[lib::intvector_intrinsics::vec256]> =
                vec![lib::intvector_intrinsics::vec256_zero; 4usize].into_boxed_slice();
            crate::hash_blake2b_simd256::option__·uint8_t···uint8_t···bool····Lib_IntVector_Intrinsics_vec256·····Lib_IntVector_Intrinsics_vec256··::Some
            {
                v:
                crate::hash_blake2b_simd256::__uint8_t_uint8_t_bool_·Lib_IntVector_Intrinsics_vec256·_·Lib_IntVector_Intrinsics_vec256·
    ...
    match block_state
    {
        crate::hash_blake2b_simd256::option__·uint8_t···uint8_t···bool····Lib_IntVector_Intrinsics_vec256·····Lib_IntVector_Intrinsics_vec256··::None
        => { [].into() },
        crate::hash_blake2b_simd256::option__·uint8_t···uint8_t···bool····Lib_IntVector_Intrinsics_vec256·····Lib_IntVector_Intrinsics_vec256··::Some
        { v: block_state1 }
        =>
                  ...
                  crate::streaming_types::optional::Some =>
                    {
                            ...
                            =>
                              {
                                  ...
                                  let h: &mut [lib::intvector_intrinsics::vec256] =
                                      &mut block_state2.f4;
                        ...
                        let s: crate::hash_blake2b_simd256::state_t =
                            crate::hash_blake2b_simd256::state_t
                            {
                                block_state: block_state2,
                                buf: (*buf1).into(),
                                total_len: ite as u64
                            };
                        let p0: Box<[crate::hash_blake2b_simd256::state_t]> =
...
fn reset_raw(
    state: &mut [crate::hash_blake2b_simd256::state_t],
...
pub fn
copy
<'a>(state: &'a [crate::hash_blake2b_simd256::state_t]) ->
    Box<[crate::hash_blake2b_simd256::state_t]>
{
    let
    block_state0:
                  ...
                  crate::streaming_types::optional::Some =>
                    {
                        ...
                        let p: Box<[crate::hash_blake2b_simd256::state_t]> =
                            vec![s].into_boxed_slice();
                        p
                    },
                  _ => panic!("Precondition of the function most likely violated")
