...
)
{
    ...
    wv3.1[0usize] = lib::intvector_intrinsics::vec256_xor(wv3.1[0usize], (&mut mask)[0usize]);
    krml::unroll_for!(
        12,
        "i",
        0u32,
        1u32,
        {
            ...
            let
            x: (&mut [lib::intvector_intrinsics::vec256], &mut [lib::intvector_intrinsics::vec256])
            =
                r1.0.split_at_mut(0usize);
            let
            y: (&mut [lib::intvector_intrinsics::vec256], &mut [lib::intvector_intrinsics::vec256])
            =
                r2.0.split_at_mut(0usize);
            let
            z: (&mut [lib::intvector_intrinsics::vec256], &mut [lib::intvector_intrinsics::vec256])
            =
                r3.0.split_at_mut(0usize);
            let
            w: (&mut [lib::intvector_intrinsics::vec256], &mut [lib::intvector_intrinsics::vec256])
            =
...
pub(crate) fn init(hash: &mut [lib::intvector_intrinsics::vec256], kk: u32, nn: u32)
{
    ...
    let r3: (&mut [lib::intvector_intrinsics::vec256], &mut [lib::intvector_intrinsics::vec256]) =
        r2.1.split_at_mut(1usize);
    let iv0: u64 = (&mut crate::impl_blake2_constants::ivTable_B)[0usize];
    let iv1: u64 = (&mut crate::impl_blake2_constants::ivTable_B)[1usize];
    let iv2: u64 = (&mut crate::impl_blake2_constants::ivTable_B)[2usize];
    let iv3: u64 = (&mut crate::impl_blake2_constants::ivTable_B)[3usize];
    let iv4: u64 = (&mut crate::impl_blake2_constants::ivTable_B)[4usize];
    let iv5: u64 = (&mut crate::impl_blake2_constants::ivTable_B)[5usize];
    let iv6: u64 = (&mut crate::impl_blake2_constants::ivTable_B)[6usize];
    let iv7: u64 = (&mut crate::impl_blake2_constants::ivTable_B)[7usize];
...
)
{
    ...
    if ll == 0u32
    { crate::hash_blake2b_simd256::update_block(wv, hash, true, false, lb, &mut b) }
    else
    { crate::hash_blake2b_simd256::update_block(wv, hash, false, false, lb, &mut b) };
...
)
{
    ...
    crate::hash_blake2b_simd256::update_block(wv, hash, true, last_node, totlen, &mut b);
    lib::memzero0::memzero::<u8>(&mut b, 128u32)
}
...
)
{
    ...
    let
    row0: (&mut [lib::intvector_intrinsics::vec256], &mut [lib::intvector_intrinsics::vec256])
    =
        hash.split_at_mut(0usize);
    let
    row1: (&mut [lib::intvector_intrinsics::vec256], &mut [lib::intvector_intrinsics::vec256])
    =
    ...
    Box<[crate::hash_blake2b_simd256::state_t]>
{
    ...
    let mut wv: Box<[lib::intvector_intrinsics::vec256]> =
        vec![lib::intvector_intrinsics::vec256_zero; 4usize].into_boxed_slice();
    let mut b: Box<[lib::intvector_intrinsics::vec256]> =
        vec![lib::intvector_intrinsics::vec256_zero; 4usize].into_boxed_slice();
        ...
        crate::hash_blake2b_simd256::block_state_t { thd: last_node, .. } =>
          {
              ...
              krml::unroll_for!(
                  ...
                  1u32,
                  {
                      let bj: &mut [u8] = &mut pv.salt[i0.wrapping_mul(8u32) as usize..];
                      let u: u64 = lowstar::endianness::load64_le(bj);
                      let r4: u64 = u;
                      let x: u64 = r4;
                      let os: (&mut [u64], &mut [u64]) = uu____0.1.split_at_mut(0usize);
              ...
              krml::unroll_for!(
                  ...
                  1u32,
                  {
                      let bj: &mut [u8] = &mut pv.personal[i0.wrapping_mul(8u32) as usize..];
                      let u: u64 = lowstar::endianness::load64_le(bj);
                      let r4: u64 = u;
                      let x: u64 = r4;
                      let os: (&mut [u64], &mut [u64]) = uu____1.1.split_at_mut(0usize);
    ...
    let mut s: crate::hash_blake2b_simd256::state_t =
        crate::hash_blake2b_simd256::state_t { block_state, buf, total_len: ite as u64 };
    let mut p0: Box<[crate::hash_blake2b_simd256::state_t]> = vec![s].into_boxed_slice();
    p0
}

fn index_of_state(s: &mut [crate::hash_blake2b_simd256::state_t]) -> crate::hash_blake2b::index
{
    let mut block_state: &mut crate::hash_blake2b_simd256::block_state_t =
...
*/
pub fn
reset_with_key(s: &mut [crate::hash_blake2b_simd256::state_t], k: &mut [u8])
{
...
{ crate::hash_blake2b_simd256::reset_with_key(s, &mut []) }

/**
Update function; 0 = success, 1 = max length exceeded
*/
pub fn
update0(state: &mut [crate::hash_blake2b_simd256::state_t], chunk: &mut [u8], chunk_len: u32) ->
    ...
    else
    {
        ...
        else if sz == 0u32
        {
            ...
            if sz1 != 0u32
            {
                ...
                match *block_state
                {
                    crate::hash_blake2b_simd256::block_state_t { f3: wv, f4: hash, .. } =>
                      {
                          let nb: u32 = 1u32;
...
*/
pub fn
digest(s: &mut [crate::hash_blake2b_simd256::state_t], dst: &mut [u8]) ->
    u8
{
    let mut block_state: &mut crate::hash_blake2b_simd256::block_state_t =
        &mut (s[0usize]).block_state;
    ...
    let mut block_state0: &mut crate::hash_blake2b_simd256::block_state_t =
        &mut (s[0usize]).block_state;
    ...
    match *block_state0
    {
        crate::hash_blake2b_simd256::block_state_t { f4: src_b, .. } =>
          match tmp_block_state
          {
              crate::hash_blake2b_simd256::block_state_t { f4: dst_b, .. } =>
    ...
    match tmp_block_state
    {
        crate::hash_blake2b_simd256::block_state_t { f3: wv0, f4: hash, .. } =>
          {
              let nb: u32 = 0u32;
              crate::hash_blake2b_simd256::update_multi(
                  0u32,
    ...
    match tmp_block_state
    {
        crate::hash_blake2b_simd256::block_state_t { thd: last_node, f3: wv0, f4: hash, .. } =>
    ...
    match tmp_block_state
    {
        crate::hash_blake2b_simd256::block_state_t { snd: nn, .. } =>
          crate::hash_blake2b_simd256::finish(nn as u32, dst, &mut tmp_block_state.f4)
    };
    let mut block_state1: &mut crate::hash_blake2b_simd256::block_state_t =
        &mut (s[0usize]).block_state;
    match *block_state1
    {
        crate::hash_blake2b_simd256::block_state_t { fst: kk, snd: nn, thd: last_node, .. } =>
...
pub fn info(s: &mut [crate::hash_blake2b_simd256::state_t]) -> crate::hash_blake2b::index
{
    let mut block_state: &mut crate::hash_blake2b_simd256::block_state_t =
        &mut (s[0usize]).block_state;
    match *block_state
...
*/
pub fn
copy(state: &mut [crate::hash_blake2b_simd256::state_t]) ->
    Box<[crate::hash_blake2b_simd256::state_t]>
{
    let mut block_state0: &mut crate::hash_blake2b_simd256::block_state_t =
        &mut (state[0usize]).block_state;
    ...
    let mut p: Box<[crate::hash_blake2b_simd256::state_t]> = vec![s].into_boxed_slice();
    p
}
...
)
{
    ...
    crate::hash_blake2b_simd256::finish(output_len, output, &mut b);
...
)
{
    ...
    crate::hash_blake2b_simd256::finish(params.digest_length as u32, output, &mut b);
    lib::memzero0::memzero::<lib::intvector_intrinsics::vec256>(&mut b1, 4u32);
    lib::memzero0::memzero::<lib::intvector_intrinsics::vec256>(&mut b, 4u32)
}
