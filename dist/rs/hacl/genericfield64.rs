...
pub type pbn_mont_ctx_u64 <'a> = &'a mut [bignum::bignum::bn_mont_ctx_u64];
...
*/
pub fn
field_modulus_check(len: u32, n: &mut [u64]) ->
    bool
{
    ...
    Box<[bignum::bignum::bn_mont_ctx_u64]>
{
    ...
    let mut res: bignum::bignum::bn_mont_ctx_u64 =
        bignum::bignum::bn_mont_ctx_u64 { len, n: (*n11).into(), mu, r2: (*r21).into() };
    let mut buf: Box<[bignum::bignum::bn_mont_ctx_u64]> = vec![res].into_boxed_slice();
    buf
}
...
*/
pub fn
field_get_len(k: &mut [bignum::bignum::bn_mont_ctx_u64]) ->
    u32
{ (k[0usize]).len }
...
*/
pub fn
to_field(k: &mut [bignum::bignum::bn_mont_ctx_u64], a: &mut [u64], aM: &mut [u64])
{
    let len1: u32 = crate::genericfield64::field_get_len(k);
    let mut uu____0: &mut bignum::bignum::bn_mont_ctx_u64 = &mut k[0usize];
    bignum::bignum::bn_to_mont_u64(len1, &mut uu____0.n, uu____0.mu, &mut uu____0.r2, a, aM)
}
...
*/
pub fn
from_field(k: &mut [bignum::bignum::bn_mont_ctx_u64], aM: &mut [u64], a: &mut [u64])
{
    let len1: u32 = crate::genericfield64::field_get_len(k);
    let mut uu____0: &mut bignum::bignum::bn_mont_ctx_u64 = &mut k[0usize];
    bignum::bignum::bn_from_mont_u64(len1, &mut uu____0.n, uu____0.mu, aM, a)
}
...
*/
pub fn
add(k: &mut [bignum::bignum::bn_mont_ctx_u64], aM: &mut [u64], bM: &mut [u64], cM: &mut [u64])
{
    let len1: u32 = crate::genericfield64::field_get_len(k);
    let mut uu____0: &mut bignum::bignum::bn_mont_ctx_u64 = &mut k[0usize];
    ...
    bignum::bignum::bn_add_mod_n_u64(len1, &mut uu____0.n, &mut a_copy, &mut b_copy, cM)
}
...
*/
pub fn
sub(k: &mut [bignum::bignum::bn_mont_ctx_u64], aM: &mut [u64], bM: &mut [u64], cM: &mut [u64])
{
    let len1: u32 = crate::genericfield64::field_get_len(k);
    bignum::bignum::bn_sub_mod_n_u64(len1, &mut (k[0usize]).n, aM, bM, cM)
}
...
*/
pub fn
mul(k: &mut [bignum::bignum::bn_mont_ctx_u64], aM: &mut [u64], bM: &mut [u64], cM: &mut [u64])
{
    let len1: u32 = crate::genericfield64::field_get_len(k);
    let mut uu____0: &mut bignum::bignum::bn_mont_ctx_u64 = &mut k[0usize];
    bignum::bignum::bn_mont_mul_u64(len1, &mut uu____0.n, uu____0.mu, aM, bM, cM)
}
...
*/
pub fn
sqr(k: &mut [bignum::bignum::bn_mont_ctx_u64], aM: &mut [u64], cM: &mut [u64])
{
    let len1: u32 = crate::genericfield64::field_get_len(k);
    let mut uu____0: &mut bignum::bignum::bn_mont_ctx_u64 = &mut k[0usize];
    bignum::bignum::bn_mont_sqr_u64(len1, &mut uu____0.n, uu____0.mu, aM, cM)
}
...
*/
pub fn
one(k: &mut [bignum::bignum::bn_mont_ctx_u64], oneM: &mut [u64])
{
    let len1: u32 = crate::genericfield64::field_get_len(k);
    let mut uu____0: &mut bignum::bignum::bn_mont_ctx_u64 = &mut k[0usize];
    bignum::bignum::bn_from_mont_u64(len1, &mut uu____0.n, uu____0.mu, &mut uu____0.r2, oneM)
}
...
pub fn
exp_consttime(
    k: &mut [bignum::bignum::bn_mont_ctx_u64],
    aM: &mut [u64],
    bBits: u32,
    b: &mut [u64],
    resM: &mut [u64]
)
{
    ...
    if bBits < 200u32
    {
        ...
        for i in 0u32..bBits
        {
            ...
            bignum::bignum::bn_mont_mul_u64(len1, ctx_n0.1, uu____0.mu, &mut aMc, resM, &mut aMc);
    ...
    else
    {
        ...
        for i in 0u32..bBits.wrapping_div(4u32)
        {
            ...
            let ctx_n0: (&mut [u64], &mut [u64]) = ctx_r2.1.split_at_mut(0usize - len1 as usize);
            bignum::bignum::bn_mont_mul_u64(len1, ctx_n0.1, uu____0.mu, resM, &mut tmp0, resM)
        }
    }
}
    ...
    if bBits < 200u32
    {
        ...
        for i in 0u32..bBits
        {
            ...
            if bit != 0u64
            {
                let ctx_n0: (&mut [u64], &mut [u64]) =
                    ctx_r2.1.split_at_mut(0usize - len1 as usize);
                bignum::bignum::bn_mont_mul_u64(len1, ctx_n0.1, uu____0.mu, resM, &mut aMc, resM)
            };
            let ctx_n0: (&mut [u64], &mut [u64]) = ctx_r2.1.split_at_mut(0usize - len1 as usize);
            bignum::bignum::bn_mont_sqr_u64(len1, ctx_n0.1, uu____0.mu, &mut aMc, &mut aMc)
        }
    }
    else
    {
...
*/
pub fn
inverse(k: &mut [bignum::bignum::bn_mont_ctx_u64], aM: &mut [u64], aInvM: &mut [u64])
{
    let mut uu____0: &mut bignum::bignum::bn_mont_ctx_u64 = &mut k[0usize];
    ...
    crate::genericfield64::exp_vartime(k, aM, uu____0.len.wrapping_mul(64u32), &mut n2, aInvM)
}
