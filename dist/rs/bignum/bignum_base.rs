...
*/
pub fn
bn_from_bytes_be_uint64(len: u32, b: &mut [u8], res: &mut [u64])
{
...
*/
pub fn
bn_to_bytes_be_uint64(len: u32, b: &mut [u64], res: &mut [u8])
{
    let bnLen: u32 = len.wrapping_sub(1u32).wrapping_div(8u32).wrapping_add(1u32);
    let tmpLen: u32 = 8u32.wrapping_mul(bnLen);
    let mut tmp: Box<[u8]> = vec![0u8; tmpLen as usize].into_boxed_slice();
...
*/
pub fn
bn_get_top_index_u32(len: u32, b: &mut [u32]) ->
    u32
{
...
*/
pub fn
bn_get_top_index_u64(len: u32, b: &mut [u64]) ->
    u64
{
...
*/
#[inline] pub fn
bn_get_bits_u32(len: u32, b: &mut [u32], i: u32, l: u32) ->
    u32
{
...
*/
#[inline] pub fn
bn_get_bits_u64(len: u32, b: &mut [u64], i: u32, l: u32) ->
    u64
{
...
pub(crate) fn bn_sub_eq_len_u32(aLen: u32, a: &mut [u32], b: &mut [u32], res: &mut [u32]) ->
    u32
{
...
pub(crate) fn bn_sub_eq_len_u64(aLen: u32, a: &mut [u64], b: &mut [u64], res: &mut [u64]) ->
    u64
{
...
pub(crate) fn bn_add_eq_len_u32(aLen: u32, a: &mut [u32], b: &mut [u32], res: &mut [u32]) ->
    u32
{
    let mut c: [u32; 1] = [0u32; 1usize];
    for i in 0u32..aLen.wrapping_div(4u32)
...
*/
pub fn
bn_add_eq_len_u64(aLen: u32, a: &mut [u64], b: &mut [u64], res: &mut [u64]) ->
    u64
{
    let mut c: [u64; 1] = [0u64; 1usize];
    for i in 0u32..aLen.wrapping_div(4u32)
...
#[inline] pub(crate) fn bn_mul_u32(
    aLen: u32,
    a: &mut [u32],
    bLen: u32,
    b: &mut [u32],
...
#[inline] pub(crate) fn bn_mul_u64(
    aLen: u32,
    a: &mut [u64],
    bLen: u32,
    b: &mut [u64],
...
#[inline] pub(crate) fn bn_sqr_u32(aLen: u32, a: &mut [u32], res: &mut [u32])
{
    ...
    let r: u32 =
        crate::bignum_base::bn_add_eq_len_u32(
...
#[inline] pub(crate) fn bn_sqr_u64(aLen: u32, a: &mut [u64], res: &mut [u64])
{
    (res[0usize..aLen.wrapping_add(aLen) as usize]).copy_from_slice(
    ...
    let r: u64 =
        crate::bignum_base::bn_add_eq_len_u64(
            aLen.wrapping_add(aLen),
            &mut a_copy,
            &mut b_copy,
            res
