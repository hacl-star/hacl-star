...
mul(a: &mut [u32], b: &mut [u32], res: &mut [u32])
{
    ...
    crate::bignum::bn_karatsuba_mul_uint32(128u32, a, b, &mut tmp, res)
}
...
{
    let mut tmp: [u32; 512] = [0u32; 512usize];
    crate::bignum::bn_karatsuba_sqr_uint32(128u32, a, &mut tmp, res)
}
...
#[inline] fn precompr2(nBits: u32, n: &mut [u32], res: &mut [u32])
{
    ...
    for _i in 0u32..8192u32.wrapping_sub(nBits)
    {
        ...
        crate::bignum4096_32::add_mod(n, &mut a_copy, &mut b_copy, res)
    }
}
...
#[inline] fn to(n: &mut [u32], nInv: u32, r2: &mut [u32], a: &mut [u32], aM: &mut [u32])
{
    ...
    crate::bignum4096_32::mul(a, r2, &mut c);
    crate::bignum4096_32::reduction(n, nInv, &mut c, aM)
}
...
#[inline] fn from(n: &mut [u32], nInv_u64: u32, aM: &mut [u32], a: &mut [u32])
{
    ...
    crate::bignum4096_32::reduction(n, nInv_u64, &mut tmp, a)
}
...
#[inline] fn areduction(n: &mut [u32], nInv: u32, c: &mut [u32], res: &mut [u32])
{
    ...
    let c00: u32 = (&mut c0)[0usize];
    let mut tmp: [u32; 128] = [0u32; 128usize];
    let c1: u32 = crate::bignum4096_32::sub(res, n, &mut tmp);
...
{
    let mut c: [u32; 256] = [0u32; 256usize];
    crate::bignum4096_32::mul(aM, bM, &mut c);
    crate::bignum4096_32::areduction(n, nInv_u64, &mut c, resM)
}

#[inline] fn amont_sqr(n: &mut [u32], nInv_u64: u32, aM: &mut [u32], resM: &mut [u32])
{
    let mut c: [u32; 256] = [0u32; 256usize];
    crate::bignum4096_32::sqr(aM, &mut c);
    crate::bignum4096_32::areduction(n, nInv_u64, &mut c, resM)
}
...
)
{
    ...
    crate::bignum4096_32::areduction(n, mu, &mut a1, &mut a_mod);
    crate::bignum4096_32::to(n, mu, r2, &mut a_mod, res)
}
    ...
    bool
{
    ...
    let nBits: u32 = 32u32.wrapping_mul(crate::bignum_base::bn_get_top_index_u32(128u32, n));
    if is_valid_m == 0xFFFFFFFFu32
    {
        let mut r2: [u32; 128] = [0u32; 128usize];
        crate::bignum4096_32::precompr2(nBits, n, &mut r2);
        let mu: u32 = crate::bignum::mod_inv_uint32(n[0usize]);
        crate::bignum4096_32::bn_slow_precomp(n, mu, &mut r2, a, res)
    }
    else
    { (res[0usize..128usize]).copy_from_slice(&[0u32; 128usize]) };
...
)
{
    if bBits < 200u32
    {
        ...
        crate::bignum4096_32::to(n, mu, r2, a, &mut aM);
        ...
        crate::bignum4096_32::from(ctx_r2.0, mu, ctx_r2.1, &mut resM);
        ...
        for i in 0u32..bBits
        {
            ...
            if bit != 0u32
            {
                ...
                crate::bignum4096_32::amont_mul(ctx_n0.1, mu, &mut aM_copy, &mut aM, &mut resM);
                lowstar::ignore::ignore::<&mut [u32]>(&mut ctx)
            };
            let mut aM_copy: [u32; 128] = [0u32; 128usize];
            ((&mut aM_copy)[0usize..128usize]).copy_from_slice(&(&mut aM)[0usize..128usize]);
            let ctx_n0: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
            crate::bignum4096_32::amont_sqr(ctx_n0.1, mu, &mut aM_copy, &mut aM);
            lowstar::ignore::ignore::<&mut [u32]>(&mut ctx)
        };
        crate::bignum4096_32::from(n, mu, &mut resM, res)
    }
    else
    {
        let mut aM: [u32; 128] = [0u32; 128usize];
        ...
        let ctx_n: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
        let ctx_r2: (&mut [u32], &mut [u32]) = ctx_n.1.split_at_mut(128usize);
        crate::bignum4096_32::from(ctx_r2.0, mu, ctx_r2.1, t1.0);
        lowstar::ignore::ignore::<&mut [u32]>(&mut ctx);
        ...
        krml::unroll_for!(
            ...
            1u32,
            {
                let t11: (&mut [u32], &mut [u32]) =
                    table.split_at_mut(i.wrapping_add(1u32).wrapping_mul(128u32) as usize);
                let mut aM_copy: [u32; 128] = [0u32; 128usize];
                ((&mut aM_copy)[0usize..128usize]).copy_from_slice(&t11.1[0usize..128usize]);
                let ctx_n0: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
                crate::bignum4096_32::amont_sqr(ctx_n0.1, mu, &mut aM_copy, &mut tmp);
                lowstar::ignore::ignore::<&mut [u32]>(&mut ctx);
                ...
                crate::bignum4096_32::amont_mul(ctx_n1.1, mu, &mut aM_copy0, t2.1, &mut tmp);
                lowstar::ignore::ignore::<&mut [u32]>(&mut ctx);
        ...
        if bBits.wrapping_rem(4u32) != 0u32
        {
            ...
            let a_bits_l: (&mut [u32], &mut [u32]) =
                table.split_at_mut(bits_l32.wrapping_mul(128u32) as usize);
            ((&mut resM)[0usize..128usize]).copy_from_slice(&a_bits_l.1[0usize..128usize])
        }
        else
        {
            let ctx_n0: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
            let ctx_r20: (&mut [u32], &mut [u32]) = ctx_n0.1.split_at_mut(128usize);
            crate::bignum4096_32::from(ctx_r20.0, mu, ctx_r20.1, &mut resM);
            lowstar::ignore::ignore::<&mut [u32]>(&mut ctx)
        };
        ...
        for i in 0u32..bBits.wrapping_div(4u32)
        {
            krml::unroll_for!(
                ...
                {
                    let mut aM_copy: [u32; 128] = [0u32; 128usize];
                    ((&mut aM_copy)[0usize..128usize]).copy_from_slice(
                        &(&mut resM)[0usize..128usize]
                    );
                    let ctx_n0: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
                    crate::bignum4096_32::amont_sqr(ctx_n0.1, mu, &mut aM_copy, &mut resM);
                    lowstar::ignore::ignore::<&mut [u32]>(&mut ctx)
                }
            );
            let k: u32 =
            ...
            ((&mut aM_copy)[0usize..128usize]).copy_from_slice(&(&mut resM)[0usize..128usize]);
            let ctx_n0: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
            crate::bignum4096_32::amont_mul(ctx_n0.1, mu, &mut aM_copy, &mut tmp0, &mut resM);
            lowstar::ignore::ignore::<&mut [u32]>(&mut ctx)
        };
        crate::bignum4096_32::from(n, mu, &mut resM, res)
    }
...
)
{
    if bBits < 200u32
    {
        ...
        for i in 0u32..bBits
        {
            ...
            ((&mut aM_copy)[0usize..128usize]).copy_from_slice(&(&mut aM)[0usize..128usize]);
            let ctx_n0: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
            crate::bignum4096_32::amont_mul(ctx_n0.1, mu, &mut aM_copy, &mut resM, &mut aM);
            lowstar::ignore::ignore::<&mut [u32]>(&mut ctx);
            let mut aM_copy0: [u32; 128] = [0u32; 128usize];
            ((&mut aM_copy0)[0usize..128usize]).copy_from_slice(&(&mut resM)[0usize..128usize]);
            let ctx_n1: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
            crate::bignum4096_32::amont_sqr(ctx_n1.1, mu, &mut aM_copy0, &mut resM);
            lowstar::ignore::ignore::<&mut [u32]>(&mut ctx);
            (&mut sw)[0usize] = bit
        };
            ...
            krml::unroll_for!(
                ...
                1u32,
                {
                    ...
                    let res_j: (&mut [u32], &mut [u32]) =
                        table.split_at_mut(i0.wrapping_add(1u32).wrapping_mul(128u32) as usize);
...
)
{
    ...
    crate::bignum4096_32::precompr2(nBits, n, &mut r2);
    let mu: u32 = crate::bignum::mod_inv_uint32(n[0usize]);
    crate::bignum4096_32::exp_vartime_precomp(n, mu, &mut r2, a, bBits, b, res)
}
...
)
{
    ...
    crate::bignum4096_32::precompr2(nBits, n, &mut r2);
    let mu: u32 = crate::bignum::mod_inv_uint32(n[0usize]);
    crate::bignum4096_32::exp_consttime_precomp(n, mu, &mut r2, a, bBits, b, res)
}
...
mod_exp_vartime(n: &mut [u32], a: &mut [u32], bBits: u32, b: &mut [u32], res: &mut [u32]) ->
    bool
{
    let is_valid_m: u32 = crate::bignum4096_32::exp_check(n, a, bBits, b);
    let nBits: u32 = 32u32.wrapping_mul(crate::bignum_base::bn_get_top_index_u32(128u32, n));
    if is_valid_m == 0xFFFFFFFFu32
    { crate::bignum4096_32::exp_vartime(nBits, n, a, bBits, b, res) }
    else
    { (res[0usize..128usize]).copy_from_slice(&[0u32; 128usize]) };
    is_valid_m == 0xFFFFFFFFu32
}
    ...
    bool
{
    ...
    let nBits: u32 = 32u32.wrapping_mul(crate::bignum_base::bn_get_top_index_u32(128u32, n));
    if is_valid_m == 0xFFFFFFFFu32
    { crate::bignum4096_32::exp_consttime(nBits, n, a, bBits, b, res) }
    else
    { (res[0usize..128usize]).copy_from_slice(&[0u32; 128usize]) };
    is_valid_m == 0xFFFFFFFFu32
}
    ...
    bool
{
    ...
    if is_valid_m == 0xFFFFFFFFu32
    {
        ...
        crate::bignum4096_32::exp_vartime(nBits, n, a, 4096u32, &mut n2, res)
    }
    else
    { (res[0usize..128usize]).copy_from_slice(&[0u32; 128usize]) };
    is_valid_m == 0xFFFFFFFFu32
    ...
    Box<[crate::bignum::bn_mont_ctx_u32]>
{
    ...
    let nBits: u32 = 32u32.wrapping_mul(crate::bignum_base::bn_get_top_index_u32(128u32, n));
    crate::bignum4096_32::precompr2(nBits, n, r21);
    let mu: u32 = crate::bignum::mod_inv_uint32(n[0usize]);
    let mut res: crate::bignum::bn_mont_ctx_u32 =
        crate::bignum::bn_mont_ctx_u32 { len: 128u32, n: (*n11).into(), mu, r2: (*r21).into() };
...
mod_precomp(k: &mut [crate::bignum::bn_mont_ctx_u32], a: &mut [u32], res: &mut [u32])
{
    ...
    crate::bignum4096_32::bn_slow_precomp(n, mu, r2, a, res)
}
...
)
{
    ...
    let mu: u32 = (k[0usize]).mu;
    let r2: &mut [u32] = &mut (k[0usize]).r2;
    crate::bignum4096_32::exp_vartime_precomp(n, mu, r2, a, bBits, b, res)
}
...
)
{
    ...
    let mu: u32 = (k[0usize]).mu;
    let r2: &mut [u32] = &mut (k[0usize]).r2;
    crate::bignum4096_32::exp_consttime_precomp(n, mu, r2, a, bBits, b, res)
}
...
)
{
    ...
    let c2: u32 = c1;
    lowstar::ignore::ignore::<u32>(c2);
    crate::bignum4096_32::exp_vartime_precomp(n, mu, r2, a, 4096u32, &mut n2, res)
}
