...
*/
pub fn
add(a: &mut [u32], b: &mut [u32], res: &mut [u32]) ->
    u32
{
...
*/
pub fn
sub(a: &mut [u32], b: &mut [u32], res: &mut [u32]) ->
    u32
{
    let mut c: [u32; 1] = [0u32; 1usize];
    krml::unroll_for!(
...
*/
pub fn
add_mod(n: &mut [u32], a: &mut [u32], b: &mut [u32], res: &mut [u32])
{
    let mut c: [u32; 1] = [0u32; 1usize];
    krml::unroll_for!(
        2,
...
*/
pub fn
sub_mod(n: &mut [u32], a: &mut [u32], b: &mut [u32], res: &mut [u32])
{
    let mut c: [u32; 1] = [0u32; 1usize];
    krml::unroll_for!(
        2,
...
*/
pub fn
mul(a: &mut [u32], b: &mut [u32], res: &mut [u32])
{
        ...
        1u32,
        {
            ...
            krml::unroll_for!(
                ...
                1u32,
                {
                    ...
                    (&mut c)[0usize] =
                        crate::bignum_base::mul_wide_add2_u32(a_i, bj, (&mut c)[0usize], res_i.1);
                    let a_i0: u32 = a[4u32.wrapping_mul(i0).wrapping_add(1u32) as usize];
                    let res_i0: (&mut [u32], &mut [u32]) = res_i.1.split_at_mut(1usize);
                    (&mut c)[0usize] =
                        crate::bignum_base::mul_wide_add2_u32(a_i0, bj, (&mut c)[0usize], res_i0.1);
                    let a_i1: u32 = a[4u32.wrapping_mul(i0).wrapping_add(2u32) as usize];
                    let res_i1: (&mut [u32], &mut [u32]) = res_i0.1.split_at_mut(1usize);
                    (&mut c)[0usize] =
                        crate::bignum_base::mul_wide_add2_u32(a_i1, bj, (&mut c)[0usize], res_i1.1);
                    let a_i2: u32 = a[4u32.wrapping_mul(i0).wrapping_add(3u32) as usize];
                    let res_i2: (&mut [u32], &mut [u32]) = res_i1.1.split_at_mut(1usize);
                    (&mut c)[0usize] =
                        crate::bignum_base::mul_wide_add2_u32(a_i2, bj, (&mut c)[0usize], res_i2.1)
                }
            );
...
sqr(a: &mut [u32], res: &mut [u32])
{
        ...
        1u32,
        {
            ...
            for i0 in 0u32..i.wrapping_div(4u32)
            {
                ...
                let res_i: (&mut [u32], &mut [u32]) =
                    res_j.1.split_at_mut(4u32.wrapping_mul(i0) as usize);
                (&mut c)[0usize] =
                    crate::bignum_base::mul_wide_add2_u32(a_i, a_j, (&mut c)[0usize], res_i.1);
                let a_i0: u32 = ab.1[4u32.wrapping_mul(i0).wrapping_add(1u32) as usize];
                let res_i0: (&mut [u32], &mut [u32]) = res_i.1.split_at_mut(1usize);
                (&mut c)[0usize] =
                    crate::bignum_base::mul_wide_add2_u32(a_i0, a_j, (&mut c)[0usize], res_i0.1);
                let a_i1: u32 = ab.1[4u32.wrapping_mul(i0).wrapping_add(2u32) as usize];
                let res_i1: (&mut [u32], &mut [u32]) = res_i0.1.split_at_mut(1usize);
                (&mut c)[0usize] =
                    crate::bignum_base::mul_wide_add2_u32(a_i1, a_j, (&mut c)[0usize], res_i1.1);
                let a_i2: u32 = ab.1[4u32.wrapping_mul(i0).wrapping_add(3u32) as usize];
                let res_i2: (&mut [u32], &mut [u32]) = res_i1.1.split_at_mut(1usize);
                (&mut c)[0usize] =
                    crate::bignum_base::mul_wide_add2_u32(a_i2, a_j, (&mut c)[0usize], res_i2.1)
            };
    ...
    let r: u32 = crate::bignum_base::bn_add_eq_len_u32(16u32, &mut a_copy, &mut b_copy, res);
    let c0: u32 = r;
    ...
    let r0: u32 = crate::bignum_base::bn_add_eq_len_u32(16u32, &mut a_copy0, &mut b_copy0, res);
    let c1: u32 = r0;
...
#[inline] fn precompr2(nBits: u32, n: &mut [u32], res: &mut [u32])
{
    ...
    for _i in 0u32..512u32.wrapping_sub(nBits)
    {
        ...
        crate::bignum256_32::add_mod(n, &mut a_copy, &mut b_copy, res)
    }
}
...
#[inline] fn to(n: &mut [u32], nInv: u32, r2: &mut [u32], a: &mut [u32], aM: &mut [u32])
{
    ...
    crate::bignum256_32::mul(a, r2, &mut c);
    crate::bignum256_32::reduction(n, nInv, &mut c, aM)
}
...
#[inline] fn from(n: &mut [u32], nInv_u64: u32, aM: &mut [u32], a: &mut [u32])
{
    ...
    crate::bignum256_32::reduction(n, nInv_u64, &mut tmp, a)
}
...
#[inline] fn areduction(n: &mut [u32], nInv: u32, c: &mut [u32], res: &mut [u32])
{
    ...
    let c00: u32 = (&mut c0)[0usize];
    let mut tmp: [u32; 8] = [0u32; 8usize];
    let c1: u32 = crate::bignum256_32::sub(res, n, &mut tmp);
    lowstar::ignore::ignore::<u32>(c1);
...
{
    let mut c: [u32; 16] = [0u32; 16usize];
    crate::bignum256_32::mul(aM, bM, &mut c);
    crate::bignum256_32::areduction(n, nInv_u64, &mut c, resM)
}

#[inline] fn amont_sqr(n: &mut [u32], nInv_u64: u32, aM: &mut [u32], resM: &mut [u32])
{
    let mut c: [u32; 16] = [0u32; 16usize];
    crate::bignum256_32::sqr(aM, &mut c);
    crate::bignum256_32::areduction(n, nInv_u64, &mut c, resM)
}
...
)
{
    ...
    crate::bignum256_32::areduction(n, mu, &mut a1, &mut a_mod);
    crate::bignum256_32::to(n, mu, r2, &mut a_mod, res)
}
...
*/
pub fn
r#mod(n: &mut [u32], a: &mut [u32], res: &mut [u32]) ->
    bool
{
    ...
    let nBits: u32 = 32u32.wrapping_mul(crate::bignum_base::bn_get_top_index_u32(8u32, n));
    if is_valid_m == 0xFFFFFFFFu32
    {
        let mut r2: [u32; 8] = [0u32; 8usize];
        crate::bignum256_32::precompr2(nBits, n, &mut r2);
        let mu: u32 = crate::bignum::mod_inv_uint32(n[0usize]);
        crate::bignum256_32::bn_slow_precomp(n, mu, &mut r2, a, res)
    }
    else
    { (res[0usize..8usize]).copy_from_slice(&[0u32; 8usize]) };
...
)
{
    if bBits < 200u32
    {
        ...
        crate::bignum256_32::to(n, mu, r2, a, &mut aM);
        ...
        crate::bignum256_32::from(ctx_r2.0, mu, ctx_r2.1, &mut resM);
        ...
        for i in 0u32..bBits
        {
            ...
            if bit != 0u32
            {
                ...
                crate::bignum256_32::amont_mul(ctx_n0.1, mu, &mut aM_copy, &mut aM, &mut resM);
                lowstar::ignore::ignore::<&mut [u32]>(&mut ctx)
            };
            let mut aM_copy: [u32; 8] = [0u32; 8usize];
            ((&mut aM_copy)[0usize..8usize]).copy_from_slice(&(&mut aM)[0usize..8usize]);
            let ctx_n0: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
            crate::bignum256_32::amont_sqr(ctx_n0.1, mu, &mut aM_copy, &mut aM);
            lowstar::ignore::ignore::<&mut [u32]>(&mut ctx)
        };
        crate::bignum256_32::from(n, mu, &mut resM, res)
    }
    else
    {
        let mut aM: [u32; 8] = [0u32; 8usize];
        ...
        let ctx_n: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
        let ctx_r2: (&mut [u32], &mut [u32]) = ctx_n.1.split_at_mut(8usize);
        crate::bignum256_32::from(ctx_r2.0, mu, ctx_r2.1, t1.0);
        lowstar::ignore::ignore::<&mut [u32]>(&mut ctx);
        ...
        krml::unroll_for!(
            ...
            1u32,
            {
                let t11: (&mut [u32], &mut [u32]) =
                    table.split_at_mut(i.wrapping_add(1u32).wrapping_mul(8u32) as usize);
                let mut aM_copy: [u32; 8] = [0u32; 8usize];
                ((&mut aM_copy)[0usize..8usize]).copy_from_slice(&t11.1[0usize..8usize]);
                let ctx_n0: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
                crate::bignum256_32::amont_sqr(ctx_n0.1, mu, &mut aM_copy, &mut tmp);
                lowstar::ignore::ignore::<&mut [u32]>(&mut ctx);
                ...
                crate::bignum256_32::amont_mul(ctx_n1.1, mu, &mut aM_copy0, t2.1, &mut tmp);
                lowstar::ignore::ignore::<&mut [u32]>(&mut ctx);
        ...
        if bBits.wrapping_rem(4u32) != 0u32
        {
            ...
            let a_bits_l: (&mut [u32], &mut [u32]) =
                table.split_at_mut(bits_l32.wrapping_mul(8u32) as usize);
        ...
        else
        {
            ...
            crate::bignum256_32::from(ctx_r20.0, mu, ctx_r20.1, &mut resM);
            lowstar::ignore::ignore::<&mut [u32]>(&mut ctx)
        };
        ...
        for i in 0u32..bBits.wrapping_div(4u32)
        {
            krml::unroll_for!(
                ...
                1u32,
                {
                    ...
                    ((&mut aM_copy)[0usize..8usize]).copy_from_slice(&(&mut resM)[0usize..8usize]);
                    let ctx_n0: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
                    crate::bignum256_32::amont_sqr(ctx_n0.1, mu, &mut aM_copy, &mut resM);
                    lowstar::ignore::ignore::<&mut [u32]>(&mut ctx)
                }
            );
            let k: u32 =
            ...
            ((&mut aM_copy)[0usize..8usize]).copy_from_slice(&(&mut resM)[0usize..8usize]);
            let ctx_n0: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
            crate::bignum256_32::amont_mul(ctx_n0.1, mu, &mut aM_copy, &mut tmp0, &mut resM);
            lowstar::ignore::ignore::<&mut [u32]>(&mut ctx)
        };
        crate::bignum256_32::from(n, mu, &mut resM, res)
    }
...
)
{
    if bBits < 200u32
    {
        ...
        for i in 0u32..bBits
        {
            ...
            ((&mut aM_copy)[0usize..8usize]).copy_from_slice(&(&mut aM)[0usize..8usize]);
            let ctx_n0: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
            crate::bignum256_32::amont_mul(ctx_n0.1, mu, &mut aM_copy, &mut resM, &mut aM);
            lowstar::ignore::ignore::<&mut [u32]>(&mut ctx);
            let mut aM_copy0: [u32; 8] = [0u32; 8usize];
            ((&mut aM_copy0)[0usize..8usize]).copy_from_slice(&(&mut resM)[0usize..8usize]);
            let ctx_n1: (&mut [u32], &mut [u32]) = ctx.split_at_mut(0usize);
            crate::bignum256_32::amont_sqr(ctx_n1.1, mu, &mut aM_copy0, &mut resM);
            lowstar::ignore::ignore::<&mut [u32]>(&mut ctx);
            (&mut sw)[0usize] = bit
        };
            ...
            krml::unroll_for!(
                ...
                1u32,
                {
                    ...
                    let res_j: (&mut [u32], &mut [u32]) =
                        table.split_at_mut(i0.wrapping_add(1u32).wrapping_mul(8u32) as usize);
                    krml::unroll_for!(
                        8,
                        "i1",
                        0u32,
...
)
{
    ...
    crate::bignum256_32::precompr2(nBits, n, &mut r2);
    let mu: u32 = crate::bignum::mod_inv_uint32(n[0usize]);
    crate::bignum256_32::exp_vartime_precomp(n, mu, &mut r2, a, bBits, b, res)
}
...
)
{
    ...
    crate::bignum256_32::precompr2(nBits, n, &mut r2);
    let mu: u32 = crate::bignum::mod_inv_uint32(n[0usize]);
    crate::bignum256_32::exp_consttime_precomp(n, mu, &mut r2, a, bBits, b, res)
}
...
*/
pub fn
mod_exp_vartime(n: &mut [u32], a: &mut [u32], bBits: u32, b: &mut [u32], res: &mut [u32]) ->
    bool
{
    let is_valid_m: u32 = crate::bignum256_32::exp_check(n, a, bBits, b);
    let nBits: u32 = 32u32.wrapping_mul(crate::bignum_base::bn_get_top_index_u32(8u32, n));
    if is_valid_m == 0xFFFFFFFFu32
    { crate::bignum256_32::exp_vartime(nBits, n, a, bBits, b, res) }
    else
    { (res[0usize..8usize]).copy_from_slice(&[0u32; 8usize]) };
    is_valid_m == 0xFFFFFFFFu32
}
...
*/
pub fn
mod_exp_consttime(n: &mut [u32], a: &mut [u32], bBits: u32, b: &mut [u32], res: &mut [u32]) ->
    bool
{
    let is_valid_m: u32 = crate::bignum256_32::exp_check(n, a, bBits, b);
    let nBits: u32 = 32u32.wrapping_mul(crate::bignum_base::bn_get_top_index_u32(8u32, n));
    if is_valid_m == 0xFFFFFFFFu32
    { crate::bignum256_32::exp_consttime(nBits, n, a, bBits, b, res) }
    else
    { (res[0usize..8usize]).copy_from_slice(&[0u32; 8usize]) };
    is_valid_m == 0xFFFFFFFFu32
}
...
*/
pub fn
mod_inv_prime_vartime(n: &mut [u32], a: &mut [u32], res: &mut [u32]) ->
    bool
{
    let mut one: [u32; 8] = [0u32; 8usize];
    ((&mut one)[0usize..8usize]).copy_from_slice(&[0u32; 8usize]);
    ...
    krml::unroll_for!(
        ...
        1u32,
        {
            let uu____0: u32 = fstar::uint32::eq_mask(a[i as usize], (&mut bn_zero)[i as usize]);
    ...
    if is_valid_m == 0xFFFFFFFFu32
    {
        ...
        let mut c: [u32; 1] = [c0; 1usize];
        {
            ...
            (&mut c)[0usize] =
                lib::inttypes_intrinsics::sub_borrow_u32((&mut c)[0usize], t1, 0u32, res_i.1);
            let t10: u32 = a1.1[4u32.wrapping_mul(0u32).wrapping_add(1u32) as usize];
            let res_i0: (&mut [u32], &mut [u32]) = res_i.1.split_at_mut(1usize);
            (&mut c)[0usize] =
                lib::inttypes_intrinsics::sub_borrow_u32((&mut c)[0usize], t10, 0u32, res_i0.1);
            let t11: u32 = a1.1[4u32.wrapping_mul(0u32).wrapping_add(2u32) as usize];
            let res_i1: (&mut [u32], &mut [u32]) = res_i0.1.split_at_mut(1usize);
            (&mut c)[0usize] =
                lib::inttypes_intrinsics::sub_borrow_u32((&mut c)[0usize], t11, 0u32, res_i1.1);
            let t12: u32 = a1.1[4u32.wrapping_mul(0u32).wrapping_add(3u32) as usize];
            let res_i2: (&mut [u32], &mut [u32]) = res_i1.1.split_at_mut(1usize);
            (&mut c)[0usize] =
                lib::inttypes_intrinsics::sub_borrow_u32((&mut c)[0usize], t12, 0u32, res_i2.1)
        };
        krml::unroll_for!(
            3,
            "i",
        ...
        crate::bignum256_32::exp_vartime(nBits, n, a, 256u32, &mut n2, res)
    }
    else
    { (res[0usize..8usize]).copy_from_slice(&[0u32; 8usize]) };
    is_valid_m == 0xFFFFFFFFu32
    ...
    Box<[crate::bignum::bn_mont_ctx_u32]>
{
    ...
    let nBits: u32 = 32u32.wrapping_mul(crate::bignum_base::bn_get_top_index_u32(8u32, n));
    crate::bignum256_32::precompr2(nBits, n, r21);
    let mu: u32 = crate::bignum::mod_inv_uint32(n[0usize]);
    let mut res: crate::bignum::bn_mont_ctx_u32 =
        crate::bignum::bn_mont_ctx_u32 { len: 8u32, n: (*n11).into(), mu, r2: (*r21).into() };
    let mut buf: Box<[crate::bignum::bn_mont_ctx_u32]> = vec![res].into_boxed_slice();
    buf
}
...
*/
pub fn
mod_precomp(k: &mut [crate::bignum::bn_mont_ctx_u32], a: &mut [u32], res: &mut [u32])
{
    let n: &mut [u32] = &mut (k[0usize]).n;
    let mu: u32 = (k[0usize]).mu;
    let r2: &mut [u32] = &mut (k[0usize]).r2;
    crate::bignum256_32::bn_slow_precomp(n, mu, r2, a, res)
}
...
mod_exp_vartime_precomp(
    k: &mut [crate::bignum::bn_mont_ctx_u32],
    a: &mut [u32],
    bBits: u32,
    b: &mut [u32],
    res: &mut [u32]
)
{
    ...
    let mu: u32 = (k[0usize]).mu;
    let r2: &mut [u32] = &mut (k[0usize]).r2;
    crate::bignum256_32::exp_vartime_precomp(n, mu, r2, a, bBits, b, res)
}
...
)
{
    ...
    let mu: u32 = (k[0usize]).mu;
    let r2: &mut [u32] = &mut (k[0usize]).r2;
    crate::bignum256_32::exp_consttime_precomp(n, mu, r2, a, bBits, b, res)
}
...
)
{
    ...
    let c2: u32 = c1;
    lowstar::ignore::ignore::<u32>(c2);
    crate::bignum256_32::exp_vartime_precomp(n, mu, r2, a, 256u32, &mut n2, res)
}
...
*/
pub fn
new_bn_from_bytes_be(len: u32, b: &mut [u8]) ->
    Box<[u32]>
{
...
*/
pub fn
new_bn_from_bytes_le(len: u32, b: &mut [u8]) ->
    Box<[u32]>
{
    if len == 0u32 || len.wrapping_sub(1u32).wrapping_div(4u32).wrapping_add(1u32) > 1073741823u32
    { [].into() }
    else
    {
        ...
        else
        {
            ...
            {
                let bj: (&mut [u8], &mut [u8]) = tmp.split_at_mut(i.wrapping_mul(4u32) as usize);
...
*/
pub fn
bn_to_bytes_be(b: &mut [u32], res: &mut [u8])
{
...
*/
pub fn
bn_to_bytes_le(b: &mut [u32], res: &mut [u8])
{
    let mut tmp: [u8; 32] = [0u8; 32usize];
    lowstar::ignore::ignore::<&mut [u8]>(&mut tmp);
    krml::unroll_for!(
