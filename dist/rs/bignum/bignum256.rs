...
#[inline] fn precompr2(nBits: u32, n: &[u64], res: &mut [u64])
{
    ...
    for _i in 0u32..512u32.wrapping_sub(nBits)
    {
        ...
        crate::bignum256::add_mod(n, &a_copy, &b_copy, res)
    }
}
...
#[inline] fn bn_slow_precomp(n: &[u64], mu: u64, r2: &[u64], a: &[u64], res: &mut [u64])
{
    ...
    crate::bignum256::to(n, mu, r2, &a_mod, res)
}
    ...
    if bBits < 200u32
    {
        ...
        for i in 0u32..bBits
        {
            ...
            if bit != 0u64
            {
                ...
                crate::bignum256::amont_mul(ctx_n0.1, mu, &aM_copy, &aM, &mut resM);
                lowstar::ignore::ignore::<&[u64]>(&ctx)
            };
            let mut aM_copy: [u64; 4] = [0u64; 4usize];
            ((&mut aM_copy)[0usize..4usize]).copy_from_slice(&(&aM)[0usize..4usize]);
            let ctx_n0: (&[u64], &[u64]) = ctx.split_at(0usize);
            crate::bignum256::amont_sqr(ctx_n0.1, mu, &aM_copy, &mut aM);
            lowstar::ignore::ignore::<&[u64]>(&ctx)
        };
        crate::bignum256::from(n, mu, &resM, res)
    }
    else
    {
        let mut aM: [u64; 4] = [0u64; 4usize];
        ...
        krml::unroll_for!(
            ...
            1u32,
            {
                ...
                let ctx_n0: (&[u64], &[u64]) = ctx.split_at(0usize);
                crate::bignum256::amont_sqr(ctx_n0.1, mu, &aM_copy, &mut tmp);
                lowstar::ignore::ignore::<&[u64]>(&ctx);
                ...
                usize
                +
                4usize]).copy_from_slice(&(&tmp)[0usize..4usize]);
                let t2: (&[u64], &[u64]) =
                    table.split_at(
                ...
                crate::bignum256::amont_mul(ctx_n1.1, mu, &aM_copy0, t2.1, &mut tmp);
                lowstar::ignore::ignore::<&[u64]>(&ctx);
        ...
        for i in 0u32..bBits.wrapping_div(4u32)
        {
            krml::unroll_for!(
                ...
                1u32,
                {
                    ...
                    ((&mut aM_copy)[0usize..4usize]).copy_from_slice(&(&resM)[0usize..4usize]);
                    let ctx_n0: (&[u64], &[u64]) = ctx.split_at(0usize);
                    crate::bignum256::amont_sqr(ctx_n0.1, mu, &aM_copy, &mut resM);
                    lowstar::ignore::ignore::<&[u64]>(&ctx)
                }
            );
            let k: u32 =
            ...
            ((&mut aM_copy)[0usize..4usize]).copy_from_slice(&(&resM)[0usize..4usize]);
            let ctx_n0: (&[u64], &[u64]) = ctx.split_at(0usize);
            crate::bignum256::amont_mul(ctx_n0.1, mu, &aM_copy, &tmp0, &mut resM);
            lowstar::ignore::ignore::<&[u64]>(&ctx)
        };
        crate::bignum256::from(n, mu, &resM, res)
    }
...
)
{
    if bBits < 200u32
    {
        ...
        for i in 0u32..bBits
        {
            ...
            ((&mut aM_copy)[0usize..4usize]).copy_from_slice(&(&aM)[0usize..4usize]);
            let ctx_n0: (&[u64], &[u64]) = ctx.split_at(0usize);
            crate::bignum256::amont_mul(ctx_n0.1, mu, &aM_copy, &resM, &mut aM);
            lowstar::ignore::ignore::<&[u64]>(&ctx);
            let mut aM_copy0: [u64; 4] = [0u64; 4usize];
            ((&mut aM_copy0)[0usize..4usize]).copy_from_slice(&(&resM)[0usize..4usize]);
            let ctx_n1: (&[u64], &[u64]) = ctx.split_at(0usize);
            crate::bignum256::amont_sqr(ctx_n1.1, mu, &aM_copy0, &mut resM);
            lowstar::ignore::ignore::<&[u64]>(&ctx);
            (&mut sw)[0usize] = bit
        };
    ...
    else
    {
        ...
        if bBits.wrapping_rem(4u32) != 0u32
        {
            let i: u32 = bBits.wrapping_div(4u32).wrapping_mul(4u32);
            let bits_c: u64 = crate::bignum_base::bn_get_bits_u64(bLen, b, i, 4u32);
            ((&mut resM)[0usize..4usize]).copy_from_slice(&(&(&table)[0usize..])[0usize..4usize]);
            krml::unroll_for!(
                15,
                "i0",
                0u32,
        ...
        for i in 0u32..bBits.wrapping_div(4u32)
        {
            ...
            let bits_l: u64 = crate::bignum_base::bn_get_bits_u64(bLen, b, k, 4u32);
            lowstar::ignore::ignore::<&[u64]>(&table);
            ((&mut tmp0)[0usize..4usize]).copy_from_slice(&(&(&table)[0usize..])[0usize..4usize]);
            krml::unroll_for!(
                15,
                "i0",
                0u32,
    ...
    bool
{
    ...
    if is_valid_m == 0xFFFFFFFFFFFFFFFFu64
    {
        ...
        crate::bignum256::exp_vartime(nBits, n, a, 256u32, &n2, res)
    }
    else
    { (res[0usize..4usize]).copy_from_slice(&[0u64; 4usize]) };
    is_valid_m == 0xFFFFFFFFFFFFFFFFu64
...
mod_inv_prime_vartime_precomp(k: &[crate::bignum::bn_mont_ctx_u64], a: &[u64], res: &mut [u64])
{
    ...
    let c2: u64 = c1;
    lowstar::ignore::ignore::<u64>(c2);
    crate::bignum256::exp_vartime_precomp(n, mu, r2, a, 256u32, &n2, res)
}
