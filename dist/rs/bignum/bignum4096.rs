...
#[inline] fn precompr2(nBits: u32, n: &mut [u64], res: &mut [u64])
{
    ...
    for _i in 0u32..8192u32.wrapping_sub(nBits)
    {
        ...
        crate::bignum4096::add_mod(n, &mut a_copy, &mut b_copy, res)
    }
}
...
)
{
    ...
    crate::bignum4096::to(n, mu, r2, &mut a_mod, res)
}
    ...
    bool
{
    ...
    if is_valid_m == 0xFFFFFFFFFFFFFFFFu64
    {
        ...
        crate::bignum4096::bn_slow_precomp(n, mu, &mut r2, a, res)
    }
    else
    { (res[0usize..64usize]).copy_from_slice(&[0u64; 64usize]) };
    ...
    if bBits < 200u32
    {
        ...
        for i in 0u32..bBits
        {
            ...
            if bit != 0u64
            {
                ...
                crate::bignum4096::amont_mul(ctx_n0.1, mu, &mut aM_copy, &mut aM, &mut resM);
                lowstar::ignore::ignore::<&mut [u64]>(&mut ctx)
            };
            let mut aM_copy: [u64; 64] = [0u64; 64usize];
            ((&mut aM_copy)[0usize..64usize]).copy_from_slice(&(&mut aM)[0usize..64usize]);
            let ctx_n0: (&mut [u64], &mut [u64]) = ctx.split_at_mut(0usize);
            crate::bignum4096::amont_sqr(ctx_n0.1, mu, &mut aM_copy, &mut aM);
            lowstar::ignore::ignore::<&mut [u64]>(&mut ctx)
        };
        crate::bignum4096::from(n, mu, &mut resM, res)
    }
    else
    {
        let mut aM: [u64; 64] = [0u64; 64usize];
        ...
        krml::unroll_for!(
            ...
            1u32,
            {
                let t11: (&mut [u64], &mut [u64]) =
                    table.split_at_mut(i.wrapping_add(1u32).wrapping_mul(64u32) as usize);
                let mut aM_copy: [u64; 64] = [0u64; 64usize];
                ((&mut aM_copy)[0usize..64usize]).copy_from_slice(&t11.1[0usize..64usize]);
                let ctx_n0: (&mut [u64], &mut [u64]) = ctx.split_at_mut(0usize);
                crate::bignum4096::amont_sqr(ctx_n0.1, mu, &mut aM_copy, &mut tmp);
                lowstar::ignore::ignore::<&mut [u64]>(&mut ctx);
                ...
                crate::bignum4096::amont_mul(ctx_n1.1, mu, &mut aM_copy0, t2.1, &mut tmp);
                lowstar::ignore::ignore::<&mut [u64]>(&mut ctx);
        ...
        if bBits.wrapping_rem(4u32) != 0u32
        {
            ...
            let a_bits_l: (&mut [u64], &mut [u64]) =
                table.split_at_mut(bits_l32.wrapping_mul(64u32) as usize);
        ...
        for i in 0u32..bBits.wrapping_div(4u32)
        {
            krml::unroll_for!(
                ...
                1u32,
                {
                    ...
                    ((&mut aM_copy)[0usize..64usize]).copy_from_slice(&(&mut resM)[0usize..64usize]);
                    let ctx_n0: (&mut [u64], &mut [u64]) = ctx.split_at_mut(0usize);
                    crate::bignum4096::amont_sqr(ctx_n0.1, mu, &mut aM_copy, &mut resM);
                    lowstar::ignore::ignore::<&mut [u64]>(&mut ctx)
                }
            );
            let k: u32 =
            ...
            ((&mut aM_copy)[0usize..64usize]).copy_from_slice(&(&mut resM)[0usize..64usize]);
            let ctx_n0: (&mut [u64], &mut [u64]) = ctx.split_at_mut(0usize);
            crate::bignum4096::amont_mul(ctx_n0.1, mu, &mut aM_copy, &mut tmp0, &mut resM);
            lowstar::ignore::ignore::<&mut [u64]>(&mut ctx)
        };
        crate::bignum4096::from(n, mu, &mut resM, res)
    }
...
)
{
    if bBits < 200u32
    {
        ...
        for i in 0u32..bBits
        {
            ...
            ((&mut aM_copy)[0usize..64usize]).copy_from_slice(&(&mut aM)[0usize..64usize]);
            let ctx_n0: (&mut [u64], &mut [u64]) = ctx.split_at_mut(0usize);
            crate::bignum4096::amont_mul(ctx_n0.1, mu, &mut aM_copy, &mut resM, &mut aM);
            lowstar::ignore::ignore::<&mut [u64]>(&mut ctx);
            let mut aM_copy0: [u64; 64] = [0u64; 64usize];
            ((&mut aM_copy0)[0usize..64usize]).copy_from_slice(&(&mut resM)[0usize..64usize]);
            let ctx_n1: (&mut [u64], &mut [u64]) = ctx.split_at_mut(0usize);
            crate::bignum4096::amont_sqr(ctx_n1.1, mu, &mut aM_copy0, &mut resM);
            lowstar::ignore::ignore::<&mut [u64]>(&mut ctx);
            (&mut sw)[0usize] = bit
        };
            ...
            krml::unroll_for!(
                ...
                1u32,
                {
                    ...
                    let res_j: (&mut [u64], &mut [u64]) =
                        table.split_at_mut(i0.wrapping_add(1u32).wrapping_mul(64u32) as usize);
...
)
{
    ...
    crate::bignum4096::precompr2(nBits, n, &mut r2);
    let mu: u64 = crate::bignum::mod_inv_uint64(n[0usize]);
    crate::bignum4096::exp_vartime_precomp(n, mu, &mut r2, a, bBits, b, res)
}
...
)
{
    ...
    crate::bignum4096::precompr2(nBits, n, &mut r2);
    let mu: u64 = crate::bignum::mod_inv_uint64(n[0usize]);
    crate::bignum4096::exp_consttime_precomp(n, mu, &mut r2, a, bBits, b, res)
}
    ...
    bool
{
    ...
    if is_valid_m == 0xFFFFFFFFFFFFFFFFu64
    {
        ...
        crate::bignum4096::exp_vartime(nBits, n, a, 4096u32, &mut n2, res)
    }
    else
    { (res[0usize..64usize]).copy_from_slice(&[0u64; 64usize]) };
    is_valid_m == 0xFFFFFFFFFFFFFFFFu64
...
)
{
    ...
    let c2: u64 = c1;
    lowstar::ignore::ignore::<u64>(c2);
    crate::bignum4096::exp_vartime_precomp(n, mu, r2, a, 4096u32, &mut n2, res)
}
