    ...
    else
    {
        ...
        krml::unroll_for!(
            ...
            1u32,
            {
                let t11: (&mut [u32], &mut [u32]) =
                    (&mut table).split_at_mut(i.wrapping_add(1u32).wrapping_mul(128u32) as usize);
                let mut aM_copy: [u32; 128] = [0u32; 128usize];
        ...
        if bBits.wrapping_rem(4u32) != 0u32
        {
            ...
            let a_bits_l: (&[u32], &[u32]) =
                (&mut table).split_at(bits_l32.wrapping_mul(128u32) as usize);
...
pub fn mont_ctx_init(n: &mut [u32]) -> Vec<crate::hacl::bignum::bn_mont_ctx_u32>
{
    ...
    let mut res: crate::hacl::bignum::bn_mont_ctx_u32 =
        ...
        { len: 128u32, n: n11.to_vec(), mu: mu, r2: r21.to_vec() };
