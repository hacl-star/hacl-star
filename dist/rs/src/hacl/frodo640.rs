...
pub fn crypto_kem_keypair(pk: &mut [u8], sk: &mut [u8]) -> u32
{
    ...
    crate::hacl::hash_sha3::shake128(seed_a.1, 16u32, z.1, 16u32);
    ...
    crate::hacl::hash_sha3::shake128(&mut r, 20480u32, &shake_input_seed_se, 17u32);
    crate::lib::memzero0::memzero::<u8>(&mut shake_input_seed_se, 17u32);
    crate::hacl::frodo_kem::frodo_sample_matrix640(640u32, 8u32, &(&r)[0usize..], &mut s_matrix);
    crate::hacl::frodo_kem::frodo_sample_matrix640(
        640u32,
        8u32,
        &(&r)[10240usize..],
        &mut e_matrix
    ...
    crate::hacl::frodo_kem::matrix_mul_s(640u32, 640u32, 8u32, &a_matrix, &s_matrix, &mut b_matrix);
    crate::hacl::frodo_kem::matrix_add(640u32, 8u32, &mut b_matrix, &e_matrix);
    crate::hacl::frodo_kem::frodo_pack(640u32, 8u32, 15u32, &b_matrix, b_bytes.1);
    crate::hacl::frodo_kem::matrix_to_lbytes(640u32, 8u32, &s_matrix, s_bytes.1);
    crate::lib::memzero0::memzero::<u16>(&mut s_matrix, 5120u32);
    crate::lib::memzero0::memzero::<u16>(&mut e_matrix, 5120u32);
    ...
    crate::hacl::hash_sha3::shake128(&mut sk[slen1 as usize..], 16u32, pk, 9616u32);
...
pub fn crypto_kem_enc(ct: &mut [u8], ss: &mut [u8], pk: &[u8]) -> u32
{
    ...
    crate::hacl::hash_sha3::shake128(&mut r, 20608u32, &shake_input_seed_se, 17u32);
    crate::lib::memzero0::memzero::<u8>(&mut shake_input_seed_se, 17u32);
    crate::hacl::frodo_kem::frodo_sample_matrix640(8u32, 640u32, &(&r)[0usize..], &mut sp_matrix);
    crate::hacl::frodo_kem::frodo_sample_matrix640(
        8u32,
        640u32,
        &(&r)[10240usize..],
    ...
    crate::hacl::frodo_kem::matrix_mul(8u32, 640u32, 640u32, &sp_matrix, &a_matrix, &mut bp_matrix);
    crate::hacl::frodo_kem::matrix_add(8u32, 640u32, &mut bp_matrix, &ep_matrix);
    crate::hacl::frodo_kem::frodo_pack(8u32, 640u32, 15u32, &bp_matrix, c2.0);
    let mut v_matrix: [u16; 64] = [0u16; 64usize];
    let mut b_matrix: [u16; 5120] = [0u16; 5120usize];
    crate::hacl::frodo_kem::frodo_unpack(640u32, 8u32, 15u32, b.1, &mut b_matrix);
    crate::hacl::frodo_kem::matrix_mul(8u32, 640u32, 8u32, &sp_matrix, &b_matrix, &mut v_matrix);
    crate::hacl::frodo_kem::matrix_add(8u32, 8u32, &mut v_matrix, &epp_matrix);
    let mut mu_encode: [u16; 64] = [0u16; 64usize];
    crate::hacl::frodo_kem::frodo_key_encode(15u32, 2u32, 8u32, &coins, &mut mu_encode);
    crate::hacl::frodo_kem::matrix_add(8u32, 8u32, &mut v_matrix, &mu_encode);
    crate::lib::memzero0::memzero::<u16>(&mut mu_encode, 64u32);
    crate::hacl::frodo_kem::frodo_pack(8u32, 8u32, 15u32, &v_matrix, c2.1);
    crate::lib::memzero0::memzero::<u16>(&mut v_matrix, 64u32);
    crate::lib::memzero0::memzero::<u16>(&mut sp_matrix, 5120u32);
    crate::lib::memzero0::memzero::<u16>(&mut ep_matrix, 5120u32);
    ...
    crate::hacl::hash_sha3::shake128(ss, 16u32, &shake_input_ss, ss_init_len);
...
pub fn crypto_kem_dec(ss: &mut [u8], ct: &[u8], sk: &[u8]) -> u32
{
    ...
    let c2: (&[u8], &[u8]) = c1.1.split_at(9600usize);
    crate::hacl::frodo_kem::frodo_unpack(8u32, 640u32, 15u32, c2.0, &mut bp_matrix);
    crate::hacl::frodo_kem::frodo_unpack(8u32, 8u32, 15u32, c2.1, &mut c_matrix);
    let mut mu_decode: [u8; 16] = [0u8; 16usize];
    let s_bytes: (&[u8], &[u8]) = sk.split_at(9632usize);
    let mut s_matrix: [u16; 5120] = [0u16; 5120usize];
    let mut m_matrix: [u16; 64] = [0u16; 64usize];
    crate::hacl::frodo_kem::matrix_from_lbytes(640u32, 8u32, s_bytes.1, &mut s_matrix);
    crate::hacl::frodo_kem::matrix_mul_s(8u32, 640u32, 8u32, &bp_matrix, &s_matrix, &mut m_matrix);
    crate::hacl::frodo_kem::matrix_sub(8u32, 8u32, &c_matrix, &mut m_matrix);
    crate::hacl::frodo_kem::frodo_key_decode(15u32, 2u32, 8u32, &m_matrix, &mut mu_decode);
    crate::lib::memzero0::memzero::<u16>(&mut s_matrix, 5120u32);
    ...
    let pkh: (&[u8], &[u8]) = s_bytes.1.split_at(10240usize);
    ...
    crate::hacl::frodo_kem::matrix_add(8u32, 640u32, &mut bpp_matrix, &ep_matrix);
    let mut b_matrix: [u16; 5120] = [0u16; 5120usize];
    crate::hacl::frodo_kem::frodo_unpack(640u32, 8u32, 15u32, b.1, &mut b_matrix);
    crate::hacl::frodo_kem::matrix_mul(8u32, 640u32, 8u32, &sp_matrix, &b_matrix, &mut cp_matrix);
    crate::hacl::frodo_kem::matrix_add(8u32, 8u32, &mut cp_matrix, &epp_matrix);
    let mut mu_encode: [u16; 64] = [0u16; 64usize];
    crate::hacl::frodo_kem::frodo_key_encode(15u32, 2u32, 8u32, &mu_decode, &mut mu_encode);
    crate::hacl::frodo_kem::matrix_add(8u32, 8u32, &mut cp_matrix, &mu_encode);
    crate::lib::memzero0::memzero::<u16>(&mut mu_encode, 64u32);
    crate::hacl::frodo_kem::mod_pow2(8u32, 640u32, 15u32, &mut bpp_matrix);
    crate::hacl::frodo_kem::mod_pow2(8u32, 8u32, 15u32, &mut cp_matrix);
    crate::lib::memzero0::memzero::<u16>(&mut sp_matrix, 5120u32);
    crate::lib::memzero0::memzero::<u16>(&mut ep_matrix, 5120u32);
    crate::lib::memzero0::memzero::<u16>(&mut epp_matrix, 64u32);
    let b1: u16 = crate::hacl::frodo_kem::matrix_eq(8u32, 640u32, &bp_matrix, &bpp_matrix);
    ...
    ((&mut ss_init)[9720usize..9720usize + 16usize]).copy_from_slice(&(&kp_s)[0usize..16usize]);
    crate::hacl::hash_sha3::shake128(ss, 16u32, &ss_init, ss_init_len);
