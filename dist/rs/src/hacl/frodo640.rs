...
pub fn crypto_kem_keypair(pk: &mut [u8], sk: &mut [u8]) -> u32
{
    ...
    crate::hacl::hash_sha3::shake128(&mut r, 20480u32, &mut shake_input_seed_se, 17u32);
    ...
    crate::hacl::frodo_kem::matrix_add(640u32, 8u32, &mut b_matrix, &mut e_matrix);
    crate::hacl::frodo_kem::frodo_pack(640u32, 8u32, 15u32, &mut b_matrix, b_bytes.1);
    crate::hacl::frodo_kem::matrix_to_lbytes(640u32, 8u32, &mut s_matrix, s_bytes.1);
...
pub fn crypto_kem_enc(ct: &mut [u8], ss: &mut [u8], pk: &mut [u8]) -> u32
{
    ...
    crate::hacl::hash_sha3::shake128(&mut seed_se_k, 32u32, &mut pkh_mu, 32u32);
    ...
    crate::hacl::hash_sha3::shake128(&mut r, 20608u32, &mut shake_input_seed_se, 17u32);
    crate::lib::memzero0::memzero::<u8>(&mut shake_input_seed_se, 17u32);
    crate::hacl::frodo_kem::frodo_sample_matrix640(
        8u32,
        640u32,
    ...
    crate::hacl::frodo_kem::matrix_add(8u32, 640u32, &mut bp_matrix, &mut ep_matrix);
    crate::hacl::frodo_kem::frodo_pack(8u32, 640u32, 15u32, &mut bp_matrix, c2.0);
    ...
    crate::hacl::hash_sha3::shake128(ss, 16u32, &mut shake_input_ss, ss_init_len);
...
pub fn crypto_kem_dec(ss: &mut [u8], ct: &mut [u8], sk: &mut [u8]) -> u32
{
    ...
    crate::hacl::hash_sha3::shake128(&mut seed_se_k, 32u32, &mut pkh_mu_decode, pkh_mu_decode_len);
    let seed_se: (&mut [u8], &mut [u8]) = (&mut seed_se_k).split_at_mut(0usize);
    ...
    crate::hacl::frodo_kem::matrix_add(8u32, 640u32, &mut bpp_matrix, &mut ep_matrix);
    let mut b_matrix: [u16; 5120] = [0u16; 5120usize];
    crate::hacl::frodo_kem::frodo_unpack(640u32, 8u32, 15u32, b.1, &mut b_matrix);
    crate::hacl::frodo_kem::matrix_mul(
        8u32,
    ...
    crate::lib::memzero0::memzero::<u16>(&mut ep_matrix, 5120u32);
    crate::lib::memzero0::memzero::<u16>(&mut epp_matrix, 64u32);
    let b1: u16 = crate::hacl::frodo_kem::matrix_eq(8u32, 640u32, &mut bp_matrix, &mut bpp_matrix);
    ...
    crate::hacl::hash_sha3::shake128(ss, 16u32, &mut ss_init, ss_init_len);
