  ...
  ()
{
  ...
  crate::hacl::impl::curve25519::field51::fsqr2(z31.0, z31.0, tmp2);
  ...
  ab1.0[4u32 as usize] = c.1[4u32 as usize];
  crate::hacl::bignum25519_51::fsub(c.1, dc1.0, c.1);
...
fn montgomery_ladder(out: &mut [u64], key: &mut [u8], init: &mut [u64]) -> ()
{
  ...
  let tmp1: (&mut [u64], &mut [u64]) = nq1.1.split_at_mut(20usize);
...
pub fn finv(o: &mut [u64], i: &mut [u64], tmp: &mut [crate::fstar::uint128::uint128]) -> ()
{
  ...
  let c1: (&mut [u64], &mut [u64]) = b1.1.split_at_mut(5usize);
  let t01: (&mut [u64], &mut [u64]) = t01.1.split_at_mut(0usize);
  let tmp1: (&mut [crate::fstar::uint128::uint128], &mut [crate::fstar::uint128::uint128]) =
    tmp1.1.split_at_mut(0usize);
  fsquare_times(t01.1, c1.0, tmp1.1, 10u32);
  crate::hacl::impl::curve25519::field51::fmul(c1.1, t01.1, c1.0, tmp1.0);
  fsquare_times(t01.1, c1.1, tmp1.1, 20u32);
  crate::hacl::impl::curve25519::field51::fmul(t01.1, t01.1, c1.1, tmp1.0);
  fsquare_times(t01.1, t01.1, tmp1.1, 10u32);
  crate::hacl::impl::curve25519::field51::fmul(c1.0, t01.1, c1.0, tmp1.0);
  ...
  crate::hacl::impl::curve25519::field51::fmul(t01.1, t01.1, b1.1, tmp1.0);
  ...
  crate::hacl::impl::curve25519::field51::fmul(o, t0.1, a.1, tmp1.0)
}
