...
fn point_add_and_double(
    q: &[u64],
    p01_tmp1: &mut [u64],
    tmp2: &[crate::fstar::uint128::uint128]
)
{
    ...
    crate::hacl::bignum25519_51::fmul2(dc.1, &f1_copy, ab1.1, tmp2);
    ...
    crate::hacl::bignum25519_51::fsqr2(tmp1.0, &f1_copy0, tmp2);
    ...
    crate::hacl::bignum25519_51::fsub(c0.1, c0.0, &f2_copy);
    ...
    crate::hacl::bignum25519_51::fadd(b1.1, &f1_copy1, c0.0);
    ...
    crate::hacl::bignum25519_51::fmul(z310.1, &f1_copy2, x1.1, tmp2)
}

fn point_double(nq: &mut [u64], tmp1: &mut [u64], tmp2: &[crate::fstar::uint128::uint128])
{
    ...
    crate::hacl::bignum25519_51::fsub(c.1, c.0, &f2_copy);
    ...
    crate::hacl::bignum25519_51::fadd(b1.1, &f1_copy, c.0);
...
{
    let tmp2: [crate::fstar::uint128::uint128; 10] =
...
)
{
    ...
    for _i in 0u32..n.wrapping_sub(1u32)
    {
        ...
        crate::hacl::bignum25519_51::fsqr(o, &f1_copy, tmp)
    }
}
...
pub(crate) fn finv(o: &mut [u64], i: &[u64], tmp: &[crate::fstar::uint128::uint128])
{
    ...
    let tmp1: (&[crate::fstar::uint128::uint128], &[crate::fstar::uint128::uint128]) =
        tmp.split_at(0usize);
    ...
    crate::hacl::bignum25519_51::fmul(b1.0, t01.0, &f2_copy, tmp);
    let tmp11: (&[crate::fstar::uint128::uint128], &[crate::fstar::uint128::uint128]) =
        tmp.split_at(0usize);
    ...
    crate::hacl::bignum25519_51::fmul(t01.0, t01.1, &f2_copy0, tmp);
    let tmp12: (&[crate::fstar::uint128::uint128], &[crate::fstar::uint128::uint128]) =
        tmp.split_at(0usize);
    ...
    crate::hacl::bignum25519_51::fmul(t01.0, t01.1, &f2_copy1, tmp);
    ...
    let tmp10: (&[crate::fstar::uint128::uint128], &[crate::fstar::uint128::uint128]) =
        tmp.split_at(0usize);
    fsquare_times(t010.1, c1.0, tmp10.1, 10u32);
    crate::hacl::bignum25519_51::fmul(c1.1, t010.1, c1.0, tmp);
    let tmp110: (&[crate::fstar::uint128::uint128], &[crate::fstar::uint128::uint128]) =
        tmp.split_at(0usize);
    fsquare_times(t010.1, c1.1, tmp110.1, 20u32);
    let mut f1_copy: [u64; 5] = [0u64; 5usize];
    ((&mut f1_copy)[0usize..5usize]).copy_from_slice(&t010.1[0usize..5usize]);
    crate::hacl::bignum25519_51::fmul(t010.1, &f1_copy, c1.1, tmp);
    let tmp120: (&[crate::fstar::uint128::uint128], &[crate::fstar::uint128::uint128]) =
        tmp.split_at(0usize);
    ...
    crate::hacl::bignum25519_51::fmul(c1.0, t010.1, &f2_copy2, tmp);
    let tmp13: (&[crate::fstar::uint128::uint128], &[crate::fstar::uint128::uint128]) =
        tmp.split_at(0usize);
    ...
    let tmp14: (&[crate::fstar::uint128::uint128], &[crate::fstar::uint128::uint128]) =
        tmp.split_at(0usize);
    ...
    crate::hacl::bignum25519_51::fmul(t011.1, &f1_copy0, c10.1, tmp);
    let tmp111: (&[crate::fstar::uint128::uint128], &[crate::fstar::uint128::uint128]) =
        tmp.split_at(0usize);
    ...
    crate::hacl::bignum25519_51::fmul(t011.1, &f1_copy1, b11.1, tmp);
    let tmp121: (&[crate::fstar::uint128::uint128], &[crate::fstar::uint128::uint128]) =
        tmp.split_at(0usize);
...
fn encode_point(o: &mut [u8], i: &[u64])
{
    ...
    let tmp_w: [crate::fstar::uint128::uint128; 10] =
        [crate::fstar::uint128::uint64_to_uint128(0u64); 10usize];
    finv(&mut tmp, z.1, &tmp_w);
    let mut f1_copy: [u64; 5] = [0u64; 5usize];
    ((&mut f1_copy)[0usize..5usize]).copy_from_slice(&(&tmp)[0usize..5usize]);
    crate::hacl::bignum25519_51::fmul(&mut tmp, &f1_copy, z.0, &tmp_w);
    crate::hacl::bignum25519_51::store_felem(&mut u64s, &tmp);
    krml::unroll_for!(
        4,
        "i0",
        0u32,
