...
pub fn load_felem(f: &mut [u64], b: &mut [u8]) -> ()
{
  ...
  for i in 0u32..4u32
  {
    ...
    let bj: (&mut [u8], &mut [u8]) =
      b.split_at_mut((i.wrapping_mul(8u32) as usize).wrapping_add(0usize));
...
pub fn store_felem(b: &mut [u8], f: &mut [u64]) -> ()
{
  ...
  let f2: u64 = o2;
  let f3: u64 = o3;
  (&mut tmp)[0u32 as usize] = f3;
  (&mut tmp)[1u32 as usize] = f2;
  (&mut tmp)[2u32 as usize] = f1;
  (&mut tmp)[3u32 as usize] = f0;
  for i in 0u32..4u32
  {
...
pub fn fsub(out: &mut [u64], f1: &mut [u64], f2: &mut [u64], x: u64) -> ()
{
  ...
  let r3: u64 = r3;
  let r4: u64 = r4;
  let o0: u64 = a0.wrapping_add(r0);
  let o1: u64 = a1.wrapping_add(r1);
  let o2: u64 = a2.wrapping_add(r2);
  let o3: u64 = a3.wrapping_add(r3);
  let o4: u64 = a4.wrapping_add(r4);
  let f0: u64 = o0;
  let f11: u64 = o1;
  let f21: u64 = o2;
  let f3: u64 = o3;
...
pub fn fmul(out: &mut [u64], f1: &mut [u64], f2: &mut [u64]) -> ()
{
  ...
  let d4: crate::fstar::uint128::uint128 =
    crate::fstar::uint128::add_mod(d3, crate::fstar::uint128::mul_wide(r.wrapping_shl(12u32), c1));
  ...
  let c3: crate::fstar::uint128::uint128 =
    crate::fstar::uint128::add_mod(c2, crate::fstar::uint128::mul_wide(u0', r.wrapping_shr(4u32)));
...
pub fn fnormalize_weak(out: &mut [u64], f: &mut [u64]) -> ()
{
  ...
  let t31: u64 = t3;
  let t41: u64 = t41;
  let t02: u64 = t01.wrapping_add(x.wrapping_mul(0x1000003D1u64));
  ...
  let t42: u64 = t41.wrapping_add(t32.wrapping_shr(52u32));
...
pub fn fnormalize(out: &mut [u64], f: &mut [u64]) -> ()
{
  ...
  let t3: u64 = f3;
  let t4: u64 = t4;
  let t01: u64 = t0.wrapping_add(x.wrapping_mul(0x1000003D1u64));
  ...
  let t41: u64 = t4.wrapping_add(t31.wrapping_shr(52u32));
  ...
  let x1: u64 = m_to_one | x;
  let t01: u64 = r0.wrapping_add(x1.wrapping_mul(0x1000003D1u64));
  let t11: u64 = r1.wrapping_add(t01.wrapping_shr(52u32));
  let t02: u64 = t01 & 0xfffffffffffffu64;
  let t21: u64 = r2.wrapping_add(t11.wrapping_shr(52u32));
  let t12: u64 = t11 & 0xfffffffffffffu64;
  let t31: u64 = r3.wrapping_add(t21.wrapping_shr(52u32));
  let t22: u64 = t21 & 0xfffffffffffffu64;
  let t41: u64 = r4.wrapping_add(t31.wrapping_shr(52u32));
  let t32: u64 = t31 & 0xfffffffffffffu64;
  let s0: u64 = t02;
  let s1: u64 = t12;
  let s2: u64 = t22;
  let s3: u64 = t32;
  let s4: u64 = t41;
  let t41: u64 = s4 & 0xffffffffffffu64;
  let k0: u64 = s0;
  let k1: u64 = s1;
  let k2: u64 = s2;
  let k3: u64 = s3;
