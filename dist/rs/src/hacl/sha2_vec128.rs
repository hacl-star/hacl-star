fn sha224_init4(hash: &mut [crate::lib::intvector::intrinsics::vec128]) -> ()
for i in 0u32..8u32
{
    let
    os:
    ...
    let x: crate::lib::intvector::intrinsics::vec128 =
        crate::lib::intvector::intrinsics::vec128_load32(hi);
    os.1[i as usize] = x
}

fn sha256_init4(hash: &mut [crate::lib::intvector::intrinsics::vec128]) -> ()
for i in 0u32..8u32
{
    let
    os:
