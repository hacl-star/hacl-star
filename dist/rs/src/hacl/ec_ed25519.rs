...
{
    b[0u32 as usize] = 0u64;
    b[1u32 as usize] = 0u64;
    b[2u32 as usize] = 0u64;
    b[3u32 as usize] = 0u64;
    b[4u32 as usize] = 0u64
}

pub fn mk_felem_one(b: &mut [u64]) -> ()
{
    b[0u32 as usize] = 1u64;
    b[1u32 as usize] = 0u64;
    b[2u32 as usize] = 0u64;
    b[3u32 as usize] = 0u64;
    b[4u32 as usize] = 0u64
...
pub fn mk_base_point(p: &mut [u64]) -> ()
{
    ...
    gy.0[0u32 as usize] = 0x00062d608f25d51au64;
    gy.0[1u32 as usize] = 0x000412a4b4f6592au64;
    gy.0[2u32 as usize] = 0x00075b7171a4b31du64;
    gy.0[3u32 as usize] = 0x0001ff60527118feu64;
    gy.0[4u32 as usize] = 0x000216936d3cd6e5u64;
    gz.0[0u32 as usize] = 0x0006666666666658u64;
    gz.0[1u32 as usize] = 0x0004ccccccccccccu64;
    gz.0[2u32 as usize] = 0x0001999999999999u64;
    gz.0[3u32 as usize] = 0x0003333333333333u64;
    gz.0[4u32 as usize] = 0x0006666666666666u64;
    gt.0[0u32 as usize] = 1u64;
    gt.0[1u32 as usize] = 0u64;
    gt.0[2u32 as usize] = 0u64;
    gt.0[3u32 as usize] = 0u64;
    gt.0[4u32 as usize] = 0u64;
    gt.1[0u32 as usize] = 0x00068ab3a5b7dda3u64;
    gt.1[1u32 as usize] = 0x00000eea2a5eadbbu64;
    gt.1[2u32 as usize] = 0x0002af8df483c27eu64;
    gt.1[3u32 as usize] = 0x000332b375274732u64;
    gt.1[4u32 as usize] = 0x00067875f0fd78b7u64
}
