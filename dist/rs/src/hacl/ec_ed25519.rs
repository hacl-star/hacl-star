...
pub fn felem_sqr(a: &[u64], out: &mut [u64])
{
...
pub fn felem_inv(a: &[u64], out: &mut [u64])
{
    crate::hacl::ed25519::inverse(out, a);
    crate::hacl::ed25519::reduce_513(out)
}

pub fn felem_load(b: &[u8], out: &mut [u64]) { crate::hacl::ed25519::load_51(out, b) }

pub fn felem_store(a: &[u64], out: &mut [u8]) { crate::hacl::ed25519::store_51(out, a) }
...
pub fn point_negate(p: &[u64], out: &mut [u64]) { crate::hacl::ed25519::point_negate(p, out) }

pub fn point_add(p: &[u64], q: &[u64], out: &mut [u64])
{ crate::hacl::ed25519::point_add(out, p, q) }

pub fn point_double(p: &[u64], out: &mut [u64]) { crate::hacl::ed25519::point_double(out, p) }

pub fn point_mul(scalar: &[u8], p: &[u64], out: &mut [u64])
{ crate::hacl::ed25519::point_mul(out, scalar, p) }

pub fn point_eq(p: &[u64], q: &[u64]) -> bool { crate::hacl::ed25519::point_equal(p, q) }

pub fn point_compress(p: &[u64], out: &mut [u8])
{ crate::hacl::ed25519::point_compress(out, p) }

pub fn point_decompress(s: &[u8], out: &mut [u64]) -> bool
