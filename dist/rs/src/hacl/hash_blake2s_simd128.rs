    ...
    Vec<state_t>
{
    ...
    (&mut tmp)[3usize] =
        ...
        ^
        ((pv.node_depth as u32).wrapping_shl(16u32) ^ (pv.inner_length as u32).wrapping_shl(24u32));
    let tmp0: u32 = (&tmp)[0usize];
    let tmp1: u32 = (&tmp)[1usize];
    let tmp2: u32 = (&tmp)[2usize];
    let tmp3: u32 = (&tmp)[3usize];
    ...
    else
    {
        ...
        else if sz == 0u32
        {
            ...
            if sz1 != 0u32
            {
                ...
                let hash: &mut [crate::lib::intvector_intrinsics::vec128] = &mut block_state.f4;
                let wv: &mut [crate::lib::intvector_intrinsics::vec128] = &mut block_state.f3;
                let nb: u32 = 1u32;
    ...
    u8
{
    ...
    let hash: &mut [crate::lib::intvector_intrinsics::vec128] = &mut tmp_block_state.f4;
    let wv0: &mut [crate::lib::intvector_intrinsics::vec128] = &mut tmp_block_state.f3;
    let nb: u32 = 0u32;
    update_multi(0u32, wv0, hash, prev_len, buf_last.0, nb);
    let prev_len_last: u64 = total_len.wrapping_sub(r as u64);
    let hash0: &mut [crate::lib::intvector_intrinsics::vec128] = &mut tmp_block_state.f4;
    let wv1: &mut [crate::lib::intvector_intrinsics::vec128] = &mut tmp_block_state.f3;
