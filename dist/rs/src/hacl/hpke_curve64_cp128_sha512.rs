    ...
    u32
{
    ...
    if res == 0u32
    {
        ...
        crate::hacl::hkdf::extract_sha2_512(&mut o_psk_id_hash, empty.1, 0u32, &mut tmp, len);
        ...
        crate::hacl::hkdf::extract_sha2_512(&mut o_info_hash, empty.1, 0u32, &mut tmp0, len0);
        ...
        crate::hacl::hkdf::extract_sha2_512(&mut o_secret, &mut o_shared, 32u32, &mut tmp1, len1);
    ...
    u32
{
    ...
    if res1 == 0u32
    {
        ...
        if res2 == 0u32
        {
            ...
            crate::hacl::hkdf::extract_sha2_512(&mut o_secret, &mut shared, 32u32, &mut tmp1, len1);
            let mut label_exp: [u8; 3] = [0x65u8, 0x78u8, 0x70u8];
            let len2: u32 = 151u32;
            let mut tmp2: Vec<u8> = vec![0u8; len2 as usize];
            crate::lowstar::endianness::store16_be(&mut (&mut tmp2)[0usize..], 64u32 as u16);
