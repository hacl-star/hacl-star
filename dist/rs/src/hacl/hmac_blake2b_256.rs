...
compute_blake2b_256(dst: &mut [u8], key: &[u8], key_len: u32, data: &[u8], data_len: u32)
{
    ...
    { crate::hacl::hash_blake2b_simd256::hash_with_key(zeroes.0, 64u32, key, key_len, &[], 0u32) };
    ...
    let mut s: [crate::lib::intvector_intrinsics::vec256; 4] =
        [crate::lib::intvector_intrinsics::vec256_zero; 4usize];
    crate::hacl::hash_blake2b_simd256::init(&mut s, 0u32, 64u32);
    let s0: &mut [crate::lib::intvector_intrinsics::vec256] = &mut s;
    if data_len == 0u32
    {
        let mut wv: [crate::lib::intvector_intrinsics::vec256; 4] =
            [crate::lib::intvector_intrinsics::vec256_zero; 4usize];
        crate::hacl::hash_blake2b_simd256::update_last(
            128u32,
            &mut wv,
            s0,
            false,
    ...
    else
    {
        ...
        let mut wv: [crate::lib::intvector_intrinsics::vec256; 4] =
            [crate::lib::intvector_intrinsics::vec256_zero; 4usize];
        crate::hacl::hash_blake2b_simd256::update_multi(
            128u32,
            &mut wv,
            s0,
            crate::fstar::uint128::uint64_to_uint128(0u64),
        ...
        let mut wv0: [crate::lib::intvector_intrinsics::vec256; 4] =
            [crate::lib::intvector_intrinsics::vec256_zero; 4usize];
        crate::hacl::hash_blake2b_simd256::update_multi(
        ...
        let mut wv1: [crate::lib::intvector_intrinsics::vec256; 4] =
            [crate::lib::intvector_intrinsics::vec256_zero; 4usize];
        crate::hacl::hash_blake2b_simd256::update_last(
            rem_len,
            &mut wv1,
    ...
    crate::hacl::hash_blake2b_simd256::finish(64u32, dst, s0)
}
