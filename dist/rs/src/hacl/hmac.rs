...
compute_sha1(dst: &mut [u8], key: &[u8], key_len: u32, data: &[u8], data_len: u32)
{
    ...
    if data_len == 0u32
    { crate::hacl::hash_sha1::update_last(&mut s, 0u64, &ipad, 64u32) }
    else
    {
        ...
        crate::hacl::hash_sha1::update_multi(&mut s, &ipad, 1u32);
    ...
    crate::hacl::hash_sha1::finish(&s, dst1.1);
    ...
    let rem0: (&[u8], &[u8]) = full_blocks.1.split_at(full_blocks_len as usize);
    crate::hacl::hash_sha1::update_multi(&mut s, &opad, 1u32);
    crate::hacl::hash_sha1::update_multi(&mut s, rem0.0, n_blocks0);
    crate::hacl::hash_sha1::update_last(
        &mut s,
        (64u32 as u64).wrapping_add(full_blocks_len as u64),
...
compute_sha2_256(dst: &mut [u8], key: &[u8], key_len: u32, data: &[u8], data_len: u32)
{
    ...
    if data_len == 0u32
    {
        crate::hacl::hash_sha2::sha256_update_last(0u64.wrapping_add(64u32 as u64), 64u32, &ipad, s)
    }
    else
    {
        let block_len: u32 = 64u32;
        ...
        let full_blocks: (&[u8], &[u8]) = data.split_at(0usize);
        let rem0: (&[u8], &[u8]) = full_blocks.1.split_at(full_blocks_len as usize);
        crate::hacl::hash_sha2::sha256_update_nblocks(64u32, &ipad, s);
    ...
    let full_blocks: (&[u8], &[u8]) = hash1.1.split_at(0usize);
    let rem0: (&[u8], &[u8]) = full_blocks.1.split_at(full_blocks_len as usize);
    crate::hacl::hash_sha2::sha256_update_nblocks(64u32, &opad, s);
    crate::hacl::hash_sha2::sha256_update_nblocks(n_blocks0.wrapping_mul(64u32), rem0.0, s);
    crate::hacl::hash_sha2::sha256_update_last(
        (64u32 as u64).wrapping_add(full_blocks_len as u64).wrapping_add(rem_len as u64),
        rem_len,
...
compute_sha2_384(dst: &mut [u8], key: &[u8], key_len: u32, data: &[u8], data_len: u32)
{
    ...
    else
    {
        ...
        let full_blocks: (&[u8], &[u8]) = data.split_at(0usize);
        let rem0: (&[u8], &[u8]) = full_blocks.1.split_at(full_blocks_len as usize);
        crate::hacl::hash_sha2::sha384_update_nblocks(128u32, &ipad, s);
    ...
    let full_blocks: (&[u8], &[u8]) = hash1.1.split_at(0usize);
    let rem0: (&[u8], &[u8]) = full_blocks.1.split_at(full_blocks_len as usize);
    crate::hacl::hash_sha2::sha384_update_nblocks(128u32, &opad, s);
    crate::hacl::hash_sha2::sha384_update_nblocks(n_blocks0.wrapping_mul(128u32), rem0.0, s);
    crate::hacl::hash_sha2::sha384_update_last(
        crate::fstar::uint128::add(
            crate::fstar::uint128::add(
...
compute_sha2_512(dst: &mut [u8], key: &[u8], key_len: u32, data: &[u8], data_len: u32)
{
    ...
    else
    {
        ...
        let full_blocks: (&[u8], &[u8]) = data.split_at(0usize);
        let rem0: (&[u8], &[u8]) = full_blocks.1.split_at(full_blocks_len as usize);
        crate::hacl::hash_sha2::sha512_update_nblocks(128u32, &ipad, s);
    ...
    let full_blocks: (&[u8], &[u8]) = hash1.1.split_at(0usize);
    let rem0: (&[u8], &[u8]) = full_blocks.1.split_at(full_blocks_len as usize);
    crate::hacl::hash_sha2::sha512_update_nblocks(128u32, &opad, s);
    crate::hacl::hash_sha2::sha512_update_nblocks(n_blocks0.wrapping_mul(128u32), rem0.0, s);
    crate::hacl::hash_sha2::sha512_update_last(
        crate::fstar::uint128::add(
            crate::fstar::uint128::add(
...
compute_blake2s_32(dst: &mut [u8], key: &[u8], key_len: u32, data: &[u8], data_len: u32)
{
    ...
    if data_len == 0u32
    {
        ...
        crate::hacl::hash_blake2s::update_last(64u32, &mut wv, s0, false, 0u64, 64u32, &ipad)
    }
    else
    {
        let block_len: u32 = 64u32;
        ...
        let rem0: (&[u8], &[u8]) = full_blocks.1.split_at(full_blocks_len as usize);
        let mut wv: [u32; 16] = [0u32; 16usize];
        crate::hacl::hash_blake2s::update_multi(64u32, &mut wv, s0, 0u64, &ipad, 1u32);
    ...
    let rem0: (&[u8], &[u8]) = full_blocks.1.split_at(full_blocks_len as usize);
    let mut wv: [u32; 16] = [0u32; 16usize];
    crate::hacl::hash_blake2s::update_multi(64u32, &mut wv, s0, 0u64, &opad, 1u32);
    let mut wv0: [u32; 16] = [0u32; 16usize];
    crate::hacl::hash_blake2s::update_multi(
        n_blocks0.wrapping_mul(64u32),
        &mut wv0,
