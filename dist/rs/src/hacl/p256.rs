...
fn bn_add_mod4(res: &mut [u64], n: &mut [u64], x: &mut [u64], y: &mut [u64]) -> ()
{
    ...
    for i in 0u32..1u32
    {
        ...
        let res_i0: (&mut [u64], &mut [u64]) = res_i.1.split_at_mut(1usize);
        c1 = crate::lib::inttypes::intrinsics::sub_borrow_u64(c1, t10, t20, res_i0.1);
        ...
        let res_i1: (&mut [u64], &mut [u64]) = res_i0.1.split_at_mut(1usize);
        c1 = crate::lib::inttypes::intrinsics::sub_borrow_u64(c1, t11, t21, res_i1.1);
        ...
        let res_i2: (&mut [u64], &mut [u64]) = res_i1.1.split_at_mut(1usize);
        c1 = crate::lib::inttypes::intrinsics::sub_borrow_u64(c1, t12, t22, res_i2.1)
    };
    for i in 4u32..4u32
    {
...
fn mont_reduction(res: &mut [u64], x: &mut [u64]) -> ()
{
    ...
    for i in 0u32..4u32
    {
        ...
        c0 = crate::lib::inttypes::intrinsics::add_carry_u64(c0, c1, res_j0, resb.1)
    };
    ...
    bool
{
    ...
    let mut oneq0: [u64; 4] = [0u64; 4u32 as usize];
    (&mut oneq0)[0u32 as usize] = 1u64;
    (&mut oneq0)[1u32 as usize] = 0u64;
    (&mut oneq0)[2u32 as usize] = 0u64;
    (&mut oneq0)[3u32 as usize] = 0u64;
    for i in 0u32..4u32
    {
