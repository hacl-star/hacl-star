...
fn bn_add_mod4(res: &mut [u64], n: &mut [u64], x: &mut [u64], y: &mut [u64]) -> ()
{
  ...
  for i in 0u32..1u32
  {
    ...
    let t1: u64 = x[4u32.wrapping_mul(i).wrapping_add(1u32) as usize];
    let t2: u64 = y[4u32.wrapping_mul(i).wrapping_add(1u32) as usize];
    let res_i: (&mut [u64], &mut [u64]) = res_i.1.split_at_mut(1usize);
    c = crate::lib::inttypes::intrinsics::add_carry_u64(c, t1, t2, res_i.1);
    let t1: u64 = x[4u32.wrapping_mul(i).wrapping_add(2u32) as usize];
    let t2: u64 = y[4u32.wrapping_mul(i).wrapping_add(2u32) as usize];
    let res_i: (&mut [u64], &mut [u64]) = res_i.1.split_at_mut(1usize);
    c = crate::lib::inttypes::intrinsics::add_carry_u64(c, t1, t2, res_i.1);
    let t1: u64 = x[4u32.wrapping_mul(i).wrapping_add(3u32) as usize];
    let t2: u64 = y[4u32.wrapping_mul(i).wrapping_add(3u32) as usize];
    let res_i: (&mut [u64], &mut [u64]) = res_i.1.split_at_mut(1usize);
    c = crate::lib::inttypes::intrinsics::add_carry_u64(c, t1, t2, res_i.1)
  };
  for i in 4u32..4u32
  ...
  {
    let os: (&mut [u64], &mut [u64]) = res.split_at_mut(0usize);
    let x1: u64 = c & os.1[i as usize] | ! c & (&mut tmp)[i as usize];
    os.1[i as usize] = x1
  }
}
...
{
  crate::hacl::impl::p256::bignum::bn_to_bytes_be4(&mut res[0u32 as usize..], x);
  crate::hacl::impl::p256::bignum::bn_to_bytes_be4(&mut res[32u32 as usize..], y)
}

fn make_prime(n: &mut [u64]) -> ()
{
  n[0u32 as usize] = 0xffffffffffffffffu64;
  n[1u32 as usize] = 0xffffffffu64;
  n[2u32 as usize] = 0x0u64;
  n[3u32 as usize] = 0xffffffff00000001u64
}

fn make_order(n: &mut [u64]) -> ()
{
  n[0u32 as usize] = 0xf3b9cac2fc632551u64;
  n[1u32 as usize] = 0xbce6faada7179e84u64;
  n[2u32 as usize] = 0xffffffffffffffffu64;
  n[3u32 as usize] = 0xffffffff00000000u64
}

fn make_a_coeff(a: &mut [u64]) -> ()
{
  a[0u32 as usize] = 0xfffffffffffffffcu64;
  a[1u32 as usize] = 0x3ffffffffu64;
  a[2u32 as usize] = 0x0u64;
  a[3u32 as usize] = 0xfffffffc00000004u64
}

fn make_b_coeff(b: &mut [u64]) -> ()
{
  b[0u32 as usize] = 0xd89cdf6229c4bddfu64;
  b[1u32 as usize] = 0xacf005cd78843090u64;
  b[2u32 as usize] = 0xe5a220abf7212ed6u64;
  b[3u32 as usize] = 0xdc30061d04874834u64
}

fn make_g_x(n: &mut [u64]) -> ()
{
  n[0u32 as usize] = 0x79e730d418a9143cu64;
  n[1u32 as usize] = 0x75ba95fc5fedb601u64;
  n[2u32 as usize] = 0x79fb732b77622510u64;
  n[3u32 as usize] = 0x18905f76a53755c6u64
}

fn make_g_y(n: &mut [u64]) -> ()
{
  n[0u32 as usize] = 0xddf25357ce95560au64;
  n[1u32 as usize] = 0x8b4ab8e4ba19e45cu64;
  n[2u32 as usize] = 0xd2e88688dd21f325u64;
  n[3u32 as usize] = 0x8571ff1825885d85u64
}

fn make_fmont_R2(n: &mut [u64]) -> ()
{
  n[0u32 as usize] = 0x3u64;
  n[1u32 as usize] = 0xfffffffbffffffffu64;
  n[2u32 as usize] = 0xfffffffffffffffeu64;
  n[3u32 as usize] = 0x4fffffffdu64
}

fn make_fzero(n: &mut [u64]) -> ()
{
  n[0u32 as usize] = 0u64;
  n[1u32 as usize] = 0u64;
  n[2u32 as usize] = 0u64;
  n[3u32 as usize] = 0u64
}

fn make_fone(n: &mut [u64]) -> ()
{
  n[0u32 as usize] = 0x1u64;
  n[1u32 as usize] = 0xffffffff00000000u64;
  n[2u32 as usize] = 0xffffffffffffffffu64;
  n[3u32 as usize] = 0xfffffffeu64
}
...
fn fsub(res: &mut [u64], x: &mut [u64], y: &mut [u64]) -> ()
{
  let mut n: [u64; 4] = [0u64; 4u32 as usize];
  make_prime(&mut n);
  crate::hacl::impl::p256::bignum::bn_sub_mod4(res, &mut n, x, y)
}
...
fn mont_reduction(res: &mut [u64], x: &mut [u64]) -> ()
{
  ...
  for i in 0u32..4u32
  {
    ...
    for i in 0u32..1u32
    {
      let a_i: u64 = (&mut n)[4u32.wrapping_mul(i) as usize];
      let res_i: (&mut [u64], &mut [u64]) =
      ...
      let a_i: u64 = (&mut n)[4u32.wrapping_mul(i).wrapping_add(1u32) as usize];
      let res_i: (&mut [u64], &mut [u64]) = res_i.1.split_at_mut(1usize);
      c = crate::hacl::bignum_base::mul_wide_add2_u64(a_i, qj, c, res_i.1);
      let a_i: u64 = (&mut n)[4u32.wrapping_mul(i).wrapping_add(2u32) as usize];
      let res_i: (&mut [u64], &mut [u64]) = res_i.1.split_at_mut(1usize);
      c = crate::hacl::bignum_base::mul_wide_add2_u64(a_i, qj, c, res_i.1);
      let a_i: u64 = (&mut n)[4u32.wrapping_mul(i).wrapping_add(3u32) as usize];
      let res_i: (&mut [u64], &mut [u64]) = res_i.1.split_at_mut(1usize);
      c = crate::hacl::bignum_base::mul_wide_add2_u64(a_i, qj, c, res_i.1)
    };
    for i in 4u32..4u32
    {
      let a_i: u64 = (&mut n)[i as usize];
    ...
    let res_j: u64 = resb.0[4u32.wrapping_add(i) as usize];
    c0 = crate::lib::inttypes::intrinsics::add_carry_u64(c0, c1, res_j, resb.1)
  };
  (res[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    &(&mut x[4u32 as usize..])[0u32 as usize..0u32 as usize + 4u32 as usize]
  );
  let c0: u64 = c0;
  let mut tmp: [u64; 4] = [0u64; 4u32 as usize];
  let mut c: u64 = 0u64;
  for i in 0u32..1u32
  {
    ...
    c = crate::lib::inttypes::intrinsics::sub_borrow_u64(c, t1, t2, res_i.1);
    let t1: u64 = res[4u32.wrapping_mul(i).wrapping_add(1u32) as usize];
    let t2: u64 = (&mut n)[4u32.wrapping_mul(i).wrapping_add(1u32) as usize];
    let res_i: (&mut [u64], &mut [u64]) = res_i.1.split_at_mut(1usize);
    c = crate::lib::inttypes::intrinsics::sub_borrow_u64(c, t1, t2, res_i.1);
    let t1: u64 = res[4u32.wrapping_mul(i).wrapping_add(2u32) as usize];
    let t2: u64 = (&mut n)[4u32.wrapping_mul(i).wrapping_add(2u32) as usize];
    let res_i: (&mut [u64], &mut [u64]) = res_i.1.split_at_mut(1usize);
    c = crate::lib::inttypes::intrinsics::sub_borrow_u64(c, t1, t2, res_i.1);
    let t1: u64 = res[4u32.wrapping_mul(i).wrapping_add(3u32) as usize];
    let t2: u64 = (&mut n)[4u32.wrapping_mul(i).wrapping_add(3u32) as usize];
    let res_i: (&mut [u64], &mut [u64]) = res_i.1.split_at_mut(1usize);
    c = crate::lib::inttypes::intrinsics::sub_borrow_u64(c, t1, t2, res_i.1)
  };
  for i in 4u32..4u32
...
fn fmul(res: &mut [u64], x: &mut [u64], y: &mut [u64]) -> ()
{
  ...
  crate::hacl::impl::p256::bignum::bn_mul4(&mut tmp, x, y);
...
{
  let mut tmp: [u64; 8] = [0u64; 8u32 as usize];
  crate::hacl::impl::p256::bignum::bn_sqr4(&mut tmp, x);
  mont_reduction(res, &mut tmp)
}
...
fn from_mont(res: &mut [u64], a: &mut [u64]) -> ()
{
  ...
  ((&mut tmp)[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    &a[0u32 as usize..0u32 as usize + 4u32 as usize]
  );
  mont_reduction(res, &mut tmp)
}
...
{
  let mut r2modn: [u64; 4] = [0u64; 4u32 as usize];
...
{
  let mut b_coeff: [u64; 4] = [0u64; 4u32 as usize];
...
{
  let mut tmp: [u64; 16] = [0u64; 16u32 as usize];
  ...
  (tmp1.0[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    &a[0u32 as usize..0u32 as usize + 4u32 as usize]
  );
  for i in 0u32..1u32 { fsqr(tmp1.0, tmp1.0) };
  fmul(tmp1.0, tmp1.0, a);
  (x2.0[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    &tmp1.0[0u32 as usize..0u32 as usize + 4u32 as usize]
  );
  for i in 0u32..1u32 { fsqr(x2.0, x2.0) };
  fmul(x2.0, x2.0, a);
  (tmp2.0[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    &x2.0[0u32 as usize..0u32 as usize + 4u32 as usize]
  );
  for i in 0u32..3u32 { fsqr(tmp2.0, tmp2.0) };
  fmul(tmp2.0, tmp2.0, x2.0);
  (tmp2.1[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    &tmp2.0[0u32 as usize..0u32 as usize + 4u32 as usize]
  );
  for i in 0u32..6u32 { fsqr(tmp2.1, tmp2.1) };
  fmul(tmp2.1, tmp2.1, tmp2.0);
  (tmp2.0[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    &tmp2.1[0u32 as usize..0u32 as usize + 4u32 as usize]
  );
  for i in 0u32..3u32 { fsqr(tmp2.0, tmp2.0) };
  fmul(tmp2.0, tmp2.0, x2.0);
  (x2.0[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
...
{
  let mut zinv: [u64; 4] = [0u64; 4u32 as usize];
...
{
  let mut rp: [u64; 4] = [0u64; 4u32 as usize];
  let mut tx: [u64; 4] = [0u64; 4u32 as usize];
  let mut ty: [u64; 4] = [0u64; 4u32 as usize];
  let px: (&mut [u64], &mut [u64]) = p.split_at_mut(0usize);
  let py: (&mut [u64], &mut [u64]) = px.1.split_at_mut(4usize);
  to_mont(&mut tx, py.0);
  to_mont(&mut ty, py.1);
  ...
  let r: bool = r == 0xFFFFFFFFFFFFFFFFu64;
  r
}
...
{
  let mut aff_p: [u64; 8] = [0u64; 8u32 as usize];
...
{
  let mut p_aff: [u64; 8] = [0u64; 8u32 as usize];
...
fn aff_point_decompress_vartime(x: &mut [u64], y: &mut [u64], s: &mut [u8]) -> bool
{
  ...
  else
  {
    ...
    {
      let mut y2M: [u64; 4] = [0u64; 4u32 as usize];
      let mut xM: [u64; 4] = [0u64; 4u32 as usize];
      let mut yM: [u64; 4] = [0u64; 4u32 as usize];
      to_mont(&mut xM, x);
      let mut tmp: [u64; 4] = [0u64; 4u32 as usize];
      ...
      {
        let is_y_odd1: u64 = y[0u32 as usize] & 1u64;
...
{
  let mut tmp: [u64; 36] = [0u64; 36u32 as usize];
  let t0: (&mut [u64], &mut [u64]) = (&mut tmp).split_at_mut(0usize);
  ...
  let z1: (&mut [u64], &mut [u64]) = z1.1.split_at_mut(0usize);
  let y2: (&mut [u64], &mut [u64]) = z2.0.split_at_mut(0usize);
  let z2: (&mut [u64], &mut [u64]) = z2.1.split_at_mut(0usize);
  fsub(t4.0, t4.0, t5.0);
  fadd(t5.0, y1.1, z1.1);
  fadd(t5.1, y2.1, z2.1);
  fmul(t5.0, t5.0, t5.1);
  ...
  let z1: (&mut [u64], &mut [u64]) = z1.1.split_at_mut(0usize);
  let x2: (&mut [u64], &mut [u64]) = y2.0.split_at_mut(0usize);
  let z2: (&mut [u64], &mut [u64]) = z2.1.split_at_mut(0usize);
  fadd(y3.0, x1.1, z1.1);
  fadd(z3.0, x2.1, z2.1);
  fmul(y3.0, y3.0, z3.0);
  ...
  fadd(z3.1, z3.1, t2.0);
  (res[0u32 as usize..0u32 as usize + 12u32 as usize]).copy_from_slice(
    &y3.0[0u32 as usize..0u32 as usize + 12u32 as usize]
  )
}

fn precomp_get_consttime(table: &[u64], bits_l: u64, tmp: &mut [u64]) -> ()
{
  (tmp[0u32 as usize..0u32 as usize + 12u32 as usize]).copy_from_slice(
    &(&mut table[0u32 as usize..] as &mut [u64])[0u32 as usize..0u32 as usize + 12u32 as usize]
  );
  for i in 0u32..15u32
  {
    let c: u64 = crate::fstar::uint64::eq_mask(bits_l, i.wrapping_add(1u32) as u64);
    let res_j: (&[u64], &[u64]) =
      table.split_at_mut((i.wrapping_add(1u32).wrapping_mul(12u32) as usize).wrapping_add(0usize));
    for i in 0u32..12u32
    {
...
fn from_qmont(res: &mut [u64], x: &mut [u64]) -> ()
{
  let mut tmp: [u64; 8] = [0u64; 8u32 as usize];
  ((&mut tmp)[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    &x[0u32 as usize..0u32 as usize + 4u32 as usize]
  );
...
pub fn ecp256dh_i(public_key: &mut [u8], private_key: &mut [u8]) -> bool
{
  ...
  let mut oneq: [u64; 4] = [0u64; 4u32 as usize];
  (&mut oneq)[0u32 as usize] = 1u64;
  (&mut oneq)[1u32 as usize] = 0u64;
  (&mut oneq)[2u32 as usize] = 0u64;
  (&mut oneq)[3u32 as usize] = 0u64;
  for i in 0u32..4u32
  {
  ...
  crate::hacl::impl::p256::pointmul::point_mul_g(pk.1, pk.0);
  ...
  bool
{
  ...
  let is_sk_valid: u64 = is_b_valid;
  let mut ss_proj: [u64; 12] = [0u64; 12u32 as usize];
  if is_pk_valid
  {
    crate::hacl::impl::p256::pointmul::point_mul(&mut ss_proj, pk.0, pk.1);
...
{
  let mut tmp: [u64; 28] = [0u64; 28u32 as usize];
  ...
  (x_11.0[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    &r[0u32 as usize..0u32 as usize + 4u32 as usize]
  );
  ...
  (x_11.0[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    &x_111.0[0u32 as usize..0u32 as usize + 4u32 as usize]
  );
  for i in 0u32..1u32 { qsqr(x_11.0, x_11.0) };
  ...
  (x_11.0[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    &x_101111.0[0u32 as usize..0u32 as usize + 4u32 as usize]
  );
  for i in 0u32..1u32 { qsqr(x_11.0, x_11.0) };
  ...
  ((&mut tmp1)[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    &x_11.0[0u32 as usize..0u32 as usize + 4u32 as usize]
  );
  for i in 0u32..8u32 { qsqr(&mut tmp1, &mut tmp1) };
  qmul(&mut tmp1, &mut tmp1, x_11.0);
  (x_11.0[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    &(&mut tmp1)[0u32 as usize..0u32 as usize + 4u32 as usize]
  );
  ...
  bool
{
  ...
  else
  {
    ...
    let mut res: [u64; 12] = [0u64; 12u32 as usize];
    crate::hacl::impl::p256::pointmul::point_mul_double_g(&mut res, u2.0, u2.1, r_q.0);
    if is_point_at_inf_vartime(&mut res)
    { falsebool }
    else
    {
      let mut x: [u64; 4] = [0u64; 4u32 as usize];
...
fn ecdsa_sign_msg_as_qelem(
  ...
  bool
{
  let mut rsdk_q: [u64; 16] = [0u64; 16u32 as usize];
  ...
  for i in 0u32..4u32
  {
    ...
    let uu____1: u64 = (&mut oneq)[i as usize];
    let x: u64 = uu____1 ^ is_b_valid & (os.1[i as usize] ^ uu____1);
    os.1[i as usize] = x
  };
  let is_nonce_valid: u64 = is_b_valid;
  let are_sk_nonce_valid: u64 = is_sk_valid & is_nonce_valid;
  let mut p: [u64; 12] = [0u64; 12u32 as usize];
  crate::hacl::impl::p256::pointmul::point_mul_g(&mut p, k_q.1);
  to_aff_point_x(s_q.0, &mut p);
  qmod_short(s_q.0, s_q.0);
  let mut kinv: [u64; 4] = [0u64; 4u32 as usize];
  qinv(&mut kinv, k_q.1);
...
{
  let mut point_jac: [u64; 12] = [0u64; 12u32 as usize];
...
{
  let mut bn_sk: [u64; 4] = [0u64; 4u32 as usize];
...
{
  let mut xa: [u64; 4] = [0u64; 4u32 as usize];
  let mut ya: [u64; 4] = [0u64; 4u32 as usize];
  ...
  if b
  {
    ...
    crate::hacl::impl::p256::bignum::bn_to_bytes_be4(&mut pk_raw[32u32 as usize..], &mut ya)
  };
  b
}
...
pub fn raw_to_compressed(pk_raw: &mut [u8], pk: &mut [u8]) -> ()
{
  ...
  let mut bn_f: [u64; 4] = [0u64; 4u32 as usize];
  bn_from_bytes_be4(&mut bn_f, pk_y.1);
  let is_odd_f: u64 = (&mut bn_f)[0u32 as usize] & 1u64;
  pk[0u32 as usize] = (is_odd_f as u8).wrapping_add(0x02u8);
