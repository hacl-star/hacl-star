...
fn legacy_update(abcd: &mut [u32], x: &mut [u8]) -> ()
{
    ...
    let va0: u32 = abcd[3u32 as usize];
    let vb0: u32 = abcd[0u32 as usize];
    let vc0: u32 = abcd[1u32 as usize];
    let vd0: u32 = abcd[2u32 as usize];
    let b0: (&mut [u8], &mut [u8]) = b.1.split_at_mut(4usize);
    let u0: u32 = crate::lowstar::endianness::load32_le(b0.1);
    let xk0: u32 = u0;
    let ti0: u32 = (&mut _t)[1u32 as usize];
    let v0: u32 =
        vb0.wrapping_add(
    ...
    abcd[3u32 as usize] = v0;
    let va1: u32 = abcd[2u32 as usize];
    let vb1: u32 = abcd[3u32 as usize];
    let vc1: u32 = abcd[0u32 as usize];
    let vd1: u32 = abcd[1u32 as usize];
    let b1: (&mut [u8], &mut [u8]) = b0.1.split_at_mut(4usize);
    let u1: u32 = crate::lowstar::endianness::load32_le(b1.1);
    let xk1: u32 = u1;
    let ti1: u32 = (&mut _t)[2u32 as usize];
    let v1: u32 =
        vb1.wrapping_add(
    ...
    abcd[2u32 as usize] = v1;
    let va2: u32 = abcd[1u32 as usize];
    let vb2: u32 = abcd[2u32 as usize];
    let vc2: u32 = abcd[3u32 as usize];
    let vd2: u32 = abcd[0u32 as usize];
    let b2: (&mut [u8], &mut [u8]) = b1.1.split_at_mut(4usize);
    let u2: u32 = crate::lowstar::endianness::load32_le(b2.1);
    let xk2: u32 = u2;
    let ti2: u32 = (&mut _t)[3u32 as usize];
    let v2: u32 =
        vb2.wrapping_add(
    ...
    abcd[1u32 as usize] = v2;
    let va3: u32 = abcd[0u32 as usize];
    let vb3: u32 = abcd[1u32 as usize];
    let vc3: u32 = abcd[2u32 as usize];
    let vd3: u32 = abcd[3u32 as usize];
    let b3: (&mut [u8], &mut [u8]) = b2.1.split_at_mut(4usize);
    let u3: u32 = crate::lowstar::endianness::load32_le(b3.1);
    let xk3: u32 = u3;
    let ti3: u32 = (&mut _t)[4u32 as usize];
    let v3: u32 =
        vb3.wrapping_add(
    ...
    abcd[0u32 as usize] = v3;
    let va4: u32 = abcd[3u32 as usize];
    let vb4: u32 = abcd[0u32 as usize];
    let vc4: u32 = abcd[1u32 as usize];
    let vd4: u32 = abcd[2u32 as usize];
    let b4: (&mut [u8], &mut [u8]) = b3.1.split_at_mut(4usize);
    let u4: u32 = crate::lowstar::endianness::load32_le(b4.1);
    let xk4: u32 = u4;
    let ti4: u32 = (&mut _t)[5u32 as usize];
    let v4: u32 =
        vb4.wrapping_add(
    ...
    abcd[3u32 as usize] = v4;
    let va5: u32 = abcd[2u32 as usize];
    let vb5: u32 = abcd[3u32 as usize];
    let vc5: u32 = abcd[0u32 as usize];
    let vd5: u32 = abcd[1u32 as usize];
    let b5: (&mut [u8], &mut [u8]) = b4.1.split_at_mut(4usize);
    let u5: u32 = crate::lowstar::endianness::load32_le(b5.1);
    let xk5: u32 = u5;
    let ti5: u32 = (&mut _t)[6u32 as usize];
    let v5: u32 =
        vb5.wrapping_add(
    ...
    abcd[2u32 as usize] = v5;
    let va6: u32 = abcd[1u32 as usize];
    let vb6: u32 = abcd[2u32 as usize];
    let vc6: u32 = abcd[3u32 as usize];
    let vd6: u32 = abcd[0u32 as usize];
    let b6: (&mut [u8], &mut [u8]) = b5.1.split_at_mut(4usize);
    let u6: u32 = crate::lowstar::endianness::load32_le(b6.1);
    let xk6: u32 = u6;
    let ti6: u32 = (&mut _t)[7u32 as usize];
    let v6: u32 =
        vb6.wrapping_add(
    ...
    abcd[1u32 as usize] = v6;
    let va7: u32 = abcd[0u32 as usize];
    let vb7: u32 = abcd[1u32 as usize];
    let vc7: u32 = abcd[2u32 as usize];
    let vd7: u32 = abcd[3u32 as usize];
    let b7: (&mut [u8], &mut [u8]) = b6.1.split_at_mut(4usize);
    let u7: u32 = crate::lowstar::endianness::load32_le(b7.1);
    let xk7: u32 = u7;
    let ti7: u32 = (&mut _t)[8u32 as usize];
    let v7: u32 =
        vb7.wrapping_add(
    ...
    abcd[0u32 as usize] = v7;
    let va8: u32 = abcd[3u32 as usize];
    let vb8: u32 = abcd[0u32 as usize];
    let vc8: u32 = abcd[1u32 as usize];
    let vd8: u32 = abcd[2u32 as usize];
    let b8: (&mut [u8], &mut [u8]) = b7.1.split_at_mut(4usize);
    let u8: u32 = crate::lowstar::endianness::load32_le(b8.1);
    let xk8: u32 = u8;
    let ti8: u32 = (&mut _t)[9u32 as usize];
    let v8: u32 =
        vb8.wrapping_add(
    ...
    abcd[3u32 as usize] = v8;
    let va9: u32 = abcd[2u32 as usize];
    let vb9: u32 = abcd[3u32 as usize];
    let vc9: u32 = abcd[0u32 as usize];
    let vd9: u32 = abcd[1u32 as usize];
    let b9: (&mut [u8], &mut [u8]) = b8.1.split_at_mut(4usize);
    let u9: u32 = crate::lowstar::endianness::load32_le(b9.1);
    let xk9: u32 = u9;
    let ti9: u32 = (&mut _t)[10u32 as usize];
    let v9: u32 =
        vb9.wrapping_add(
    ...
    abcd[2u32 as usize] = v9;
    let va10: u32 = abcd[1u32 as usize];
    let vb10: u32 = abcd[2u32 as usize];
    let vc10: u32 = abcd[3u32 as usize];
    let vd10: u32 = abcd[0u32 as usize];
    let b10: (&mut [u8], &mut [u8]) = b9.1.split_at_mut(4usize);
    let u10: u32 = crate::lowstar::endianness::load32_le(b10.1);
    let xk10: u32 = u10;
    let ti10: u32 = (&mut _t)[11u32 as usize];
    let v10: u32 =
        vb10.wrapping_add(
    ...
    abcd[1u32 as usize] = v10;
    let va11: u32 = abcd[0u32 as usize];
    let vb11: u32 = abcd[1u32 as usize];
    let vc11: u32 = abcd[2u32 as usize];
    let vd11: u32 = abcd[3u32 as usize];
    let b11: (&mut [u8], &mut [u8]) = b10.1.split_at_mut(4usize);
    let u11: u32 = crate::lowstar::endianness::load32_le(b11.1);
    let xk11: u32 = u11;
    let ti11: u32 = (&mut _t)[12u32 as usize];
    let v11: u32 =
        vb11.wrapping_add(
    ...
    abcd[0u32 as usize] = v11;
    let va12: u32 = abcd[3u32 as usize];
    let vb12: u32 = abcd[0u32 as usize];
    let vc12: u32 = abcd[1u32 as usize];
    let vd12: u32 = abcd[2u32 as usize];
    let b12: (&mut [u8], &mut [u8]) = b11.1.split_at_mut(4usize);
    let u12: u32 = crate::lowstar::endianness::load32_le(b12.1);
    let xk12: u32 = u12;
    let ti12: u32 = (&mut _t)[13u32 as usize];
    let v12: u32 =
        vb12.wrapping_add(
    ...
    abcd[3u32 as usize] = v12;
    let va13: u32 = abcd[2u32 as usize];
    let vb13: u32 = abcd[3u32 as usize];
    let vc13: u32 = abcd[0u32 as usize];
    let vd13: u32 = abcd[1u32 as usize];
    let b13: (&mut [u8], &mut [u8]) = b12.1.split_at_mut(4usize);
    let u13: u32 = crate::lowstar::endianness::load32_le(b13.1);
    let xk13: u32 = u13;
    let ti13: u32 = (&mut _t)[14u32 as usize];
    let v13: u32 =
        vb13.wrapping_add(
    ...
    abcd[2u32 as usize] = v13;
    let va14: u32 = abcd[1u32 as usize];
    let vb14: u32 = abcd[2u32 as usize];
    let vc14: u32 = abcd[3u32 as usize];
    let vd14: u32 = abcd[0u32 as usize];
    let b14: (&mut [u8], &mut [u8]) = b13.1.split_at_mut(4usize);
    let u14: u32 = crate::lowstar::endianness::load32_le(b14.1);
    let xk14: u32 = u14;
    let ti14: u32 = (&mut _t)[15u32 as usize];
    let v14: u32 =
        vb14.wrapping_add(
    ...
    abcd[1u32 as usize] = v14;
    let va15: u32 = abcd[0u32 as usize];
    let vb15: u32 = abcd[1u32 as usize];
    let vc15: u32 = abcd[2u32 as usize];
    let vd15: u32 = abcd[3u32 as usize];
    let b15: (&mut [u8], &mut [u8]) = b1.0.split_at_mut(0usize);
    let u15: u32 = crate::lowstar::endianness::load32_le(b15.1);
    let xk15: u32 = u15;
    let ti15: u32 = (&mut _t)[16u32 as usize];
    let v15: u32 =
        vb15.wrapping_add(
    ...
    abcd[0u32 as usize] = v15;
    let va16: u32 = abcd[3u32 as usize];
    let vb16: u32 = abcd[0u32 as usize];
    let vc16: u32 = abcd[1u32 as usize];
    let vd16: u32 = abcd[2u32 as usize];
    let b16: (&mut [u8], &mut [u8]) = b6.0.split_at_mut(0usize);
    let u16: u32 = crate::lowstar::endianness::load32_le(b16.1);
    let xk16: u32 = u16;
    let ti16: u32 = (&mut _t)[17u32 as usize];
    let v16: u32 =
        vb16.wrapping_add(
    ...
    abcd[3u32 as usize] = v16;
    let va17: u32 = abcd[2u32 as usize];
    let vb17: u32 = abcd[3u32 as usize];
    let vc17: u32 = abcd[0u32 as usize];
    let vd17: u32 = abcd[1u32 as usize];
    let b17: (&mut [u8], &mut [u8]) = b11.0.split_at_mut(0usize);
    let u17: u32 = crate::lowstar::endianness::load32_le(b17.1);
    let xk17: u32 = u17;
    let ti17: u32 = (&mut _t)[18u32 as usize];
    let v17: u32 =
        vb17.wrapping_add(
    ...
    abcd[2u32 as usize] = v17;
    let va18: u32 = abcd[1u32 as usize];
    let vb18: u32 = abcd[2u32 as usize];
    let vc18: u32 = abcd[3u32 as usize];
    let vd18: u32 = abcd[0u32 as usize];
    let b18: (&mut [u8], &mut [u8]) = b0.0.split_at_mut(0usize);
    let u18: u32 = crate::lowstar::endianness::load32_le(b18.1);
    let xk18: u32 = u18;
    let ti18: u32 = (&mut _t)[19u32 as usize];
    let v18: u32 =
        vb18.wrapping_add(
    ...
    abcd[1u32 as usize] = v18;
    let va19: u32 = abcd[0u32 as usize];
    let vb19: u32 = abcd[1u32 as usize];
    let vc19: u32 = abcd[2u32 as usize];
    let vd19: u32 = abcd[3u32 as usize];
    let b19: (&mut [u8], &mut [u8]) = b5.0.split_at_mut(0usize);
    let u19: u32 = crate::lowstar::endianness::load32_le(b19.1);
    let xk19: u32 = u19;
    let ti19: u32 = (&mut _t)[20u32 as usize];
    let v19: u32 =
        vb19.wrapping_add(
    ...
    abcd[0u32 as usize] = v19;
    let va20: u32 = abcd[3u32 as usize];
    let vb20: u32 = abcd[0u32 as usize];
    let vc20: u32 = abcd[1u32 as usize];
    let vd20: u32 = abcd[2u32 as usize];
    let b20: (&mut [u8], &mut [u8]) = b10.0.split_at_mut(0usize);
    let u20: u32 = crate::lowstar::endianness::load32_le(b20.1);
    let xk20: u32 = u20;
    let ti20: u32 = (&mut _t)[21u32 as usize];
    let v20: u32 =
        vb20.wrapping_add(
    ...
    abcd[3u32 as usize] = v20;
    let va21: u32 = abcd[2u32 as usize];
    let vb21: u32 = abcd[3u32 as usize];
    let vc21: u32 = abcd[0u32 as usize];
    let vd21: u32 = abcd[1u32 as usize];
    let b21: (&mut [u8], &mut [u8]) = b14.1.split_at_mut(0usize);
    let u21: u32 = crate::lowstar::endianness::load32_le(b21.1);
    let xk21: u32 = u21;
    let ti21: u32 = (&mut _t)[22u32 as usize];
    let v21: u32 =
        vb21.wrapping_add(
    ...
    abcd[2u32 as usize] = v21;
    let va22: u32 = abcd[1u32 as usize];
    let vb22: u32 = abcd[2u32 as usize];
    let vc22: u32 = abcd[3u32 as usize];
    let vd22: u32 = abcd[0u32 as usize];
    let b22: (&mut [u8], &mut [u8]) = b4.0.split_at_mut(0usize);
    let u22: u32 = crate::lowstar::endianness::load32_le(b22.1);
    let xk22: u32 = u22;
    let ti22: u32 = (&mut _t)[23u32 as usize];
    let v22: u32 =
        vb22.wrapping_add(
    ...
    abcd[1u32 as usize] = v22;
    let va23: u32 = abcd[0u32 as usize];
    let vb23: u32 = abcd[1u32 as usize];
    let vc23: u32 = abcd[2u32 as usize];
    let vd23: u32 = abcd[3u32 as usize];
    let b23: (&mut [u8], &mut [u8]) = b9.0.split_at_mut(0usize);
    let u23: u32 = crate::lowstar::endianness::load32_le(b23.1);
    let xk23: u32 = u23;
    let ti23: u32 = (&mut _t)[24u32 as usize];
    let v23: u32 =
        vb23.wrapping_add(
    ...
    abcd[0u32 as usize] = v23;
    let va24: u32 = abcd[3u32 as usize];
    let vb24: u32 = abcd[0u32 as usize];
    let vc24: u32 = abcd[1u32 as usize];
    let vd24: u32 = abcd[2u32 as usize];
    let b24: (&mut [u8], &mut [u8]) = b14.0.split_at_mut(0usize);
    let u24: u32 = crate::lowstar::endianness::load32_le(b24.1);
    let xk24: u32 = u24;
    let ti24: u32 = (&mut _t)[25u32 as usize];
    let v24: u32 =
        vb24.wrapping_add(
    ...
    abcd[3u32 as usize] = v24;
    let va25: u32 = abcd[2u32 as usize];
    let vb25: u32 = abcd[3u32 as usize];
    let vc25: u32 = abcd[0u32 as usize];
    let vd25: u32 = abcd[1u32 as usize];
    let b25: (&mut [u8], &mut [u8]) = b3.0.split_at_mut(0usize);
    let u25: u32 = crate::lowstar::endianness::load32_le(b25.1);
    let xk25: u32 = u25;
    let ti25: u32 = (&mut _t)[26u32 as usize];
    let v25: u32 =
        vb25.wrapping_add(
    ...
    abcd[2u32 as usize] = v25;
    let va26: u32 = abcd[1u32 as usize];
    let vb26: u32 = abcd[2u32 as usize];
    let vc26: u32 = abcd[3u32 as usize];
    let vd26: u32 = abcd[0u32 as usize];
    let b26: (&mut [u8], &mut [u8]) = b8.0.split_at_mut(0usize);
    let u26: u32 = crate::lowstar::endianness::load32_le(b26.1);
    let xk26: u32 = u26;
    let ti26: u32 = (&mut _t)[27u32 as usize];
    let v26: u32 =
        vb26.wrapping_add(
    ...
    abcd[1u32 as usize] = v26;
    let va27: u32 = abcd[0u32 as usize];
    let vb27: u32 = abcd[1u32 as usize];
    let vc27: u32 = abcd[2u32 as usize];
    let vd27: u32 = abcd[3u32 as usize];
    let b27: (&mut [u8], &mut [u8]) = b13.0.split_at_mut(0usize);
    let u27: u32 = crate::lowstar::endianness::load32_le(b27.1);
    let xk27: u32 = u27;
    let ti27: u32 = (&mut _t)[28u32 as usize];
    let v27: u32 =
        vb27.wrapping_add(
    ...
    abcd[0u32 as usize] = v27;
    let va28: u32 = abcd[3u32 as usize];
    let vb28: u32 = abcd[0u32 as usize];
    let vc28: u32 = abcd[1u32 as usize];
    let vd28: u32 = abcd[2u32 as usize];
    let b28: (&mut [u8], &mut [u8]) = b2.0.split_at_mut(0usize);
    let u28: u32 = crate::lowstar::endianness::load32_le(b28.1);
    let xk28: u32 = u28;
    let ti28: u32 = (&mut _t)[29u32 as usize];
    let v28: u32 =
        vb28.wrapping_add(
    ...
    abcd[3u32 as usize] = v28;
    let va29: u32 = abcd[2u32 as usize];
    let vb29: u32 = abcd[3u32 as usize];
    let vc29: u32 = abcd[0u32 as usize];
    let vd29: u32 = abcd[1u32 as usize];
    let b29: (&mut [u8], &mut [u8]) = b7.0.split_at_mut(0usize);
    let u29: u32 = crate::lowstar::endianness::load32_le(b29.1);
    let xk29: u32 = u29;
    let ti29: u32 = (&mut _t)[30u32 as usize];
    let v29: u32 =
        vb29.wrapping_add(
    ...
    abcd[2u32 as usize] = v29;
    let va30: u32 = abcd[1u32 as usize];
    let vb30: u32 = abcd[2u32 as usize];
    let vc30: u32 = abcd[3u32 as usize];
    let vd30: u32 = abcd[0u32 as usize];
    let b30: (&mut [u8], &mut [u8]) = b12.0.split_at_mut(0usize);
    let u30: u32 = crate::lowstar::endianness::load32_le(b30.1);
    let xk30: u32 = u30;
    let ti30: u32 = (&mut _t)[31u32 as usize];
    let v30: u32 =
        vb30.wrapping_add(
    ...
    abcd[1u32 as usize] = v30;
    let va31: u32 = abcd[0u32 as usize];
    let vb31: u32 = abcd[1u32 as usize];
    let vc31: u32 = abcd[2u32 as usize];
    let vd31: u32 = abcd[3u32 as usize];
    let b31: (&mut [u8], &mut [u8]) = b19.1.split_at_mut(0usize);
    let u31: u32 = crate::lowstar::endianness::load32_le(b31.1);
    let xk31: u32 = u31;
    let ti31: u32 = (&mut _t)[32u32 as usize];
    let v31: u32 =
        vb31.wrapping_add(
    ...
    abcd[0u32 as usize] = v31;
    let va32: u32 = abcd[3u32 as usize];
    let vb32: u32 = abcd[0u32 as usize];
    let vc32: u32 = abcd[1u32 as usize];
    let vd32: u32 = abcd[2u32 as usize];
    let b32: (&mut [u8], &mut [u8]) = b26.1.split_at_mut(0usize);
    let u32: u32 = crate::lowstar::endianness::load32_le(b32.1);
    let xk32: u32 = u32;
    let ti32: u32 = (&mut _t)[33u32 as usize];
    let v32: u32 =
        vb32.wrapping_add(
    ...
    abcd[3u32 as usize] = v32;
    let va33: u32 = abcd[2u32 as usize];
    let vb33: u32 = abcd[3u32 as usize];
    let vc33: u32 = abcd[0u32 as usize];
    let vd33: u32 = abcd[1u32 as usize];
    let b33: (&mut [u8], &mut [u8]) = b17.1.split_at_mut(0usize);
    let u33: u32 = crate::lowstar::endianness::load32_le(b33.1);
    let xk33: u32 = u33;
    let ti33: u32 = (&mut _t)[34u32 as usize];
    let v33: u32 =
        vb33.wrapping_add(
    ...
    abcd[2u32 as usize] = v33;
    let va34: u32 = abcd[1u32 as usize];
    let vb34: u32 = abcd[2u32 as usize];
    let vc34: u32 = abcd[3u32 as usize];
    let vd34: u32 = abcd[0u32 as usize];
    let b34: (&mut [u8], &mut [u8]) = b24.1.split_at_mut(0usize);
    let u34: u32 = crate::lowstar::endianness::load32_le(b34.1);
    let xk34: u32 = u34;
    let ti34: u32 = (&mut _t)[35u32 as usize];
    let v34: u32 =
        vb34.wrapping_add(
    ...
    abcd[1u32 as usize] = v34;
    let va35: u32 = abcd[0u32 as usize];
    let vb35: u32 = abcd[1u32 as usize];
    let vc35: u32 = abcd[2u32 as usize];
    let vd35: u32 = abcd[3u32 as usize];
    let b35: (&mut [u8], &mut [u8]) = b15.1.split_at_mut(0usize);
    let u35: u32 = crate::lowstar::endianness::load32_le(b35.1);
    let xk35: u32 = u35;
    let ti35: u32 = (&mut _t)[36u32 as usize];
    let v35: u32 =
        vb35.wrapping_add(
    ...
    abcd[0u32 as usize] = v35;
    let va36: u32 = abcd[3u32 as usize];
    let vb36: u32 = abcd[0u32 as usize];
    let vc36: u32 = abcd[1u32 as usize];
    let vd36: u32 = abcd[2u32 as usize];
    let b36: (&mut [u8], &mut [u8]) = b22.1.split_at_mut(0usize);
    let u36: u32 = crate::lowstar::endianness::load32_le(b36.1);
    let xk36: u32 = u36;
    let ti36: u32 = (&mut _t)[37u32 as usize];
    let v36: u32 =
        vb36.wrapping_add(
    ...
    abcd[3u32 as usize] = v36;
    let va37: u32 = abcd[2u32 as usize];
    let vb37: u32 = abcd[3u32 as usize];
    let vc37: u32 = abcd[0u32 as usize];
    let vd37: u32 = abcd[1u32 as usize];
    let b37: (&mut [u8], &mut [u8]) = b29.1.split_at_mut(0usize);
    let u37: u32 = crate::lowstar::endianness::load32_le(b37.1);
    let xk37: u32 = u37;
    let ti37: u32 = (&mut _t)[38u32 as usize];
    let v37: u32 =
        vb37.wrapping_add(
    ...
    abcd[2u32 as usize] = v37;
    let va38: u32 = abcd[1u32 as usize];
    let vb38: u32 = abcd[2u32 as usize];
    let vc38: u32 = abcd[3u32 as usize];
    let vd38: u32 = abcd[0u32 as usize];
    let b38: (&mut [u8], &mut [u8]) = b20.1.split_at_mut(0usize);
    let u38: u32 = crate::lowstar::endianness::load32_le(b38.1);
    let xk38: u32 = u38;
    let ti38: u32 = (&mut _t)[39u32 as usize];
    let v38: u32 =
        vb38.wrapping_add(
    ...
    abcd[1u32 as usize] = v38;
    let va39: u32 = abcd[0u32 as usize];
    let vb39: u32 = abcd[1u32 as usize];
    let vc39: u32 = abcd[2u32 as usize];
    let vd39: u32 = abcd[3u32 as usize];
    let b39: (&mut [u8], &mut [u8]) = b27.1.split_at_mut(0usize);
    let u39: u32 = crate::lowstar::endianness::load32_le(b39.1);
    let xk39: u32 = u39;
    let ti39: u32 = (&mut _t)[40u32 as usize];
    let v39: u32 =
        vb39.wrapping_add(
    ...
    abcd[0u32 as usize] = v39;
    let va40: u32 = abcd[3u32 as usize];
    let vb40: u32 = abcd[0u32 as usize];
    let vc40: u32 = abcd[1u32 as usize];
    let vd40: u32 = abcd[2u32 as usize];
    let b40: (&mut [u8], &mut [u8]) = b18.1.split_at_mut(0usize);
    let u40: u32 = crate::lowstar::endianness::load32_le(b40.1);
    let xk40: u32 = u40;
    let ti40: u32 = (&mut _t)[41u32 as usize];
    let v40: u32 =
        vb40.wrapping_add(
    ...
    abcd[3u32 as usize] = v40;
    let va41: u32 = abcd[2u32 as usize];
    let vb41: u32 = abcd[3u32 as usize];
    let vc41: u32 = abcd[0u32 as usize];
    let vd41: u32 = abcd[1u32 as usize];
    let b41: (&mut [u8], &mut [u8]) = b25.1.split_at_mut(0usize);
    let u41: u32 = crate::lowstar::endianness::load32_le(b41.1);
    let xk41: u32 = u41;
    let ti41: u32 = (&mut _t)[42u32 as usize];
    let v41: u32 =
        vb41.wrapping_add(
    ...
    abcd[2u32 as usize] = v41;
    let va42: u32 = abcd[1u32 as usize];
    let vb42: u32 = abcd[2u32 as usize];
    let vc42: u32 = abcd[3u32 as usize];
    let vd42: u32 = abcd[0u32 as usize];
    let b42: (&mut [u8], &mut [u8]) = b16.1.split_at_mut(0usize);
    let u42: u32 = crate::lowstar::endianness::load32_le(b42.1);
    let xk42: u32 = u42;
    let ti42: u32 = (&mut _t)[43u32 as usize];
    let v42: u32 =
        vb42.wrapping_add(
    ...
    abcd[1u32 as usize] = v42;
    let va43: u32 = abcd[0u32 as usize];
    let vb43: u32 = abcd[1u32 as usize];
    let vc43: u32 = abcd[2u32 as usize];
    let vd43: u32 = abcd[3u32 as usize];
    let b43: (&mut [u8], &mut [u8]) = b23.1.split_at_mut(0usize);
    let u43: u32 = crate::lowstar::endianness::load32_le(b43.1);
    let xk43: u32 = u43;
    let ti43: u32 = (&mut _t)[44u32 as usize];
    let v43: u32 =
        vb43.wrapping_add(
    ...
    abcd[0u32 as usize] = v43;
    let va44: u32 = abcd[3u32 as usize];
    let vb44: u32 = abcd[0u32 as usize];
    let vc44: u32 = abcd[1u32 as usize];
    let vd44: u32 = abcd[2u32 as usize];
    let b44: (&mut [u8], &mut [u8]) = b30.1.split_at_mut(0usize);
    let u44: u32 = crate::lowstar::endianness::load32_le(b44.1);
    let xk44: u32 = u44;
    let ti44: u32 = (&mut _t)[45u32 as usize];
    let v44: u32 =
        vb44.wrapping_add(
    ...
    abcd[3u32 as usize] = v44;
    let va45: u32 = abcd[2u32 as usize];
    let vb45: u32 = abcd[3u32 as usize];
    let vc45: u32 = abcd[0u32 as usize];
    let vd45: u32 = abcd[1u32 as usize];
    let b45: (&mut [u8], &mut [u8]) = b21.1.split_at_mut(0usize);
    let u45: u32 = crate::lowstar::endianness::load32_le(b45.1);
    let xk45: u32 = u45;
    let ti45: u32 = (&mut _t)[46u32 as usize];
    let v45: u32 =
        vb45.wrapping_add(
    ...
    abcd[2u32 as usize] = v45;
    let va46: u32 = abcd[1u32 as usize];
    let vb46: u32 = abcd[2u32 as usize];
    let vc46: u32 = abcd[3u32 as usize];
    let vd46: u32 = abcd[0u32 as usize];
    let b46: (&mut [u8], &mut [u8]) = b28.1.split_at_mut(0usize);
    let u46: u32 = crate::lowstar::endianness::load32_le(b46.1);
    let xk46: u32 = u46;
    let ti46: u32 = (&mut _t)[47u32 as usize];
    let v46: u32 =
        vb46.wrapping_add(
    ...
    abcd[1u32 as usize] = v46;
    let va47: u32 = abcd[0u32 as usize];
    let vb47: u32 = abcd[1u32 as usize];
    let vc47: u32 = abcd[2u32 as usize];
    let vd47: u32 = abcd[3u32 as usize];
    let b47: (&mut [u8], &mut [u8]) = b40.1.split_at_mut(0usize);
    let u47: u32 = crate::lowstar::endianness::load32_le(b47.1);
    let xk47: u32 = u47;
    let ti47: u32 = (&mut _t)[48u32 as usize];
    let v47: u32 =
        vb47.wrapping_add(
    ...
    abcd[0u32 as usize] = v47;
    let va48: u32 = abcd[3u32 as usize];
    let vb48: u32 = abcd[0u32 as usize];
    let vc48: u32 = abcd[1u32 as usize];
    let vd48: u32 = abcd[2u32 as usize];
    let b48: (&mut [u8], &mut [u8]) = b37.1.split_at_mut(0usize);
    let u48: u32 = crate::lowstar::endianness::load32_le(b48.1);
    let xk48: u32 = u48;
    let ti48: u32 = (&mut _t)[49u32 as usize];
    let v48: u32 =
        vb48.wrapping_add(
    ...
    abcd[3u32 as usize] = v48;
    let va49: u32 = abcd[2u32 as usize];
    let vb49: u32 = abcd[3u32 as usize];
    let vc49: u32 = abcd[0u32 as usize];
    let vd49: u32 = abcd[1u32 as usize];
    let b49: (&mut [u8], &mut [u8]) = b34.1.split_at_mut(0usize);
    let u49: u32 = crate::lowstar::endianness::load32_le(b49.1);
    let xk49: u32 = u49;
    let ti49: u32 = (&mut _t)[50u32 as usize];
    let v49: u32 =
        vb49.wrapping_add(
    ...
    abcd[2u32 as usize] = v49;
    let va50: u32 = abcd[1u32 as usize];
    let vb50: u32 = abcd[2u32 as usize];
    let vc50: u32 = abcd[3u32 as usize];
    let vd50: u32 = abcd[0u32 as usize];
    let b50: (&mut [u8], &mut [u8]) = b31.1.split_at_mut(0usize);
    let u50: u32 = crate::lowstar::endianness::load32_le(b50.1);
    let xk50: u32 = u50;
    let ti50: u32 = (&mut _t)[51u32 as usize];
    let v50: u32 =
        vb50.wrapping_add(
    ...
    abcd[1u32 as usize] = v50;
    let va51: u32 = abcd[0u32 as usize];
    let vb51: u32 = abcd[1u32 as usize];
    let vc51: u32 = abcd[2u32 as usize];
    let vd51: u32 = abcd[3u32 as usize];
    let b51: (&mut [u8], &mut [u8]) = b44.1.split_at_mut(0usize);
    let u51: u32 = crate::lowstar::endianness::load32_le(b51.1);
    let xk51: u32 = u51;
    let ti51: u32 = (&mut _t)[52u32 as usize];
    let v51: u32 =
        vb51.wrapping_add(
    ...
    abcd[0u32 as usize] = v51;
    let va52: u32 = abcd[3u32 as usize];
    let vb52: u32 = abcd[0u32 as usize];
    let vc52: u32 = abcd[1u32 as usize];
    let vd52: u32 = abcd[2u32 as usize];
    let b52: (&mut [u8], &mut [u8]) = b41.1.split_at_mut(0usize);
    let u52: u32 = crate::lowstar::endianness::load32_le(b52.1);
    let xk52: u32 = u52;
    let ti52: u32 = (&mut _t)[53u32 as usize];
    let v52: u32 =
        vb52.wrapping_add(
    ...
    abcd[3u32 as usize] = v52;
    let va53: u32 = abcd[2u32 as usize];
    let vb53: u32 = abcd[3u32 as usize];
    let vc53: u32 = abcd[0u32 as usize];
    let vd53: u32 = abcd[1u32 as usize];
    let b53: (&mut [u8], &mut [u8]) = b38.1.split_at_mut(0usize);
    let u53: u32 = crate::lowstar::endianness::load32_le(b53.1);
    let xk53: u32 = u53;
    let ti53: u32 = (&mut _t)[54u32 as usize];
    let v53: u32 =
        vb53.wrapping_add(
    ...
    abcd[2u32 as usize] = v53;
    let va54: u32 = abcd[1u32 as usize];
    let vb54: u32 = abcd[2u32 as usize];
    let vc54: u32 = abcd[3u32 as usize];
    let vd54: u32 = abcd[0u32 as usize];
    let b54: (&mut [u8], &mut [u8]) = b35.1.split_at_mut(0usize);
    let u54: u32 = crate::lowstar::endianness::load32_le(b54.1);
    let xk54: u32 = u54;
    let ti54: u32 = (&mut _t)[55u32 as usize];
    let v54: u32 =
        vb54.wrapping_add(
    ...
    abcd[1u32 as usize] = v54;
    let va55: u32 = abcd[0u32 as usize];
    let vb55: u32 = abcd[1u32 as usize];
    let vc55: u32 = abcd[2u32 as usize];
    let vd55: u32 = abcd[3u32 as usize];
    let b55: (&mut [u8], &mut [u8]) = b32.1.split_at_mut(0usize);
    let u55: u32 = crate::lowstar::endianness::load32_le(b55.1);
    let xk55: u32 = u55;
    let ti55: u32 = (&mut _t)[56u32 as usize];
    let v55: u32 =
        vb55.wrapping_add(
    ...
    abcd[0u32 as usize] = v55;
    let va56: u32 = abcd[3u32 as usize];
    let vb56: u32 = abcd[0u32 as usize];
    let vc56: u32 = abcd[1u32 as usize];
    let vd56: u32 = abcd[2u32 as usize];
    let b56: (&mut [u8], &mut [u8]) = b45.1.split_at_mut(0usize);
    let u56: u32 = crate::lowstar::endianness::load32_le(b56.1);
    let xk56: u32 = u56;
    let ti56: u32 = (&mut _t)[57u32 as usize];
    let v56: u32 =
        vb56.wrapping_add(
    ...
    abcd[3u32 as usize] = v56;
    let va57: u32 = abcd[2u32 as usize];
    let vb57: u32 = abcd[3u32 as usize];
    let vc57: u32 = abcd[0u32 as usize];
    let vd57: u32 = abcd[1u32 as usize];
    let b57: (&mut [u8], &mut [u8]) = b42.1.split_at_mut(0usize);
    let u57: u32 = crate::lowstar::endianness::load32_le(b57.1);
    let xk57: u32 = u57;
    let ti57: u32 = (&mut _t)[58u32 as usize];
    let v57: u32 =
        vb57.wrapping_add(
    ...
    abcd[2u32 as usize] = v57;
    let va58: u32 = abcd[1u32 as usize];
    let vb58: u32 = abcd[2u32 as usize];
    let vc58: u32 = abcd[3u32 as usize];
    let vd58: u32 = abcd[0u32 as usize];
    let b58: (&mut [u8], &mut [u8]) = b39.1.split_at_mut(0usize);
    let u58: u32 = crate::lowstar::endianness::load32_le(b58.1);
    let xk58: u32 = u58;
    let ti58: u32 = (&mut _t)[59u32 as usize];
    let v58: u32 =
        vb58.wrapping_add(
    ...
    abcd[1u32 as usize] = v58;
    let va59: u32 = abcd[0u32 as usize];
    let vb59: u32 = abcd[1u32 as usize];
    let vc59: u32 = abcd[2u32 as usize];
    let vd59: u32 = abcd[3u32 as usize];
    let b59: (&mut [u8], &mut [u8]) = b36.1.split_at_mut(0usize);
    let u59: u32 = crate::lowstar::endianness::load32_le(b59.1);
    let xk59: u32 = u59;
    let ti59: u32 = (&mut _t)[60u32 as usize];
    let v59: u32 =
        vb59.wrapping_add(
    ...
    abcd[0u32 as usize] = v59;
    let va60: u32 = abcd[3u32 as usize];
    let vb60: u32 = abcd[0u32 as usize];
    let vc60: u32 = abcd[1u32 as usize];
    let vd60: u32 = abcd[2u32 as usize];
    let b60: (&mut [u8], &mut [u8]) = b33.1.split_at_mut(0usize);
    let u60: u32 = crate::lowstar::endianness::load32_le(b60.1);
    let xk60: u32 = u60;
    let ti60: u32 = (&mut _t)[61u32 as usize];
    let v60: u32 =
        vb60.wrapping_add(
    ...
    abcd[3u32 as usize] = v60;
    let va61: u32 = abcd[2u32 as usize];
    let vb61: u32 = abcd[3u32 as usize];
    let vc61: u32 = abcd[0u32 as usize];
    let vd61: u32 = abcd[1u32 as usize];
    let b61: (&mut [u8], &mut [u8]) = b46.1.split_at_mut(0usize);
    let u61: u32 = crate::lowstar::endianness::load32_le(b61.1);
    let xk61: u32 = u61;
    let ti61: u32 = (&mut _t)[62u32 as usize];
    let v61: u32 =
        vb61.wrapping_add(
    ...
    abcd[2u32 as usize] = v61;
    let va62: u32 = abcd[1u32 as usize];
    let vb62: u32 = abcd[2u32 as usize];
    let vc62: u32 = abcd[3u32 as usize];
    let vd62: u32 = abcd[0u32 as usize];
    let b62: (&mut [u8], &mut [u8]) = b43.1.split_at_mut(0usize);
    let u62: u32 = crate::lowstar::endianness::load32_le(b62.1);
    let xk62: u32 = u62;
    let ti62: u32 = (&mut _t)[63u32 as usize];
    let v62: u32 =
        vb62.wrapping_add(
