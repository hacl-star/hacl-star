fn secretbox_init(xkeys: &mut [u8], k: &mut [u8], n: &mut [u8]) -> ()
{
    ...
    crate::hacl::salsa20::hsalsa20(aekey.0, k, n1.0);
    crate::hacl::salsa20::salsa20_key_block0(aekey.1, aekey.0, n1.1)
}
    ...
    ()
{
    ...
    for i in 0u32..32u32
    {
        ...
        let x: u8 = os.1[i as usize] ^ ekey0.1[i as usize];
        os.1[i as usize] = x
    };
...
#[inline] fn box_beforenm(k: &mut [u8], pk: &mut [u8], sk: &mut [u8]) -> u32
{
    ...
    if r
    {
        crate::hacl::salsa20::hsalsa20(k, k, &mut n0);
        0u32
    }
    else
    { 0xffffffffu32 }
