fn sha224_init8(hash: &mut [crate::lib::intvector::intrinsics::vec256]) -> ()
for i in 0u32..8u32
{
  let
  os:
  ...
  let x: crate::lib::intvector::intrinsics::vec256 =
    crate::lib::intvector::intrinsics::vec256_load32(hi);
  os.1[i as usize] = x
}

fn sha256_init8(hash: &mut [crate::lib::intvector::intrinsics::vec256]) -> ()
for i in 0u32..8u32
{
  let
  os:
...
fn sha384_init4(hash: &mut [crate::lib::intvector::intrinsics::vec256]) -> ()
for i in 0u32..8u32
{
  let
  os:
...
fn sha512_init4(hash: &mut [crate::lib::intvector::intrinsics::vec256]) -> ()
for i in 0u32..8u32
{
  let
  os:
