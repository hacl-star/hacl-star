pub fn load_acc2(acc: &mut [crate::lib::intvector::intrinsics::vec128], b: &mut [u8]) -> ()
{
    ...
    (&mut e)[0u32 as usize] = f00;
    (&mut e)[1u32 as usize] = f10;
    ...
    let f41: crate::lib::intvector::intrinsics::vec128 = (&mut e)[4u32 as usize];
    (&mut e)[4u32 as usize] = crate::lib::intvector::intrinsics::vec128_or(f41, mask);
    ...
    ()
{
    ...
    let f200: crate::lib::intvector::intrinsics::vec128 = r5.0[0u32 as usize];
    ...
    rn.0[0u32 as usize] = crate::lib::intvector::intrinsics::vec128_smul64(f200, 5u64);
    ...
    let f100: crate::lib::intvector::intrinsics::vec128 = r5.0[0u32 as usize];
    ...
    let f201: crate::lib::intvector::intrinsics::vec128 = rn_5.0[0u32 as usize];
    let f210: crate::lib::intvector::intrinsics::vec128 = rn_5.0[1u32 as usize];
    let f220: crate::lib::intvector::intrinsics::vec128 = rn_5.0[2u32 as usize];
    let f230: crate::lib::intvector::intrinsics::vec128 = rn_5.0[3u32 as usize];
    let f240: crate::lib::intvector::intrinsics::vec128 = rn_5.0[4u32 as usize];
    rn_5.1[0u32 as usize] = crate::lib::intvector::intrinsics::vec128_smul64(f201, 5u64);
    rn_5.1[1u32 as usize] = crate::lib::intvector::intrinsics::vec128_smul64(f210, 5u64);
    rn_5.1[2u32 as usize] = crate::lib::intvector::intrinsics::vec128_smul64(f220, 5u64);
    rn_5.1[3u32 as usize] = crate::lib::intvector::intrinsics::vec128_smul64(f230, 5u64);
    rn_5.1[4u32 as usize] = crate::lib::intvector::intrinsics::vec128_smul64(f240, 5u64)
}
    ...
    ()
{
    ...
    let f111: crate::lib::intvector::intrinsics::vec128 = (&mut e)[1u32 as usize];
    ...
    ()
{
    ...
    if len0 > 0u32
    {
        ...
        for i in 0u32..nb
        {
            ...
            let f100: crate::lib::intvector::intrinsics::vec128 = acc.1[0u32 as usize];
            ...
            acc.1[3u32 as usize] = o3;
            acc.1[4u32 as usize] = o4;
            let f101: crate::lib::intvector::intrinsics::vec128 = acc.1[0u32 as usize];
            let f110: crate::lib::intvector::intrinsics::vec128 = acc.1[1u32 as usize];
            let f120: crate::lib::intvector::intrinsics::vec128 = acc.1[2u32 as usize];
            let f130: crate::lib::intvector::intrinsics::vec128 = acc.1[3u32 as usize];
            let f140: crate::lib::intvector::intrinsics::vec128 = acc.1[4u32 as usize];
            let f200: crate::lib::intvector::intrinsics::vec128 = (&mut e)[0u32 as usize];
            ...
            acc.1[1u32 as usize] = o10;
            acc.1[2u32 as usize] = o20;
            acc.1[3u32 as usize] = o30;
            acc.1[4u32 as usize] = o40
        };
    ...
    ()
{
    ...
    let f00: crate::lib::intvector::intrinsics::vec128 = acc.1[0u32 as usize];
    let f10: crate::lib::intvector::intrinsics::vec128 = acc.1[1u32 as usize];
    let f20: crate::lib::intvector::intrinsics::vec128 = acc.1[2u32 as usize];
    let f30: crate::lib::intvector::intrinsics::vec128 = acc.1[3u32 as usize];
    let f40: crate::lib::intvector::intrinsics::vec128 = acc.1[4u32 as usize];
