...
fn sha256_update(b: &mut [u8], hash: &mut [u32]) -> ()
{
  ...
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[4u32 as usize..]);
  (&mut ws)[1u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[8u32 as usize..]);
  (&mut ws)[2u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[12u32 as usize..]);
  (&mut ws)[3u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[16u32 as usize..]);
  (&mut ws)[4u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[20u32 as usize..]);
  (&mut ws)[5u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[24u32 as usize..]);
  (&mut ws)[6u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[28u32 as usize..]);
  (&mut ws)[7u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[32u32 as usize..]);
  (&mut ws)[8u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[36u32 as usize..]);
  (&mut ws)[9u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[40u32 as usize..]);
  (&mut ws)[10u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[44u32 as usize..]);
  (&mut ws)[11u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[48u32 as usize..]);
  (&mut ws)[12u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[52u32 as usize..]);
  (&mut ws)[13u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[56u32 as usize..]);
  (&mut ws)[14u32 as usize] = u;
  let u: u32 = crate::lowstar::endianness::load32_be(&mut b1[60u32 as usize..]);
  (&mut ws)[15u32 as usize] = u;
  for i in 0u32..4u32
  {
    for i in 0u32..16u32
    {
      let k_t: u32 = (&k224_256)[16u32.wrapping_mul(i).wrapping_add(i) as usize];
      let ws_t: u32 = (&mut ws)[i as usize];
    ...
    for i in 0u32..16u32
    {
      let t16: u32 = (&mut ws)[i as usize];
      let t15: u32 = (&mut ws)[i.wrapping_add(1u32).wrapping_rem(16u32) as usize];
      let t7: u32 = (&mut ws)[i.wrapping_add(9u32).wrapping_rem(16u32) as usize];
      let t2: u32 = (&mut ws)[i.wrapping_add(14u32).wrapping_rem(16u32) as usize];
      let s1: u32 =
      ...
      (&mut ws)[i as usize] = s1.wrapping_add(t7).wrapping_add(s0).wrapping_add(t16)
    }
  };
  for i in 0u32..8u32
  {
...
pub fn sha256_update_last(totlen: u64, len: u32, b: &mut [u8], hash: &mut [u32]) -> ()
{
  ...
  let lb0: &mut [u8] = l0;
  let lb1: &mut [u8] = l1;
  let last0: &mut [u8] = lb0;
  let last1: &mut [u8] = lb1;
  sha256_update(last0, hash);
  if blocks > 1u32 { sha256_update(last1, hash) }
}
...
fn sha512_update(b: &mut [u8], hash: &mut [u64]) -> ()
{
  ...
  (&mut ws)[0u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[8u32 as usize..]);
  (&mut ws)[1u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[16u32 as usize..]);
  (&mut ws)[2u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[24u32 as usize..]);
  (&mut ws)[3u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[32u32 as usize..]);
  (&mut ws)[4u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[40u32 as usize..]);
  (&mut ws)[5u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[48u32 as usize..]);
  (&mut ws)[6u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[56u32 as usize..]);
  (&mut ws)[7u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[64u32 as usize..]);
  (&mut ws)[8u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[72u32 as usize..]);
  (&mut ws)[9u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[80u32 as usize..]);
  (&mut ws)[10u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[88u32 as usize..]);
  (&mut ws)[11u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[96u32 as usize..]);
  (&mut ws)[12u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[104u32 as usize..]);
  (&mut ws)[13u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[112u32 as usize..]);
  (&mut ws)[14u32 as usize] = u;
  let u: u64 = crate::lowstar::endianness::load64_be(&mut b1[120u32 as usize..]);
  (&mut ws)[15u32 as usize] = u;
  for i in 0u32..5u32
  {
    for i in 0u32..16u32
    {
      let k_t: u64 = (&k384_512)[16u32.wrapping_mul(i).wrapping_add(i) as usize];
      let ws_t: u64 = (&mut ws)[i as usize];
    ...
    for i in 0u32..16u32
    {
      let t16: u64 = (&mut ws)[i as usize];
      let t15: u64 = (&mut ws)[i.wrapping_add(1u32).wrapping_rem(16u32) as usize];
      let t7: u64 = (&mut ws)[i.wrapping_add(9u32).wrapping_rem(16u32) as usize];
      let t2: u64 = (&mut ws)[i.wrapping_add(14u32).wrapping_rem(16u32) as usize];
      let s1: u64 =
  ...
  ()
{
  ...
  if blocks > 1u32 { sha512_update(last1, hash) }
}
...
pub fn update_256(
  ...
  crate::hacl::streaming::types::error_code
{ crate::hacl::streaming::sha2::update_224_256(p, input, input_len) }
...
pub fn free_224(p: &mut [crate::hacl::streaming::md::state_32]) -> ()
{ crate::hacl::streaming::sha2::free_256(p) }
...
pub fn update_512(
  ...
  crate::hacl::streaming::types::error_code
{ crate::hacl::streaming::sha2::update_384_512(p, input, input_len) }
...
pub fn free_384(p: &mut [crate::hacl::streaming::md::state_64]) -> ()
{ crate::hacl::streaming::sha2::free_512(p) }
