    ...
    ()
{
    ...
    if len0 > 0u32
    {
        ...
        crate::hacl::poly1305_128::load_acc2(acc.1, text0.1);
        ...
        crate::hacl::poly1305_128::fmul_r2_normalize(acc.1, pre.1)
    };
    ...
    for i in 0u32..nb
    {
        ...
        let r11: crate::lib::intvector::intrinsics::vec128 = r5.0[1usize];
        ...
        let a12: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_mul64(r11, a01);
        let a22: crate::lib::intvector::intrinsics::vec128 =
        ...
        let a23: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_add64(
                a22,
                crate::lib::intvector::intrinsics::vec128_mul64(r11, a11)
            );
        let a33: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_add64(
                a32,
        ...
        let a34: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_add64(
                a33,
                crate::lib::intvector::intrinsics::vec128_mul64(r11, a21)
            );
        let a44: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_add64(
                a43,
        ...
        let a45: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_add64(
                a44,
                crate::lib::intvector::intrinsics::vec128_mul64(r11, a31)
            );
    ...
    if r > 0u32
    {
        ...
        let f13: crate::lib::intvector::intrinsics::vec128 = (&mut e)[3usize];
        let f14: crate::lib::intvector::intrinsics::vec128 = (&mut e)[4usize];
        let a0: crate::lib::intvector::intrinsics::vec128 = acc0.1[0usize];
        let a1: crate::lib::intvector::intrinsics::vec128 = acc0.1[1usize];
        let a2: crate::lib::intvector::intrinsics::vec128 = acc0.1[2usize];
        let a3: crate::lib::intvector::intrinsics::vec128 = acc0.1[3usize];
        let a4: crate::lib::intvector::intrinsics::vec128 = acc0.1[4usize];
        let a01: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_add64(a0, f10);
        let a11: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_add64(a1, f111);
        ...
        let t00: crate::lib::intvector::intrinsics::vec128 = a06;
        let t10: crate::lib::intvector::intrinsics::vec128 = a16;
        let t2: crate::lib::intvector::intrinsics::vec128 = a26;
        let t3: crate::lib::intvector::intrinsics::vec128 = a36;
        let t4: crate::lib::intvector::intrinsics::vec128 = a46;
        let mask26: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_load64(0x3ffffffu64);
        let z0: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_shift_right64(t00, 26u32);
        let z1: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_shift_right64(t3, 26u32);
        let x0: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_and(t00, mask26);
        let x3: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_and(t3, mask26);
        let x1: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_add64(t10, z0);
        let x4: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_add64(t4, z1);
        let z01: crate::lib::intvector::intrinsics::vec128 =
            crate::lib::intvector::intrinsics::vec128_shift_right64(x1, 26u32);
    ...
    ()
{
    ...
    crate::hacl::poly1305_128::poly1305_init(&mut ctx, k);
    if aadlen != 0u32 { poly1305_padded_128(&mut ctx, aadlen, aad) };
    if mlen != 0u32 { poly1305_padded_128(&mut ctx, mlen, m) };
    ...
    acc.1[3usize] = o3;
    acc.1[4usize] = o4;
    crate::hacl::poly1305_128::poly1305_finish(out, k, acc.1)
}
...
pub fn aead_encrypt(
    ...
    ()
{
    crate::hacl::chacha20_vec128::chacha20_encrypt_128(mlen, cipher, m, k, n, 1u32);
    let mut tmp: [u8; 64] = [0u8; 64usize];
    let mut tmp_copy: [u8; 64] = [0u8; 64usize];
    crate::hacl::chacha20_vec128::chacha20_encrypt_128(64u32, &mut tmp, &mut tmp_copy, k, n, 0u32);
    let key: (&mut [u8], &mut [u8]) = (&mut tmp).split_at_mut(0usize);
    poly1305_do_128(key.1, aadlen, aad, mlen, cipher, mac)
}
    ...
    u32
{
    ...
    crate::hacl::chacha20_vec128::chacha20_encrypt_128(64u32, &mut tmp, &mut tmp_copy, k, n, 0u32);
    let key: (&mut [u8], &mut [u8]) = (&mut tmp).split_at_mut(0usize);
    poly1305_do_128(key.1, aadlen, aad, mlen, cipher, &mut computed_mac);
    ...
    if z == 255u8
    {
        crate::hacl::chacha20_vec128::chacha20_encrypt_128(mlen, m, cipher, k, n, 1u32);
        0u32
    }
    else
    { 1u32 }
