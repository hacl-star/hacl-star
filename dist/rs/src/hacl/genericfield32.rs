...
pub fn field_modulus_check(len: u32, n: &[u32]) -> bool
{
    let m: u32 = crate::hacl::bignum::bn_check_modulus_u32(len, n);
    m == 0xFFFFFFFFu32
}

pub fn field_init(len: u32, n: &[u32]) -> Vec<crate::hacl::bignum::bn_mont_ctx_u32>
{
...
pub fn field_get_len(k: &[crate::hacl::bignum::bn_mont_ctx_u32]) -> u32 { (k[0usize]).len }

pub fn to_field(k: &[crate::hacl::bignum::bn_mont_ctx_u32], a: &[u32], aM: &mut [u32])
{
...
pub fn from_field(k: &[crate::hacl::bignum::bn_mont_ctx_u32], aM: &[u32], a: &mut [u32])
{
    let len1: u32 = field_get_len(k);
    let uu____0: &crate::hacl::bignum::bn_mont_ctx_u32 = &k[0usize];
...
pub fn add(k: &[crate::hacl::bignum::bn_mont_ctx_u32], aM: &[u32], bM: &[u32], cM: &mut [u32])
{
    let len1: u32 = field_get_len(k);
    let uu____0: &crate::hacl::bignum::bn_mont_ctx_u32 = &k[0usize];
...
pub fn sub(k: &[crate::hacl::bignum::bn_mont_ctx_u32], aM: &[u32], bM: &[u32], cM: &mut [u32])
{
    let len1: u32 = field_get_len(k);
    crate::hacl::bignum::bn_sub_mod_n_u32(len1, &(k[0usize]).n, aM, bM, cM)
}

pub fn mul(k: &[crate::hacl::bignum::bn_mont_ctx_u32], aM: &[u32], bM: &[u32], cM: &mut [u32])
{
    let len1: u32 = field_get_len(k);
    let uu____0: &crate::hacl::bignum::bn_mont_ctx_u32 = &k[0usize];
...
pub fn sqr(k: &[crate::hacl::bignum::bn_mont_ctx_u32], aM: &[u32], cM: &mut [u32])
{
    let len1: u32 = field_get_len(k);
    let uu____0: &crate::hacl::bignum::bn_mont_ctx_u32 = &k[0usize];
...
pub fn one(k: &[crate::hacl::bignum::bn_mont_ctx_u32], oneM: &mut [u32])
{
    let len1: u32 = field_get_len(k);
    let uu____0: &crate::hacl::bignum::bn_mont_ctx_u32 = &k[0usize];
...
pub fn inverse(k: &[crate::hacl::bignum::bn_mont_ctx_u32], aM: &[u32], aInvM: &mut [u32])
{
    let uu____0: &crate::hacl::bignum::bn_mont_ctx_u32 = &k[0usize];
