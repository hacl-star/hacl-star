...
pub fn field_init(len: u32, n: &mut [u32]) -> &mut [crate::hacl::bignum::bn_mont_ctx_u32]
{
    ...
    ()
{
    ...
    crate::hacl::bignum::bn_add_mod_n_u32(len1, uu____0.n, &mut a_copy, &mut b_copy, cM)
}
    ...
    ()
{
    let len1: u32 = field_get_len(k);
    let uu____0: crate::hacl::bignum::bn_mont_ctx_u32 = k[0usize];
    let mut aMc: Vec<u32> = vec![0u32; uu____0.len];
    ((&mut aMc)[0usize..uu____0.len]).copy_from_slice(&aM[0usize..uu____0.len]);
    if bBits < 200u32
    {
    ...
    else
    {
        ...
        for i in 0u32..bBits.wrapping_div(4u32)
        {
            ...
            let ctx_n0: (&mut [u32], &mut [u32]) = ctx_r2.1.split_at_mut(0usize - len1 as usize);
            crate::hacl::bignum::bn_mont_mul_u32(len1, ctx_n0.1, uu____0.mu, resM, &mut tmp0, resM)
        }
    }
}
    ...
    ()
{
    ...
    let c: u32 =
        if 1u32 < len1
        {
            let a1: &mut [u32] = &mut uu____0.n[1usize..];
