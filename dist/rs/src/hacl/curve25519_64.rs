...
fn point_add_and_double(q: &mut [u64], p01_tmp1: &mut [u64], tmp2: &mut [u64]) -> ()
{
  ...
  let dc1: (&mut [u64], &mut [u64]) = c.0.split_at_mut(0usize);
  crate::hacl::impl::curve25519::field64::vale::fsqr2(dc1.1, ab1.1, tmp2);
  crate::hacl::impl::curve25519::field64::vale::fsqr2(z31.0, z31.0, tmp2);
  ab1.0[0u32 as usize] = c.1[0u32 as usize];
  ab1.0[1u32 as usize] = c.1[1u32 as usize];
  ab1.0[2u32 as usize] = c.1[2u32 as usize];
  ab1.0[3u32 as usize] = c.1[3u32 as usize];
  crate::hacl::impl::curve25519::field64::vale::fsub(c.1, dc1.0, c.1);
  crate::hacl::impl::curve25519::field64::vale::fmul_scalar(b1.1, c.1, 121665u64);
...
fn montgomery_ladder(out: &mut [u64], key: &mut [u8], init: &mut [u64]) -> ()
{
  ...
  let nq1: (&mut [u64], &mut [u64]) = p01_tmp11.0.split_at_mut(0usize);
  let tmp1: (&mut [u64], &mut [u64]) = nq1.1.split_at_mut(16usize);
...
fn finv(o: &mut [u64], i: &mut [u64], tmp: &mut [u64]) -> ()
{
  ...
  crate::hacl::impl::curve25519::field64::vale::fmul(t01.0, t01.1, t01.0, tmp1.1);
  let b1: (&mut [u64], &mut [u64]) = t01.0.split_at_mut(0usize);
  let c1: (&mut [u64], &mut [u64]) = b1.1.split_at_mut(4usize);
  let t01: (&mut [u64], &mut [u64]) = t01.1.split_at_mut(0usize);
  let tmp1: (&mut [u64], &mut [u64]) = tmp1.1.split_at_mut(0usize);
  fsquare_times(t01.1, c1.0, tmp1.1, 10u32);
  crate::hacl::impl::curve25519::field64::vale::fmul(c1.1, t01.1, c1.0, tmp1.0);
  fsquare_times(t01.1, c1.1, tmp1.1, 20u32);
  crate::hacl::impl::curve25519::field64::vale::fmul(t01.1, t01.1, c1.1, tmp1.0);
  fsquare_times(t01.1, t01.1, tmp1.1, 10u32);
  crate::hacl::impl::curve25519::field64::vale::fmul(c1.0, t01.1, c1.0, tmp1.0);
  fsquare_times(t01.1, c1.0, tmp1.1, 50u32);
  crate::hacl::impl::curve25519::field64::vale::fmul(c1.1, t01.1, c1.0, tmp1.0);
  let b1: (&mut [u64], &mut [u64]) = c1.0.split_at_mut(0usize);
  let c1: (&mut [u64], &mut [u64]) = c1.1.split_at_mut(0usize);
  let t01: (&mut [u64], &mut [u64]) = t01.1.split_at_mut(0usize);
  let tmp1: (&mut [u64], &mut [u64]) = tmp1.1.split_at_mut(0usize);
  fsquare_times(t01.1, c1.1, tmp1.1, 100u32);
  crate::hacl::impl::curve25519::field64::vale::fmul(t01.1, t01.1, c1.1, tmp1.0);
  fsquare_times(t01.1, t01.1, tmp1.1, 50u32);
  crate::hacl::impl::curve25519::field64::vale::fmul(t01.1, t01.1, b1.1, tmp1.0);
  fsquare_times(t01.1, t01.1, tmp1.1, 5u32);
  let a: (&mut [u64], &mut [u64]) = b1.0.split_at_mut(0usize);
  let t0: (&mut [u64], &mut [u64]) = t01.1.split_at_mut(0usize);
  crate::hacl::impl::curve25519::field64::vale::fmul(o, t0.1, a.1, tmp1.0)
}
...
fn store_felem(b: &mut [u64], f: &mut [u64]) -> ()
{
  ...
  let m3: u64 = crate::fstar::uint64::eq_mask(f3, 0x7fffffffffffffffu64);
  ...
  let f3': u64 = f3.wrapping_sub(mask & 0x7fffffffffffffffu64);
  let o0: u64 = f0';
  let o1: u64 = f1';
  let o2: u64 = f2';
  let o3: u64 = f3';
...
fn encode_point(o: &mut [u8], i: &mut [u64]) -> ()
{
  ...
  for i in 0u32..4u32
  {
    crate::lowstar::endianness::store64_le(
      &mut o[i.wrapping_mul(8u32) as usize..],
      (&mut u64s)[i as usize]
    )
  }
}
