    ...
    crate::hacl::streaming_types::error_code
{
    ...
    else
    {
        ...
        {
            let block_state1: &mut [crate::lib::intvector_intrinsics::vec128] =
                &mut state[0usize].block_state;
            let buf: &mut [u8] = &mut state[0usize].buf;
        ...
        if sz == 0u32
        {
            ...
            let sz1: u32 =
                ...
                { total_len1.wrapping_rem(32u32 as u64) as u32 };
            if ! (sz1 == 0u32) { poly1305_update(block_state1, 32u32, buf) };
            let ite: u32 =
            ...
            poly1305_update(block_state1, data1_len, data2.0);
        ...
        else
        {
            ...
            let block_state10: &mut [crate::lib::intvector_intrinsics::vec128] =
                &mut state[0usize].block_state;
            ...
            if ! (sz10 == 0u32) { poly1305_update(block_state10, 32u32, buf0) };
            let ite: u32 =
                if
            ...
            let data2: (&mut [u8], &mut [u8]) = data1.1.split_at_mut(data1_len as usize);
            poly1305_update(block_state10, data1_len, data2.0);
