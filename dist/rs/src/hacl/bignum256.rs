...
{
    (res[0usize..0usize + 8usize]).copy_from_slice(&[0u64; 8usize]);
    for i in 0u32..4u32
    {
...
{
    (res[0usize..0usize + 4usize]).copy_from_slice(&[0u64; 4usize]);
...
#[inline] fn reduction(n: &mut [u64], nInv: u64, c: &mut [u64], res: &mut [u64]) -> ()
{
    ...
    (res[0usize..0usize + 4usize]).copy_from_slice(&(&mut c[4usize..])[0usize..0usize + 4usize]);
    let c00: u64 = c0;
    let mut tmp: [u64; 4] = [0u64; 4usize];
    let mut c1: u64 = 0u64;
    for i in 0u32..1u32
    ...
    ()
{
    ...
    ((&mut c)[0usize..0usize + 8usize]).copy_from_slice(&[0u64; 8usize]);
    for i in 0u32..4u32
    {
    ...
    ()
{
    ...
    ((&mut a1)[0usize..0usize + 8usize]).copy_from_slice(&a[0usize..0usize + 8usize]);
    let mut c0: u64 = 0u64;
    for i in 0u32..4u32
    {
    ...
    ((&mut a_mod)[0usize..0usize + 4usize]).copy_from_slice(
        &(&mut (&mut a1)[4usize..])[0usize..0usize + 4usize]
    );
    let c00: u64 = c0;
    let mut tmp: [u64; 4] = [0u64; 4usize];
...
pub fn mod(n: &mut [u64], a: &mut [u64], res: &mut [u64]) -> bool
{
    ...
    ((&mut one)[0usize..0usize + 4usize]).copy_from_slice(&[0u64; 4usize]);
    (&mut one)[0usize] = 1u64;
