fn bn_add(aLen: u32, a: &mut [u64], bLen: u32, b: &mut [u64], res: &mut [u64]) -> u64
{
    ...
    if bLen < aLen
    {
        ...
        for i in 0u32..aLen.wrapping_sub(bLen).wrapping_div(4u32)
        {
            ...
            c1 = crate::lib::inttypes::intrinsics::add_carry_u64(c1, t1, 0u64, res_i.1);
            let t10: u64 = a1.1[4u32.wrapping_mul(i).wrapping_add(1u32) as usize];
            let res_i0: (&mut [u64], &mut [u64]) = res_i.1.split_at_mut(1usize);
            c1 = crate::lib::inttypes::intrinsics::add_carry_u64(c1, t10, 0u64, res_i0.1);
            let t11: u64 = a1.1[4u32.wrapping_mul(i).wrapping_add(2u32) as usize];
            let res_i1: (&mut [u64], &mut [u64]) = res_i0.1.split_at_mut(1usize);
            c1 = crate::lib::inttypes::intrinsics::add_carry_u64(c1, t11, 0u64, res_i1.1);
            let t12: u64 = a1.1[4u32.wrapping_mul(i).wrapping_add(3u32) as usize];
            let res_i2: (&mut [u64], &mut [u64]) = res_i1.1.split_at_mut(1usize);
            c1 = crate::lib::inttypes::intrinsics::add_carry_u64(c1, t12, 0u64, res_i2.1)
        };
        for
        i
        in
...
{
    (out[0u32 as usize..0u32 as usize + 4u32 as usize]).copy_from_slice(
    ...
    bool
{
    ...
    let f20: u64 = r2[2u32 as usize];
    let f30: u64 = r2[3u32 as usize];
    let b2: bool = f20 == 0u64 && f30 == 0u64;
    let f21: u64 = r3[2u32 as usize];
    let f31: u64 = r3[3u32 as usize];
    let b3: bool = f21 == 0u64 && f31 == 0u64;
    let f22: u64 = r4[2u32 as usize];
    let f32: u64 = r4[3u32 as usize];
...
pub fn secp256k1_ecdsa_signature_normalize(signature: &mut [u8]) -> bool
{
    ...
    else
    {
        ...
        crate::hacl::k256::scalar::store_qelem(&mut s.0[32u32 as usize..], &mut s_q);
        truebool
    }
}
