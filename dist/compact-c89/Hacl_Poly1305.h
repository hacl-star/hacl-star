...
void Hacl_Impl_Poly1305_poly1305_init_32(uint64_t *ctx, uint8_t *k);

void Hacl_Impl_Poly1305_poly1305_update_32(uint64_t *ctx, uint32_t len1, uint8_t *text);

void Hacl_Impl_Poly1305_poly1305_finish_32(uint8_t *tag, uint8_t *key, uint64_t *ctx);
