...
)
{
  ...
  {
    uint32_t _i;
    for (_i = 0U; _i < (uint32_t)64U; ++_i)
      keyblock[_i] = (uint8_t)0x00U;
  }
  {
    EverCrypt_Hash_state_s s;
    uint32_t buf[5U];
    EverCrypt_Hash_state_s acc[1U];
    uint32_t i1;
    uint8_t *nkey;
