...
inline static void Hacl_Impl_Chacha20_Core32_double_round(uint32_t *st)
{
  ...
  sta13 = sta4 + stb3;
  std13 = std5 ^ sta13;
  std23 = std13 << (uint32_t)7U | std13 >> (uint32_t)25U;
  st[8U] = sta13;
  st[4U] = std23;
  sta5 = st[1U];
  stb4 = st[5U];
  ...
  sta14 = sta5 + stb4;
  std14 = std6 ^ sta14;
  std24 = std14 << (uint32_t)16U | std14 >> (uint32_t)16U;
  st[1U] = sta14;
  st[13U] = std24;
  sta6 = st[9U];
  stb5 = st[13U];
  ...
  sta15 = sta6 + stb5;
  std15 = std7 ^ sta15;
  std25 = std15 << (uint32_t)12U | std15 >> (uint32_t)20U;
  st[9U] = sta15;
  st[5U] = std25;
  sta7 = st[1U];
  stb6 = st[5U];
  ...
  sta16 = sta7 + stb6;
  std16 = std8 ^ sta16;
  std26 = std16 << (uint32_t)8U | std16 >> (uint32_t)24U;
  st[1U] = sta16;
  st[13U] = std26;
  sta8 = st[9U];
  stb7 = st[13U];
  ...
  sta17 = sta8 + stb7;
  std17 = std9 ^ sta17;
  std27 = std17 << (uint32_t)7U | std17 >> (uint32_t)25U;
  st[9U] = sta17;
  st[5U] = std27;
  sta9 = st[2U];
  stb8 = st[6U];
  ...
  sta18 = sta9 + stb8;
  std19 = std18 ^ sta18;
  std28 = std19 << (uint32_t)16U | std19 >> (uint32_t)16U;
  st[2U] = sta18;
  st[14U] = std28;
  sta19 = st[10U];
  stb9 = st[14U];
  ...
  sta110 = sta19 + stb9;
  std110 = std29 ^ sta110;
  std210 = std110 << (uint32_t)12U | std110 >> (uint32_t)20U;
  st[10U] = sta110;
  st[6U] = std210;
  sta20 = st[2U];
  stb10 = st[6U];
  ...
  sta111 = sta20 + stb10;
  std111 = std30 ^ sta111;
  std211 = std111 << (uint32_t)8U | std111 >> (uint32_t)24U;
  st[2U] = sta111;
  st[14U] = std211;
  sta21 = st[10U];
  stb11 = st[14U];
  ...
  sta112 = sta21 + stb11;
  std112 = std31 ^ sta112;
  std212 = std112 << (uint32_t)7U | std112 >> (uint32_t)25U;
  st[10U] = sta112;
  st[6U] = std212;
  sta22 = st[3U];
  stb12 = st[7U];
  ...
  sta113 = sta22 + stb12;
  std113 = std32 ^ sta113;
  std213 = std113 << (uint32_t)16U | std113 >> (uint32_t)16U;
  st[3U] = sta113;
  st[15U] = std213;
  sta23 = st[11U];
  stb13 = st[15U];
  ...
  sta114 = sta23 + stb13;
  std114 = std33 ^ sta114;
  std214 = std114 << (uint32_t)12U | std114 >> (uint32_t)20U;
  st[11U] = sta114;
  st[7U] = std214;
  sta24 = st[3U];
  stb14 = st[7U];
  ...
  sta115 = sta24 + stb14;
  std115 = std34 ^ sta115;
  std215 = std115 << (uint32_t)8U | std115 >> (uint32_t)24U;
  st[3U] = sta115;
  st[15U] = std215;
  sta25 = st[11U];
  stb15 = st[15U];
  ...
  sta116 = sta25 + stb15;
  std116 = std35 ^ sta116;
  std216 = std116 << (uint32_t)7U | std116 >> (uint32_t)25U;
  st[11U] = sta116;
  st[7U] = std216;
  sta26 = st[0U];
  stb16 = st[5U];
  ...
  sta117 = sta26 + stb16;
  std117 = std36 ^ sta117;
  std217 = std117 << (uint32_t)16U | std117 >> (uint32_t)16U;
  st[0U] = sta117;
  st[15U] = std217;
  sta27 = st[10U];
  stb17 = st[15U];
  ...
  sta118 = sta27 + stb17;
  std118 = std37 ^ sta118;
  std218 = std118 << (uint32_t)12U | std118 >> (uint32_t)20U;
  st[10U] = sta118;
  st[5U] = std218;
  sta28 = st[0U];
  stb18 = st[5U];
  ...
  sta119 = sta28 + stb18;
  std119 = std38 ^ sta119;
  std219 = std119 << (uint32_t)8U | std119 >> (uint32_t)24U;
  st[0U] = sta119;
  st[15U] = std219;
  sta29 = st[10U];
  stb19 = st[15U];
  ...
  sta120 = sta29 + stb19;
  std120 = std39 ^ sta120;
  std220 = std120 << (uint32_t)7U | std120 >> (uint32_t)25U;
  st[10U] = sta120;
  st[5U] = std220;
  sta30 = st[1U];
  stb20 = st[6U];
  ...
  sta121 = sta30 + stb20;
  std121 = std40 ^ sta121;
  std221 = std121 << (uint32_t)16U | std121 >> (uint32_t)16U;
  st[1U] = sta121;
  st[12U] = std221;
  sta31 = st[11U];
  stb21 = st[12U];
  ...
  sta122 = sta31 + stb21;
  std122 = std41 ^ sta122;
  std222 = std122 << (uint32_t)12U | std122 >> (uint32_t)20U;
  st[11U] = sta122;
  st[6U] = std222;
  sta32 = st[1U];
  stb22 = st[6U];
  ...
  sta123 = sta32 + stb22;
  std123 = std42 ^ sta123;
  std223 = std123 << (uint32_t)8U | std123 >> (uint32_t)24U;
  st[1U] = sta123;
  st[12U] = std223;
  sta33 = st[11U];
  stb23 = st[12U];
  ...
  sta124 = sta33 + stb23;
  std124 = std43 ^ sta124;
  std224 = std124 << (uint32_t)7U | std124 >> (uint32_t)25U;
  st[11U] = sta124;
  st[6U] = std224;
  sta34 = st[2U];
  stb24 = st[7U];
  ...
  sta125 = sta34 + stb24;
  std125 = std44 ^ sta125;
  std225 = std125 << (uint32_t)16U | std125 >> (uint32_t)16U;
  st[2U] = sta125;
  st[13U] = std225;
  sta35 = st[8U];
  stb25 = st[13U];
  ...
  sta126 = sta35 + stb25;
  std126 = std45 ^ sta126;
  std226 = std126 << (uint32_t)12U | std126 >> (uint32_t)20U;
  st[8U] = sta126;
  st[7U] = std226;
  sta36 = st[2U];
  stb26 = st[7U];
  ...
  sta127 = sta36 + stb26;
  std127 = std46 ^ sta127;
  std227 = std127 << (uint32_t)8U | std127 >> (uint32_t)24U;
  st[2U] = sta127;
  st[13U] = std227;
  sta37 = st[8U];
  stb27 = st[13U];
  ...
  sta128 = sta37 + stb27;
  std128 = std47 ^ sta128;
  std228 = std128 << (uint32_t)7U | std128 >> (uint32_t)25U;
  st[8U] = sta128;
  st[7U] = std228;
  sta38 = st[3U];
  stb28 = st[4U];
  ...
  sta129 = sta38 + stb28;
  std129 = std48 ^ sta129;
  std229 = std129 << (uint32_t)16U | std129 >> (uint32_t)16U;
  st[3U] = sta129;
  st[14U] = std229;
  sta39 = st[9U];
  stb29 = st[14U];
  ...
  sta130 = sta39 + stb29;
  std130 = std49 ^ sta130;
  std230 = std130 << (uint32_t)12U | std130 >> (uint32_t)20U;
  st[9U] = sta130;
  st[4U] = std230;
  sta40 = st[3U];
  stb30 = st[4U];
  ...
  sta131 = sta40 + stb30;
  std131 = std50 ^ sta131;
  std231 = std131 << (uint32_t)8U | std131 >> (uint32_t)24U;
  st[3U] = sta131;
  st[14U] = std231;
  sta = st[9U];
  stb = st[14U];
