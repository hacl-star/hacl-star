      ...
      case Spec_AEAD_AES128_GCM:
        {
          ...
          memcpy(tmp_keys, ek, (uint32_t)176U * sizeof ek[0U]);
          {
            ...
            memcpy(tmp_iv, iv, (uint32_t)12U * sizeof iv[0U]);
            {
              ...
              uint32_t
              cipher_extlength = (uint32_t)16U * (cipher_len_ + (uint32_t)15U) / (uint32_t)16U;
              ...
              {
                uint8_t cipher_extra[cipher_extlength + (uint32_t)1U];
                memset(cipher_extra,
                  0U,
                  (cipher_extlength + (uint32_t)1U) * sizeof cipher_extra[0U]);
                KRML_CHECK_SIZE(sizeof (uint8_t), cipher_extlength + (uint32_t)1U);
                {
                  uint8_t out_extra[cipher_extlength + (uint32_t)1U];
                  ...
                  {
                    uint8_t auth_extra[auth_extlength + (uint32_t)1U];
