...
void Hacl_Curve25519_51_secret_to_public(uint8_t *pub, uint8_t *priv)
{
  ...
  uint64_t *init1 = alloca((uint32_t)2U * (uint32_t)5U * sizeof (uint64_t));
  ...
  FStar_UInt128_uint128
  *tmp_w = alloca((uint32_t)2U * (uint32_t)5U * sizeof (FStar_UInt128_uint128));
...
void Hacl_Curve25519_64_secret_to_public(uint8_t *pub, uint8_t *priv)
{
  ...
  uint64_t *init1 = alloca((uint32_t)2U * (uint32_t)4U * sizeof (uint64_t));
  ...
  uint64_t *tmp_w = alloca((uint32_t)2U * (uint32_t)8U * sizeof (uint64_t));
