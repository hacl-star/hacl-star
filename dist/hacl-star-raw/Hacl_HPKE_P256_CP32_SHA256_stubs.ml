...
external _1_Hacl_HPKE_P256_CP32_SHA256_setupBaseS
  : bytes CI.ocaml -> _ CI.fatptr -> bytes CI.ocaml -> bytes CI.ocaml ->
    Unsigned.uint32 -> bytes CI.ocaml -> Unsigned.uint32
  =
  "_1_Hacl_HPKE_P256_CP32_SHA256_setupBaseS_byte6" "_1_Hacl_HPKE_P256_CP32_SHA256_setupBaseS"
...
external _3_Hacl_HPKE_P256_CP32_SHA256_sealBase
  ...
  =
  "_3_Hacl_HPKE_P256_CP32_SHA256_sealBase_byte10" "_3_Hacl_HPKE_P256_CP32_SHA256_sealBase"
...
external _4_Hacl_HPKE_P256_CP32_SHA256_openBase
  : bytes CI.ocaml -> bytes CI.ocaml -> Unsigned.uint32 -> bytes CI.ocaml ->
    ...
    bytes CI.ocaml -> Unsigned.uint32
  =
  "_4_Hacl_HPKE_P256_CP32_SHA256_openBase_byte9" "_4_Hacl_HPKE_P256_CP32_SHA256_openBase"
...
| Function
  ...
  (fun x20 x22 x23 x24 x25 ->
    ...
    _2_Hacl_HPKE_P256_CP32_SHA256_setupBaseR x21 x22 x23 x24 x25)
| Function
    (CI.OCaml CI.Bytes,
     Function
       (CI.Struct _,
  ...
  (fun x26 x27 x29 x30 x31 x32 ->
    ...
    _1_Hacl_HPKE_P256_CP32_SHA256_setupBaseS x26 x28 x29 x30 x31 x32)
