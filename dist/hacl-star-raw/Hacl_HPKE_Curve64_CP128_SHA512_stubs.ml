...
external _1_Hacl_HPKE_Curve64_CP128_SHA512_setupBaseS
  : bytes CI.ocaml -> _ CI.fatptr -> bytes CI.ocaml -> bytes CI.ocaml ->
    Unsigned.uint32 -> bytes CI.ocaml -> Unsigned.uint32
  =
  "_1_Hacl_HPKE_Curve64_CP128_SHA512_setupBaseS_byte6" "_1_Hacl_HPKE_Curve64_CP128_SHA512_setupBaseS"
...
external _3_Hacl_HPKE_Curve64_CP128_SHA512_sealBase
  ...
  =
  "_3_Hacl_HPKE_Curve64_CP128_SHA512_sealBase_byte10" "_3_Hacl_HPKE_Curve64_CP128_SHA512_sealBase"
...
external _4_Hacl_HPKE_Curve64_CP128_SHA512_openBase
  : bytes CI.ocaml -> bytes CI.ocaml -> Unsigned.uint32 -> bytes CI.ocaml ->
    ...
    bytes CI.ocaml -> Unsigned.uint32
  =
  "_4_Hacl_HPKE_Curve64_CP128_SHA512_openBase_byte9" "_4_Hacl_HPKE_Curve64_CP128_SHA512_openBase"
...
| Function
  ...
  (fun x20 x22 x23 x24 x25 ->
    ...
    _2_Hacl_HPKE_Curve64_CP128_SHA512_setupBaseR x21 x22 x23 x24 x25)
| Function
    (CI.OCaml CI.Bytes,
     Function
       (CI.Struct _,
  ...
  (fun x26 x27 x29 x30 x31 x32 ->
    ...
    _1_Hacl_HPKE_Curve64_CP128_SHA512_setupBaseS x26 x28 x29 x30 x31 x32)
