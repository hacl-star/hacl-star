...
static inline void fmul (uint64_t *out, uint64_t *f1, uint64_t *f2, uint64_t *tmp) 
{
  __asm__ volatile(
    ...
    "  mulxq 16(%1), %%r12, %%r13;"    "  adox %%r11, %%r12;"
    ...
    "  mulxq 8(%1), %%r10, %%r11;"     "  adox %%r9, %%r10;"     "  adcx %%r12, %%r10;"    "  movq %%r10, 16(%2);"
    "  mulxq 16(%1), %%r12, %%r13;"    "  adox %%r11, %%r12;"    "  adcx %%r14, %%r12;"    "  mov $0, %%r8;"
    ...
    "  mulxq 8(%1), %%r10, %%r11;"     "  adox %%r9, %%r10;"     "  adcx %%r12, %%r10;"    "  movq %%r10, 24(%2);"
    "  mulxq 16(%1), %%r12, %%r13;"    "  adox %%r11, %%r12;"    "  adcx %%r14, %%r12;"    "  mov $0, %%r8;"
    "  mulxq 24(%1), %%r14, %%rdx;"    "  adox %%r13, %%r14;"    "  adcx %%rax, %%r14;"    "  mov $0, %%rax;"
                                       "  adox %%rdx, %%rax;"    "  adcx %%r8, %%rax;"
    ...
    "  mulxq 8(%1), %%r10, %%r11;"     "  adox %%r9, %%r10;"     "  adcx %%r12, %%r10;"    "  movq %%r10, 32(%2);"
    "  mulxq 16(%1), %%r12, %%r13;"    "  adox %%r11, %%r12;"    "  adcx %%r14, %%r12;"    "  movq %%r12, 40(%2);"    "  mov $0, %%r8;"
...
static inline void fmul2 (uint64_t *out, uint64_t *f1, uint64_t *f2, uint64_t *tmp) 
{
  __asm__ volatile(
    ...
    "  mulxq 48(%1), %%r12, %%r13;"    "  adox %%r11, %%r12;"
    ...
    "  mulxq 40(%1), %%r10, %%r11;"     "  adox %%r9, %%r10;"     "  adcx %%r12, %%r10;"    "  movq %%r10, 80(%2);"
    "  mulxq 48(%1), %%r12, %%r13;"    "  adox %%r11, %%r12;"    "  adcx %%r14, %%r12;"    "  mov $0, %%r8;"
    ...
    "  mulxq 40(%1), %%r10, %%r11;"     "  adox %%r9, %%r10;"     "  adcx %%r12, %%r10;"    "  movq %%r10, 88(%2);"
    "  mulxq 48(%1), %%r12, %%r13;"    "  adox %%r11, %%r12;"    "  adcx %%r14, %%r12;"    "  mov $0, %%r8;"
    "  mulxq 56(%1), %%r14, %%rdx;"    "  adox %%r13, %%r14;"    "  adcx %%rax, %%r14;"    "  mov $0, %%rax;"
                                       "  adox %%rdx, %%rax;"    "  adcx %%r8, %%rax;"
    ...
    "  mulxq 40(%1), %%r10, %%r11;"     "  adox %%r9, %%r10;"     "  adcx %%r12, %%r10;"    "  movq %%r10, 96(%2);"
    "  mulxq 48(%1), %%r12, %%r13;"    "  adox %%r11, %%r12;"    "  adcx %%r14, %%r12;"    "  movq %%r12, 104(%2);"    "  mov $0, %%r8;"
...
static inline void fsqr (uint64_t *out, uint64_t *f, uint64_t *tmp) 
{
  __asm__ volatile(
    ...
    "  movq 24(%1), %%rdx;"                                      // f[3]
    "  mulxq 8(%1), %%r11, %0;"     "  adcx %%rcx, %%r11;"    // f[1]*f[3]
    "  mulxq 16(%1), %%rax, %%r13;"    "  adcx %%rax, %0;"    // f[2]*f[3]
  ...
  : "+&r" (out), "+&r" (f), "+&r" (tmp)
  : 
  : "%rax", "%rcx", "%rdx", "%r8", "%r9", "%r10", "%r11", "%r13", "%r14", "%r15", "memory", "cc"
  );
}
...
static inline void fsqr2 (uint64_t *out, uint64_t *f, uint64_t *tmp) 
{
  __asm__ volatile(
    ...
    "  movq 56(%1), %%rdx;"                                      // f[3]
    "  mulxq 40(%1), %%r11, %0;"     "  adcx %%rcx, %%r11;"    // f[1]*f[3]
    "  mulxq 48(%1), %%rax, %%r13;"    "  adcx %%rax, %0;"    // f[2]*f[3]
