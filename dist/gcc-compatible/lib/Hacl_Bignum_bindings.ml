...
module Bindings(F:Cstubs.FOREIGN) =
  struct
      ...
      foreign "Hacl_Bignum_Exponentiation_bn_check_mod_exp_u32"
        (uint32_t @->
           ((ptr uint32_t) @->
              ((ptr uint32_t) @->
                 (uint32_t @-> ((ptr uint32_t) @-> (returning uint32_t))))))
    let hacl_Bignum_Exponentiation_bn_mod_exp_bm_vartime_precompr2_u32 =
      foreign
    ...
    let hacl_Bignum_Exponentiation_bn_mod_exp_bm_consttime_precompr2_u32 =
      foreign
              ...
              ((ptr uint32_t) @->
                 (uint32_t @->
                    ((ptr uint32_t) @->
                       ((ptr uint32_t) @->
                          ((ptr uint32_t) @-> (returning void))))))))
    let hacl_Bignum_Exponentiation_bn_mod_exp_fw_vartime_precompr2_u32 =
      foreign
                 ...
                 ((ptr uint32_t) @->
                    (uint32_t @->
                       ((ptr uint32_t) @->
                          ((ptr uint32_t) @->
                             ((ptr uint32_t) @-> (returning void)))))))))
    let hacl_Bignum_Exponentiation_bn_mod_exp_fw_consttime_precompr2_u32 =
      foreign
      ...
      foreign "Hacl_Bignum_Exponentiation_bn_check_mod_exp_u64"
        (uint32_t @->
           ((ptr uint64_t) @->
              ((ptr uint64_t) @->
                 (uint32_t @-> ((ptr uint64_t) @-> (returning uint64_t))))))
    let hacl_Bignum_Exponentiation_bn_mod_exp_bm_vartime_precompr2_u64 =
      foreign
    ...
    let hacl_Bignum_Exponentiation_bn_mod_exp_bm_consttime_precompr2_u64 =
      foreign
              ...
              ((ptr uint64_t) @->
                 (uint32_t @->
                    ((ptr uint64_t) @->
                       ((ptr uint64_t) @->
                          ((ptr uint64_t) @-> (returning void))))))))
    let hacl_Bignum_Exponentiation_bn_mod_exp_fw_vartime_precompr2_u64 =
      foreign
                 ...
                 ((ptr uint64_t) @->
                    (uint32_t @->
                       ((ptr uint64_t) @->
                          ((ptr uint64_t) @->
                             ((ptr uint64_t) @-> (returning void)))))))))
    let hacl_Bignum_Exponentiation_bn_mod_exp_fw_consttime_precompr2_u64 =
      foreign
