...
module Bindings(F:Cstubs.FOREIGN) =
  struct
    ...
    let hacl_Streaming_SHA2_malloc_256 =
      foreign "Hacl_Streaming_SHA2_malloc_256"
    ...
    let hacl_Streaming_SHA2_reset_256 =
      foreign "Hacl_Streaming_SHA2_reset_256"
    ...
    let hacl_Streaming_SHA2_digest_256 =
      foreign "Hacl_Streaming_SHA2_digest_256"
        ((ptr hacl_Streaming_MD_state_32) @->
    ...
    let hacl_Streaming_SHA2_malloc_224 =
      foreign "Hacl_Streaming_SHA2_malloc_224"
        (void @-> (returning (ptr hacl_Streaming_MD_state_32)))
    let hacl_Streaming_SHA2_reset_224 =
      foreign "Hacl_Streaming_SHA2_reset_224"
        ((ptr hacl_Streaming_MD_state_32) @-> (returning void))
    let hacl_Streaming_SHA2_update_224 =
      foreign "Hacl_Streaming_SHA2_update_224"
        ((ptr hacl_Streaming_MD_state_32) @->
           (ocaml_bytes @-> (uint32_t @-> (returning uint32_t))))
    let hacl_Streaming_SHA2_digest_224 =
      foreign "Hacl_Streaming_SHA2_digest_224"
        ((ptr hacl_Streaming_MD_state_32) @->
           (ocaml_bytes @-> (returning void)))
    ...
    let hacl_Streaming_SHA2_sha224 =
      foreign "Hacl_Streaming_SHA2_sha224"
        (ocaml_bytes @-> (ocaml_bytes @-> (uint32_t @-> (returning void))))
    let hacl_Streaming_SHA2_malloc_512 =
      foreign "Hacl_Streaming_SHA2_malloc_512"
    ...
    let hacl_Streaming_SHA2_reset_512 =
      foreign "Hacl_Streaming_SHA2_reset_512"
        ((ptr hacl_Streaming_MD_state_64) @-> (returning void))
    let hacl_Streaming_SHA2_update_512 =
      foreign "Hacl_Streaming_SHA2_update_512"
        ((ptr hacl_Streaming_MD_state_64) @->
           (ocaml_bytes @-> (uint32_t @-> (returning uint32_t))))
    let hacl_Streaming_SHA2_digest_512 =
      foreign "Hacl_Streaming_SHA2_digest_512"
        ((ptr hacl_Streaming_MD_state_64) @->
           (ocaml_bytes @-> (returning void)))
    ...
    let hacl_Streaming_SHA2_sha512 =
      foreign "Hacl_Streaming_SHA2_sha512"
        (ocaml_bytes @-> (ocaml_bytes @-> (uint32_t @-> (returning void))))
    let hacl_Streaming_SHA2_malloc_384 =
      foreign "Hacl_Streaming_SHA2_malloc_384"
        (void @-> (returning (ptr hacl_Streaming_MD_state_64)))
    let hacl_Streaming_SHA2_reset_384 =
      foreign "Hacl_Streaming_SHA2_reset_384"
        ((ptr hacl_Streaming_MD_state_64) @-> (returning void))
    let hacl_Streaming_SHA2_update_384 =
      foreign "Hacl_Streaming_SHA2_update_384"
        ((ptr hacl_Streaming_MD_state_64) @->
           (ocaml_bytes @-> (uint32_t @-> (returning uint32_t))))
    let hacl_Streaming_SHA2_digest_384 =
      foreign "Hacl_Streaming_SHA2_digest_384"
        ((ptr hacl_Streaming_MD_state_64) @->
           (ocaml_bytes @-> (returning void)))
