...
module Bindings(F:Cstubs.FOREIGN) =
  struct
    ...
    type hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_ =
      [ `hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_ ] structure
    let (hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_ :
      [ `hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_ ] structure
        typ)
      =
      structure "Hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s__s"
    let hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s__block_state
      =
      field hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_
        "block_state" (ptr everCrypt_Hash_state_s)
    let hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s__buf =
      field hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_ "buf"
        (ptr uint8_t)
    let hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s__total_len =
      field hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_
        "total_len" uint64_t
    let _ = seal hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_
    let everCrypt_Hash_Incremental_alg_of_state =
      foreign "EverCrypt_Hash_Incremental_alg_of_state"
        ((ptr hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_) @->
           (returning spec_Hash_Definitions_hash_alg))
