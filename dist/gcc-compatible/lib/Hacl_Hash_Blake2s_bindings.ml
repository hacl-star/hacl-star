...
module Bindings(F:Cstubs.FOREIGN) =
  struct
    ...
    type ___uint32_t___uint32_t_ = [ `___uint32_t___uint32_t_ ] structure
    let (___uint32_t___uint32_t_ :
      [ `___uint32_t___uint32_t_ ] structure typ) =
      structure "K____uint32_t___uint32_t__s"
    let ___uint32_t___uint32_t__fst =
      field ___uint32_t___uint32_t_ "fst" (ptr uint32_t)
    let ___uint32_t___uint32_t__snd =
      field ___uint32_t___uint32_t_ "snd" (ptr uint32_t)
    let _ = seal ___uint32_t___uint32_t_
    type __uint8_t_uint8_t__uint32_t_____uint32_t_ =
      [ `__uint8_t_uint8_t__uint32_t_____uint32_t_ ] structure
    let (__uint8_t_uint8_t__uint32_t_____uint32_t_ :
      [ `__uint8_t_uint8_t__uint32_t_____uint32_t_ ] structure typ) =
      structure "K___uint8_t_uint8_t__uint32_t_____uint32_t__s"
    let __uint8_t_uint8_t__uint32_t_____uint32_t__fst =
      field __uint8_t_uint8_t__uint32_t_____uint32_t_ "fst" uint8_t
    let __uint8_t_uint8_t__uint32_t_____uint32_t__snd =
      field __uint8_t_uint8_t__uint32_t_____uint32_t_ "snd" uint8_t
    let __uint8_t_uint8_t__uint32_t_____uint32_t__thd =
      field __uint8_t_uint8_t__uint32_t_____uint32_t_ "thd"
        ___uint32_t___uint32_t_
    let _ = seal __uint8_t_uint8_t__uint32_t_____uint32_t_
