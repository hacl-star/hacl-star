...
module Bindings(F:Cstubs.FOREIGN) =
  struct
    ...
    let hacl_Bignum_Lib_bn_get_bits_l_u32 =
      foreign "Hacl_Bignum_Lib_bn_get_bits_l_u32"
        (uint32_t @->
           (uint32_t @->
              ((ptr uint32_t) @->
                 (uint32_t @-> (uint32_t @-> (returning uint32_t))))))
    let hacl_Bignum_Lib_bn_get_bits_l_u64 =
      foreign "Hacl_Bignum_Lib_bn_get_bits_l_u64"
        (uint32_t @->
           (uint32_t @->
              ((ptr uint64_t) @->
                 (uint32_t @-> (uint32_t @-> (returning uint64_t))))))
    let hacl_Bignum_Lib_bn_get_bits_c_u32 =
      foreign "Hacl_Bignum_Lib_bn_get_bits_c_u32"
        (uint32_t @->
           (uint32_t @->
              ((ptr uint32_t) @-> (uint32_t @-> (returning uint32_t)))))
    let hacl_Bignum_Lib_bn_get_bits_c_u64 =
      foreign "Hacl_Bignum_Lib_bn_get_bits_c_u64"
        (uint32_t @->
           (uint32_t @->
