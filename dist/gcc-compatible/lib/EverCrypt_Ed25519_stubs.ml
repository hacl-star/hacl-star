...
external _4_EverCrypt_Ed25519_expand_keys
  : _ CI.fatptr -> _ CI.fatptr -> unit = "_4_EverCrypt_Ed25519_expand_keys" 

external _5_EverCrypt_Ed25519_sign_expanded
  : _ CI.fatptr -> _ CI.fatptr -> Unsigned.uint32 -> _ CI.fatptr -> unit
  = "_5_EverCrypt_Ed25519_sign_expanded" 
...
| Function
  ...
  (fun x1 x2 x3 x4 ->
    _5_EverCrypt_Ed25519_sign_expanded (CI.cptr x1) (CI.cptr x2) x3
    (CI.cptr x4))
| Function (CI.Pointer _, Function (CI.Pointer _, Returns CI.Void)),
  "EverCrypt_Ed25519_expand_keys" ->
  (fun x5 x6 -> _4_EverCrypt_Ed25519_expand_keys (CI.cptr x5) (CI.cptr x6))
| Function (CI.Pointer _, Function (CI.Pointer _, Returns CI.Void)),
  "EverCrypt_Ed25519_secret_to_public" ->
  (fun x7 x8 ->
    _3_EverCrypt_Ed25519_secret_to_public (CI.cptr x7) (CI.cptr x8))
| Function
    (CI.Pointer _,
     Function
       (CI.Primitive CI.Uint32_t,
  ...
  (fun x9 x10 x11 x12 ->
    _2_EverCrypt_Ed25519_verify (CI.cptr x9) x10 (CI.cptr x11) (CI.cptr x12))
| Function
    (CI.Pointer _,
     Function
       (CI.Pointer _,
  ...
  (fun x13 x14 x15 x16 ->
    _1_EverCrypt_Ed25519_sign (CI.cptr x13) (CI.cptr x14) x15 (CI.cptr x16))
