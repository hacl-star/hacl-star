...
module Bindings(F:Cstubs.FOREIGN) =
  struct
    ...
    let hacl_Hash_SHA2_uint8_2p : [ `hacl_Hash_SHA2_uint8_2p ] structure typ
    ...
    let hacl_Hash_SHA2_uint8_3p : [ `hacl_Hash_SHA2_uint8_3p ] structure typ
    ...
    let hacl_Hash_SHA2_uint8_4p : [ `hacl_Hash_SHA2_uint8_4p ] structure typ
    ...
    let hacl_Hash_SHA2_uint8_5p : [ `hacl_Hash_SHA2_uint8_5p ] structure typ
    ...
    let hacl_Hash_SHA2_uint8_6p : [ `hacl_Hash_SHA2_uint8_6p ] structure typ
    ...
    let hacl_Hash_SHA2_uint8_7p : [ `hacl_Hash_SHA2_uint8_7p ] structure typ
    ...
    let hacl_Hash_SHA2_uint8_8p : [ `hacl_Hash_SHA2_uint8_8p ] structure typ
