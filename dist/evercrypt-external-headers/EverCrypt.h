...
extern void EverCrypt_random_sample(uint32_t x0, uint8_t *x1);
...
extern bool EverCrypt_uu___is_AES128_OPENSSL(EverCrypt_aes128_key_s x0);

extern FStar_Dyn_dyn EverCrypt___proj__AES128_OPENSSL__item__st(EverCrypt_aes128_key_s x0);

extern bool EverCrypt_uu___is_AES128_BCRYPT(EverCrypt_aes128_key_s x0);

extern FStar_Dyn_dyn EverCrypt___proj__AES128_BCRYPT__item__st(EverCrypt_aes128_key_s x0);

extern bool EverCrypt_uu___is_AES128_VALE(EverCrypt_aes128_key_s x0);

extern uint8_t *EverCrypt___proj__AES128_VALE__item__w(EverCrypt_aes128_key_s x0);

extern uint8_t *EverCrypt___proj__AES128_VALE__item__sbox(EverCrypt_aes128_key_s x0);

extern bool EverCrypt_uu___is_AES128_HACL(EverCrypt_aes128_key_s x0);

extern uint8_t *EverCrypt___proj__AES128_HACL__item__w(EverCrypt_aes128_key_s x0);

extern uint8_t *EverCrypt___proj__AES128_HACL__item__sbox(EverCrypt_aes128_key_s x0);

typedef EverCrypt_aes128_key_s *EverCrypt_aes128_key;

extern EverCrypt_aes128_key_s *EverCrypt_aes128_create(uint8_t *x0);

extern void EverCrypt_aes128_compute(EverCrypt_aes128_key_s *x0, uint8_t *x1, uint8_t *x2);

extern void EverCrypt_aes128_free(EverCrypt_aes128_key_s *x0);
...
extern bool EverCrypt_uu___is_AES256_OPENSSL(EverCrypt_aes256_key_s x0);

extern FStar_Dyn_dyn EverCrypt___proj__AES256_OPENSSL__item__st(EverCrypt_aes256_key_s x0);

extern bool EverCrypt_uu___is_AES256_BCRYPT(EverCrypt_aes256_key_s x0);

extern FStar_Dyn_dyn EverCrypt___proj__AES256_BCRYPT__item__st(EverCrypt_aes256_key_s x0);

extern bool EverCrypt_uu___is_AES256_HACL(EverCrypt_aes256_key_s x0);

extern uint8_t *EverCrypt___proj__AES256_HACL__item__w(EverCrypt_aes256_key_s x0);

extern uint8_t *EverCrypt___proj__AES256_HACL__item__sbox(EverCrypt_aes256_key_s x0);

typedef EverCrypt_aes256_key_s *EverCrypt_aes256_key;

extern EverCrypt_aes256_key_s *EverCrypt_aes256_create(uint8_t *x0);

extern void EverCrypt_aes256_compute(EverCrypt_aes256_key_s *x0, uint8_t *x1, uint8_t *x2);

extern void EverCrypt_aes256_free(EverCrypt_aes256_key_s *x0);
...
extern bool EverCrypt_uu___is_AES128_CBC(EverCrypt_block_cipher_alg x0);

extern bool EverCrypt_uu___is_AES256_CBC(EverCrypt_block_cipher_alg x0);

extern bool EverCrypt_uu___is_TDES_EDE_CBC(EverCrypt_block_cipher_alg x0);

extern uint32_t EverCrypt_block_cipher_keyLen(EverCrypt_block_cipher_alg x0);

extern uint32_t EverCrypt_block_cipher_blockLen(EverCrypt_block_cipher_alg x0);

#define EverCrypt_RC4_128 0

typedef uint8_t EverCrypt_stream_cipher_alg;

extern bool EverCrypt_uu___is_RC4_128(EverCrypt_stream_cipher_alg x0);
...
extern bool EverCrypt_uu___is_AES128_GCM(EverCrypt_aead_alg x0);

extern bool EverCrypt_uu___is_AES256_GCM(EverCrypt_aead_alg x0);

extern bool EverCrypt_uu___is_CHACHA20_POLY1305(EverCrypt_aead_alg x0);

extern bool EverCrypt_uu___is_AES128_CCM(EverCrypt_aead_alg x0);

extern bool EverCrypt_uu___is_AES256_CCM(EverCrypt_aead_alg x0);

extern bool EverCrypt_uu___is_AES128_CCM8(EverCrypt_aead_alg x0);

extern bool EverCrypt_uu___is_AES256_CCM8(EverCrypt_aead_alg x0);

extern uint32_t EverCrypt_aead_keyLen(EverCrypt_aead_alg x0);

extern uint32_t EverCrypt_aead_tagLen(EverCrypt_aead_alg x0);

extern uint32_t EverCrypt_aead_ivLen(EverCrypt_aead_alg x0);
...
extern EverCrypt__aead_state *EverCrypt_aead_create(EverCrypt_aead_alg x0, uint8_t *x1);

extern void
EverCrypt_aead_encrypt(
  EverCrypt__aead_state *x0,
  uint8_t *x1,
  uint8_t *x2,
  uint32_t x3,
  uint8_t *x4,
...
extern void EverCrypt_aead_free(EverCrypt__aead_state *x0);
...
extern void EverCrypt_dh_free_group(EverCrypt__dh_state *x0);

extern uint32_t EverCrypt_dh_keygen(EverCrypt__dh_state *x0, uint8_t *x1);

extern uint32_t
EverCrypt_dh_compute(EverCrypt__dh_state *x0, uint8_t *x1, uint32_t x2, uint8_t *x3);
...
extern bool EverCrypt_uu___is_ECC_P256(EverCrypt_ec_curve x0);

extern bool EverCrypt_uu___is_ECC_P384(EverCrypt_ec_curve x0);

extern bool EverCrypt_uu___is_ECC_P521(EverCrypt_ec_curve x0);

extern bool EverCrypt_uu___is_ECC_X25519(EverCrypt_ec_curve x0);

extern bool EverCrypt_uu___is_ECC_X448(EverCrypt_ec_curve x0);
...
extern EverCrypt__ecdh_state *EverCrypt_ecdh_load_curve(EverCrypt_ec_curve x0);

extern void EverCrypt_ecdh_free_curve(EverCrypt__ecdh_state *x0);

extern void EverCrypt_ecdh_keygen(EverCrypt__ecdh_state *x0, uint8_t *x1, uint8_t *x2);

extern uint32_t
EverCrypt_ecdh_compute(EverCrypt__ecdh_state *x0, uint8_t *x1, uint8_t *x2, uint8_t *x3);
...
typedef Spec_Hash_Definitions_hash_alg EverCrypt_HMAC_ha;

extern void
EverCrypt_HMAC_compute_sha1(uint8_t *x0, uint8_t *x1, uint32_t x2, uint8_t *x3, uint32_t x4);
...
extern C_String_t EverCrypt_Hash_string_of_alg(Spec_Hash_Definitions_hash_alg x0);
...
extern uint32_t EverCrypt_Hash_tagLen(Spec_Hash_Definitions_hash_alg x0);

extern uint32_t EverCrypt_Hash_blockLen(Spec_Hash_Definitions_hash_alg x0);
...
extern bool
EverCrypt_Hash_uu___is_MD5_s(Spec_Hash_Definitions_hash_alg x0, EverCrypt_Hash_state_s x1);

extern uint32_t
*EverCrypt_Hash___proj__MD5_s__item__p(
  Spec_Hash_Definitions_hash_alg x0,
  EverCrypt_Hash_state_s x1
);

extern bool
EverCrypt_Hash_uu___is_SHA1_s(Spec_Hash_Definitions_hash_alg x0, EverCrypt_Hash_state_s x1);
...
extern bool
EverCrypt_Hash_uu___is_SHA2_224_s(Spec_Hash_Definitions_hash_alg x0, EverCrypt_Hash_state_s x1);
...
extern bool
EverCrypt_Hash_uu___is_SHA2_256_s(Spec_Hash_Definitions_hash_alg x0, EverCrypt_Hash_state_s x1);
...
extern bool
EverCrypt_Hash_uu___is_SHA2_384_s(Spec_Hash_Definitions_hash_alg x0, EverCrypt_Hash_state_s x1);
...
extern bool
EverCrypt_Hash_uu___is_SHA2_512_s(Spec_Hash_Definitions_hash_alg x0, EverCrypt_Hash_state_s x1);
...
extern EverCrypt_Hash_state_s *EverCrypt_Hash_create_in(Spec_Hash_Definitions_hash_alg x0);

extern EverCrypt_Hash_state_s *EverCrypt_Hash_create(Spec_Hash_Definitions_hash_alg x0);
...
extern void EverCrypt_Hash_update_multi(EverCrypt_Hash_state_s *x0, uint8_t *x1, uint32_t x2);

extern void EverCrypt_Hash_update_last(EverCrypt_Hash_state_s *x0, uint8_t *x1, uint64_t x2);

extern void EverCrypt_Hash_finish(EverCrypt_Hash_state_s *x0, uint8_t *x1);

extern void EverCrypt_Hash_free(EverCrypt_Hash_state_s *x0);

extern void EverCrypt_Hash_copy(EverCrypt_Hash_state_s *x0, EverCrypt_Hash_state_s *x1);

extern void
EverCrypt_Hash_hash(Spec_Hash_Definitions_hash_alg x0, uint8_t *x1, uint8_t *x2, uint32_t x3);
...
EverCrypt_Hash_Incremental_uu___is_State(
  Spec_Hash_Definitions_hash_alg x0,
  EverCrypt_Hash_Incremental_state x1
);
...
extern EverCrypt_Hash_Incremental_state
EverCrypt_Hash_Incremental_create_in(Spec_Hash_Definitions_hash_alg x0);
...
extern void EverCrypt_Poly1305_poly1305(uint8_t *x0, uint8_t *x1, uint32_t x2, uint8_t *x3);
...
extern void EverCrypt_Curve25519_secret_to_public(uint8_t *x0, uint8_t *x1);

extern void EverCrypt_Curve25519_ecdh(uint8_t *x0, uint8_t *x1, uint8_t *x2);
