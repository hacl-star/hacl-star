...
#include "EverCrypt_Hash_Incremental.h"
  ...
  return
    (
      (EverCrypt_Hash_Incremental_state){
        ...
        .buf = buf1,
        .total_len = total_len + (uint64_t)len1
      }
    );
}
...
EverCrypt_Hash_Incremental_finish_md5(EverCrypt_Hash_Incremental_state s, uint8_t *dst)
{
  ...
  uint8_t *buf_1 = buf_;
  uint32_t buf[4U] = { 0U };
  EverCrypt_Hash_state_s s1 = { .tag = EverCrypt_Hash_MD5_s, { .case_MD5_s = buf } };
...
EverCrypt_Hash_Incremental_finish_sha1(EverCrypt_Hash_Incremental_state s, uint8_t *dst)
{
  ...
  uint8_t *buf_1 = buf_;
  uint32_t buf[5U] = { 0U };
  EverCrypt_Hash_state_s s1 = { .tag = EverCrypt_Hash_SHA1_s, { .case_SHA1_s = buf } };
  EverCrypt_Hash_state_s tmp_hash_state = s1;
  EverCrypt_Hash_copy(hash_state, &tmp_hash_state);
  EverCrypt_Hash_update_last(&tmp_hash_state, buf_1, total_len);
  EverCrypt_Hash_finish(&tmp_hash_state, dst);
...
EverCrypt_Hash_Incremental_finish_sha224(EverCrypt_Hash_Incremental_state s, uint8_t *dst)
{
  ...
  uint8_t *buf_1 = buf_;
  uint32_t buf[8U] = { 0U };
  EverCrypt_Hash_state_s s1 = { .tag = EverCrypt_Hash_SHA2_224_s, { .case_SHA2_224_s = buf } };
  EverCrypt_Hash_state_s tmp_hash_state = s1;
  EverCrypt_Hash_copy(hash_state, &tmp_hash_state);
  EverCrypt_Hash_update_last(&tmp_hash_state, buf_1, total_len);
  EverCrypt_Hash_finish(&tmp_hash_state, dst);
...
EverCrypt_Hash_Incremental_finish_sha256(EverCrypt_Hash_Incremental_state s, uint8_t *dst)
{
  ...
  uint8_t *buf_1 = buf_;
  uint32_t buf[8U] = { 0U };
  EverCrypt_Hash_state_s s1 = { .tag = EverCrypt_Hash_SHA2_256_s, { .case_SHA2_256_s = buf } };
  EverCrypt_Hash_state_s tmp_hash_state = s1;
  EverCrypt_Hash_copy(hash_state, &tmp_hash_state);
  EverCrypt_Hash_update_last(&tmp_hash_state, buf_1, total_len);
  EverCrypt_Hash_finish(&tmp_hash_state, dst);
...
EverCrypt_Hash_Incremental_finish_sha384(EverCrypt_Hash_Incremental_state s, uint8_t *dst)
{
  ...
  uint8_t *buf_1 = buf_;
  uint64_t buf[8U] = { 0U };
  EverCrypt_Hash_state_s s1 = { .tag = EverCrypt_Hash_SHA2_384_s, { .case_SHA2_384_s = buf } };
  EverCrypt_Hash_state_s tmp_hash_state = s1;
  EverCrypt_Hash_copy(hash_state, &tmp_hash_state);
  EverCrypt_Hash_update_last(&tmp_hash_state, buf_1, total_len);
  EverCrypt_Hash_finish(&tmp_hash_state, dst);
...
EverCrypt_Hash_Incremental_finish_sha512(EverCrypt_Hash_Incremental_state s, uint8_t *dst)
{
  ...
  uint8_t *buf_1 = buf_;
  uint64_t buf[8U] = { 0U };
  EverCrypt_Hash_state_s s1 = { .tag = EverCrypt_Hash_SHA2_512_s, { .case_SHA2_512_s = buf } };
  EverCrypt_Hash_state_s tmp_hash_state = s1;
  EverCrypt_Hash_copy(hash_state, &tmp_hash_state);
  EverCrypt_Hash_update_last(&tmp_hash_state, buf_1, total_len);
  EverCrypt_Hash_finish(&tmp_hash_state, dst);
