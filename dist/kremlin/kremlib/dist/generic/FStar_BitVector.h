...
extern Prims_list__bool *FStar_BitVector_zero_vec(Prims_pos x0);

extern Prims_list__bool *FStar_BitVector_elem_vec(Prims_pos x0, Prims_int x1);

extern Prims_list__bool *FStar_BitVector_ones_vec(Prims_pos x0);

extern Prims_list__bool
*FStar_BitVector_logand_vec(Prims_pos x0, Prims_list__bool *x1, Prims_list__bool *x2);

extern Prims_list__bool
*FStar_BitVector_logxor_vec(Prims_pos x0, Prims_list__bool *x1, Prims_list__bool *x2);

extern Prims_list__bool
*FStar_BitVector_logor_vec(Prims_pos x0, Prims_list__bool *x1, Prims_list__bool *x2);

extern Prims_list__bool *FStar_BitVector_lognot_vec(Prims_pos x0, Prims_list__bool *x1);

extern Prims_list__bool
*FStar_BitVector_shift_left_vec(Prims_pos x0, Prims_list__bool *x1, Prims_int x2);

extern Prims_list__bool
*FStar_BitVector_shift_right_vec(Prims_pos x0, Prims_list__bool *x1, Prims_int x2);
