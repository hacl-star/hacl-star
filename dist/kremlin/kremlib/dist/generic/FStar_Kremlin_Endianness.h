...
extern Prims_int FStar_Kremlin_Endianness_le_to_n(Prims_list__uint8_t *x0);

extern Prims_int FStar_Kremlin_Endianness_be_to_n(Prims_list__uint8_t *x0);

extern Prims_list__uint8_t *FStar_Kremlin_Endianness_n_to_le(uint32_t x0, Prims_int x1);

extern Prims_list__uint8_t *FStar_Kremlin_Endianness_n_to_be(uint32_t x0, Prims_int x1);

extern uint32_t FStar_Kremlin_Endianness_uint32_of_le(Prims_list__uint8_t *x0);

extern Prims_list__uint8_t *FStar_Kremlin_Endianness_le_of_uint32(uint32_t x0);

extern uint32_t FStar_Kremlin_Endianness_uint32_of_be(Prims_list__uint8_t *x0);

extern Prims_list__uint8_t *FStar_Kremlin_Endianness_be_of_uint32(uint32_t x0);

extern uint64_t FStar_Kremlin_Endianness_uint64_of_le(Prims_list__uint8_t *x0);

extern Prims_list__uint8_t *FStar_Kremlin_Endianness_le_of_uint64(uint64_t x0);

extern uint64_t FStar_Kremlin_Endianness_uint64_of_be(Prims_list__uint8_t *x0);

extern Prims_list__uint8_t *FStar_Kremlin_Endianness_be_of_uint64(uint64_t x0);
...
*FStar_Kremlin_Endianness_seq_uint32_of_le(Prims_int x0, Prims_list__uint8_t *x1);

extern Prims_list__uint8_t
*FStar_Kremlin_Endianness_le_of_seq_uint32(Prims_list__uint32_t *x0);

extern Prims_list__uint32_t
*FStar_Kremlin_Endianness_seq_uint32_of_be(Prims_int x0, Prims_list__uint8_t *x1);

extern Prims_list__uint8_t
*FStar_Kremlin_Endianness_be_of_seq_uint32(Prims_list__uint32_t *x0);
...
*FStar_Kremlin_Endianness_seq_uint64_of_le(Prims_int x0, Prims_list__uint8_t *x1);

extern Prims_list__uint8_t
*FStar_Kremlin_Endianness_le_of_seq_uint64(Prims_list__uint64_t *x0);

extern Prims_list__uint64_t
*FStar_Kremlin_Endianness_seq_uint64_of_be(Prims_int x0, Prims_list__uint8_t *x1);

extern Prims_list__uint8_t
*FStar_Kremlin_Endianness_be_of_seq_uint64(Prims_list__uint64_t *x0);
