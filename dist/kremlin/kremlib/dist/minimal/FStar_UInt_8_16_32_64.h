...
extern Prims_string FStar_UInt64_to_string(uint64_t uu____885);

extern Prims_string FStar_UInt64_to_string_hex(uint64_t uu____896);

extern Prims_string FStar_UInt64_to_string_hex_pad(uint64_t uu____907);

extern uint64_t FStar_UInt64_of_string(Prims_string uu____918);
...
extern Prims_string FStar_UInt32_to_string(uint32_t uu____885);

extern Prims_string FStar_UInt32_to_string_hex(uint32_t uu____896);

extern Prims_string FStar_UInt32_to_string_hex_pad(uint32_t uu____907);

extern uint32_t FStar_UInt32_of_string(Prims_string uu____918);
...
extern Prims_string FStar_UInt16_to_string(uint16_t uu____885);

extern Prims_string FStar_UInt16_to_string_hex(uint16_t uu____896);

extern Prims_string FStar_UInt16_to_string_hex_pad(uint16_t uu____907);

extern uint16_t FStar_UInt16_of_string(Prims_string uu____918);
...
extern Prims_string FStar_UInt8_to_string(uint8_t uu____885);

extern Prims_string FStar_UInt8_to_string_hex(uint8_t uu____896);

extern Prims_string FStar_UInt8_to_string_hex_pad(uint8_t uu____907);

extern uint8_t FStar_UInt8_of_string(Prims_string uu____918);
