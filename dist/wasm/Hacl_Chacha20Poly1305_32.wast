(module
  ...
  (type $156 (func (param i32 i32 i32) (result i32)))
  (type $157 (func (param i32 i32 i32 i32 i32 i32) (result i32)))
  (type $158 (func (param i32 i32 i32 i32 i32 i32 i32 i32) (result i32)))
  (type $159 (func (param i32 i32 i32 i32 i32 i32 i32 i32) (result i32)))
  ...
  (func $157
    ...
    (if
      (result i32)
      (then (local.get 12) (local.get 1) (local.get 2) (call 156))
      (else (i32.const -559_038_737))
    )
    (drop)
    (local.get 3)
    ...
    (if
      (result i32)
      (then (local.get 12) (local.get 3) (local.get 4) (call 156))
      (else (i32.const -559_038_737))
    )
    (drop)
    (local.get 15)
  ...
  (export "Hacl_Chacha20Poly1305_32_aead_encrypt" (func 158))
  (export "Hacl_Chacha20Poly1305_32_aead_decrypt" (func 159))
