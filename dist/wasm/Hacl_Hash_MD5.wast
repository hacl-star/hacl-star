(module
  ...
  (export "Hacl_Hash_MD5_legacy_update_multi" (func 37))
  (export "Hacl_Hash_MD5_legacy_update_last" (func 38))
  (export "Hacl_Hash_MD5_legacy_hash" (func 39))
  (export "Hacl_Hash_Core_MD5___get__h0" (func 40))
  ...
  (data
    ...
    "\53\f7\35\f2\3a\bd\bb\d2\d7\2a\91\d3\86\eb\00"
  )
)
