(module
  ...
  (func $113
    ...
    (if
      ...
      (else (get_local 1) (get_local 2) (get_local 14) (call 16))
    )
    (drop)
    (get_local 9)
    (set_local 18)
          ...
          (loop
            ...
            (if
              (then
                ...
                (if
                  (result i32)
                  (then (i32.const 1518500249) (set_local 60) (i32.const 0))
                  (else
                    (get_local 52)
                    (i32.const 40)
                    (i32.lt_u)
                    (if
                      (result i32)
                      (then (i32.const 1859775393) (set_local 60) (i32.const 0))
                      (else
                        (get_local 52)
                        (i32.const 60)
                        (i32.lt_u)
          ...
          (loop
            ...
            (if
              (then
                ...
                (if
                  (result i32)
                  (then (i32.const 1518500249) (set_local 100) (i32.const 0))
                  (else
                    (get_local 92)
                    (i32.const 40)
                    (i32.lt_u)
  ...
  (func $114
    ...
    (if
      ...
      (else (get_local 1) (get_local 2) (get_local 14) (call 30))
    )
    (drop)
    (get_local 9)
    (set_local 18)
  ...
  (func $115
    ...
    (if
      ...
      (else (get_local 1) (get_local 2) (get_local 14) (call 31))
    )
    (drop)
    (get_local 9)
    (set_local 18)
  ...
  (func $116
    ...
    (if
      ...
      (else (get_local 1) (get_local 2) (get_local 14) (call 32))
    )
    (drop)
    (get_local 9)
    (set_local 18)
  ...
  (export "Hacl_HMAC_legacy_compute_sha1" (func 113))
  (export "Hacl_HMAC_compute_sha2_256" (func 114))
  (export "Hacl_HMAC_compute_sha2_384" (func 115))
  (export "Hacl_HMAC_compute_sha2_512" (func 116))
