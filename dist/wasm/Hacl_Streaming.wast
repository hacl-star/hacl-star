(module
      ...
      (else
        ...
        (if
          ...
          (then
            ...
            (if
              (result i32)
              (then (local.get 24) (local.get 25) (i32.const 1) (call 47))
          ...
          (else
            ...
            (if
              (result i32)
              (then (local.get 58) (local.get 59) (i32.const 1) (call 47))
              (else (i32.const -559_038_737))
            )
            (drop)
            (local.get 2)
  ...
  (export "Hacl_Streaming_SHA2_update_512" (func 91))
  (export "Hacl_Streaming_SHA2_finish_512" (func 92))
