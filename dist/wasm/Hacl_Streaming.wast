(module
  ...
  (func $121
    ...
    (if
      (result i32)
      (then (i32.const 128) (local.set 9) (i32.const 0))
      (else
        (local.get 8)
        (i32.const 128)
        (i64.extend_i32_u)
    ...
    (if
      ...
      (then
        ...
        (if
          (result i32)
          (then (i32.const 128) (local.set 14) (i32.const 0))
          (else
            (local.get 13)
            (i32.const 128)
            (i64.extend_i32_u)
      ...
      (else
        ...
        (if
          ...
          (then
            ...
            (if
              (result i32)
              (then (i32.const 128) (local.set 27) (i32.const 0))
              (else
                (local.get 26)
                (i32.const 128)
                (i64.extend_i32_u)
            ...
            (if
              (result i32)
              (then (local.get 24) (local.get 25) (i32.const 1) (call 48))
            ...
            (if
              (result i32)
              (then (i32.const 128) (local.set 28) (i32.const 0))
              (else
                (local.get 2)
                (i64.extend_i32_u)
                (i32.const 128)
          ...
          (else
            ...
            (if
              (result i32)
              (then (i32.const 128) (local.set 48) (i32.const 0))
              (else
                (local.get 47)
                (i32.const 128)
                (i64.extend_i32_u)
            ...
            (if
              (result i32)
              (then (i32.const 128) (local.set 61) (i32.const 0))
              (else
                (local.get 60)
                (i32.const 128)
                (i64.extend_i32_u)
            ...
            (if
              (result i32)
              (then (local.get 58) (local.get 59) (i32.const 1) (call 48))
              (else (i32.const -559_038_737))
            )
            (drop)
            (local.get 2)
            ...
            (if
              (result i32)
              (then (i32.const 128) (local.set 62) (i32.const 0))
              (else
                (local.get 2)
                (local.get 41)
                (i32.sub)
  ...
  (func $122
    ...
    (if
      (result i32)
      (then (i32.const 128) (local.set 10) (i32.const 0))
      (else
        (local.get 9)
        (i32.const 128)
        (i64.extend_i32_u)
    ...
    (if
      (result i32)
      (then (i32.const 128) (local.set 18) (i32.const 0))
      (else
        (local.get 10)
        (i32.const 128)
        (i32.rem_u)
  ...
  (export "Hacl_Streaming_SHA2_update_512" (func 121))
  (export "Hacl_Streaming_SHA2_finish_512" (func 122))
