(module
  ...
  (func $162
    ...
    (if
      (result i32)
      (then (i32.const 1) (local.set 32) (i32.const 0))
      (else (i32.const 0) (local.set 32) (i32.const 0))
    )
    (drop)
    (local.get 32)
    (local.set 33)
  ...
  (func $163
    ...
    (if
      (result i32)
      (then (i32.const 1) (local.set 34) (i32.const 0))
      (else (i32.const 0) (local.set 34) (i32.const 0))
    )
    (drop)
    (local.get 34)
    (local.set 35)
  ...
  (export "Hacl_HPKE_Curve51_CP32_SHA512_setupBaseI" (func 162))
  (export "Hacl_HPKE_Curve51_CP32_SHA512_setupBaseR" (func 163))
  (export "Hacl_HPKE_Curve51_CP32_SHA512_sealBase" (func 164))
  (export "Hacl_HPKE_Curve51_CP32_SHA512_openBase" (func 165))
