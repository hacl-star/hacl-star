...
static uint8_t test1_plaintext[0U] = { (uint32_t)0U };
...
static uint8_t test5_plaintext_shake128[0U] = { (uint32_t)0U };
...
static uint8_t test9_plaintext_shake256[0U] = { (uint32_t)0U };
