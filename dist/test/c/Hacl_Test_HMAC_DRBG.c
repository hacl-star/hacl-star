    ...
    case SHA1:
      {
        ...
        legacy_compute_sha1(k_, k1, (uint32_t)20U, input0, input_len);
        legacy_compute_sha1(v1, k_, (uint32_t)20U, v1, (uint32_t)20U);
        ...
        if (entropy_input_len + nonce_len + personalization_string_len != (uint32_t)0U)
        {
          ...
          legacy_compute_sha1(k_0, k1, (uint32_t)20U, input, input_len0);
          legacy_compute_sha1(v1, k_0, (uint32_t)20U, v1, (uint32_t)20U);
    ...
    case SHA2_256:
      {
        ...
        compute_sha2_256(k_, k1, (uint32_t)32U, input0, input_len);
        compute_sha2_256(v1, k_, (uint32_t)32U, v1, (uint32_t)32U);
        ...
        if (entropy_input_len + nonce_len + personalization_string_len != (uint32_t)0U)
        {
          ...
          compute_sha2_256(k_0, k1, (uint32_t)32U, input, input_len0);
          compute_sha2_256(v1, k_0, (uint32_t)32U, v1, (uint32_t)32U);
    ...
    case SHA2_384:
      {
        ...
        compute_sha2_384(k_, k1, (uint32_t)48U, input0, input_len);
        compute_sha2_384(v1, k_, (uint32_t)48U, v1, (uint32_t)48U);
        ...
        if (entropy_input_len + nonce_len + personalization_string_len != (uint32_t)0U)
        {
          ...
          compute_sha2_384(k_0, k1, (uint32_t)48U, input, input_len0);
          compute_sha2_384(v1, k_0, (uint32_t)48U, v1, (uint32_t)48U);
    ...
    case SHA2_512:
      {
        ...
        compute_sha2_512(k_, k1, (uint32_t)64U, input0, input_len);
        compute_sha2_512(v1, k_, (uint32_t)64U, v1, (uint32_t)64U);
        ...
        if (entropy_input_len + nonce_len + personalization_string_len != (uint32_t)0U)
        {
          ...
          compute_sha2_512(k_0, k1, (uint32_t)64U, input, input_len0);
          compute_sha2_512(v1, k_0, (uint32_t)64U, v1, (uint32_t)64U);
    ...
    case SHA1:
      {
        ...
        else
        {
          ...
          {
            legacy_compute_sha1(v1, k1, (uint32_t)20U, v1, (uint32_t)20U);
    ...
    case SHA2_256:
      {
        ...
        else
        {
          ...
          for (uint32_t i = (uint32_t)0U; i < max1; i++)
          {
            compute_sha2_256(v1, k1, (uint32_t)32U, v1, (uint32_t)32U);
    ...
    case SHA2_384:
      {
        ...
        else
        {
          ...
          for (uint32_t i = (uint32_t)0U; i < max1; i++)
          {
            compute_sha2_384(v1, k1, (uint32_t)48U, v1, (uint32_t)48U);
    ...
    case SHA2_512:
      {
        ...
        else
        {
          ...
          for (uint32_t i = (uint32_t)0U; i < max1; i++)
          {
            compute_sha2_512(v1, k1, (uint32_t)64U, v1, (uint32_t)64U);
...
)
{
  ...
  else
  {
    ...
    state st = { .k = k1, .v = v1, .reseed_counter = &ctr };
    instantiate(a,
      st,
      entropy_input_len,
      entropy_input,
