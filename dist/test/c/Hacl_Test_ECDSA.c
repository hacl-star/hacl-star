...
typedef uint8_t hash_alg_ecdsa_tags;

typedef struct hash_alg_ecdsa_s
{
  hash_alg_ecdsa_tags tag;
  hash_alg _0;
}
hash_alg_ecdsa;

extern void Hacl_Impl_P256_LowLevel_toUint8(uint64_t *i, uint8_t *o);

extern void Hacl_Impl_P256_LowLevel_changeEndian(uint64_t *i);

extern void Hacl_Impl_P256_LowLevel_toUint64ChangeEndian(uint8_t *i, uint64_t *o);
...
extern void Hacl_Impl_P256_Core_norm(uint64_t *p, uint64_t *resultPoint, uint64_t *tempBuffer);
...
extern void Hacl_Impl_P256_Signature_Common_bufferToJac(uint64_t *p, uint64_t *result);

/*
  This code is not side channel resistant
*/
extern bool Hacl_Impl_P256_Signature_Common_isPointAtInfinityPublic(uint64_t *p);
...
extern void Hacl_Impl_ECDSA_MM_Exponent_montgomery_ladder_exponent(uint64_t *r);

extern void Hacl_Impl_ECDSA_MM_Exponent_fromDomainImpl(uint64_t *a, uint64_t *result);
...
static uint64_t
ecdsa_sign_p256_sha2(uint8_t *result, uint32_t mLen, uint8_t *m, uint8_t *privKey, uint8_t *k)
{
  ...
  flag =
    Hacl_Impl_ECDSA_P256_Signature_Agile_ecdsa_signature_core((
        (hash_alg_ecdsa){ .tag = Hash, ._0 = SHA2_256 }
      ),
      r,
      s,
      mLen,
...
)
{
  ...
  flag =
    Hacl_Impl_ECDSA_P256_Signature_Agile_ecdsa_signature_core((
        (hash_alg_ecdsa){ .tag = Hash, ._0 = SHA2_384 }
      ),
      r,
      s,
      mLen,
...
)
{
  ...
  flag =
    Hacl_Impl_ECDSA_P256_Signature_Agile_ecdsa_signature_core((
        (hash_alg_ecdsa){ .tag = Hash, ._0 = SHA2_512 }
      ),
      r,
      s,
      mLen,
...
*/
static bool
ecdsa_verif_p256_sha2(uint32_t mLen, uint8_t *m, uint8_t *pubKey, uint8_t *r, uint8_t *s)
{
...
*/
static bool
ecdsa_verif_p256_sha384(uint32_t mLen, uint8_t *m, uint8_t *pubKey, uint8_t *r, uint8_t *s)
{
  uint64_t publicKeyAsFelem[8U] = { 0U };
  uint64_t *publicKeyFelemX = publicKeyAsFelem;
  uint64_t *publicKeyFelemY = publicKeyAsFelem + (uint32_t)4U;
...
*/
static bool
ecdsa_verif_p256_sha512(uint32_t mLen, uint8_t *m, uint8_t *pubKey, uint8_t *r, uint8_t *s)
{
  uint64_t publicKeyAsFelem[8U] = { 0U };
  uint64_t *publicKeyFelemX = publicKeyAsFelem;
  uint64_t *publicKeyFelemY = publicKeyAsFelem + (uint32_t)4U;
...
)
{
  ...
  else
  {
    ...
    bool result_ = ecdsa_verif_p256_sha2(msg_len, msg, qxy, r, s);
    if (!(result_ == result))
    {
      LowStar_Printf_print_string("FAIL\n");
      exit((int32_t)1);
...
)
{
  ...
  else
  {
    ...
    memcpy(qxy, qx, (uint32_t)32U * sizeof (qx[0U]));
    memcpy(qxy + (uint32_t)32U, qy, (uint32_t)32U * sizeof (qy[0U]));
    bool result_ = ecdsa_verif_p256_sha384(msg_len, msg, qxy, r, s);
    if (!(result_ == result))
    {
      LowStar_Printf_print_string("FAIL\n");
      exit((int32_t)1);
...
)
{
  ...
  else
  {
    ...
    memcpy(qxy, qx, (uint32_t)32U * sizeof (qx[0U]));
    memcpy(qxy + (uint32_t)32U, qy, (uint32_t)32U * sizeof (qy[0U]));
    bool result_ = ecdsa_verif_p256_sha512(msg_len, msg, qxy, r, s);
    if (!(result_ == result))
    {
      LowStar_Printf_print_string("FAIL\n");
      exit((int32_t)1);
...
)
{
  ...
  else
  {
    ...
    memcpy(qxy, qx, (uint32_t)32U * sizeof (qx[0U]));
    memcpy(qxy + (uint32_t)32U, qy, (uint32_t)32U * sizeof (qy[0U]));
    uint64_t flag = ecdsa_sign_p256_sha2(rs, msg_len, msg, d, k);
    if (flag == (uint64_t)0U)
    {
      ...
      if (okr && oks)
      {
        bool result = ecdsa_verif_p256_sha2(msg_len, msg, qxy, r, s);
        if (!result)
        {
...
)
{
  ...
  else
  {
    ...
    memcpy(qxy, qx, (uint32_t)32U * sizeof (qx[0U]));
    memcpy(qxy + (uint32_t)32U, qy, (uint32_t)32U * sizeof (qy[0U]));
    uint64_t flag = ecdsa_sign_p256_sha384(rs, msg_len, msg, d, k);
    if (flag == (uint64_t)0U)
    {
      bool okr = compare_and_print(rs, r, (uint32_t)32U);
      bool oks = compare_and_print(rs + (uint32_t)32U, s, (uint32_t)32U);
      if (okr && oks)
      {
        bool result = ecdsa_verif_p256_sha384(msg_len, msg, qxy, r, s);
        if (!result)
        {
          LowStar_Printf_print_string("FAIL: verification\n");
          exit((int32_t)1);
...
)
{
  ...
  else
  {
    ...
    memcpy(qxy, qx, (uint32_t)32U * sizeof (qx[0U]));
    memcpy(qxy + (uint32_t)32U, qy, (uint32_t)32U * sizeof (qy[0U]));
    uint64_t flag = ecdsa_sign_p256_sha512(rs, msg_len, msg, d, k);
    if (flag == (uint64_t)0U)
    {
      bool okr = compare_and_print(rs, r, (uint32_t)32U);
      bool oks = compare_and_print(rs + (uint32_t)32U, s, (uint32_t)32U);
      if (okr && oks)
      {
        bool result = ecdsa_verif_p256_sha512(msg_len, msg, qxy, r, s);
        if (!result)
        {
          LowStar_Printf_print_string("FAIL: verification\n");
          exit((int32_t)1);
