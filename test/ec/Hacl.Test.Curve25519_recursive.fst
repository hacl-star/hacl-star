module Hacl.Test.Curve25519_recursive
...
let main () =
  ...
  Hacl.EC.Curve25519_recursive.crypto_scalarmult_curve25519_donna_c64 result scalar1 input1;
  let curve25519 = createL [0y] in
  TestLib.compare_and_print curve25519 expected1 result keysize;
  Hacl.EC.Curve25519_recursive.crypto_scalarmult_curve25519_donna_c64 result scalar2 input2;
