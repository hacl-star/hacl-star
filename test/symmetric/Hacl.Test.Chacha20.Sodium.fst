module Hacl.Test.Chacha20.Sodium
...
let main () =
  ...
  Hacl.Symmetric.Chacha20.Sodium.chacha_keysetup ctx key;
  Hacl.Symmetric.Chacha20.Sodium.chacha_ietf_ivsetup ctx nonce counter;
  Hacl.Symmetric.Chacha20.Sodium.chacha_encrypt_bytes ctx plaintext ciphertext len;
