...
let test_aes_gcm_7 () =
  ...
  let cipher = Buffer.createL [ 
    ...
    0x2cuy; 0xf3uy; 0x5auy; 0xbduy; 0x2buy; 0xa6uy; 0xfauy; 0xb4uy ] in
  assume(Buffer.length cipher = v (plainlen +^ 16ul));
  test_aes_gcm i 3ul k iv aadlen aad plainlen plain cipher 
...
let main () =
  ...
  let _ = test_aes_gcm_5 () in
  let _ = test_aes_gcm_6 () in
  let _ = test_aes_gcm_7 () in
  let _ = test_aes_gcm_8 () in
  C.exit_success
