...
let finalize b =
  ...
  let mask4 = H64.eq_mask b4 mask_26 in
  let mask3 = H64.eq_mask b3 mask_26 in
  let mask2 = H64.eq_mask b2 mask_26 in
  let mask1 = H64.eq_mask b1 mask_26 in
  let mask0 = H64.gte_mask b0 mask2_26m5 in
