...
static uint64_t Hacl_EC_Format_load64_le(const uint8_t *b)
{
  uint8_t b0 = b[0];
  uint8_t b1 = b[1];
  uint8_t b2 = b[2];
...
static void Hacl_EC_Format_fexpand(uint64_t *output, const uint8_t *input)
{
...
)
{
  ...
  x[3] = a30 + b30;
  x[4] = a40 + b40;
  /* start inlining Hacl.Bignum.fsum */
  /* start inlining Hacl.Bignum.Fsum.fsum_ */
  /* end inlining Hacl.Bignum.Fsum.fsum_ */
  /* end inlining Hacl.Bignum.fsum */
  Hacl_Bignum_fdifference(z, origx0);
  memcpy(origxprime, xprime, (uint32_t )5 * sizeof xprime[0]);
  uint64_t a01 = xprime[0];
  uint64_t b01 = zprime[0];
  uint64_t a11 = xprime[1];
  uint64_t b11 = zprime[1];
  uint64_t a21 = xprime[2];
  uint64_t b21 = zprime[2];
  uint64_t a31 = xprime[3];
  uint64_t b31 = zprime[3];
  uint64_t a41 = xprime[4];
  uint64_t b41 = zprime[4];
  xprime[0] = a01 + b01;
  xprime[1] = a11 + b11;
  xprime[2] = a21 + b21;
  xprime[3] = a31 + b31;
  ...
  uint64_t a0 = xxprime2[0];
  uint64_t b02 = zzprime[0];
  uint64_t a12 = xxprime2[1];
  uint64_t b12 = zzprime[1];
  uint64_t a22 = xxprime2[2];
  uint64_t b22 = zzprime[2];
  uint64_t a32 = xxprime2[3];
  uint64_t b32 = zzprime[3];
  uint64_t a42 = xxprime2[4];
  uint64_t b42 = zzprime[4];
  xxprime2[0] = a0 + b02;
  xxprime2[1] = a12 + b12;
  xxprime2[2] = a22 + b22;
  xxprime2[3] = a32 + b32;
...
static void
Hacl_EC_Ladder_cmult_(uint64_t *result, uint64_t *point_buf, const uint8_t *n, uint64_t *q)
{
...
static void Hacl_EC_Ladder_cmult(uint64_t *result, const uint8_t *n, uint64_t *q)
{
...
static void
Hacl_EC_crypto_scalarmult_(uint8_t *mypublic, const uint8_t *secret, const uint8_t *basepoint, uint64_t *q)
{
  uint8_t e[32] = { 0 };
...
void Hacl_EC_crypto_scalarmult(uint8_t *mypublic, const uint8_t *secret, const uint8_t *basepoint)
{
  uint64_t buf[10] = { 0 };
  uint64_t *x = buf;
