...
in (let _33_503 = ()
in (let _33_506 = ()
in (let _33_508 = (Fscalar.scalar_multiplication_tr tmp a s 0)
...
let lemma_helper_00 = (fun _33_546 -> ())
...
in (let _33_975 = (multiplication_step_0 a b ctr c tmp)
in (let h1 = (FStar_ST.get ())
in (let _33_978 = ()
in (let _33_980 = (FsumWide.fsum_index c ctr tmp 0 Parameters.norm_length 0)
...
in (let _33_1043 = (multiplication_step_p1 a b ctr c tmp)
in (let h1 = (FStar_ST.get ())
in ()))))
...
| _33_1219 -> begin
(let _33_1220 = ()
in (let _33_1222 = (multiplication_step a b (Parameters.norm_length - ctr) c tmp)
in (let h1 = (FStar_ST.get ())
in (let _33_1225 = ()
in (let _33_1227 = (multiplication_aux a b (ctr - 1) c tmp)
in (let h2 = (FStar_ST.get ())
in ()))))))
end)))
...
in (let _33_1355 = ()
in (let _33_1357 = ()
in (let _33_1359 = (multiplication_aux a b Parameters.norm_length c tmp)
in (let h2 = (FStar_ST.get ())
in ()))))))))))
