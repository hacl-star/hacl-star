...
(let i = ctr
in (let _32_157 = ()
in (let _32_159 = (scalar_multiplication_tr_1 res a s ctr)
in (let h1 = (FStar_ST.get ())
in (let _32_162 = ()
in (let _32_164 = (scalar_multiplication_tr res a s (ctr + 1))
...
in (let _32_260 = ()
in (let _32_262 = (scalar_multiplication_tr res a s 0)
in (let h1 = (FStar_ST.get ())
in ())))))
