...
//////////////////////////////////////////////////////////////////
opaque type AbelianGroup (#a:Type) (zero:a) (opp:a -> Tot a) (add:a -> a -> Tot a)  =
...
(*  Field predicate *)
opaque type CommutativeField (#a:Type) (zero:a) (one:a) (opp:a -> Tot a) (add:a -> a -> Tot a) (inv:(e:a{e<>zero}) -> Tot a) (mul:a -> a -> Tot a) = 
...
let rec scalar_multiplication zero opp add n p =
  match n with
  | 0 -> zero
  | _ -> 
    mandatory_lemma n;
