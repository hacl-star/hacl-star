...
val frodo_mul_add_sa_plus_e:
  ...
  -> Stack unit
    ...
    (ensures  fun h0 _ h1 ->
      ...
      as_matrix h1 ep_matrix == S.clear_matrix (as_seq h0 ep_matrix))
[@"c_inline"]
...
val frodo_mul_add_sa_plus_e_main:
  ...
  -> Stack unit
    ...
    (ensures  fun h0 r h1 -> modifies (loc_buffer bp_matrix) h0 h1) ///\
     (* (let ep_matrix_s = Spec.Frodo.Sample.frodo_sample_matrix (v params_nbar) (v params_n) (v crypto_bytes) (as_seq h0 seed_e) (u16 5) in
       let a_matrix_s = Spec.Frodo.Params.frodo_gen_matrix (v params_n) (v bytes_seed_a) (as_seq h0 seed_a) in
       let bp_matrix_s = M.add (M.mul (as_matrix h0 sp_matrix) a_matrix_s) ep_matrix_s in
       assert (v params_nbar * v params_n % 2 = 0);
       let ep_matrix_s = S.clear_matrix ep_matrix_s in
       as_matrix h1 bp_matrix == bp_matrix_s)) *)
...
val frodo_mul_add_sb_plus_e:
  ...
  -> Stack unit
    ...
    (ensures fun h0 _ h1 -> modifies (loc_union (loc_buffer v_matrix) (loc_buffer epp_matrix)) h0 h1 /\
      ...
      as_matrix h1 epp_matrix == S.clear_matrix (as_matrix h0 epp_matrix))
[@"c_inline"]
...
val frodo_mul_add_sb_plus_e_plus_mu:
  ...
  -> Stack unit
    ...
    (ensures fun h0 r h1 -> modifies (loc_buffer v_matrix) h0 h1)
[@"c_inline"]
