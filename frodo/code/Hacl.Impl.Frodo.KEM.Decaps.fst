...
val frodo_sub_mul_c_minus_bs:
  ...
  -> Stack unit
    ...
    (ensures fun h0 r h1 -> modifies (loc_buffer mu_decode) h0 h1)
[@"c_inline"]
...
let get_dec_ss ct kp_s ss =
  ...
  let c12 = sub #uint8 #_ #(v c1Len + v c2Len) ct (size 0) (c1Len +! c2Len) in
  ...
  update_sub ss_init (size 0) (c1Len +! c2Len) c12;
