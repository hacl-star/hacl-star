...
)
{
  ...
  uint8_t state[size_Ti + size_Til + size_T];
...
uint32_t Crypto_HMAC_block_size(Crypto_HMAC_alg uu___58_177)
{
  switch (uu___58_177)
  {
    case Crypto_HMAC_SHA256:
...
uint32_t Crypto_HMAC_hash_size(Crypto_HMAC_alg uu___59_183)
{
  switch (uu___59_183)
  {
    case Crypto_HMAC_SHA256:
...
uint32_t Crypto_HMAC_state_size(Crypto_HMAC_alg uu___60_189)
{
  switch (uu___60_189)
  {
    case Crypto_HMAC_SHA256:
...
uint32_t Crypto_HMAC_counter_pos(Crypto_HMAC_alg uu___62_393)
{
  switch (uu___62_393)
  {
    case Crypto_HMAC_SHA256:
...
uint32_t Crypto_HMAC_counter_size(Crypto_HMAC_alg uu___63_399)
{
  switch (uu___63_399)
  {
    case Crypto_HMAC_SHA256:
...
)
{
  ...
  uint8_t ipad[Crypto_HMAC_block_size(a)];
  for (uint32_t _i = 0U; _i < Crypto_HMAC_block_size(a); ++_i)
    ipad[_i] = (uint8_t)0x36U;
  KRML_CHECK_SIZE(sizeof (uint8_t), Crypto_HMAC_block_size(a));
  uint8_t opad[Crypto_HMAC_block_size(a)];
  for (uint32_t _i = 0U; _i < Crypto_HMAC_block_size(a); ++_i)
...
{
  KRML_CHECK_SIZE(sizeof (uint8_t), Crypto_HMAC_block_size(a));
  uint8_t nkey[Crypto_HMAC_block_size(a)];
  for (uint32_t _i = 0U; _i < Crypto_HMAC_block_size(a); ++_i)
