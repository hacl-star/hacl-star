...
let state_s = F.state_s evercrypt_hash
...
let alg_of_state = F.index_of_state evercrypt_hash
...
let create_in = F.create_in evercrypt_hash

let init = F.init evercrypt_hash
let update i s data len =
  ...
  F.update evercrypt_hash i s data len

/// The wrapper pattern, to ensure that the stack-allocated state is properly
/// monomorphized.
let finish_md5: finish_st MD5 = F.mk_finish evercrypt_hash MD5
let finish_sha1: finish_st SHA1 = F.mk_finish evercrypt_hash SHA1
let finish_sha224: finish_st SHA2_224 = F.mk_finish evercrypt_hash SHA2_224
let finish_sha256: finish_st SHA2_256 = F.mk_finish evercrypt_hash SHA2_256
let finish_sha384: finish_st SHA2_384 = F.mk_finish evercrypt_hash SHA2_384
let finish_sha512: finish_st SHA2_512 = F.mk_finish evercrypt_hash SHA2_512
...
let free = F.free evercrypt_hash
