...
(* Note that those predicates don't check [EverCrypt.TargetConfig.evercrypt_can_compile_128],
 ...
 * [> if EverCrypt.TargetConfig.evercrypt_can_compile_128 && has_vec128 ... then
 * Leading to the following C code:
 * [> #if defined(COMPILE_128)
 * [>   if has_vec128 ... { ... }
 * [> #endif
 * Note that if one forgets to guard the code with flags like
 * [EverCrypt.TargetConfig.evercrypt_can_compile_128], the code will not compile on platforms
