...
dist/linux/Makefile.basic: HPKE_BUNDLE = -bundle 'Hacl.HPKE.*,Hacl.Impl.Generic.*'
...
dist/ccf/Makefile.basic: HPKE_BUNDLE = -bundle 'Hacl.HPKE.*,Hacl.Impl.Generic.*'
...
dist/mozilla/Makefile.basic: HPKE_BUNDLE = -bundle 'Hacl.HPKE.*,Hacl.Impl.Generic.*'
