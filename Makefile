...
dist/wasm/Makefile.basic: P256_BUNDLE = -bundle Hacl.Interface.*,Hacl.Impl.ECDSA.*,Hacl.Hash.SHA2,Hacl.Hash.Core.SHA2,Hacl.Hash.Core.SHA2.Constants,Hacl.Hash.Definitions,Hacl.Impl.SolinasReduction,Hacl.Impl.P256.*[rename=Hacl_P256]
...
dist/ccf/Makefile.basic: P256_BUNDLE = -bundle Hacl.Interface.*,Hacl.Impl.ECDSA.*,Hacl.Hash.SHA2,Hacl.Hash.Core.SHA2,Hacl.Hash.Core.SHA2.Constants,Hacl.Hash.Definitions,Hacl.Impl.SolinasReduction,Hacl.Impl.P256.*[rename=Hacl_P256]
...
dist/mozilla/Makefile.basic: P256_BUNDLE = -bundle Hacl.Interface.*,Hacl.Impl.ECDSA.*,Hacl.Hash.SHA2,Hacl.Hash.Core.SHA2,Hacl.Hash.Core.SHA2.Constants,Hacl.Hash.Definitions,Hacl.Impl.SolinasReduction,Hacl.Impl.P256.*[rename=Hacl_P256]
