...
int main() {
    ...
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input, v->input_len) == 0);
    ...
    Hacl_Streaming_Blake2s_128_blake2s_128_no_key_init(s);
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, NULL, 0) == 0);
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input, 8) == 0);
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+8, 8) == 0);
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+16, 16) == 0);
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+32, 32) == 0);
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+64, 64) == 0);
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+128, 127) == 0);
    Hacl_Streaming_Blake2s_128_blake2s_128_no_key_finish(s, tag);
    ok &= compare_and_print(32, tag, v->expected);
    ...
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+32, 32) == 0);
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+64, 64) == 0);
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+128, v->input_len - 128) == 0);
    Hacl_Streaming_Blake2s_128_blake2s_128_no_key_finish(s, tag);
    ok &= compare_and_print(32, tag, v->expected);
    ...
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+8, 8) == 0);
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+16, 16) == 0);
    assert(Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+32, v->input_len - 32) == 0);
    Hacl_Streaming_Blake2s_128_blake2s_128_no_key_finish(s, tag);
    ok &= compare_and_print(32, tag, v->expected);
