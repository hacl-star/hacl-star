...
int main() {
    ...
    Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+32, 32);
    Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+64, 64);
    Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+128, 127);
    Hacl_Streaming_Blake2s_128_blake2s_128_no_key_finish(s, tag);
    ok &= compare_and_print(32, tag, v->expected);
    ...
    Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+32, 32);
    Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+64, 64);
    Hacl_Streaming_Blake2s_128_blake2s_128_no_key_update(s, v->input+128, v->input_len - 128);
    Hacl_Streaming_Blake2s_128_blake2s_128_no_key_finish(s, tag);
    ok &= compare_and_print(32, tag, v->expected);
