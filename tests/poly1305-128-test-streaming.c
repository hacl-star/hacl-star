...
typedef struct Hacl_Streaming_Poly1305_128_state_t poly1305_state;
...
main()
{
  ...
  poly1305_state* s = Hacl_Streaming_Poly1305_128_malloc(v->key);
  ...
  Hacl_Streaming_Poly1305_128_digest(s, tag);
  ok &= compare_and_print(16, tag, v->tag);

  v++;
  Hacl_Streaming_Poly1305_128_reset(v->key, s);
