...
val game1 : b:bool{b <==> not ae_ind_cpa /\ ~ae_int_ctxt /\ prf_odh}

val game2 : b:bool{b <==> not ae_ind_cca /\ prf_odh}
...
val game3 : b:bool{b <==> b2t ae_ind_cca /\ ~prf_odh /\ pkae} // This should imply that forall ids, honest i = True
