...
private val get: (#id:eqtype) -> (#key_length:(n:nat{n<=32})) -> (#key_type:(id -> Type0)) -> kp:key_package #id key_length key_type -> (i:id -> k:key_type i -> (raw:lbytes key_length{raw = kp.getGT i k}))
...
private val set: (#id:eqtype) -> (#key_length:(n:nat{n<=32})) -> (#key_type:(id -> Type0)) -> kp:key_package #id key_length key_type -> (i:id -> raw:lbytes key_length -> (k:key_type i{raw = kp.getGT i k /\ kp.hon i k = true}))
