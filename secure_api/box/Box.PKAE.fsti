...
val random_bytes: (n:n32) -> unit -> lbytes n
...
val pp : (pp:plain_package{pp.flag == b2t pkae_flag})

// Footpring function instead of rgn in the type
val pkae_package: rgn:erid -> Type
