...
// hashLength would be closer to our naming conventions
// val hash_size: nat
// let hash_size = tagLength ha 

// [tag] is a better name than [hash] for this
val hash_raw: eqtype
let hash_raw = b:bytes{Seq.length b = tagLength ha}

assume val hash2_raw: hash_raw -> hash_raw -> Tot hash_raw
//let hash2_raw src1 src2 =
//  extract (hash0 #ha (S.append src1 src2))
...
// systematically elide merkle_ or mt_ ?
...
// tempting, at least as a private notation? 
...
/// right_padded_merkle_tree, a tree refinement
...
/// 1) they have the same height (`n`) and number of raw hashes (`RP?.i`),
/// 2) their contents differ, and

// removed 3) their roots are valid (HRaw) and same. 
// we may want to work towards removing 1) using a hash prefix
