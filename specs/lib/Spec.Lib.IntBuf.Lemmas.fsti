...
val live_sub_lemma: #a:Type0 -> #len:size_t -> h:mem -> b:lbuffer a len -> start:size_t -> n:size_t{v start + v n <= v len} -> Lemma
			 (requires (live h b))
			 (ensures (live h (sub #a #len #(n) b start n)))
			 [SMTPat (live h (sub #a #len #(n) b start n))]

val live_super_lemma: #a:Type0 -> #len:size_t -> h:mem -> b:lbuffer a len -> start:size_t -> n:size_t{v start + v n <= v len} -> Lemma
			 (requires (live h (sub #a #len #(n) b start n)))
			 (ensures (live h b))
			 [SMTPat (live h (sub #a #len #(n) b start n))]
...
val disjoint_sub_lemma1: #a1:Type0 -> #a2:Type0 -> #len1:size_t -> #len2:size_t -> b1:lbuffer a1 len1 -> b2:lbuffer a2 len2 -> start1:size_t -> n1:size_t{v start1 + v n1 <= v len1} -> Lemma
			 (requires (disjoint b1 b2))
			 (ensures (disjoint (sub #a1 #len1 #(n1) b1 start1 n1) b2 /\ disjoint b2 (sub #a1 #len1 #(n1) b1 start1 n1)))
			 [SMTPatOr[[SMTPat (disjoint (sub #a1 #len1 #(n1) b1 start1 n1) b2)];
				   [SMTPat (disjoint b2 (sub #a1 #len1 #(n1) b1 start1 n1))]]]

val disjoint_sub_lemma2: #a:Type0 -> #len:size_t -> b:lbuffer a len -> start1:size_t -> n1:size_t{v start1 + v n1 <= v len} -> start2:size_t -> n2:size_t{v start2 + v n2 <= v len} -> Lemma
...
val as_lseq_sub_lemma: #a:Type0 -> #len:size_t -> h:mem -> b:lbuffer a len -> start:size_t -> n:size_t{v start + v n <= v len} -> Lemma
			 (requires (live h b))
			 (ensures (as_lseq (sub #a #len #(n) b start n) h == LSeq.sub (as_lseq b h) (v start) (v n)))
...
val disjoint_list_lemma1: #a:Type0 -> #a1:Type0 -> #len:size_t -> #len1:size_t -> b0:lbuffer a len -> b:lbuffer a1 len1 -> Lemma
			(requires (True))
...
val disjoint_lists_lemma_1_1: #a0:Type0 -> #a1:Type0 -> #len0:size_t -> #len1:size_t -> b0:lbuffer a0 len0 -> b1:lbuffer a1 len1 -> Lemma
			(requires (True))
			(ensures (disjoint_lists [BufItem b0] [BufItem b1] == (disjoint b0 b1 /\ disjoint b1 b0) ))
			[SMTPat (disjoint_lists [BufItem b0] [BufItem b1])]

val disjoint_lists_lemma_2_1: #a0:Type0 -> #a1:Type0 -> #a2:Type0 -> #len0:size_t -> #len1:size_t -> #len2:size_t -> b0:lbuffer a0 len0 -> b1:lbuffer a1 len1 -> b2:lbuffer a2 len2 -> Lemma
			(requires (True))
...
val disjoint_lists_lemma_1_2: #a0:Type0 -> #a1:Type0 -> #a2:Type0 -> #len0:size_t -> #len1:size_t -> #len2:size_t -> b0:lbuffer a0 len0 -> b1:lbuffer a1 len1 -> b2:lbuffer a2 len2 -> Lemma
			(requires (True))
			(ensures (disjoint_lists [BufItem b0] [BufItem b1; BufItem b2] == (disjoint b0 b1 /\ disjoint b1 b0 /\ disjoint b0 b2 /\ disjoint b2 b0)))
			[SMTPat (disjoint_lists [BufItem b0] [BufItem b1; BufItem b2])]

val disjoint_lists_lemma_2_2: #a0:Type0 -> #a1:Type0 -> #a2:Type0 -> #a3:Type0 -> #len0:size_t -> #len1:size_t -> #len2:size_t -> #len3:size_t -> b0:lbuffer a0 len0 -> b1:lbuffer a1 len1 -> b2:lbuffer a2 len2 -> b3:lbuffer a3 len3 -> Lemma
			(requires (True))
...
val disjoint_lists_lemma_3_1: #a0:Type0 -> #a1:Type0 -> #a2:Type0 -> #a3:Type0 -> #len0:size_t -> #len1:size_t -> #len2:size_t -> #len3:size_t -> b0:lbuffer a0 len0 -> b1:lbuffer a1 len1 -> b2:lbuffer a2 len2 -> b3:lbuffer a3 len3 -> Lemma
			(requires (True))
...
val disjoint_lists_lemma_1_3: #a0:Type0 -> #a1:Type0 -> #a2:Type0 -> #a3:Type0 -> #len0:size_t -> #len1:size_t -> #len2:size_t -> #len3:size_t -> b0:lbuffer a0 len0 -> b1:lbuffer a1 len1 -> b2:lbuffer a2 len2 -> b3:lbuffer a3 len3 -> Lemma
			(requires (True))
...
val disjoint_lists_lemma_1_4: #a0:Type0 -> #a1:Type0 -> #a2:Type0 -> #a3:Type0 -> #a4:Type0 -> #len0:size_t -> #len1:size_t -> #len2:size_t -> #len3:size_t -> #len4:size_t -> b0:lbuffer a0 len0 -> b1:lbuffer a1 len1 -> b2:lbuffer a2 len2 -> b3:lbuffer a3 len3 -> b4:lbuffer a4 len4 -> Lemma
			(requires (True))
...
val disjoint_lists_lemma_4_1: #a0:Type0 -> #a1:Type0 -> #a2:Type0 -> #a3:Type0 -> #a4:Type0 -> #len0:size_t -> #len1:size_t -> #len2:size_t -> #len3:size_t -> #len4:size_t -> b0:lbuffer a0 len0 -> b1:lbuffer a1 len1 -> b2:lbuffer a2 len2 -> b3:lbuffer a3 len3 -> b4:lbuffer a4 len4 -> Lemma
			(requires (True))
...
val disjoint_lists_lemma_2_4: #a0:Type0 -> #a1:Type0 -> #a2:Type0 -> #a3:Type0 -> #a4:Type0 -> #a5:Type0 -> #len0:size_t -> #len1:size_t -> #len2:size_t -> #len3:size_t -> #len4:size_t -> #len5:size_t -> b0:lbuffer a0 len0 -> b1:lbuffer a1 len1 -> b2:lbuffer a2 len2 -> b3:lbuffer a3 len3 -> b4:lbuffer a4 len4 -> b5:lbuffer a5 len5 -> Lemma
			(requires (True))
...
val disjoint_lists_lemma_4_2: #a0:Type0 -> #a1:Type0 -> #a2:Type0 -> #a3:Type0 -> #a4:Type0 -> #a5:Type0 -> #len0:size_t -> #len1:size_t -> #len2:size_t -> #len3:size_t -> #len4:size_t -> #len5:size_t -> b0:lbuffer a0 len0 -> b1:lbuffer a1 len1 -> b2:lbuffer a2 len2 -> b3:lbuffer a3 len3 -> b4:lbuffer a4 len4 -> b5:lbuffer a5 len5 -> Lemma
			(requires (True))
...
val disjoints_lemma1: #a:Type0 -> #len:size_t -> b:lbuffer a len -> Lemma
			(requires (True))
			(ensures (disjoints [BufItem b] == (disjoint b b)))
//			[SMTPat (disjoints [BufItem #a #len b])]

val disjoints_lemma2: #a0:Type0 -> #a1:Type0 -> #len0:size_t -> #len1:size_t -> b0:lbuffer a0 len0 -> b1:lbuffer a1 len1 -> Lemma
			(requires (True))
			(ensures (disjoints [BufItem b0; BufItem b1] == (disjoint b0 b1 /\ disjoint b1 b0) ))
//			[SMTPat (disjoints [BufItem b0; BufItem b1])]

val disjoints_lemma3: #a0:Type0 -> #a1:Type0 -> #a2:Type0 -> #len0:size_t -> #len1:size_t -> #len2:size_t -> b0:lbuffer a0 len0 -> b1:lbuffer a1 len1 -> b2:lbuffer a2 len2 ->  Lemma
			(requires (True))
...
val disjoints_lemma4: #a0:Type0 -> #a1:Type0 -> #a2:Type0 -> #a3:Type0 -> #len0:size_t -> #len1:size_t -> #len2:size_t -> #len3:size_t ->
			b0:lbuffer a0 len0 -> b1:lbuffer a1 len1 -> b2:lbuffer a2 len2 -> b3:lbuffer a3 len3 -> Lemma
			(requires (True))
...
val modifies_sub_lemma: #a:Type0 -> #len:size_t -> b:lbuffer a len -> start:size_t -> n:size_t{v start+v n <= v len} -> h0:mem -> h1:mem -> Lemma
			 ...
			 (ensures  (modifies1 b h0 h1 /\ as_lseq b h1 == LSeq.update_sub (as_lseq b h0) (v start) (v n) (LSeq.sub (as_lseq b h1) (v start) (v n))))
			 [SMTPat (live h0 b);
