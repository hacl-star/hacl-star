...
val vec_shift_right: #vt:vectype -> intvec vt -> (s:Ints.uint32{Ints.uint_v s < bits vt}) -> intvec vt
val vec_shift_left: #vt:vectype -> intvec vt -> (s:Ints.uint32{Ints.uint_v s < bits vt}) -> intvec vt
val vec_rotate_right: #vt:vectype -> intvec vt -> (s:Ints.uint32{Ints.uint_v s > 0 /\ Ints.uint_v s < bits vt}) -> intvec vt
val vec_rotate_left: #vt:vectype -> intvec vt -> (s:Ints.uint32{Ints.uint_v s > 0 /\ Ints.uint_v s < bits vt}) -> intvec vt
...
val ( >>| ): #vt:vectype -> intvec vt -> (s:Ints.uint32{Ints.uint_v s < bits vt}) -> intvec vt
val ( <<| ): #vt:vectype -> intvec vt -> (s:Ints.uint32{Ints.uint_v s < bits vt}) -> intvec vt
val ( >>>| ): #vt:vectype -> intvec vt -> (s:Ints.uint32{Ints.uint_v s > 0 /\ Ints.uint_v s < bits vt}) -> intvec vt
val ( <<<| ): #vt:vectype -> intvec vt -> (s:Ints.uint32{Ints.uint_v s > 0 /\ Ints.uint_v s < bits vt}) -> intvec vt
