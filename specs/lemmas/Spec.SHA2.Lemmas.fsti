...
val update_multi_224_256: hash:words_state SHA2_256 -> prev:nat -> blocks:bytes_blocks SHA2_256 ->
  Lemma
    (ensures (Spec.Agile.Hash.update_multi SHA2_256 hash prev blocks ==
      Spec.Agile.Hash.update_multi SHA2_224 hash prev blocks))
