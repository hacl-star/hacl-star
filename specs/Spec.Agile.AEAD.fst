...
let encrypt #a kv iv ad plain =
  ...
  | AES128_GCM ->
      Spec.AES_GCM.aes128gcm_encrypt kv iv plain ad
  | AES256_GCM ->
      Spec.AES_GCM.aes256gcm_encrypt kv iv plain ad
...
let decrypt #a kv iv ad cipher =
  ...
  | AES128_GCM ->
      Spec.AES_GCM.aes128gcm_decrypt kv iv ad cipher tag
  | AES256_GCM ->
      Spec.AES_GCM.aes256gcm_decrypt kv iv ad cipher tag
