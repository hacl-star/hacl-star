...
let ctest sLen modBits n e d msg salt rBlind sgnt_expected =
	...
	let sgnt = rsa_sign sLen modBits msg skey salt rBlind in
    let check_sgnt = sgnt = sgnt_expected in
	let verify_sgnt = rsa_verify sLen modBits sgnt pkey msg in
...
let test1() =
	...
	ctest 20 1024 n e d msg salt rBlind sgnt_expected
...
let test2() = 
    ...
    let sgnt_expected = createL [
        ...
        0x2duy ] in
    ctest 20 1025 n e d msg salt rBlind sgnt_expected
...
let test3() = 
    ...
    ctest 20 1536 n e d msg salt rBlind sgnt_expected
...
let test4() = 
    ...
    ctest 20 2048 n e d msg salt rBlind sgnt_expected
