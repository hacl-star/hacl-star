...
let ctest sLen modBits n e d msg salt rBlind sgnt_expected =
    let n = os2ip n in
	let e = os2ip e in
	let d = os2ip d in
    let rBlind = os2ip rBlind in
	let pkey = Mk_rsa_pubkey n e in
	let skey = Mk_rsa_privkey pkey d in
	let sgnt = rsa_sign modBits skey rBlind salt msg in
    let check_sgnt = sgnt = sgnt_expected in
	let verify_sgnt = rsa_verify modBits pkey sLen sgnt msg in
...
let test1() =
	...
	ctest 20ul 1024ul n e d msg salt rBlind sgnt_expected
...
let test2() = 
    ...
    let sgnt_expected = createL [
        ...
        0x2duy ] in
    ctest 20ul 1025ul n e d msg salt rBlind sgnt_expected
...
let test3() = 
    ...
    ctest 20ul 1536ul n e d msg salt rBlind sgnt_expected
...
let test4() = 
    ...
    ctest 20ul 2048ul n e d msg salt rBlind sgnt_expected
