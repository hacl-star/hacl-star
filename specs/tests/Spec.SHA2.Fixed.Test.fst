...
let test () =
  ...
  let init0 = Spec.init 1 Def.SHA2_256 in
  let update0 = Spec.compress #1 #Def.SHA2_256 test0 init0 in
  IO.print_string "\ninit 0\n";
  List.iter (fun a -> IO.print_string (UInt32.to_string (u32_to_UInt32 a));
	           IO.print_string ":") (to_list (Lib.FixedSequence.to_lseq init0));
  IO.print_string "\nupdate 0\n";
  List.iter (fun a -> IO.print_string (UInt32.to_string (u32_to_UInt32 a));
	           IO.print_string ":") (to_list (Lib.FixedSequence.to_lseq update0));

  let ws0 = Spec.ws0 #1 #Def.SHA2_256 test0 in
  let ws0_ = Def.words_of_bytes Def.SHA2_256 #16 test0 in //Spec.ws0 #1 #Def.SHA2_256 test0 in
  IO.print_string "\nws0_\n";
  List.iter (fun a -> IO.print_string (UInt32.to_string (u32_to_UInt32 a));
	           IO.print_string ":") (to_list ws0_);
  IO.print_string "\nws 0\n";
  List.iter (fun a -> IO.print_string (UInt32.to_string (u32_to_UInt32 a));
	           IO.print_string ":") (to_list (Lib.FixedSequence.to_lseq ws0));
  IO.print_string "\nws 1\n";
  let ws1 = Lib.FixedSequence.to_lseq (Spec.ws_next ws0) in
  List.iter (fun a -> IO.print_string (UInt32.to_string (u32_to_UInt32 a));
  ...
  let test1_result224 : lbytes 28 = Spec.hash1 Def.SHA2_224 test1_plaintext in
  let test1_result256 : lbytes 32 = Spec.hash1 Def.SHA2_256 test1_plaintext in
  let test1_result384 : lbytes 48 = Spec.hash1 Def.SHA2_384 test1_plaintext in
  let test1_result512 : lbytes 64 = Spec.hash1 Def.SHA2_512 test1_plaintext in
  ...
  let test2_result224 : lbytes 28 = Spec.hash1 Def.SHA2_224 test2_plaintext in
  let test2_result256 : lbytes 32 = Spec.hash1 Def.SHA2_256 test2_plaintext in
  let test2_result384 : lbytes 48 = Spec.hash1 Def.SHA2_384 test2_plaintext in
  let test2_result512 : lbytes 64 = Spec.hash1 Def.SHA2_512 test2_plaintext in
  ...
  let test3_result224 : lbytes 28 = Spec.hash1 Def.SHA2_224 test3_plaintext in
  let test3_result256 : lbytes 32 = Spec.hash1 Def.SHA2_256 test3_plaintext in
  let test3_result384 : lbytes 48 = Spec.hash1 Def.SHA2_384 test3_plaintext in
  let test3_result512 : lbytes 64 = Spec.hash1 Def.SHA2_512 test3_plaintext in
  ...
  let test4_result224 : lbytes 28 = Spec.hash1 Def.SHA2_224 test4_plaintext in
  let test4_result256 : lbytes 32 = Spec.hash1 Def.SHA2_256 test4_plaintext in
  let test4_result384 : lbytes 48 = Spec.hash1 Def.SHA2_384 test4_plaintext in
  let test4_result512 : lbytes 64 = Spec.hash1 Def.SHA2_512 test4_plaintext in
