...
let ctest modBits nLen n eLen e dLen d msgLen msg sLen salt sgnt_expected num =
  ...
  IO.print_string "\n sgnt_computed \n";
  List.iter (fun a -> IO.print_string (UInt8.to_string_hex (u8_to_UInt8 a))) (to_list sgnt_computed);
  IO.print_string "\n sgnt_expected \n";
  List.iter (fun a -> IO.print_string (UInt8.to_string_hex (u8_to_UInt8 a))) (to_list sgnt_expected);
  IO.print_string "\n";
  check && verify
...
let test1() =
  ...
  let n : lbytes 128 = of_list n in
  let e = List.Tot.map u8_from_UInt8 [0x01uy; 0x00uy; 0x01uy] in
  let e : lbytes 3 = of_list e in
  ...
  let msg : lbytes 51 = of_list msg in
  ...
  let sgnt_expected : lbytes 128 = of_list sgnt_expected in
  ...
  let salt : lbytes 20 = of_list salt in
...
let test2() =
  ...
  let msg: lbytes 234 = of_list msg in
  let salt = List.Tot.map u8_from_UInt8 [
  ...
  let sgnt_expected = List.Tot.map u8_from_UInt8 [
    ...
    0x2duy ] in
  let sgnt_expected : lbytes 129 = of_list sgnt_expected in
...
let test3() =
  ...
  let msg : lbytes 107 = of_list msg in
  let salt = List.Tot.map u8_from_UInt8 [
  ...
  let sgnt_expected : lbytes 192 = of_list sgnt_expected in
...
let test4() =
  ...
  let msg : lbytes 128 = of_list msg in
  let salt = List.Tot.map u8_from_UInt8 [
  ...
  let sgnt_expected : lbytes 256 = of_list sgnt_expected in
