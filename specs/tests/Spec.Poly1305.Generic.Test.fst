module Spec.Poly1305.Generic.Test

open FStar.Mul
open Spec.Lib.IntTypes
open Spec.Lib.RawIntTypes
open Spec.Lib.IntSeq
open Spec.Poly1305.Generic
...
let test () =
  ...
  List.iter (fun a -> IO.print_string (UInt8.to_string (u8_to_UInt8 a))) (as_list expected);
  IO.print_string "\nComputed MAC:";
  List.iter (fun a -> IO.print_string (UInt8.to_string (u8_to_UInt8 a))) (as_list mac2);
  if result2 then   IO.print_string "\nSuccess!\n"
  else IO.print_string "\nFailure :(\n";
  IO.print_string   "Expected MAC:";
  List.iter (fun a -> IO.print_string (UInt8.to_string (u8_to_UInt8 a))) (as_list expected);
  IO.print_string "\nComputed MAC:";
  List.iter (fun a -> IO.print_string (UInt8.to_string (u8_to_UInt8 a))) (as_list mac3);
