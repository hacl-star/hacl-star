...
let test () =
  ...
  let test1_result224 = HMAC.hmac Hash.SHA2_224 test1_key test1_data in
  let test1_result256 = HMAC.hmac Hash.SHA2_256 test1_key test1_data in
  let test1_result384 = HMAC.hmac Hash.SHA2_384 test1_key test1_data in
  let test1_result512 = HMAC.hmac Hash.SHA2_512 test1_key test1_data in
  ...
  let test2_result224 = HMAC.hmac Hash.SHA2_224 test2_key test2_data in
  let test2_result256 = HMAC.hmac Hash.SHA2_256 test2_key test2_data in
  let test2_result384 = HMAC.hmac Hash.SHA2_384 test2_key test2_data in
  let test2_result512 = HMAC.hmac Hash.SHA2_512 test2_key test2_data in
  ...
  let test3_result224 = HMAC.hmac Hash.SHA2_224 test3_key test3_data in
  let test3_result256 = HMAC.hmac Hash.SHA2_256 test3_key test3_data in
  let test3_result384 = HMAC.hmac Hash.SHA2_384 test3_key test3_data in
  let test3_result512 = HMAC.hmac Hash.SHA2_512 test3_key test3_data in
  ...
  let test4_result224 = HMAC.hmac Hash.SHA2_224 test4_key test4_data in
  let test4_result256 = HMAC.hmac Hash.SHA2_256 test4_key test4_data in
  let test4_result384 = HMAC.hmac Hash.SHA2_384 test4_key test4_data in
  let test4_result512 = HMAC.hmac Hash.SHA2_512 test4_key test4_data in
  ...
  let test5_result224b = HMAC.hmac Hash.SHA2_224 test5_key test5_data in
  let test5_result256b = HMAC.hmac Hash.SHA2_256 test5_key test5_data in
  let test5_result384b = HMAC.hmac Hash.SHA2_384 test5_key test5_data in
  let test5_result512b = HMAC.hmac Hash.SHA2_512 test5_key test5_data in
  ...
  let test6_result224 = HMAC.hmac Hash.SHA2_224 test6_key test6_data in
  let test6_result256 = HMAC.hmac Hash.SHA2_256 test6_key test6_data in
  let test6_result384 = HMAC.hmac Hash.SHA2_384 test6_key test6_data in
  let test6_result512 = HMAC.hmac Hash.SHA2_512 test6_key test6_data in
  ...
  let test7_result224 = HMAC.hmac Hash.SHA2_224 test7_key test7_data in
  let test7_result256 = HMAC.hmac Hash.SHA2_256 test7_key test7_data in
  let test7_result384 = HMAC.hmac Hash.SHA2_384 test7_key test7_data in
  let test7_result512  = HMAC.hmac Hash.SHA2_512 test7_key test7_data in
