...
let test () =
  ...
  IO.print_string "\nTEST 1\n";
  let test1_plaintext_len : size_nat = 3 in
  ...
  let test1_result224 : lbytes 28 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_224 test1_plaintext in
  let test1_result256 : lbytes 32 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_256  test1_plaintext in
  let test1_result384 : lbytes 48 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_384  test1_plaintext in
  let test1_result512 : lbytes 64 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_512  test1_plaintext in
  ...
  IO.print_string "\nTEST 2\n";
  let test2_plaintext_len : size_nat = 0 in
  ...
  let test2_result224 : lbytes 28 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_224  test2_plaintext in
  let test2_result256 : lbytes 32 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_256  test2_plaintext in
  let test2_result384 : lbytes 48 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_384  test2_plaintext in
  let test2_result512 : lbytes 64 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_512  test2_plaintext in
  ...
  IO.print_string "\nTEST 3\n";
  let test3_plaintext_len : size_nat = 56 in
  ...
  let test3_result224 : lbytes 28 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_224  test3_plaintext in
  let test3_result256 : lbytes 32 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_256  test3_plaintext in
  let test3_result384 : lbytes 48 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_384  test3_plaintext in
  let test3_result512 : lbytes 64 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_512  test3_plaintext in
  ...
  IO.print_string "\nTEST 4\n";
  let test4_plaintext_len : size_nat = 112 in
  ...
  let test4_result224 : lbytes 28 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_224  test4_plaintext in
  let test4_result256 : lbytes 32 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_256  test4_plaintext in
  let test4_result384 : lbytes 48 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_384  test4_plaintext in
  let test4_result512 : lbytes 64 = Spec.SHA2.New.sha2 Spec.SHA2.New.SHA2_512  test4_plaintext in
