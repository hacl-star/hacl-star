...
let test1_plaintext : lbytes 3 =
  assert_norm (List.Tot.length test1_plaintext_list = 3);of_list test1_plaintext_list
...
let test1_expected : lbytes 64 = assert_norm (List.Tot.length test1_expected_list = 64); of_list test1_expected_list
...
let test () =
  ...
  let test1_result : lbytes 64 =
    Spec.Blake2b.blake2b 3 test1_plaintext 0 (of_list []) 64
  in
