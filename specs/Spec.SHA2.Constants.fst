...
[@"opaque_to_smt"]
inline_for_extraction
let ops_224_256_l: List.llist (rotval U32) 12 =
  [@inline_let]
  let l = [size 2; size 13; size 22;
	   size 6; size 11; size 25;
	   size 7; size 18; size 3;
	   size 17; size 19; size 10]
  in
  assert_norm (List.length l = 12);
  l

let ops_224_256 = Seq.seq_of_list ops_224_256_l

[@"opaque_to_smt"]
inline_for_extraction
let ops_384_512_l: List.llist (rotval U64) 12 =
  [@inline_let]
  let l = [size 28; size 13; size 22;
	   size 14; size 11; size 25;
	   size 1; size  18; size  3;
	   size 19; size 19; size 10]
  in
  assert_norm (List.length l = 12);
  l

let ops_384_512 = Seq.seq_of_list ops_384_512_l
