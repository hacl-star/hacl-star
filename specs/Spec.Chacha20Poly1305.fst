...
let poly1305_padded (len:size_nat) (text:lbytes len) (tmp:lbytes Poly.size_block) (st:Poly1305.state) : Tot (Poly1305.state) =
  ...
  let st = Poly1305.update1 Poly.size_block tmp st in
  st
