...
let encrypt #olen iv receiver sender len plaintext =
...
let decrypt #olen iv sender receiver len ciphertext =
...
let encrypt2 #olen receiver sender len input =
...
let decrypt2 #olen sender receiver len input =
