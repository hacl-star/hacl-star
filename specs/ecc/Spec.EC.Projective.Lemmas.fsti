...
val to_aff_point_add_lemma_a3 (k:curve{k.coeff_a = (-3) % k.prime}) (p q:proj_point k) :
  Lemma (to_aff_point k (point_add_a3 k p q) ==
    aff_point_add k (to_aff_point k p) (to_aff_point k q))


val to_aff_point_double_lemma_a3 (k:curve{k.coeff_a = (-3) % k.prime}) (p:proj_point k) :
  Lemma (to_aff_point k (point_double_a3 k p) ==
    aff_point_add k (to_aff_point k p) (to_aff_point k p))


val to_aff_point_add_lemma_a0 (k:curve{k.coeff_a = 0}) (p q:proj_point k) :
  Lemma (to_aff_point k (point_add_a0 k p q) ==
    aff_point_add k (to_aff_point k p) (to_aff_point k q))


val to_aff_point_double_lemma_a0 (k:curve{k.coeff_a = 0}) (p:proj_point k) :
  Lemma (to_aff_point k (point_double_a0 k p) ==
    aff_point_add k (to_aff_point k p) (to_aff_point k p))
