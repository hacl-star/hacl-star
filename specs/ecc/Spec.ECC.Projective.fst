...
val point_add_c_a3: k:curve{k.coeff_a = (-3) % k.prime}
  -> SE.mul_st (proj_point_c k) (mk_to_ec_comm_monoid k)
let point_add_c_a3 k p q =
  EPL.to_aff_point_add_lemma_a3 k p q;
  point_add_a3 k p q

val point_double_c_a3: k:curve{k.coeff_a = (-3) % k.prime}
  -> SE.sqr_st (proj_point_c k) (mk_to_ec_comm_monoid k)
let point_double_c_a3 k p =
  EPL.to_aff_point_double_lemma_a3 k p;
  point_double_a3 k p

let mk_ec_concrete_ops_a3 (k:curve{k.coeff_a = (-3) % k.prime})
  : SE.concrete_ops (proj_point_c k) =
{
...
val point_add_c_a0: k:curve{k.coeff_a = 0}
  -> SE.mul_st (proj_point_c k) (mk_to_ec_comm_monoid k)
let point_add_c_a0 k p q =
  EPL.to_aff_point_add_lemma_a0 k p q;
  point_add_a0 k p q

val point_double_c_a0: k:curve{k.coeff_a = 0}
  -> SE.sqr_st (proj_point_c k) (mk_to_ec_comm_monoid k)
let point_double_c_a0 k p =
  EPL.to_aff_point_double_lemma_a0 k p;
  point_double_a0 k p

let mk_ec_concrete_ops_a0 (k:curve{k.coeff_a = 0}) : SE.concrete_ops (proj_point_c k) =
{
  SE.to = mk_to_ec_comm_monoid k;
  SE.one = point_at_inf_c k;
