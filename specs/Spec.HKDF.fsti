...
val hkdf_extract:
    a:Hash.hash_alg
  -> salt: bytes{length salt < Hash.max_input_length a}
  -> ikm: bytes{length salt + length ikm + Hash.block_length a < Hash.max_input_length a
        /\ Hash.hash_length a + length ikm + Hash.block_length a < Hash.max_input_length a} ->
...
val hkdf_expand_label:
  ...
  /\ length secret + size_hkdf_label + 1 + Hash.hash_length a + Hash.block_length a < Hash.max_input_length a}
