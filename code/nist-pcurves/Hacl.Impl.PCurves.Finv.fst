...
inline_for_extraction noextract
val one_mod {| cp:S.curve_params |} : BE.lone_st U64 cp.bn_limbs 0ul mk_to_pcurve_prime_comm_monoid
let one_mod {| cp:S.curve_params |} ctx one = make_fone one


inline_for_extraction noextract
val mul_mod {| cp:S.curve_params |} : BE.lmul_st U64 cp.bn_limbs 0ul mk_to_pcurve_prime_comm_monoid
let mul_mod {| cp:S.curve_params |} ctx x y xy = fmul xy x y


inline_for_extraction noextract
val sqr_mod {| cp:S.curve_params |} : BE.lsqr_st U64 cp.bn_limbs 0ul mk_to_pcurve_prime_comm_monoid
let sqr_mod {| cp:S.curve_params |} ctx x xx = fsqr xx x


inline_for_extraction noextract
let mk_pcurve_prime_concrete_ops {| cp:S.curve_params |} : BE.concrete_ops U64 cp.bn_limbs 0ul = {
