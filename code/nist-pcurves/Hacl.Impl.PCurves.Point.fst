...
let make_point_at_inf {| cp:S.curve_params |} {| bn_ops |} {| cc:curve_constants |} p =
  let x = getx p in
  let y = gety p in
  let z = getz p in
  cc.make_fzero x;
...
let to_aff_point {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| f:field_ops |} {| FI.curve_inv_sqrt|} res p =
  push_frame ();
...
let to_aff_point_x {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| f:field_ops |} {| FI.curve_inv_sqrt|} res p =
  push_frame ();
  let zinv = create_felem #cp in
  let px = getx p in
  let pz = getz p in
...
let to_proj_point {| cp:S.curve_params |} {| bn_ops |} {| cc:curve_constants |} {| f:field_ops |} res p =
...
inline_for_extraction noextract
val compute_rp_ec_equation {| cp:S.curve_params |} {| bn_ops |} {| cc:curve_constants |} {| f:field_ops |} :
...
let compute_rp_ec_equation {| cp:S.curve_params |} {| bn_ops |} {| cc:curve_constants |} {| f:field_ops |} x res =
  push_frame ();
...
inline_for_extraction noextract
val is_y_sqr_is_y2_vartime {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| field_ops |} (y2 y:felem) : Stack bool
  (requires fun h ->
...
let is_y_sqr_is_y2_vartime {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| f:field_ops |} y2 y =
  f.fsqr y y; // y = y * y
...
let is_on_curve_vartime {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| f:field_ops |} p =
  push_frame ();
...
let aff_point_store {| cp:S.curve_params |}  {| bn_ops |} {| CC.curve_constants |} {| field_ops |} res p =
  let px = aff_getx p in
  let py = aff_gety p in
  Math.Lemmas.pow2_le_compat (8*cp.bytes) (cp.bits);
  bn2_to_bytes_be res px py

let point_store {| cp:S.curve_params |}  {| bn_ops |} {| CC.curve_constants |} {| field_ops |} {| FI.curve_inv_sqrt|} res p =
  push_frame ();
...
inline_for_extraction noextract
val is_xy_valid_vartime {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| field_ops |}:
...
let is_xy_valid_vartime {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| f:field_ops |}  p =
  let px = aff_getx p in
  let py = aff_gety p in
...
inline_for_extraction noextract
val recover_y_vartime_candidate {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| field_ops |} {| FI.curve_inv_sqrt |} (y x:felem) : Stack bool
  (requires fun h ->
...
let recover_y_vartime_candidate {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| f:field_ops |} {| FI.curve_inv_sqrt |} y x =
  push_frame ();
...
inline_for_extraction noextract
val recover_y_vartime {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| field_ops |} {| FI.curve_inv_sqrt |} (y x:felem) (is_odd:bool) : Stack bool
  (requires fun h ->
    live h x /\ live h y /\ disjoint x y /\ as_nat h x < S.prime)
  (ensures fun h0 b h1 -> modifies (loc y) h0 h1 /\
...
let recover_y_vartime {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| f:field_ops |} {| FI.curve_inv_sqrt |} y x is_odd =
...
let aff_point_decompress_vartime {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| f:field_ops |} {| FI.curve_inv_sqrt |} x y s =
  let s0 = s.(0ul) in
