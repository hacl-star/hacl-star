...
let proj_g_pow2_64 {| cp:S.curve_params |} : S.proj_point =
  admit();
  [@inline_let]
...
val lemma_proj_g_pow2_64_eval : {| cp:S.curve_params |} ->
  Lemma (SE.exp_pow2 S.mk_p256_concrete_ops S.base_point 64 == proj_g_pow2_64)

let lemma_proj_g_pow2_64_eval {| cp:S.curve_params |} =
  admit()
(*  SPT256.exp_pow2_rec_is_exp_pow2 (S.mk_p256_concrete_ops #cp) cp.base_point 64;
...
inline_for_extraction noextract
let proj_g_pow2_128 {| cp:S.curve_params |} : S.proj_point =
  admit();
  [@inline_let]
...
val lemma_proj_g_pow2_128_eval {| cp:S.curve_params |}:
  Lemma (SE.exp_pow2 S.mk_p256_concrete_ops proj_g_pow2_64 64 == proj_g_pow2_128)

let lemma_proj_g_pow2_128_eval {| cp:S.curve_params |} =
  admit()
...
inline_for_extraction noextract
let proj_g_pow2_192 {| cp:S.curve_params |} : S.proj_point =
  [@inline_let]
...
val lemma_proj_g_pow2_192_eval {| cp:S.curve_params |} :
  Lemma (SE.exp_pow2 S.mk_p256_concrete_ops proj_g_pow2_128 64 == proj_g_pow2_192)

let lemma_proj_g_pow2_192_eval {| cp:S.curve_params |} =
  admit () 
...
inline_for_extraction noextract
let proj_g_pow2_64_list {| cp:S.curve_params |} : SPTK.point_list =
  normalize_term (SPTK.proj_point_to_list proj_g_pow2_64)

inline_for_extraction noextract
let proj_g_pow2_128_list {| cp:S.curve_params |} : SPTK.point_list =
  normalize_term (SPTK.proj_point_to_list proj_g_pow2_128)

inline_for_extraction noextract
let proj_g_pow2_192_list {| cp:S.curve_params |} : SPTK.point_list =
  normalize_term (SPTK.proj_point_to_list proj_g_pow2_192)


let proj_g_pow2_64_lseq {| cp:S.curve_params |} : LSeq.lseq uint64 (3 * v cp.bn_limbs)  =
  normalize_term_spec (SPTK.proj_point_to_list proj_g_pow2_64);
  Seq.seq_of_list proj_g_pow2_64_list

let proj_g_pow2_128_lseq {| cp:S.curve_params |} : LSeq.lseq uint64 (3 * v cp.bn_limbs)  =
  normalize_term_spec (SPTK.proj_point_to_list proj_g_pow2_128);
  Seq.seq_of_list proj_g_pow2_128_list

let proj_g_pow2_192_lseq {| cp:S.curve_params |} : LSeq.lseq uint64 (3 * v cp.bn_limbs) =
  normalize_term_spec (SPTK.proj_point_to_list proj_g_pow2_192);
  Seq.seq_of_list proj_g_pow2_192_list


val proj_g_pow2_64_lemma {| cp:S.curve_params |} :
  Lemma (S.to_aff_point proj_g_pow2_64 == pow_point (pow2 64) g_aff)

let proj_g_pow2_64_lemma {| cp:S.curve_params |} =
  lemma_proj_g_pow2_64_eval #cp;
  SPT256.a_pow2_64_lemma S.mk_p256_concrete_ops S.base_point


val proj_g_pow2_128_lemma {| cp:S.curve_params |} :
  Lemma (S.to_aff_point proj_g_pow2_128 == pow_point (pow2 128) g_aff)

let proj_g_pow2_128_lemma {| cp:S.curve_params |} =
  lemma_proj_g_pow2_128_eval #cp;
  lemma_proj_g_pow2_64_eval #cp;
  SPT256.a_pow2_128_lemma S.mk_p256_concrete_ops S.base_point


val proj_g_pow2_192_lemma {| cp:S.curve_params |} :
  Lemma (S.to_aff_point proj_g_pow2_192 == pow_point (pow2 192) g_aff)

let proj_g_pow2_192_lemma {| cp:S.curve_params |} =
  lemma_proj_g_pow2_192_eval #cp;
  lemma_proj_g_pow2_128_eval #cp;
  lemma_proj_g_pow2_64_eval #cp;
  SPT256.a_pow2_192_lemma S.mk_p256_concrete_ops S.base_point


let proj_g_pow2_64_lseq_lemma {| cp:S.curve_params |} =
  normalize_term_spec (SPTK.proj_point_to_list proj_g_pow2_64);
  proj_g_pow2_64_lemma #cp;
  SPTK.proj_point_to_list_lemma proj_g_pow2_64


let proj_g_pow2_128_lseq_lemma {| cp:S.curve_params |} =
  normalize_term_spec (SPTK.proj_point_to_list proj_g_pow2_128);
  proj_g_pow2_128_lemma #cp;
  SPTK.proj_point_to_list_lemma proj_g_pow2_128


let proj_g_pow2_192_lseq_lemma {| cp:S.curve_params |} =
  normalize_term_spec (SPTK.proj_point_to_list proj_g_pow2_192);
  proj_g_pow2_192_lemma #cp;
  SPTK.proj_point_to_list_lemma proj_g_pow2_192


let mk_proj_g_pow2_64 {| cp:S.curve_params |} =
  createL proj_g_pow2_64_list

let mk_proj_g_pow2_128 {| cp:S.curve_params |} =
  createL proj_g_pow2_128_list

let mk_proj_g_pow2_192 {| cp:S.curve_params |} =
...
inline_for_extraction noextract
let precomp_basepoint_table_list_w4 {| cp:S.curve_params |} : x:list uint64{FStar.List.Tot.length x = 192} =
  admit();
  normalize_term (SPT.precomp_base_table_list mk_p256_precomp_base_table S.p256_basepoint 15)

let precomp_basepoint_table_lseq_w4 {| cp:S.curve_params |} : LSeq.lseq uint64 192 =
...
inline_for_extraction noextract
let precomp_g_pow2_64_table_list_w4 {| cp:S.curve_params |}: x:list uint64{FStar.List.Tot.length x = 192} =
  normalize_term (SPT.precomp_base_table_list mk_p256_precomp_base_table proj_g_pow2_64 15)

let precomp_g_pow2_64_table_lseq_w4 {| cp:S.curve_params |} : LSeq.lseq uint64 192 =
...
let precomp_g_pow2_64_table_lemma_w4 {| cp:S.curve_params |} =
  normalize_term_spec (SPT.precomp_base_table_list mk_p256_precomp_base_table proj_g_pow2_64 15);
...
let precomp_g_pow2_64_table_w4 {| cp:S.curve_params |} :
...
inline_for_extraction noextract
let precomp_g_pow2_128_table_list_w4 {| cp:S.curve_params |} : x:list uint64{FStar.List.Tot.length x = 192} =
  normalize_term (SPT.precomp_base_table_list mk_p256_precomp_base_table proj_g_pow2_128 15)

let precomp_g_pow2_128_table_lseq_w4 {| cp:S.curve_params |} : LSeq.lseq uint64 192 =
...
let precomp_g_pow2_128_table_lemma_w4 {| cp:S.curve_params |} =
  normalize_term_spec (SPT.precomp_base_table_list mk_p256_precomp_base_table proj_g_pow2_128 15);
  SPT.precomp_base_table_lemma mk_p256_precomp_base_table
    proj_g_pow2_128 16 precomp_g_pow2_64_table_lseq_w4;
  proj_g_pow2_128_lemma ()

let precomp_g_pow2_128_table_w4 {| cp:S.curve_params |}:
...
inline_for_extraction noextract
let precomp_g_pow2_192_table_list_w4 {| cp:S.curve_params |}: x:list uint64{FStar.List.Tot.length x = 192} =
  normalize_term (SPT.precomp_base_table_list mk_p256_precomp_base_table proj_g_pow2_192 15)

let precomp_g_pow2_192_table_lseq_w4 {| cp:S.curve_params |}: LSeq.lseq uint64 192 =
...
let precomp_g_pow2_192_table_lemma_w4 {| cp:S.curve_params |} =
  normalize_term_spec (SPT.precomp_base_table_list mk_p256_precomp_base_table proj_g_pow2_192 15);
  SPT.precomp_base_table_lemma mk_p256_precomp_base_table
    proj_g_pow2_192 16 precomp_g_pow2_64_table_lseq_w4;
  proj_g_pow2_192_lemma ()

let precomp_g_pow2_192_table_w4 {| cp:S.curve_params |}:
...
inline_for_extraction noextract
let precomp_basepoint_table_list_w5 {| cp:S.curve_params |}: x:list uint64{FStar.List.Tot.length x = 384} =
  normalize_term (SPT.precomp_base_table_list mk_p256_precomp_base_table S.base_point 31)

let precomp_basepoint_table_lseq_w5 {| cp:S.curve_params |}: LSeq.lseq uint64 384 =
