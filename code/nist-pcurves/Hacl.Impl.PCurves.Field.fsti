...
inline_for_extraction noextract
let fadd_t {| S.curve_params |} {| CC.curve_constants |} {| bn:bn_ops |} =
...
inline_for_extraction noextract
let fsub_t {| S.curve_params |} {| CC.curve_constants |} {| bn:bn_ops |} =
  res:felem -> x:felem -> y:felem -> Stack unit
  (requires fun h ->
...
inline_for_extraction noextract
let fnegate_conditional_vartime_t {| S.curve_params |} {| CC.curve_constants |} {| bn:bn_ops |} =
...
inline_for_extraction noextract
let fmul_t {| S.curve_params |} {| CC.curve_constants |} {| bn:bn_ops |} =
  res:felem -> x:felem -> y:felem -> Stack unit
  (requires fun h ->
    live h x /\ live h y /\ live h res /\
    eq_or_disjoint x y /\ eq_or_disjoint x res /\ eq_or_disjoint y res /\
...
inline_for_extraction noextract
let fsqr_t {| S.curve_params |} {| CC.curve_constants |} {| bn:bn_ops |} =
  res:felem -> x:felem -> Stack unit
  (requires fun h ->
    live h x /\ live h res /\ eq_or_disjoint x res /\
    as_nat h x < S.prime)
...
inline_for_extraction noextract
let from_mont_t {| S.curve_params |} {| CC.curve_constants |} {| bn:bn_ops |} =
  res:felem -> x:felem -> Stack unit
  (requires fun h ->
...
inline_for_extraction noextract
let to_mont_t {| S.curve_params |} {| CC.curve_constants |} {| bn:bn_ops |} =
...
class field_ops {| S.curve_params |} {| CC.curve_constants |} {| bn:bn_ops |} = {
  ...
  fadd:fadd_t;
  fsub:fsub_t;
  fnegate_conditional_vartime:fnegate_conditional_vartime_t;
  fmul:fmul_t;
  fsqr:fsqr_t;
