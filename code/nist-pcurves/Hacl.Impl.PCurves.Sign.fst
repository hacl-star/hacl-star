...
let ecdsa_sign_r {| cp:S.curve_params |} {| curve_constants |} {| bn_ops |} {| field_ops |} {| o:order_ops |} {| curve_inv_sqrt |} {| point_ops |} {| PP.precomp_tables |} r k =
  push_frame ();
...
let ecdsa_sign_s {| cp:S.curve_params |} {| curve_constants |} {| bn_ops |} {| field_ops |} {| o:order_ops |} {| curve_inv_sqrt |} {| point_ops |} {| PP.precomp_tables |} s k r d_a m =
  push_frame ();
  let h0 = ST.get () in
...
let ecdsa_sign_load {| cp:S.curve_params |} {| curve_constants |} {| bn_ops |} {| field_ops |} {| o:order_ops |} {| curve_inv_sqrt |} {| point_ops |} {| PP.precomp_tables |} d_a k_q private_key nonce =
...
let check_signature {| cp:S.curve_params |} {| curve_constants |} {| bn_ops |} {| field_ops |} {| order_ops |} {| curve_inv_sqrt |} {| point_ops |} {| PP.precomp_tables |} are_sk_nonce_valid r_q s_q =
  let h0 = ST.get () in
...
let ecdsa_sign_msg_as_qelem {| cp:S.curve_params |} {| curve_constants |} {| bn_ops |} {| field_ops |} {| order_ops |} {| curve_inv_sqrt |} {| point_ops |} {| PP.precomp_tables |} signature m_q private_key nonce =
  push_frame ();
