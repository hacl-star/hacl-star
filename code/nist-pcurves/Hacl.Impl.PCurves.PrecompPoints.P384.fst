module Hacl.Impl.PCurves.PrecompPoints.P384
...
let lemma_proj_g_pow2_64_eval () = 
  ...
  normalize_term_spec (SPT256.exp_pow2_rec #S.proj_point (S.mk_pcurve_concrete_ops #Spec.P384.p384_params) (S.base_point #Spec.P384.p384_params) 64);
  let rX : S.felem = 0x000931f4ae428a4ad81ee0aa89cf5247ce85d4dd696c61b4bb9d4761e57b7fbe in
  let rY : S.felem = 0x7e88e5e6a142d5c2269f21a158e82ab2c79fcecb26e397b96fd5b9fbcd0a69a5 in
  let rZ : S.felem = 0x02626dc2dd5e06cd19de5e6afb6c5dbdd3e41dc1472e7b8ef11eb0662e41c44b in
  admit();
...
noextract
let lemma_proj_g_pow2_128_eval () = admit();
...
inline_for_extraction noextract
let proj_g_pow2_192 : S.proj_point = admit();
  [@inline_let]
...
noextract
let lemma_proj_g_pow2_192_eval () = admit();
...
inline_for_extraction noextract
val proj_g_pow2_64_lseq : LSeq.lseq uint64 18
inline_for_extraction noextract
let proj_g_pow2_64_lseq : LSeq.lseq uint64 18 =
  normalize_term_spec (SPTK.proj_point_to_list proj_g_pow2_64);
  Seq.seq_of_list (proj_g_pow2_64_list)

inline_for_extraction noextract
val proj_g_pow2_128_lseq : LSeq.lseq uint64 18
let proj_g_pow2_128_lseq : LSeq.lseq uint64 18 =
  normalize_term_spec (SPTK.proj_point_to_list proj_g_pow2_128);
  Seq.seq_of_list proj_g_pow2_128_list

inline_for_extraction noextract
val proj_g_pow2_192_lseq : LSeq.lseq uint64 18
let proj_g_pow2_192_lseq : LSeq.lseq uint64 18 =
...
val mk_proj_g_pow2_64 : unit -> StackInline (lbuffer uint64 (3ul *. 6ul))
  (requires fun _ -> True)
...
inline_for_extraction
val mk_proj_g_pow2_128 : unit -> StackInline (lbuffer uint64 (3ul *. 6ul))
  (requires fun _ -> True)
...
inline_for_extraction
val mk_proj_g_pow2_192 : unit -> StackInline (lbuffer uint64 (3ul *. 6ul))
  (requires fun _ -> True)
...
inline_for_extraction noextract
let g_pow2_64_table : proj_g_pow2 #p384_params g_pow2_64 = {
...
inline_for_extraction noextract
let g_pow2_128_table : proj_g_pow2 #p384_params g_pow2_128 = {
...
inline_for_extraction noextract
let g_pow2_192_table : proj_g_pow2 #p384_params g_pow2_192 = {
