...
[@(strict_on_arguments [0;1;2;3;4;5;6;7;8])]
inline_for_extraction noextract
val ecdh_i {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| field_ops |}
...
[@(strict_on_arguments [0;1;2;3;4;5;6;7;8])]
inline_for_extraction noextract
val ecdh_r {| cp:S.curve_params |} {| bn_ops |} {| curve_constants |} {| field_ops |} 
               {| order_ops |} {| curve_inv_sqrt |} {| point_ops |} {| PP.precomp_tables |} {| point_mul_ops |}:
