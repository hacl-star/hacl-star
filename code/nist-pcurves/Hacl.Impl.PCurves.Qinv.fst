...
inline_for_extraction noextract
val one_mod {| cp:S.curve_params |}: BE.lone_st U64 cp.bn_limbs 0ul mk_to_pcurve_order_comm_monoid
let one_mod ctx one = make_qone one


inline_for_extraction noextract
val mul_mod  {| cp:S.curve_params |}: BE.lmul_st U64 cp.bn_limbs 0ul mk_to_pcurve_order_comm_monoid
let mul_mod ctx x y xy = qmul xy x y


inline_for_extraction noextract
val sqr_mod  {| cp:S.curve_params |}: BE.lsqr_st U64 cp.bn_limbs 0ul mk_to_pcurve_order_comm_monoid
let sqr_mod ctx x xx = qsqr xx x


inline_for_extraction noextract
let mk_pcurve_order_concrete_ops {| cp:S.curve_params |}: BE.concrete_ops U64 cp.bn_limbs 0ul = {
