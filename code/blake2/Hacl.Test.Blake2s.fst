...
let main () =
  ...
  let test1_plaintext : buffer uint8 =
    createL [
      u8 0x61; u8 0x62; u8 0x63
    ] in
  let test1_expected : buffer uint8 =
    createL [
      u8 0x50; u8 0x8C; u8 0x5E; u8 0x8C; u8 0x32; u8 0x7C; u8 0x14; u8 0xE2;
      u8 0xE1; u8 0xA7; u8 0x2B; u8 0xA3; u8 0x4E; u8 0xEB; u8 0x45; u8 0x2F;
      u8 0x37; u8 0x45; u8 0x8B; u8 0x20; u8 0x9E; u8 0xD6; u8 0x3A; u8 0x29;
  ...
  let empty : buffer uint8 = createL [] in
  C.String.print (C.String.of_literal "\nTEST 1\n");
  let test1_result : buffer uint8 = create #uint8 #32 (size 32) (u8 0) in

  Hacl.Blake2s.blake2s test1_result test1_plaintext test1_plaintext_len empty test1_empty_len (size 32);
  ...
  (* Hacl.Impl.Blake2s.blake2s test2_plaintext_len test2_plaintext test2_key test2_key_len test2_expected_len test2_result; *)
