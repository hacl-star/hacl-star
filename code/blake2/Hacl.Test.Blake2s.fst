...
let main () =
  ...
  recall test2_key;
  recall test2_expected;
  test_blake2s test2_size_plaintext test2_plaintext test2_size_key test2_key test2_size_expected test2_expected;

  C.String.print (C.String.of_literal "\nTEST 3. \n");
  recall test3_plaintext;
  recall test3_key;
  recall test3_expected;
  test_blake2s test3_size_plaintext test3_plaintext test3_size_key test3_key test3_size_expected test3_expected;

  C.String.print (C.String.of_literal "\nTEST 4. \n");
  recall test4_plaintext;
  recall test4_key;
  recall test4_expected;
  test_blake2s test4_size_plaintext test4_plaintext test4_size_key test4_key test4_size_expected test4_expected;
