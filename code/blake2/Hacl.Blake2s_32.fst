...
(* Some specialized components of blake2. Some declarations cannot be marked as
   inline, because they are called from other C files (the streaming ones),
   which means that MSVC would remove their definitions. *)
