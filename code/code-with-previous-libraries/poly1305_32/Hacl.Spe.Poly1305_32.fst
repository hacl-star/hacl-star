...
#reset-options "--max_fuel 0  --z3rlimit 20 --z3refresh"
...
#reset-options "--max_fuel 0  --z3rlimit 50 --smtencoding.nl_arith_repr native --smtencoding.l_arith_repr native "
...
let invariant (st:poly1305_state_) : GTot Type0 =
  ...
  seval r < pow2 130 - 5 /\  red_26 r /\ red_y acc /\ selem acc = poly log (seval r)
...
val poly1305_complete:
  ...
  GTot (acc:seqelem{bounds acc p26 p26 p26 p26 p26
