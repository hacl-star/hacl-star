...
val crypto_box_detached_afternm:
  ...
  (ensures  fun h0 r h1 -> modifies2 c tag h0 h1 /\
    (as_seq h1 tag, as_seq #MUT #uint8 #mlen h1 c) == Spec.box_detached_afternm (as_seq h0 k) (as_seq h0 n) (as_seq #MUT #uint8 #mlen h0 m))
...
val crypto_box_open_detached_afternm:
  ...
  (ensures  fun h0 r h1 -> modifies1 m h0 h1 /\
   (let msg = Spec.box_open_detached_afternm (as_seq h0 k) (as_seq h0 n) (as_seq h0 tag) (as_seq #MUT #uint8 #mlen h0 c) in
    match r with
...
val crypto_box_easy_afternm:
  ...
  (ensures  fun h0 r h1 -> modifies1 c h0 h1 /\
    as_seq #MUT #uint8 #(mlen +! 16ul) h1 c ==
      Spec.box_easy_afternm (as_seq h0 k) (as_seq h0 n) (as_seq #MUT #uint8 #mlen h0 m))
...
val crypto_box_open_easy_afternm:
  ...
  (ensures fun h0 r h1 -> modifies1 m h0 h1 /\
   (let msg = Spec.box_open_easy_afternm (as_seq h0 k) (as_seq h0 n) (as_seq #MUT #uint8 #clen h0 c) in
    match r with
