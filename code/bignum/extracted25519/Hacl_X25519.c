...
static const uint64_t Hacl_Bignum_Modulo_two54m152 = (uint64_t )0x3fffffffffff68;

static const uint64_t Hacl_Bignum_Modulo_two54m8 = (uint64_t )0x3ffffffffffff8;

static const uint64_t Hacl_Bignum_Modulo_nineteen = (uint64_t )19;

static const uint64_t Hacl_Bignum_Modulo_mask_51 = (uint64_t )0x7ffffffffffff;
...
static inline force_inline void Hacl_Bignum_Modulo_carry_top(uint64_t *b)
{
  ...
  uint64_t b0_ = b0 + Hacl_Bignum_Modulo_nineteen * (b4 >> (uint32_t )51);
  b[(uint32_t )4] = b4_;
  b[(uint32_t )0] = b0_;
}
...
{
  uint64_t b0 = b[(uint32_t )0];
  b[(uint32_t )0] = Hacl_Bignum_Modulo_nineteen * b0;
}
...
static inline force_inline void Hacl_Bignum_Modulo_carry_top_wide(FStar_UInt128_t *b)
{
  ...
  b0_ =
    FStar_UInt128_add(b0,
      FStar_UInt128_mul_wide(Hacl_Bignum_Modulo_nineteen,
...
Hacl_Bignum_fdifference(uint64_t* out, const uint64_t* in) {
  ...
  out[0] = in[0] + Hacl_Bignum_Modulo_two54m152 - out[0];
  out[1] = in[1] + Hacl_Bignum_Modulo_two54m8 - out[1];
  out[2] = in[2] + Hacl_Bignum_Modulo_two54m8 - out[2];
  out[3] = in[3] + Hacl_Bignum_Modulo_two54m8 - out[3];
  out[4] = in[4] + Hacl_Bignum_Modulo_two54m8 - out[4];
}
...
static inline force_inline uint64_t *Hacl_EC_Point_getx(uint64_t *p)
{
  return p + (uint32_t )0;
}

static inline force_inline uint64_t *Hacl_EC_Point_gety(uint64_t *p)
{
  return p + (uint32_t )0;
}

static inline force_inline uint64_t *Hacl_EC_Point_getz(uint64_t *p)
{
  return p + (uint32_t )5;
}

static inline force_inline uint64_t *Hacl_EC_Point_make(uint64_t *x, uint64_t *y, uint64_t *z)
{
  return x;
}

static inline force_inline bool Hacl_EC_Point_valid(FStar_HyperStack_mem h, uint64_t *p)
{
...
static inline force_inline void Hacl_EC_Point_copy(uint64_t *output, uint64_t *input)
{
...
static const uint8_t Hacl_EC_Format_zero_8 = (uint8_t )0;
...
void Hacl_EC_Format_fexpand(uint64_t *output, uint8_t *input)
{
  ...
  uint64_t output0 = i0 & Hacl_Bignum_Modulo_mask_51;
  uint64_t output1 = i1 >> (uint32_t )3 & Hacl_Bignum_Modulo_mask_51;
  uint64_t output2 = i2 >> (uint32_t )6 & Hacl_Bignum_Modulo_mask_51;
  uint64_t output3 = i3 >> (uint32_t )1 & Hacl_Bignum_Modulo_mask_51;
  uint64_t output4 = i4 >> (uint32_t )12 & Hacl_Bignum_Modulo_mask_51;
...
void Hacl_EC_Format_fcontract(uint8_t *output, uint64_t *input)
{
  ...
  uint64_t t01 = t00 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t21 = t20 + (t11 >> (uint32_t )51);
  uint64_t t12 = t11 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t31 = t30 + (t21 >> (uint32_t )51);
  uint64_t t22 = t21 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t41 = t40 + (t31 >> (uint32_t )51);
  uint64_t t32 = t31 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t02 = t01 + Hacl_Bignum_Modulo_nineteen * (t41 >> (uint32_t )51);
  uint64_t t42 = t41 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t13 = t12 + (t02 >> (uint32_t )51);
  uint64_t t03 = t02 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t23 = t22 + (t13 >> (uint32_t )51);
  uint64_t t14 = t13 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t33 = t32 + (t23 >> (uint32_t )51);
  uint64_t t24 = t23 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t43 = t42 + (t33 >> (uint32_t )51);
  uint64_t t34 = t33 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t04 = t03 + Hacl_Bignum_Modulo_nineteen * (t43 >> (uint32_t )51);
  uint64_t t44 = t43 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t05 = t04 + Hacl_Bignum_Modulo_nineteen;
  uint64_t t15 = t14 + (t05 >> (uint32_t )51);
  uint64_t t06 = t05 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t25 = t24 + (t15 >> (uint32_t )51);
  uint64_t t16 = t15 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t35 = t34 + (t25 >> (uint32_t )51);
  uint64_t t26 = t25 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t45 = t44 + (t35 >> (uint32_t )51);
  uint64_t t36 = t35 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t07 = t06 + Hacl_Bignum_Modulo_nineteen * (t45 >> (uint32_t )51);
  uint64_t t46 = t45 & Hacl_Bignum_Modulo_mask_51;
  uint64_t two52 = (uint64_t )0x8000000000000;
  uint64_t t08 = t07 + two52 - Hacl_Bignum_Modulo_nineteen;
  ...
  uint64_t t0 = t08 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t28 = t27 + (t18 >> (uint32_t )51);
  uint64_t t1 = t18 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t38 = t37 + (t28 >> (uint32_t )51);
  uint64_t t2 = t28 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t48 = t47 + (t38 >> (uint32_t )51);
  uint64_t t3 = t38 & Hacl_Bignum_Modulo_mask_51;
  uint64_t t4 = t48 & Hacl_Bignum_Modulo_mask_51;
