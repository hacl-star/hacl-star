...
#ifndef __Hacl_Bignum_Fdifference_Spec_H
#define __Hacl_Bignum_Fdifference_Spec_H
...
void *Hacl_Bignum_Fdifference_Spec_fdifference_spec(void *a, void *b, Prims_nat ctr);
#endif
