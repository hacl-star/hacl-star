...
val mod_precomp: k:GF.bn_mont_ctx_u64 -> BS.bn_mod_slow_ctx_st t_limbs k
...
[@@ Comment "Write `a ^ b mod n` in `res`.
  ...
  • b < pow2 bBits
  • a < n "]
val mod_exp_vartime_precomp: k:GF.bn_mont_ctx_u64 -> BS.bn_mod_exp_ctx_st t_limbs k
...
[@@ Comment "Write `a ^ b mod n` in `res`.
  ...
  • b < pow2 bBits
  • a < n "]
val mod_exp_consttime_precomp: k:GF.bn_mont_ctx_u64 -> BS.bn_mod_exp_ctx_st t_limbs k
...
[@@ Comment "Write `a ^ (-1) mod n` in `res`.
  ...
  • 0 < a
  • a < n "]
val mod_inv_prime_vartime_precomp: k:GF.bn_mont_ctx_u64 -> BS.bn_mod_inv_prime_ctx_st t_limbs k
