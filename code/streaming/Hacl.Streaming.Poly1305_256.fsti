...
let state_t = F.state_s (poly1305 M256) () (t M256) (k.I.s ())

noextract
let alloca = F.alloca (poly1305 M256) () (t M256) (k.I.s ())
let malloc = F.malloc (poly1305 M256) () (t M256) (k.I.s ())
let reset = F.reset (poly1305 M256) (G.hide ()) (t M256) (k.I.s ())
[@@ Comment "0 = success, 1 = max length exceeded" ]
let update = F.update (poly1305 M256) (G.hide ()) (t M256) (k.I.s ())
let digest = F.digest (poly1305 M256) () (t M256) (k.I.s ())
