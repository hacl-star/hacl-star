...
let hacl_sha2_224 = hacl_md_index SHA2_224
inline_for_extraction noextract
let hacl_sha2_256 = hacl_md_index SHA2_256
inline_for_extraction noextract
let hacl_sha2_384 = hacl_md_index SHA2_384
inline_for_extraction noextract
...
inline_for_extraction noextract
let alloca_256 : F.alloca_st hacl_sha2_256 = mk_alloca SHA2_256

[@@ Comment
"Allocate initial state for the SHA2_256 hash. The state is to be freed by
calling `free_256`."]
let create_in_256 : F.create_in_st hacl_sha2_256 = mk_create_in SHA2_256
...
let copy_256 : F.copy_st hacl_sha2_256 = mk_copy SHA2_256

[@@ Comment
"Reset an existing state to the initial hash state with empty data."]
let init_256 : F.init_st hacl_sha2_256 = mk_init SHA2_256

[@@ CInline ]
private
let update_224_256 : F.update_st hacl_sha2_256 = mk_update SHA2_256
...
let update_256: F.update_st hacl_sha2_256 = fun p input input_len -> update_224_256 p input input_len
...
let finish_256 : F.finish_st hacl_sha2_256 = mk_finish SHA2_256

[@@ Comment
"Free a state allocated with `create_in_256`.

This function is identical to the free function for SHA2_224."]
let free_256 : F.free_st hacl_sha2_256 = mk_free SHA2_256
...
inline_for_extraction noextract
let alloca_224 : F.alloca_st hacl_sha2_224 = mk_alloca SHA2_224
let create_in_224 : F.create_in_st hacl_sha2_224 = mk_create_in SHA2_224
let init_224 : F.init_st hacl_sha2_224 = mk_init SHA2_224

// We assume verified clients will rely on Spec.SHA2.Lemmas to prove that update_224 has the same effect as update_256.
let update_224: F.update_st hacl_sha2_256 = fun p input input_len -> update_224_256 p input input_len
...
[@@ CInline ]
private
let update_384_512 : F.update_st hacl_sha2_512 = mk_update SHA2_512
[@@ Comment
"Feed an arbitrary amount of data into the hash. This function returns 0 for
...
let update_512: F.update_st hacl_sha2_512 = fun p input input_len -> update_384_512 p input input_len
...
the state and therefore does not invalidate the client-held state `p`.)"]
let finish_512 : F.finish_st hacl_sha2_512 = mk_finish SHA2_512
...
let free_512 : F.free_st hacl_sha2_512 = mk_free SHA2_512
...
inline_for_extraction noextract
let alloca_384 : F.alloca_st hacl_sha2_384 = mk_alloca SHA2_384
let create_in_384 : F.create_in_st hacl_sha2_384 = mk_create_in SHA2_384
let init_384 : F.init_st hacl_sha2_384 = mk_init SHA2_384
let update_384 : F.update_st hacl_sha2_512 = fun p input input_len -> update_384_512 p input input_len
...
let finish_384 : F.finish_st hacl_sha2_384 = mk_finish SHA2_384

let free_384 : F.free_st hacl_sha2_512 = fun p -> free_512 p
