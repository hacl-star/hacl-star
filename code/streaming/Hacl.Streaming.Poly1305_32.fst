...
let poly1305_32_state = F.state_s (poly1305 M32) () (t M32) (poly1305_key.I.s ())

noextract
let alloca = F.alloca (poly1305 M32) () (t M32) (poly1305_key.I.s ())
let create_in = F.create_in (poly1305 M32) () (t M32) (poly1305_key.I.s ())
let init = F.init (poly1305 M32) (G.hide ()) (t M32) (poly1305_key.I.s ())
[@@ Comment "0 = success, 1 = max length exceeded" ]
let update = F.update (poly1305 M32) (G.hide ()) (t M32) (poly1305_key.I.s ())
let finish = F.mk_finish (poly1305 M32) () (t M32) (poly1305_key.I.s ())
