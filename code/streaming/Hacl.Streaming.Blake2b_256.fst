...
let blake2b_256_state = F.state_s blake2b_256 () (s Spec.Blake2B M256) optional_key_blake2

/// No key
inline_for_extraction noextract
let blake2b_256_no_key_alloca =
  F.alloca blake2b_256 () (s Spec.Blake2B M256) optional_key_blake2

[@ (Comment "  State allocation function when there is no key")]
let blake2b_256_no_key_create_in =
  F.create_in blake2b_256 () (s Spec.Blake2B M256) optional_key_blake2

[@ (Comment "  (Re-)initialization function when there is no key")]
let blake2b_256_no_key_init =
  F.init blake2b_256 () (s Spec.Blake2B M256) optional_key_blake2

[@ (Comment "  Update function when there is no key")]
let blake2b_256_no_key_update =
  F.update blake2b_256 (G.hide ()) (s Spec.Blake2B M256) optional_key_blake2

[@ (Comment "  Finish function when there is no key")]
let blake2b_256_no_key_finish =
  F.mk_finish blake2b_256 () (s Spec.Blake2B M256) optional_key_blake2

[@ (Comment "  Free state function when there is no key")]
let blake2b_256_no_key_free =
  F.free blake2b_256 (G.hide ()) (s Spec.Blake2B M256) optional_key_blake2
