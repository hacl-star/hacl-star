...
let blake2s_128_no_key_malloc =
  F.malloc (blake2s_128 0) () (s Spec.Blake2S M128) (empty_key Spec.Blake2S)

[@ (Comment "  Re-initialization function when there is no key")]
let blake2s_128_no_key_reset =
  F.reset (blake2s_128 0) () (s Spec.Blake2S M128) (empty_key Spec.Blake2S)
...
let blake2s_128_no_key_digest =
  F.digest (blake2s_128 0) () (s Spec.Blake2S M128) (empty_key Spec.Blake2S)
