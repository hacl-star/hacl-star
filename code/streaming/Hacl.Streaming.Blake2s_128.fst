...
let blake2s_128_state = F.state_s blake2s_128 () (s Spec.Blake2S M128) optional_key_blake2

/// No key
inline_for_extraction noextract
let blake2s_128_no_key_alloca =
  F.alloca blake2s_128 () (s Spec.Blake2S M128) optional_key_blake2

[@ (Comment "  State allocation function when there is no key")]
let blake2s_128_no_key_create_in =
  F.create_in blake2s_128 () (s Spec.Blake2S M128) optional_key_blake2

[@ (Comment "  (Re-)initialization function when there is no key")]
let blake2s_128_no_key_init =
  F.init blake2s_128 () (s Spec.Blake2S M128) optional_key_blake2

[@ (Comment "  Update function when there is no key")]
let blake2s_128_no_key_update =
  F.update blake2s_128 (G.hide ()) (s Spec.Blake2S M128) optional_key_blake2

[@ (Comment "  Finish function when there is no key")]
let blake2s_128_no_key_finish =
  F.mk_finish blake2s_128 () (s Spec.Blake2S M128) optional_key_blake2

[@ (Comment "  Free state function when there is no key")]
let blake2s_128_no_key_free =
  F.free blake2s_128 (G.hide ()) (s Spec.Blake2S M128) optional_key_blake2
