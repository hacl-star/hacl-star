...
let state_t = F.state_s (blake2s_32 0ul) () (Common.s Spec.Blake2S Core.M32) (Common.empty_key Spec.Blake2S)
...
inline_for_extraction noextract
let alloca =
  F.alloca (blake2s_32 0ul) () (Common.s Spec.Blake2S Core.M32) (Common.empty_key Spec.Blake2S)

[@ (Comment "  State allocation function when there is no key")]
let malloc =
  F.malloc (blake2s_32 0ul) () (Common.s Spec.Blake2S Core.M32) (Common.empty_key Spec.Blake2S)

[@ (Comment "  Re-initialization function when there is no key")]
let reset =
  F.reset (blake2s_32 0ul) () (Common.s Spec.Blake2S Core.M32) (Common.empty_key Spec.Blake2S)

[@ (Comment "  Update function when there is no key; 0ul = success, 1 = max length exceeded")]
let update =
  F.update (blake2s_32 0ul) (G.hide ()) (Common.s Spec.Blake2S Core.M32) (Common.empty_key Spec.Blake2S)

[@ (Comment "  Finish function when there is no key")]
let digest =
  F.digest (blake2s_32 0ul) () (Common.s Spec.Blake2S Core.M32) (Common.empty_key Spec.Blake2S)

[@ (Comment "  Free state function when there is no key")]
let free =
  F.free (blake2s_32 0ul) (G.hide ()) (Common.s Spec.Blake2S Core.M32) (Common.empty_key Spec.Blake2S)
