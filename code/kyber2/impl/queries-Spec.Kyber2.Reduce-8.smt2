...
; encoding sigelt csubq_int16


; <Skipped Spec.Kyber2.Reduce.csubq_int16/>


; Starting query at Spec.Kyber2.Reduce.fst(308,2-320,10)

(push)
(declare-fun label_482 () Bool)
...
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(145,22-145,30); use=Spec.Kyber2.Reduce.fst(307,4-307,15)
(or label_482
