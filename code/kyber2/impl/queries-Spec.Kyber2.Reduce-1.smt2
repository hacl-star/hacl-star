...
; UNSAT CORE: @query, constructor_distinct_Lib.IntTypes.S16, constructor_distinct_Lib.IntTypes.S32, equality_tok_Lib.IntTypes.S16@tok, equality_tok_Lib.IntTypes.S32@tok, equation_Lib.IntTypes.bits, equation_Lib.IntTypes.range, equation_Lib.IntTypes.unsigned, equation_Spec.Kyber2.Params.params_q, primitive_Prims.op_Minus, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0

;;; End module Prims (688 decls; total size 34207)
...
;;; End module FStar.Pervasives.Native (1323 decls; total size 118851)
...
;;; End module FStar.Pervasives (1050 decls; total size 58742)
...
;;; End module FStar.Mul (6 decls; total size 595)
...
;;; End module FStar.Preorder (42 decls; total size 2070)
...
;;; End module FStar.Calc (212 decls; total size 14766)
...
;;; End module FStar.Classical (174 decls; total size 11880)
...
;;; End module FStar.StrongExcludedMiddle (8 decls; total size 857)
...
;;; End module FStar.FunctionalExtensionality (232 decls; total size 9021)
...
;;; End module FStar.List.Tot.Base (637 decls; total size 81318)
...
;;; End module FStar.List.Tot.Properties (449 decls; total size 46795)

;;; Start module FStar.List.Tot

; UNSAT CORE: @query, constructor_distinct_Lib.IntTypes.S16, constructor_distinct_Lib.IntTypes.S32, equality_tok_Lib.IntTypes.S16@tok, equality_tok_Lib.IntTypes.S32@tok, equation_Lib.IntTypes.bits, equation_Lib.IntTypes.range, equation_Lib.IntTypes.unsigned, equation_Spec.Kyber2.Params.params_q, primitive_Prims.op_Minus, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0

;;; End module FStar.List.Tot (1 decls; total size 424)
...
;;; End module FStar.Seq.Base (249 decls; total size 15950)
...
;;; End module FStar.Squash (88 decls; total size 3648)
...
;;; End module FStar.Seq.Properties (797 decls; total size 66204)

;;; Start module FStar.Seq

; UNSAT CORE: @query, constructor_distinct_Lib.IntTypes.S16, constructor_distinct_Lib.IntTypes.S32, equality_tok_Lib.IntTypes.S16@tok, equality_tok_Lib.IntTypes.S32@tok, equation_Lib.IntTypes.bits, equation_Lib.IntTypes.range, equation_Lib.IntTypes.unsigned, equation_Spec.Kyber2.Params.params_q, primitive_Prims.op_Minus, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0

;;; End module FStar.Seq (1 decls; total size 424)
...
;;; End module FStar.Math.Lib (136 decls; total size 11151)
...
;;; End module FStar.Math.Lemmas (482 decls; total size 42657)
...
;;; End module FStar.BitVector (148 decls; total size 15024)
...
;;; End module FStar.UInt (752 decls; total size 49000)
...
;;; End module FStar.Int (560 decls; total size 29300)
...
;;; End module FStar.UInt32 (384 decls; total size 15965)
...
;;; End module FStar.Int64 (282 decls; total size 11413)
...
;;; End module FStar.Int128 (289 decls; total size 11914)
...
;;; End module FStar.Int32 (282 decls; total size 11413)
...
;;; End module FStar.Int16 (282 decls; total size 11413)
...
;;; End module FStar.Int8 (282 decls; total size 11237)
...
;;; End module FStar.UInt64 (384 decls; total size 15965)
...
;;; End module FStar.UInt128 (303 decls; total size 12869)
...
;;; End module FStar.UInt16 (384 decls; total size 15965)
...
;;; End module FStar.UInt8 (387 decls; total size 15840)
...
;;; End module Lib.IntTypes (1384 decls; total size 71853)
...
;;; End module Spec.Unsafe (8 decls; total size 787)
...
;;; End module Kyber2.Params (46 decls; total size 2704)
...
;;; End module Spec.Kyber2.Params (56 decls; total size 3735)
...
; Starting query at Spec.Kyber2.Reduce.fst(183,2-184,22)

(push)
(declare-fun label_226 () Bool)
(declare-fun label_225 () Bool)
(declare-fun label_224 () Bool)
(declare-fun label_223 () Bool)
(declare-fun label_222 () Bool)
...
;     x:
;     Prims.unit
;       {Prims.c_and (x: Prims.unit{Prims.equals true true}) (x: Prims.unit{Prims.equals true true})} /\
;     (forall (pure_result: Prims.unit).
;         Lib.IntTypes.range (Prims.pow2 26 / 3329 + 1) (Lib.IntTypes.S16) ==>
;         (forall (pure_result: Prims.unit). Prims.pow2 15 < Prims.pow2 31 ==> p pure_result))
...
;; def=prims.fst(237,46-237,106); use=Spec.Kyber2.Reduce.fst(183,2-184,22)
(forall ((@x2 Term))
 (! (implies (and (or label_222
(HasType @x2
Prims.unit))

;; def=Spec.Kyber2.Reduce.fst(182,57-182,91); use=Spec.Kyber2.Reduce.fst(183,2-184,22)
(or label_223
...
;; def=Spec.Kyber2.Reduce.fst(182,95-182,129); use=Spec.Kyber2.Reduce.fst(183,2-184,22)
(or label_224
...
;; def=prims.fst(237,92-237,105); use=Spec.Kyber2.Reduce.fst(183,2-184,22)
(Valid 
;; def=prims.fst(237,92-237,105); use=Spec.Kyber2.Reduce.fst(183,2-184,22)
(ApplyTT @x1
@x2)
...
;; def=prims.fst(237,39-237,106); use=Spec.Kyber2.Reduce.fst(183,2-183,13)
(and 
...
;; def=prims.fst(237,46-237,106); use=Spec.Kyber2.Reduce.fst(183,2-183,13)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=Spec.Kyber2.Reduce.fst(183,14-183,50); use=Spec.Kyber2.Reduce.fst(183,2-183,13)
(Valid 
;; def=Spec.Kyber2.Reduce.fst(183,14-183,50); use=Spec.Kyber2.Reduce.fst(183,2-183,13)
(Lib.IntTypes.range (Prims.op_Addition (Prims.op_Division (Prims.pow2 (BoxInt 26))
(BoxInt 3329))
...
;; def=prims.fst(237,46-237,106); use=Spec.Kyber2.Reduce.fst(184,2-184,16)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=FStar.Math.Lemmas.fst(165,12-165,29); use=Spec.Kyber2.Reduce.fst(184,2-184,16)
(< (BoxInt_proj_0 (Prims.pow2 (BoxInt 15)))
(BoxInt_proj_0 (Prims.pow2 (BoxInt 31))))
)

;; def=prims.fst(237,92-237,105); use=Spec.Kyber2.Reduce.fst(184,2-184,16)
(Valid 
;; def=prims.fst(237,92-237,105); use=Spec.Kyber2.Reduce.fst(184,2-184,16)
(ApplyTT @x1
@x3)
