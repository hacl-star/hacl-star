...
; UNSAT CORE: @query, constructor_distinct_Lib.IntTypes.S16, equality_tok_Lib.IntTypes.S16@tok, equation_Lib.IntTypes.signed, projection_inverse_BoxBool_proj_0

;;; End module Prims (686 decls; total size 33259)
...
;;; End module FStar.Pervasives.Native (1323 decls; total size 118588)
...
;;; End module FStar.Pervasives (1050 decls; total size 58479)
...
;;; End module FStar.Mul (6 decls; total size 332)
...
;;; End module FStar.Preorder (42 decls; total size 1807)
...
;;; End module FStar.Calc (212 decls; total size 14503)
...
;;; End module FStar.Classical (174 decls; total size 11617)
...
;;; End module FStar.StrongExcludedMiddle (8 decls; total size 594)
...
;;; End module FStar.FunctionalExtensionality (232 decls; total size 8758)
...
;;; End module FStar.List.Tot.Base (637 decls; total size 81055)
...
;;; End module FStar.List.Tot.Properties (449 decls; total size 46532)

;;; Start module FStar.List.Tot

; UNSAT CORE: @query, constructor_distinct_Lib.IntTypes.S16, equality_tok_Lib.IntTypes.S16@tok, equation_Lib.IntTypes.signed, projection_inverse_BoxBool_proj_0

;;; End module FStar.List.Tot (1 decls; total size 161)
...
;;; End module FStar.Seq.Base (249 decls; total size 15687)
...
;;; End module FStar.Squash (88 decls; total size 3385)
...
;;; End module FStar.Seq.Properties (797 decls; total size 65941)

;;; Start module FStar.Seq

; UNSAT CORE: @query, constructor_distinct_Lib.IntTypes.S16, equality_tok_Lib.IntTypes.S16@tok, equation_Lib.IntTypes.signed, projection_inverse_BoxBool_proj_0

;;; End module FStar.Seq (1 decls; total size 161)
...
;;; End module FStar.Math.Lib (136 decls; total size 10888)
...
;;; End module FStar.Math.Lemmas (482 decls; total size 42394)
...
;;; End module FStar.BitVector (148 decls; total size 14761)
...
;;; End module FStar.UInt (752 decls; total size 48737)
...
;;; End module FStar.Int (560 decls; total size 29037)
...
;;; End module FStar.UInt32 (384 decls; total size 15702)
...
;;; End module FStar.Int64 (282 decls; total size 11150)
...
;;; End module FStar.Int128 (289 decls; total size 11651)
...
;;; End module FStar.Int32 (282 decls; total size 11150)
...
;;; End module FStar.Int16 (282 decls; total size 11150)
...
;;; End module FStar.Int8 (282 decls; total size 10974)
...
;;; End module FStar.UInt64 (384 decls; total size 15702)
...
;;; End module FStar.UInt128 (303 decls; total size 12606)
...
;;; End module FStar.UInt16 (384 decls; total size 15702)
...
;;; End module FStar.UInt8 (387 decls; total size 15577)
...
;;; End module Lib.IntTypes (1380 decls; total size 67763)
...
;;; End module Spec.Unsafe (8 decls; total size 524)
...
;;; End module Kyber2.Params (46 decls; total size 2441)
...
;;; End module Spec.Kyber2.Params (55 decls; total size 2848)
...
; encoding sigelt barrett_range_t


; <Start encoding Spec.Kyber2.Reduce.barrett_range_t>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Spec.Kyber2.Reduce.barrett_range_t (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Spec.Kyber2.Reduce.barrett_range_t@tok () Term)

; </end encoding Spec.Kyber2.Reduce.barrett_range_t>


; encoding sigelt barrett_range_t3


; <Start encoding Spec.Kyber2.Reduce.barrett_range_t3>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Spec.Kyber2.Reduce.barrett_range_t3 (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Spec.Kyber2.Reduce.barrett_range_t3@tok () Term)

; </end encoding Spec.Kyber2.Reduce.barrett_range_t3>


; encoding sigelt barrett_range_t4_upperbound


; <Start encoding Spec.Kyber2.Reduce.barrett_range_t4_upperbound>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Spec.Kyber2.Reduce.barrett_range_t4_upperbound (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Spec.Kyber2.Reduce.barrett_range_t4_upperbound@tok () Term)

; </end encoding Spec.Kyber2.Reduce.barrett_range_t4_upperbound>


; encoding sigelt barrett_range_t4_lowerbound


; <Start encoding Spec.Kyber2.Reduce.barrett_range_t4_lowerbound>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Spec.Kyber2.Reduce.barrett_range_t4_lowerbound (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Spec.Kyber2.Reduce.barrett_range_t4_lowerbound@tok () Term)

; </end encoding Spec.Kyber2.Reduce.barrett_range_t4_lowerbound>


; encoding sigelt barrett_reduce_int16


; <Start encoding Spec.Kyber2.Reduce.barrett_reduce_int16>

(declare-fun Spec.Kyber2.Reduce.barrett_reduce_int16 (Term) Term)
(declare-fun Tm_refine_950a2e169fb6e6c0017edc945055114e (Term) Term)
;;;;;;;;;;;;;;;;a: Lib.IntTypes.int_t (Lib.IntTypes.S16) (Lib.IntTypes.SEC)   -> Prims.Tot     (t:       Lib.IntTypes.int_t (Lib.IntTypes.S16) (Lib.IntTypes.SEC)         { Lib.IntTypes.v t % 3329 = Lib.IntTypes.v a % 3329 /\ 0 <= Lib.IntTypes.v t /\           Lib.IntTypes.v t <= 3329 })
(declare-fun Tm_arrow_c80189908a51d2768d31fca31c5ac54a () Term)
(declare-fun Spec.Kyber2.Reduce.barrett_reduce_int16@tok () Term)


; </end encoding Spec.Kyber2.Reduce.barrett_reduce_int16>


; Starting query at Spec.Kyber2.Reduce.fst(303,0-305,100)

(push)
(declare-fun label_481 () Bool)
(declare-fun label_480 () Bool)
(declare-fun label_479 () Bool)
(declare-fun label_478 () Bool)
(declare-fun label_477 () Bool)
(declare-fun label_476 () Bool)
(declare-fun label_475 () Bool)
(declare-fun label_474 () Bool)
(declare-fun Tm_refine_2fd9124f8f660a592a15fe385e31b71d () Term)





(declare-fun Tm_refine_02cc2aff06eb0316648d2125068af8de () Term)


; Encoding query formula: (forall (a: Lib.IntTypes.int_t (Lib.IntTypes.S16) (Lib.IntTypes.SEC)).
;     (*Subtyping check failed; expected type t: Lib.IntTypes.inttype{Lib.IntTypes.signed t}; got type Lib.IntTypes.inttype*)
;     Lib.IntTypes.signed (Lib.IntTypes.S16)) /\
; (forall (a:
;     Lib.IntTypes.int_t (Lib.IntTypes.S16) (Lib.IntTypes.SEC)
;       { Lib.IntTypes.v a - 3329 >=
;         (if Lib.IntTypes.unsigned (Lib.IntTypes.S16)
;           then 0
;           else - Prims.pow2 (Lib.IntTypes.bits (Lib.IntTypes.S16) - 1)) })
;     (t: Lib.IntTypes.int_t (Lib.IntTypes.S16) (Lib.IntTypes.SEC)).
;     Lib.IntTypes.signed (Lib.IntTypes.S16) /\
;     (forall (return_val: Lib.IntTypes.inttype).
;         return_val == Lib.IntTypes.S16 ==>
;         (forall (any_result: x: Prims.int{Lib.IntTypes.range x (Lib.IntTypes.S16)}).
;             Lib.IntTypes.v a == any_result ==>
;             (forall (return_val: x: Prims.int{Lib.IntTypes.range x (Lib.IntTypes.S16)}).
;                 return_val == Lib.IntTypes.v a ==>
;                 Lib.IntTypes.v a == return_val ==>
;                 (forall (any_result: Prims.bool).
;                     Lib.IntTypes.v a >= 3329 == any_result ==>
;                     Lib.IntTypes.v a >= 3329 == true ==>
;                     Lib.IntTypes.signed (Lib.IntTypes.S16) /\
;                     (forall (return_val: Lib.IntTypes.inttype).
;                         return_val == Lib.IntTypes.S16 ==>
;                         (forall (any_result: x: Prims.int{Lib.IntTypes.range x (Lib.IntTypes.S16)}).
;                             Lib.IntTypes.v t == any_result ==>
;                             (forall (return_val:
;                                 x: Prims.int{Lib.IntTypes.range x (Lib.IntTypes.S16)}).
;                                 return_val == Lib.IntTypes.v t ==>
;                                 Lib.IntTypes.v t == return_val ==>
;                                 Lib.IntTypes.signed (Lib.IntTypes.S16)))) /\
;                     ~(Lib.IntTypes.v a >= 3329 == true) ==>
;                     (forall (b: Prims.bool).
;                         Lib.IntTypes.v a >= 3329 == b ==>
;                         Lib.IntTypes.signed (Lib.IntTypes.S16) /\
;                         (forall (return_val: Lib.IntTypes.inttype).
;                             return_val == Lib.IntTypes.S16 ==>
;                             (forall (any_result:
;                                 x: Prims.int{Lib.IntTypes.range x (Lib.IntTypes.S16)}).
;                                 Lib.IntTypes.v t == any_result ==>
;                                 Lib.IntTypes.range (Lib.IntTypes.v t) (Lib.IntTypes.S16) ==>
;                                 (Lib.IntTypes.range (Lib.IntTypes.v t) (Lib.IntTypes.S16) \/
;                                   Lib.IntTypes.range (Lib.IntTypes.v t) (Lib.IntTypes.S16)) /\
;                                 (forall (return_val:
;                                     x:
;                                     Prims.int
;                                       { Lib.IntTypes.range x (Lib.IntTypes.S16) \/
;                                         Lib.IntTypes.range x (Lib.IntTypes.S16) }).
;                                     return_val == Lib.IntTypes.v t ==>
;                                     Lib.IntTypes.v t == return_val ==>
;                                     Lib.IntTypes.signed (Lib.IntTypes.S16) /\
...
;                                             x: Prims.int{Lib.IntTypes.range x (Lib.IntTypes.S16)}).
;                                             Lib.IntTypes.v a == any_result ==>
;                                             Lib.IntTypes.range (Lib.IntTypes.v a) (Lib.IntTypes.S16) ==>
;                                             Lib.IntTypes.range (Lib.IntTypes.v a) (Lib.IntTypes.S16) \/
;                                             Lib.IntTypes.range (Lib.IntTypes.v a) (Lib.IntTypes.S16)
;                                         )))))))))))
...
;;; Fact-ids: 
(assert (! (not 
;; def=<dummy>(0,0-0,0); use=Spec.Kyber2.Reduce.fst(303,0-305,100)
(and 
;; def=<dummy>(0,0-0,0); use=Spec.Kyber2.Reduce.fst(305,5-305,100)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(Lib.IntTypes.int_t Lib.IntTypes.S16@tok
Lib.IntTypes.SEC@tok))

;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(145,22-145,30); use=Spec.Kyber2.Reduce.fst(304,17-304,18)
(or label_474

;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(145,22-145,30); use=Spec.Kyber2.Reduce.fst(305,5-305,100)
...
Tm_refine_2fd9124f8f660a592a15fe385e31b71d)
(HasType @x1
(Lib.IntTypes.int_t Lib.IntTypes.S16@tok
Lib.IntTypes.SEC@tok)))

;; def=prims.fst(208,69-208,78); use=Spec.Kyber2.Reduce.fst(305,5-305,100)
(and 
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(145,22-145,30); use=Spec.Kyber2.Reduce.fst(305,24-305,25)
(or label_475
...
;; def=prims.fst(182,5-182,58); use=Spec.Kyber2.Reduce.fst(305,5-305,100)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Lib.IntTypes.inttype)

;; def=prims.fst(182,28-182,41); use=Spec.Kyber2.Reduce.fst(305,5-305,100)
(= @x2
Lib.IntTypes.S16@tok)
)

;; def=prims.fst(214,45-214,80); use=Spec.Kyber2.Reduce.fst(305,5-305,100)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_refine_b2401a8cabe2f9a01538f32548fa9f6c)

;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(79,27-79,43); use=Spec.Kyber2.Reduce.fst(305,17-305,25)
...
;; def=Spec.Kyber2.Reduce.fst(305,16-305,38); use=Spec.Kyber2.Reduce.fst(305,16-305,38)
(= (Prims.op_GreaterThanOrEqual (Lib.IntTypes.v Lib.IntTypes.S16@tok
Lib.IntTypes.SEC@tok
@x0)
(BoxInt 3329))
@x5)
...
;; def=prims.fst(140,38-140,61); use=Spec.Kyber2.Reduce.fst(305,5-305,100)
(and (implies 
;; def=Spec.Kyber2.Reduce.fst(305,16-305,38); use=Spec.Kyber2.Reduce.fst(305,16-305,38)
(= (Prims.op_GreaterThanOrEqual (Lib.IntTypes.v Lib.IntTypes.S16@tok
Lib.IntTypes.SEC@tok
...
;; def=prims.fst(208,69-208,78); use=Spec.Kyber2.Reduce.fst(305,5-305,100)
(and 
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(145,22-145,30); use=Spec.Kyber2.Reduce.fst(305,51-305,52)
(or label_476
...
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(79,27-79,43); use=Spec.Kyber2.Reduce.fst(305,44-305,52)
(= (Lib.IntTypes.v Lib.IntTypes.S16@tok
Lib.IntTypes.SEC@tok
@x1)
@x7)
...
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(145,22-145,30); use=Spec.Kyber2.Reduce.fst(305,62-305,63)
(or label_477
...
(implies 
;; def=prims.fst(140,52-140,54); use=Spec.Kyber2.Reduce.fst(305,5-305,100)
(not 
;; def=Spec.Kyber2.Reduce.fst(305,16-305,38); use=Spec.Kyber2.Reduce.fst(305,16-305,38)
(= (Prims.op_GreaterThanOrEqual (Lib.IntTypes.v Lib.IntTypes.S16@tok
Lib.IntTypes.SEC@tok
...
;; def=prims.fst(205,83-205,103); use=Spec.Kyber2.Reduce.fst(305,5-305,100)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.bool)

;; def=Spec.Kyber2.Reduce.fst(305,16-305,99); use=Spec.Kyber2.Reduce.fst(305,16-305,99)
(= (Prims.op_GreaterThanOrEqual (Lib.IntTypes.v Lib.IntTypes.S16@tok
Lib.IntTypes.SEC@tok
@x0)
(BoxInt 3329))
...
;; def=prims.fst(208,69-208,78); use=Spec.Kyber2.Reduce.fst(305,5-305,100)
(and 
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(145,22-145,30); use=Spec.Kyber2.Reduce.fst(305,87-305,88)
(or label_478
...
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(79,27-79,42); use=Spec.Kyber2.Reduce.fst(305,80-305,97)
(= (Lib.IntTypes.v Lib.IntTypes.S16@tok
Lib.IntTypes.SEC@tok
@x1)
@x8)
...
;; def=prims.fst(208,69-208,78); use=Spec.Kyber2.Reduce.fst(305,5-305,100)
(and (implies 
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(79,33-79,42); use=Spec.Kyber2.Reduce.fst(305,80-305,86)
(Valid 
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(79,33-79,42); use=Spec.Kyber2.Reduce.fst(305,80-305,86)
(Lib.IntTypes.range (Lib.IntTypes.v Lib.IntTypes.S16@tok
Lib.IntTypes.SEC@tok
@x1)
Lib.IntTypes.S16@tok)
)
...
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(79,33-79,42); use=Spec.Kyber2.Reduce.fst(305,80-305,88)
(or label_479
...
Tm_refine_02cc2aff06eb0316648d2125068af8de)
...
;; def=prims.fst(208,69-208,78); use=Spec.Kyber2.Reduce.fst(305,5-305,100)
(and 
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(145,22-145,30); use=Spec.Kyber2.Reduce.fst(305,98-305,99)
(or label_480
...
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(79,27-79,42); use=Spec.Kyber2.Reduce.fst(305,80-305,99)
(= (Lib.IntTypes.v Lib.IntTypes.S16@tok
Lib.IntTypes.SEC@tok
@x0)
@x11)
...
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(79,33-79,42); use=Spec.Kyber2.Reduce.fst(305,91-305,97)
(Valid 
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(79,33-79,42); use=Spec.Kyber2.Reduce.fst(305,91-305,97)
(Lib.IntTypes.range (Lib.IntTypes.v Lib.IntTypes.S16@tok
Lib.IntTypes.SEC@tok
...
;; def=/home/caerbannog/dev/hacl-star/lib/Lib.IntTypes.fsti(79,33-79,42); use=Spec.Kyber2.Reduce.fst(305,91-305,99)
(or label_481
