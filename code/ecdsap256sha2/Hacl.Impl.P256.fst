...
(*
val _ecp256dh_r: result: lbuffer uint64 (size 8) -> p: lbuffer uint64 (size 8) -> 
  scalar: lbuffer uint8 (size 32) -> Stack uint64 
...
(*
let _ecp256dh_r result p scalar = 
  push_frame();
    let tempBuffer = create (size 100) (u64 0) in 
    let publicKeyBuffer = create (size 12) (u64 0) in 
    bufferToJac p publicKeyBuffer;
    let publicKeyyCorrect = verifyQValidCurvePoint publicKeyBuffer tempBuffer in 
