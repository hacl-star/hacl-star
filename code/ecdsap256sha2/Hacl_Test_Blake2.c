...
uint8_t m0[32U] = {
	0xc9,  0xbd,  0x5b,  0x35,  0xd4,  0x8f,  0x71,  0xb4,  0x86,  0x56,  0xc3,  0x9e,  0x39,  0x5e,  0x4d,  0x13,  0x8a,  0x45,  0xdf,  0x54,  0xb7,  0xc0,  0x3f,  0xad,  0x73,  0x30,  0xf5,  0xfa,  0x3f,  0x42,  0xa4,  0x4d

};

uint8_t m1[32U] = {
	0xc2,  0xa4,  0x9d,  0xc5,  0x14,  0x1a,  0xfd,  0xf0,  0x24,  0x80,  0xdc,  0x2e,  0x9d,  0x7e,  0xc3,  0xf6,  0x02,  0xcc,  0xc6,  0xcf,  0x32,  0x2a,  0x0a,  0x9b,  0x48,  0x1c,  0x80,  0xd3,  0x71,  0x70,  0x71,  0x3c
};



uint8_t r00[32U] = {
	0x29,  0x93,  0xE8,  0x9E,  0xF2,  0x19,  0x0B,  0x13,  0x34,  0x49,  0x44,  0x7C,  0x01,  0x4A,  0x35,  0x8E,  0x44,  0x61,  0x82,  0x24,  0xE5,  0x2C,  0x27,  0xAC,  0x83,  0xB3,  0x46,  0x8D,  0x61,  0x5F,  0xC3,  0x90
};

uint8_t s00[32U] = {
	0x7A,  0x39,  0x8C,  0x8E,  0x09,  0x35,  0x9F,  0x54,  0xE1,  0xE5,  0x30,  0x1F,  0x0A,  0x70,  0xDA,  0x61,  0xBC,  0xA0,  0xEF,  0xC1,  0x5F,  0x03,  0x7A,  0x0A,  0x74,  0x5B,  0x78,  0xD2,  0x5F,  0x6A,  0xBD,  0x8F
};


uint8_t r01[32U] = {
	0x6F,  0x89,  0xD7,  0x30,  0xF8,  0xF9,  0x5B,  0xA3,  0x27,  0x76,  0xE7,  0xFA,  0x13,  0x63,  0x17,  0x76,  0x15,  0xB5,  0x95,  0x54,  0x05,  0x01,  0x7A,  0xEF,  0x0D,  0xD7,  0xC2,  0x47,  0x48,  0x50,  0x76,  0x4E
};

uint8_t s01[32U] = {
	0x68,  0x1D,  0xF8,  0xE9,  0x54,  0x18,  0x92,  0xB1,  0x65,  0xE3,  0x50,  0x68,  0x92,  0x46,  0x91,  0x8B,  0x97,  0x13,  0xD9,  0xE4,  0xFF,  0x03,  0x8C,  0x36,  0x89,  0xBC,  0x46,  0x37,  0x5C,  0xFC,  0xB7,  0xB7
};
...
void test10()
{
	uint8_t* publicKeyDecompressed = (uint8_t *) malloc (sizeof (uint8_t) * 64);
	Hacl_Impl_ECDSA_decompressionCompressedForm(encodedPublicKey0, publicKeyDecompressed);
	bool result = true;
	bool result_ = Hacl_Impl_ECDSA_ecdsa_verification_blake2hl(32, m0, publicKeyDecompressed, r00, s00);
	...
	if (!(result_ == result))
 	...
 	{
 		printf("%s\n", "Verification test 0 is successful" );
 	}
}
...
void test11()
{
	...
	Hacl_Impl_ECDSA_decompressionCompressedForm(encodedPublicKey0, publicKeyDecompressed);
	bool result = true;
	bool result_ = Hacl_Impl_ECDSA_ecdsa_verification_blake2hl(32, m1, publicKeyDecompressed, r01, s01);
	...
	if (!(result_ == result))
 	...
 	{
 		printf("%s\n", "Verification test 1 is successful" );
 	}
}
