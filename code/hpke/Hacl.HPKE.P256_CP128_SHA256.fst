...
let setupBaseS = hpke_setupBaseS_higher #cs True IHK.hkdf_expand256 IHK.hkdf_extract256 IHash.hash_sha256 IDH.secret_to_public_p256 IDH.dh_p256
...
let sealBase = hpke_sealBase_higher #cs True setupBaseS IAEAD.aead_encrypt_cp128
