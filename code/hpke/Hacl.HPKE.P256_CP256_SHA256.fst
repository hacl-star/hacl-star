...
@param o_pkE Pointer to 64 bytes where the ephemeral public key is written to.
...
@param pkR Pointer to 64 bytes where the recipient's public key is read from.
...
@param o_ctx The encryption context to initialize.
@param enc Pointer to 64 bytes where the encapsulated key is read from.
...
@param o_enc Pointer to 64 bytes where the encapsulated key is written to.
...
@param pkE Pointer to 64 bytes where the ephemeral public key is read from.
@param skR Pointer to 32 bytes where the recipient's secret key is read from.
@param infolen Length of the info string.
@param info Pointer to `infolen` bytes of info string.
@param aadlen Length of the associated data.
