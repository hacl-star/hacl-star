...
val lemma_k0_computation: #c: curve-> #m: mode -> t: nat -> 
  k0 : uint64 {match m with 
    |DH -> k0 ==  Hacl.Spec.Bignum.ModInvLimb.mod_inv_limb (getLastWordPrime #c)
    |DSA -> k0 ==  Hacl.Spec.Bignum.ModInvLimb.mod_inv_limb (getLastWordOrder #c)} ->
...
let lemma_k0_computation #c #m t k0 = 
  ...
  Hacl.Spec.Bignum.ModInvLimb.mod_inv_limb_lemma (getLastWordOrder #c);
