...
let ecp384dh_r_public_ml result pubKey scalar = Hacl.Impl.EC.DH.ecp256dh_r_public #P384 #MontLadder result pubKey scalar

let ecp384dh_r_public_radix result pubKey scalar = Hacl.Impl.EC.DH.ecp256dh_r_public #P384 #Radix result pubKey scalar

let ecp384dh_r_private_ml result pubKey scalar = Hacl.Impl.EC.DH.ecp256dh_r_public #P384 #MontLadder result pubKey scalar

let ecp384dh_r_private_radix result pubKey scalar = Hacl.Impl.EC.DH.ecp256dh_r_public #P384 #Radix result pubKey scalar
