...
val lemma_exp_4_0: a: int -> b: int -> c: int -> Lemma (a * b * c % prime256 == a * (b * c) % prime256)

let lemma_exp_4_0 a b c = ()

val lemma_exp_4_1: tD: nat -> a1: nat -> b1: nat -> c1: nat -> 
  Lemma (pow tD (b1 * pow2 32) * (pow tD (a1 * pow2 64) * (pow (pow tD c1 % prime256) (pow2 2) * tD)) == 
    pow (pow tD c1 % prime256) (pow2 2) * (pow tD (b1 * pow2 32) * (pow tD (a1 * pow2 64) * tD)))

let lemma_exp_4_1 tD a1 b1 c1 = ()
...
let lemma_exp_4 tD = 
  ...
  (==) {lemma_exp_4_1 tD a1 b1 c1}
  pow (pow tD c1 % prime256) pow2_2 * (pow tD (b1 * pow2_32) * (pow tD (a1 * pow2_64) * tD)) % prime256;
