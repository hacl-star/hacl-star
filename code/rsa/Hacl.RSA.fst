...
val rsa_dec:
  modBits:modBits_t ->
  RI.rsa_dec_st t_limbs (ke modBits) modBits
let rsa_dec modBits eBits dBits skey cipher plain =
  RI.rsa_dec_skey (ke modBits) modBits eBits dBits skey cipher plain
...
val rsa_enc:
  modBits:modBits_t ->
  RI.rsa_enc_st t_limbs (ke modBits) modBits
let rsa_enc modBits eBits pkey plain cipher =
  RI.rsa_enc_pkey #t_limbs (ke modBits) modBits eBits pkey plain cipher
