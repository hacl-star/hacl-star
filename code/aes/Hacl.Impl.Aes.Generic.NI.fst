...
val aes_init: keyx:keyex -> nvec:key1 -> key:skey -> nonce:lbytes 12 -> rounds:size_t -> ST unit
...
let aes_init keyx (nvec:key1) key nonce rounds = 
  push_frame();
  key_expansion keyx key ; // rounds
...
let aes128_ctr out inp len key nonce counter = 
  ...
  aes_init kex nvec key nonce (size 10);
