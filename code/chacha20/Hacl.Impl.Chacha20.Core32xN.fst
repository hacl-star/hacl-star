...
let transpose4 st =
  let h0 = ST.get() in
  let (v0,(v1,(v2,v3))) = VecTranspose.transposewxw #U32 #4 (st.(0ul),(st.(1ul),(st.(2ul),st.(3ul)))) in
  let (v4,(v5,(v6,v7))) = VecTranspose.transposewxw #U32 #4 (st.(4ul),(st.(5ul),(st.(6ul),st.(7ul)))) in
  let (v8,(v9,(v10,v11))) = VecTranspose.transposewxw #U32 #4 (st.(8ul),(st.(9ul),(st.(10ul),st.(11ul)))) in
  let (v12,(v13,(v14,v15))) = VecTranspose.transposewxw #U32 #4 (st.(12ul),(st.(13ul),(st.(14ul),st.(15ul)))) in
  st.(0ul) <- v0;
  st.(1ul) <- v4;
  st.(2ul) <- v8;
  st.(3ul) <- v12;
...
let transpose8 st =
  ...
  let (v0,(v1,(v2,(v3,(v4,(v5,(v6,v7))))))) =
    VecTranspose.transposewxw #U32 #8 (st.(0ul),(st.(1ul),(st.(2ul),(st.(3ul),(st.(4ul),(st.(5ul),(st.(6ul),st.(7ul)))))))) in
  let (v8,(v9,(v10,(v11,(v12,(v13,(v14,v15))))))) =
    VecTranspose.transposewxw #U32 #8 (st.(8ul),(st.(9ul),(st.(10ul),(st.(11ul),(st.(12ul),(st.(13ul),(st.(14ul),st.(15ul)))))))) in
  let h1 = ST.get() in
  assert (modifies (loc st)  h0 h1);
  st.(0ul) <- v0;
  st.(1ul) <- v8;
