...
val poly1305_init:
  ...
  -> Stack unit
    ...
    (ensures  fun h0 _ h1 ->
      ...
      (as_get_acc h1 ctx, as_get_r #M256 h1 ctx) == S.poly1305_init (as_seq h0 key))
let poly1305_init ctx key =
  poly1305_init #M256 ctx key
...
val poly1305_update_blocks:
  ...
  -> Stack unit
    ...
    (ensures  fun h0 _ h1 ->
      modifies (loc ctx) h0 h1 /\
      state_inv_t #M256 h1 ctx /\
      as_get_acc #M256 h1 ctx == S.poly (as_seq h0 text) (as_get_acc h0 ctx) (as_get_r h0 ctx))
let poly1305_update_blocks ctx len text =
  poly1305_update #M256 ctx len text
...
val poly1305_finish:
  ...
  -> Stack unit
    ...
    (ensures  fun h0 _ h1 ->
      ...
      as_seq h1 tag == S.finish (as_seq h0 key) (as_get_acc #M256 h0 ctx))
let poly1305_finish tag k ctx =
  poly1305_finish #M256 tag k ctx
...
val poly1305_mac:
  ...
  -> Stack unit
    ...
    (ensures  fun h0 _ h1 ->
      ...
      as_seq h1 o == S.poly1305 #4 (as_seq #MUT #uint8 #len h0 text) (as_seq h0 key))
let poly1305_mac o t l k =
  poly1305_mac #M256 o l t k
