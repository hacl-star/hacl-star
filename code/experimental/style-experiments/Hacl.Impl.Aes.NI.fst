...
[@ CInline ]
let enc_rounds st key n = enc_rounds #MAES st key n
...
[@ CInline ]
let key_expansion128 keyx key = key_expansion128 #MAES keyx key
...
val aes256_init: ctx:aes_ctx -> key:skey -> nonce:lbytes 12 -> ST unit
			     ...
			     (ensures (fun h0 b h1 -> modifies (loc_buffer ctx) h0 h1))
[@ CInline ]
let aes256_init ctx key nonce = aes256_init #MAES ctx key nonce
...
[@ CInline ]
let aes_ctr out inp len ctx counter rounds = aes_ctr #MAES out inp len ctx counter rounds
