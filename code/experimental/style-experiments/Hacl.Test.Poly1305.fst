...
let main () =
  ...
  Hacl.Poly1305.poly1305_mac comp0 input0 (size 34) key0;
  TestLib.compare_and_print (C.String.of_literal "Poly1305 Tag 0") tag0 comp0 16ul;
  ...
  Hacl.Poly1305.poly1305_mac comp1 input1 (size 16) key1;
