...
let main () =
  ...
  Hacl.Poly1305_128.poly1305_mac comp0 input0 (size 34) key0;
  TestLib.compare_and_print (C.String.of_literal "Poly1305 (128-bit) Tag 0") tag0 comp0 16ul;
  ...
  let tag1 = alloca_of_list [
		    0x03uy; 0x00uy; 0x00uy; 0x00uy; 0x00uy; 0x00uy; 0x00uy; 0x00uy;
		    0x00uy; 0x00uy; 0x00uy; 0x00uy; 0x00uy; 0x00uy; 0x00uy; 0x00uy

  ] in
  let comp1 = alloca 0uy 16ul in
  Hacl.Poly1305_128.poly1305_mac comp1 input1 (size 16) key1;
  TestLib.compare_and_print (C.String.of_literal "Poly1305 Tag 1") tag1 comp1 16ul;
