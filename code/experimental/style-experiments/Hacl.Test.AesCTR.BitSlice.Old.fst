module Hacl.Test.AesCTR.BitSlice.Old
...
[
  ...
  Hacl.AesCTR.Old.aes128_ctr_encrypt comp0 input0 (size 32) key0 iv0 (size 1);
  TestLib.compare_and_print (C.String.of_literal "AES-CTR BitSlice encryption 0") cip0 comp0 32ul;
