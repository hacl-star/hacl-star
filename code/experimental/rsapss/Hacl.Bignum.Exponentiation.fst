...
val mul_mod_mont:
  ...
  -> Stack unit
    ...
    (ensures  fun h0 _ h1 -> modifies (loc resM |+| loc st_kara) h0 h1)
[@"c_inline"]
...
val mod_exp_:
  ...
  -> Stack unit
    ...
    (ensures  fun h0 _ h1 -> modifies (loc st_exp |+| loc st_kara) h0 h1)
[@"c_inline"]
let mod_exp_ nLen rLen pow2_i n nInv_u64 st_kara st_exp bBits bLen b =
  ...
  let h0 = ST.get () in
  let inv h1 i = modifies (loc st_exp |+| loc st_kara) h0 h1 in
