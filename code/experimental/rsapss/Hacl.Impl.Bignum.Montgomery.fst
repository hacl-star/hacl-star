module Hacl.Impl.Bignum.Montgomery
...
val mont_reduction_f:
  ...
  -> Stack unit
    ...
    (ensures  fun h0 _ h1 -> modifies (loc_union (loc carry) (loc c)) h0 h1)
...
let mont_reduction_ nLen rLen c n nInv_u64 carry =
  let h0 = ST.get () in
  let inv h1 i = modifies (loc_union (loc carry) (loc c)) h0 h1 in
...
val to_mont:
  ...
  -> Stack unit
    ...
    (ensures  fun h0 _ h1 -> modifies (loc_union (loc aM) (loc st_kara)) h0 h1)
[@"c_inline"]
...
val from_mont:
  ...
  -> Stack unit
    ...
    (ensures  fun h0 _ h1 -> modifies (loc_union (loc a) (loc tmp)) h0 h1)
[@"c_inline"]
