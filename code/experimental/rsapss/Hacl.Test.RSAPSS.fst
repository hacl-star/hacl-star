...
val ctest:
  ...
  (requires fun h ->
    ...
    live h msg /\ live h salt /\
    live h sgnt_expected)
  (ensures  fun h0 r h1 -> True)

let ctest modBits n pkeyBits e skeyBits d msgLen msg saltLen salt sgnt_expected = admit();
  push_frame ();
  ...
  rsapss_sign modBits pkeyBits skeyBits skey saltLen salt msgLen msg sgnt;
  let check_sgnt = Lib.ByteBuffer.lbytes_eq #nTLen sgnt sgnt_expected in
  let verify_sgnt = rsapss_verify modBits pkeyBits pkey saltLen sgnt_expected msgLen msg in
...
let main () =
  ...
  let test1 = ctest 1024ul test1_n 24ul test1_e 1024ul test1_d
    51ul test1_msg 20ul test1_salt test1_sgnt_expected in
  recall test2_n;
  recall test2_e;
  recall test2_d;
  recall test2_msg;
  ...
  let test2 = ctest 1025ul test2_n 24ul test2_e 1024ul test2_d
    234ul test2_msg 20ul test2_salt test2_sgnt_expected in
  recall test3_n;
  recall test3_e;
  recall test3_d;
  recall test3_msg;
  ...
  let test3 = ctest 1536ul test3_n 24ul test3_e 1536ul test3_d
    107ul test3_msg 20ul test3_salt test3_sgnt_expected in
  recall test4_n;
  recall test4_e;
  recall test4_d;
  recall test4_msg;
  ...
  let test4 = ctest 2048ul test4_n 24ul test4_e 2048ul test4_d
    128ul test4_msg 20ul test4_salt test4_sgnt_expected in
