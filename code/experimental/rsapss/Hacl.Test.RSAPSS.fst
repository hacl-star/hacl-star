...
val ctest:
  ...
  Stack bool
  (requires fun h ->
    live h n /\ live h e /\ live h d /\
    live h r2 /\ live h msg /\ live h salt /\
    live h sgnt_expected)
  (ensures  fun h0 r h1 -> True)

let ctest modBits n pkeyBits e skeyBits d r2 msgLen msg saltLen salt sgnt_expected = admit();
  push_frame ();
  ...
  bn_from_bytes_be (blocks modBits 8ul) n nNat;
  bn_from_bytes_be (blocks pkeyBits 8ul) e eNat;
  bn_from_bytes_be (blocks skeyBits 8ul) d dNat;

  let r2Nat = create nLen (u64 0) in
  bn_from_bytes_be (blocks modBits 8ul) r2 r2Nat;

  let nTLen = blocks modBits 8ul in
  let sgnt = create nTLen (u8 0) in
  rsapss_sign modBits pkeyBits skeyBits skey r2Nat saltLen salt msgLen msg sgnt;
...
let main () =
  ...
  let test1 = ctest 1024ul test1_n 24ul test1_e 1024ul test1_d
    test1_r2 51ul test1_msg 20ul test1_salt test1_sgnt_expected in
  recall test2_n;
  recall test2_e;
  recall test2_d;
  recall test2_r2;
  ...
  let test2 = ctest 1025ul test2_n 24ul test2_e 1024ul test2_d
    test2_r2 234ul test2_msg 20ul test2_salt test2_sgnt_expected in
  recall test3_n;
  recall test3_e;
  recall test3_d;
  recall test3_r2;
  ...
  let test3 = ctest 1536ul test3_n 24ul test3_e 1536ul test3_d
    test3_r2 107ul test3_msg 20ul test3_salt test3_sgnt_expected in
  recall test4_n;
  recall test4_e;
  recall test4_d;
  recall test4_r2;
  ...
  let test4 = ctest 2048ul test4_n 24ul test4_e 2048ul test4_d
    test4_r2 128ul test4_msg 20ul test4_salt test4_sgnt_expected in
