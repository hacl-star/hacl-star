...
/*
when salt_len = 0, the result doesn't match with the expected value
...
)
{
  ...
  EVP_DigestSignUpdate(md_ctx, msg, sizeof(msg));
...
int main() {
  ...
  uint8_t test4_salt[0U] = { };

  uint8_t test4_sgnt_expected[256U] =
  {
    (uint8_t)0xa3U, (uint8_t)0xe0U, (uint8_t)0x09U, (uint8_t)0xc4U, (uint8_t)0x0fU, (uint8_t)0x83U,
    (uint8_t)0xd6U, (uint8_t)0x1aU, (uint8_t)0x21U, (uint8_t)0xddU, (uint8_t)0xc1U, (uint8_t)0x21U,
    (uint8_t)0xe1U, (uint8_t)0x06U, (uint8_t)0x9aU, (uint8_t)0x25U, (uint8_t)0x51U, (uint8_t)0x6fU,
    (uint8_t)0x4fU, (uint8_t)0xd5U, (uint8_t)0x48U, (uint8_t)0x47U, (uint8_t)0x02U, (uint8_t)0xcaU,
    (uint8_t)0xf8U, (uint8_t)0xe0U, (uint8_t)0x99U, (uint8_t)0xb6U, (uint8_t)0xb2U, (uint8_t)0x9eU,
    (uint8_t)0x01U, (uint8_t)0x5cU, (uint8_t)0x90U, (uint8_t)0xe6U, (uint8_t)0x1bU, (uint8_t)0x78U,
    (uint8_t)0x37U, (uint8_t)0x3cU, (uint8_t)0x7aU, (uint8_t)0x9dU, (uint8_t)0xf3U, (uint8_t)0x6fU,
    (uint8_t)0x17U, (uint8_t)0xc2U, (uint8_t)0x0bU, (uint8_t)0xb2U, (uint8_t)0xcfU, (uint8_t)0xaeU,
    (uint8_t)0x64U, (uint8_t)0x26U, (uint8_t)0x65U, (uint8_t)0xbaU, (uint8_t)0x30U, (uint8_t)0xd3U,
    (uint8_t)0xe5U, (uint8_t)0x38U, (uint8_t)0x9eU, (uint8_t)0x01U, (uint8_t)0x98U, (uint8_t)0xe1U,
    (uint8_t)0xdbU, (uint8_t)0xbeU, (uint8_t)0x01U, (uint8_t)0x45U, (uint8_t)0xa9U, (uint8_t)0xefU,
    (uint8_t)0x40U, (uint8_t)0x7cU, (uint8_t)0x40U, (uint8_t)0x4bU, (uint8_t)0xe2U, (uint8_t)0xa4U,
    (uint8_t)0xb6U, (uint8_t)0xb7U, (uint8_t)0x78U, (uint8_t)0xd2U, (uint8_t)0xd3U, (uint8_t)0x34U,
    (uint8_t)0x73U, (uint8_t)0xc1U, (uint8_t)0x89U, (uint8_t)0xf6U, (uint8_t)0xcfU, (uint8_t)0x9eU,
    (uint8_t)0x50U, (uint8_t)0xe2U, (uint8_t)0x27U, (uint8_t)0x23U, (uint8_t)0x30U, (uint8_t)0x4cU,
    (uint8_t)0x74U, (uint8_t)0xfeU, (uint8_t)0x63U, (uint8_t)0x94U, (uint8_t)0xdbU, (uint8_t)0xfdU,
    (uint8_t)0x7aU, (uint8_t)0x57U, (uint8_t)0xafU, (uint8_t)0x08U, (uint8_t)0x1cU, (uint8_t)0xa6U,
    (uint8_t)0xa1U, (uint8_t)0xdeU, (uint8_t)0xedU, (uint8_t)0x08U, (uint8_t)0x09U, (uint8_t)0x8cU,
    (uint8_t)0xd7U, (uint8_t)0x47U, (uint8_t)0xcdU, (uint8_t)0x9eU, (uint8_t)0x68U, (uint8_t)0x08U,
    (uint8_t)0x54U, (uint8_t)0x0bU, (uint8_t)0xb6U, (uint8_t)0x4eU, (uint8_t)0x24U, (uint8_t)0xd4U,
    (uint8_t)0x20U, (uint8_t)0x35U, (uint8_t)0x04U, (uint8_t)0x08U, (uint8_t)0x59U, (uint8_t)0xcfU,
    (uint8_t)0x53U, (uint8_t)0xdaU, (uint8_t)0xb3U, (uint8_t)0x12U, (uint8_t)0x90U, (uint8_t)0xafU,
    (uint8_t)0xbaU, (uint8_t)0x62U, (uint8_t)0x3eU, (uint8_t)0x75U, (uint8_t)0x1dU, (uint8_t)0xb7U,
    (uint8_t)0x8dU, (uint8_t)0x83U, (uint8_t)0x8dU, (uint8_t)0xe3U, (uint8_t)0xbcU, (uint8_t)0x38U,
    (uint8_t)0xaeU, (uint8_t)0x64U, (uint8_t)0x16U, (uint8_t)0x2eU, (uint8_t)0x8aU, (uint8_t)0x45U,
    (uint8_t)0xf5U, (uint8_t)0xf5U, (uint8_t)0xb5U, (uint8_t)0xadU, (uint8_t)0xeaU, (uint8_t)0x00U,
    (uint8_t)0x60U, (uint8_t)0xf9U, (uint8_t)0x2cU, (uint8_t)0x98U, (uint8_t)0xaeU, (uint8_t)0xc7U,
    (uint8_t)0x6eU, (uint8_t)0xbeU, (uint8_t)0x7fU, (uint8_t)0xadU, (uint8_t)0xceU, (uint8_t)0xa3U,
    (uint8_t)0x5aU, (uint8_t)0x2cU, (uint8_t)0x0aU, (uint8_t)0x39U, (uint8_t)0x0dU, (uint8_t)0x4cU,
    (uint8_t)0x2aU, (uint8_t)0x75U, (uint8_t)0x50U, (uint8_t)0x80U, (uint8_t)0x80U, (uint8_t)0xb7U,
    (uint8_t)0x6dU, (uint8_t)0x41U, (uint8_t)0xbdU, (uint8_t)0x59U, (uint8_t)0x5bU, (uint8_t)0xecU,
    (uint8_t)0x9dU, (uint8_t)0x23U, (uint8_t)0xd8U, (uint8_t)0x1dU, (uint8_t)0x63U, (uint8_t)0x6bU,
    (uint8_t)0x8fU, (uint8_t)0x14U, (uint8_t)0x3dU, (uint8_t)0x03U, (uint8_t)0x51U, (uint8_t)0x0cU,
    (uint8_t)0x76U, (uint8_t)0xc9U, (uint8_t)0xb0U, (uint8_t)0x8dU, (uint8_t)0x92U, (uint8_t)0x76U,
    (uint8_t)0x45U, (uint8_t)0xb4U, (uint8_t)0x93U, (uint8_t)0x19U, (uint8_t)0xd9U, (uint8_t)0xa8U,
    (uint8_t)0x0eU, (uint8_t)0x3fU, (uint8_t)0x79U, (uint8_t)0xccU, (uint8_t)0xadU, (uint8_t)0x78U,
    (uint8_t)0x52U, (uint8_t)0x2aU, (uint8_t)0xffU, (uint8_t)0xceU, (uint8_t)0xe1U, (uint8_t)0x46U,
    (uint8_t)0x2cU, (uint8_t)0xf0U, (uint8_t)0x51U, (uint8_t)0x05U, (uint8_t)0xc7U, (uint8_t)0xe3U,
    (uint8_t)0xb4U, (uint8_t)0x17U, (uint8_t)0x78U, (uint8_t)0x95U, (uint8_t)0xd5U, (uint8_t)0x32U,
    (uint8_t)0x34U, (uint8_t)0xb8U, (uint8_t)0x1eU, (uint8_t)0x9eU, (uint8_t)0x90U, (uint8_t)0x17U,
    (uint8_t)0x39U, (uint8_t)0x8cU, (uint8_t)0xa0U, (uint8_t)0x90U, (uint8_t)0x04U, (uint8_t)0x9dU,
    (uint8_t)0xfcU, (uint8_t)0x65U, (uint8_t)0x67U, (uint8_t)0x4bU, (uint8_t)0x41U, (uint8_t)0x45U,
    (uint8_t)0x34U, (uint8_t)0x6dU, (uint8_t)0xe0U, (uint8_t)0x34U
  };
  ...
  hacl_sign(2048U, test4_n, 24U, test4_e, 2048U, test4_d, 128U, test4_msg, 0U, test4_salt, sgnt_comp);
  printf("RSAPSS signature HACL*:\n");
  bool ok = print_result(sgnt_comp,test4_sgnt_expected);

  memset(sgnt_comp, 0, 256*sizeof(sgnt_comp[0]));
  openssl_sign(privkey, 0U, test4_msg, 128U, sgnt_comp, 256U);
  printf("RSAPSS signature OpenSSL:\n");
  ok = print_result(sgnt_comp,test4_sgnt_expected);


  printf("RSAPSS verification HACL*:\n");
  bool res_ver = hacl_verify(2048U, test4_n, 24U, test4_e, 128U, test4_msg, 0U, test4_sgnt_expected);
  if (res_ver) printf("Success!\n");
  else printf("**FAILED**\n");

  printf("RSAPSS verification OpenSSL:\n");
  res_ver = openssl_verify(pubkey, test4_msg, 128U, sgnt_comp, 256U);
  if (res_ver) printf("Success!\n");
  else printf("**FAILED**\n");
  ...
  for (int j = 0; j < ROUNDS; j++) {
    hacl_sign(2048U, test4_n, 24U, test4_e, 2048U, test4_d, 128U, test4_msg, 0U, test4_salt, comp);
    res = res ^ comp[0];
  }
  ...
  for (int j = 0; j < ROUNDS; j++) {
    int r = hacl_verify(2048U, test4_n, 24U, test4_e, 128U, test4_msg, 0U, comp);
    res = res ^ r;
  }
  ...
  for (int j = 0; j < ROUNDS; j++) {
    openssl_sign(privkey, 0U, test4_msg, 128U, comp, 256U);
    res = res ^ comp[0];
  }
