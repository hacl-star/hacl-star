...
let rec karatsuba_ #aLen pow2_i aaLen a b tmp res =
    ...
    (if (aaLen <. size 32) then
       ...
       let sa2 =  abs #(v pow2_i0) #(v pow2_i0) pow2_i0 a0 pow2_i0 a1 a2 in // a2 = |a0 - a1|
       let sb2 = abs #(v pow2_i0) #(v pow2_i0) pow2_i0 b0 pow2_i0 b1 b2 in // b2 = |b0 - b1|
       ...
       add_sign #(v pow2_i0) #(v pow2_i0) #(v tmp1Len) pow2_i0 pow2_i0 tmp1Len c0 c1 c2 a0 a1 a2 b0 b1 b2 sa2 sb2 tmp1; //tmp1 = (c0 + c1) +/- c2

       //res = [c0; c1]
       //tmp = [a2; b2; c2; tmp1; _]
       let res1Len = add #SIZE pow2_i0 (add #SIZE pow2_i0 pow2_i0) in
