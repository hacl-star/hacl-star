...
let ctest x0 iLen modBits n pkeyBits e skeyBits d msgLen msg saltLen salt sgnt_expected =
    ...
    rsa_pss_sign pow2_i iLen modBits pkeyBits skeyBits skey saltLen salt msgLen msg sgnt;
...
let test1() =
    ...
    let res = ctest 11 (size 15) modBits n pkeyBits e skeyBits d msgLen msg saltLen salt sgnt_expected in
    res
...
let test3() =
    ...
    let res = ctest 11 (size 7) modBits n pkeyBits e skeyBits d msgLen msg saltLen salt sgnt_expected in
    res
...
let test4() =
    ...
    let res = ctest 12 (size 31) modBits n pkeyBits e skeyBits d msgLen msg saltLen salt sgnt_expected in
    res
