...
let finish a s dst =
  ...
  | Blake2S ->
    Hacl.Impl.Blake2.Generic.blake2_finish #Spec.Blake2.Blake2S #Hacl.Impl.Blake2.Core.M32 32ul dst (fst s)
  | Blake2B ->
    Hacl.Impl.Blake2.Generic.blake2_finish #Spec.Blake2.Blake2B #Hacl.Impl.Blake2.Core.M32 64ul dst (fst s)
