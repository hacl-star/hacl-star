...
val make_prime: #l:limb_t -> n:felem l -> Stack unit
...
val make_order: #l:limb_t -> n:felem l -> Stack unit
  (requires fun h -> live h n)
  (ensures  fun h0 _ h1 -> modifies (loc n) h0 h1 /\
    as_nat h1 n == S.order)
...
val make_a_coeff: #l:limb_t -> a:felem l -> Stack unit
...
let make_a_coeff #l a =
  ...
  felem_make_u64_4 a n0 n1 n2 n3


val make_b_coeff: #l:limb_t -> b:felem l -> Stack unit
...
let make_b_coeff #l b =
  ...
  felem_make_u64_4 b n0 n1 n2 n3


val make_g_x: #l:limb_t -> n:felem l -> Stack unit
  (requires fun h -> live h n)
  (ensures  fun h0 _ h1 -> modifies (loc n) h0 h1 /\
    as_nat h1 n < S.prime /\
...
val make_g_y: #l:limb_t -> n:felem l -> Stack unit
  (requires fun h -> live h n)
  (ensures  fun h0 _ h1 -> modifies (loc n) h0 h1 /\
    as_nat h1 n < S.prime /\
...
val make_fmont_R2: #l:limb_t -> n:felem l -> Stack unit
  (requires fun h -> live h n)
  (ensures  fun h0 _ h1 -> modifies (loc n) h0 h1 /\
    as_nat h1 n == SM.fmont_R * SM.fmont_R % S.prime)

[@CInline]
let make_fmont_R2 #l n =
