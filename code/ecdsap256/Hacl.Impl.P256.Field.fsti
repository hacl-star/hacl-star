...
val fmod_short: x:felem -> res:felem -> Stack unit
  ...
  (ensures fun h0 _ h1 -> modifies (loc res) h0 h1 /\
    as_nat h1 res == as_nat h0 x % prime)
...
val fadd: x:felem -> y:felem -> res:felem -> Stack unit
  (requires fun h0 ->
    ...
    as_nat h0 x < prime /\ as_nat h0 y < prime)
  (ensures  fun h0 _ h1 -> modifies (loc res) h0 h1 /\
    as_nat h1 res == (as_nat h0 x + as_nat h0 y) % prime /\
    as_nat h1 res == toDomain_ ((fromDomain_ (as_nat h0 x) + fromDomain_ (as_nat h0 y)) % prime))
...
val fdouble: x:felem -> res:felem -> Stack unit
  (requires fun h0 ->
    ...
    as_nat h0 x < prime)
  (ensures fun h0 _ h1 -> modifies (loc res) h0 h1 /\
    as_nat h1 res == (2 * as_nat h0 x) % prime /\
    as_nat h1 res < prime /\
    as_nat h1 res == toDomain_ (2 * fromDomain_ (as_nat h0 x) % prime))
...
val montgomery_multiplication_buffer_by_one: a:felem -> res:felem -> Stack unit
  (requires fun h ->
    live h a /\ live h res /\ as_nat h a < prime)
  (ensures  fun h0 _ h1 -> modifies (loc res) h0 h1 /\
    as_nat h1 res = (as_nat h0 a * modp_inv2_prime (pow2 256) prime) % prime /\
...
val fmul: a:felem -> b:felem -> res:felem -> Stack unit
  ...
  (ensures fun h0 _ h1 -> modifies (loc res) h0 h1 /\
    as_nat h1 res < prime /\
    as_nat h1 res = (as_nat h0 a * as_nat h0 b * modp_inv2_prime (pow2 256) prime) % prime /\
    as_nat h1 res = toDomain_ (fromDomain_ (as_nat h0 a) * fromDomain_ (as_nat h0 b) % prime) /\
...
val fsqr: a:felem -> res:felem -> Stack unit
  ...
  (ensures  fun h0 _ h1 -> modifies (loc res) h0 h1 /\
    as_nat h1 res < prime /\
    as_nat h1 res = (as_nat h0 a * as_nat h0 a * modp_inv2_prime (pow2 256) prime) % prime /\
    as_nat h1 res = toDomain_ (fromDomain_ (as_nat h0 a) * fromDomain_ (as_nat h0 a) % prime) /\
...
val fcube: a:felem -> res:felem -> Stack unit
  ...
  (ensures fun h0 _ h1 -> modifies (loc res) h0 h1 /\
    as_nat h1 res < prime /\
    as_nat h1 res = toDomain_ (fromDomain_ (as_nat h0 a) * fromDomain_ (as_nat h0 a) * fromDomain_ (as_nat h0 a) % prime) /\
...
val fmul_by_2: a:felem -> res:felem -> Stack unit
  (requires fun h ->
    ...
    as_nat h a < prime)
  (ensures fun h0 _ h1 -> modifies (loc res) h0 h1 /\
    as_nat h1 res == toDomain_ (2 * fromDomain_ (as_nat h0 a) % prime) /\
...
val fmul_by_3: a:felem -> res:felem -> Stack unit
  ...
  (ensures fun h0 _ h1 -> modifies (loc res) h0 h1 /\
    as_nat h1 res < prime /\
    as_nat h1 res == toDomain_ (3 * fromDomain_ (as_nat h0 a) % prime) /\
...
val fmul_by_4: a:felem -> res:felem -> Stack unit
  ...
  (ensures fun h0 _ h1 -> modifies (loc res) h0 h1 /\
    as_nat h1 res < prime /\
    as_nat h1 res == toDomain_ (4 * fromDomain_ (as_nat h0 a) % prime) /\
...
val fmul_by_8: a:felem -> res:felem -> Stack unit
  ...
  (ensures fun h0 _ h1 -> modifies (loc res) h0 h1 /\
    as_nat h1 res < prime /\
    as_nat h1 res == toDomain_ (8 * fromDomain_ (as_nat h0 a) % prime) /\
