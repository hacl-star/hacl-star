...
let uploadBasePoint p = 
 ...
 let bpX, bpY, bpZ = basePoint in 
  ...
  assert_norm(bpX == fromDomain_ 11110593207902424140321080247206512405358633331993495164878354046817554469948);
 ...
 assert_norm (bpY == fromDomain_ 60359023176204190920225817201443260813112970217682417638161152432929735267850);
 ...
 assert_norm (bpZ = fromDomain_ 26959946660873538059280334323183841250350249843923952699046031785985)
