...
let ecp256scalar_mult result pubKey scalar = Hacl.Impl.P256.ScalarMult.ecp256scalar_mult result pubKey scalar
...
let point_inv8 result p = Hacl.Impl.P256.PointInverse.point_inv8 result p
