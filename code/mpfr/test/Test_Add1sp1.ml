...
fun str ->
  ...
  while true do
    ...
    print_i32 ax;
    print_i32 af;
    if (((FStar_UInt64.eq ap rp) && (FStar_Int32.eq ax rx) || (FStar_Int32.eq ax rx) && (FStar_Int32.eq ax MPFR_Lib.mpfr_EXP_INF)) && (FStar_Int32.eq asign s) && (FStar_Int32.eq af flag)) then
        print_string "YES!!!\n"
    else begin
        raise Exit;
        print_string "no...\n"
