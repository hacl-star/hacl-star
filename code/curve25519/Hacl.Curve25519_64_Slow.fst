...
let point_add_and_double =
  addanddouble_point_add_and_double_higher #M64 C.fmul_ C.fsqr2_ C.fmul1_ C.fmul2_ C.fsub_ C.fadd_
let point_double =
  addanddouble_point_double_higher #M64 C.fmul2_ C.fmul1_ C.fsqr2_ C.fsub_ C.fadd_
let montgomery_ladder =
  generic_montgomery_ladder_higher #M64 point_double C.cswap2_ point_add_and_double
let fsquare_times = finv_fsquare_times_higher #M64 C.fsqr_
let finv = finv_finv_higher #M64 fsquare_times C.fmul_
...
// that generic aspect.)
let store_felem = fields_store_felem_higher #M64 C.add1_
let encode_point = generic_encode_point_higher #M64 store_felem C.fmul_ finv
