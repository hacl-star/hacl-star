...
void Hacl_Impl_Curve25519_Field64_fadd(uint64_t *c, uint64_t *a, uint64_t *b)
{
  uint64_t carry = add(c,a,b);
  carry = add1(c,c,carry * 38);
  c[0]  += carry * 38;
}

inline static void Hacl_Impl_Curve25519_Field64_fadd_asm(uint64_t *c, uint64_t *a, uint64_t *b)
{
...
inline static void Hacl_Impl_Curve25519_Field64_fsub_vale(uint64_t *c, uint64_t *a, uint64_t *b){
  uint64_t carry = sub(c,a,b);
  carry = sub1(c,c,carry * 38);
  c[0] -= carry * 38;
}
...
inline static void Hacl_Impl_Curve25519_Field64_carry_wide_vale(uint64_t *c, uint64_t *a){
  uint64_t carry = mul1(c,a+4,(uint64_t)38);
  carry += add(c,c,a);
  carry = add1(c,c,carry*38);
  c[0]  += carry * 38;
}
  
inline static void Hacl_Impl_Curve25519_Field64_carry_wide2(uint64_t *c, uint64_t *a){
  __asm__ __volatile__(
    "movl    $38, %%edx; " /* 2*c = 38 = 2^256 */
    "mulx 32(%1),  %%r8, %%r10; " /* c*C[4] */   "xorl %%ebx, %%ebx ;"  "adox   (%1),  %%r8 ;"
    "mulx 40(%1),  %%r9, %%r11; " /* c*C[5] */   "adcx %%r10,  %%r9 ;"  "adox  8(%1),  %%r9 ;"
...
inline static void Hacl_Impl_Curve25519_Field64_fmul2(uint64_t *out, uint64_t *f1, uint64_t *f2, uint64_t *f3, uint64_t *f4)
{
...
//  mul(tmp_w2,f3,f4);
  ...
  Hacl_Impl_Curve25519_Field64_carry_wide2(out, tmp_w);
}

inline static void Hacl_Impl_Curve25519_Field64_fmul1_vale(uint64_t *c, uint64_t *a){
  const uint64_t a24 = 121665;
  uint64_t carry = mul1(c,a,a24);
  carry = add1(c,c,carry*38);
  c[0] += carry * 38;
}
...
inline static void Hacl_Impl_Curve25519_Field64_fsqr2_(uint64_t *c, uint64_t *a) {
  __asm__ __volatile__(
    "movq   (%1), %%rdx        ;" /* A[0]      */
    "mulx  8(%1),  %%r8, %%r14 ;" /* A[1]*A[0] */  "xorl %%r15d, %%r15d;"
    "mulx 16(%1),  %%r9, %%r10 ;" /* A[2]*A[0] */  "adcx %%r14,  %%r9 ;"
...
inline static void Hacl_Impl_Curve25519_Field64_fsqr2(uint64_t *out, uint64_t *f)
{
  uint64_t tmp_w[16U] = {0};
  Hacl_Impl_Curve25519_Field64_fsqr2_(tmp_w, f);
//  sqr(tmp_w, f);
//  sqr(tmp_w+8, f+4);
  Hacl_Impl_Curve25519_Field64_carry_wide2(out, tmp_w);
...
//    Hacl_Impl_Curve25519_Field64_fmul((uint64_t *)c, (uint64_t *)c, (uint64_t *)b);
      Hacl_Impl_Curve25519_Field64_fmul2((uint64_t *)c, (uint64_t *)c, (uint64_t *)b, (uint64_t *)d, (uint64_t *)a);
...
//     Hacl_Impl_Curve25519_Field64_fsqr2(x3, z3, x3, z3);
     Hacl_Impl_Curve25519_Field64_fsqr2(nq_p1, nq_p1);
...
//      Hacl_Impl_Curve25519_Field64_fsqr2((uint64_t*)c,(uint64_t *)d, (uint64_t*)a,(uint64_t *)b);
      Hacl_Impl_Curve25519_Field64_fsqr2((uint64_t*)tmp + 8,(uint64_t*)tmp);
...
//      Hacl_Impl_Curve25519_Field64_fmul(x2, (uint64_t *)c, (uint64_t *)d);
 //     Hacl_Impl_Curve25519_Field64_fmul(z2, (uint64_t *)b, (uint64_t *)a);
     Hacl_Impl_Curve25519_Field64_fmul2(x2, (uint64_t *)c, (uint64_t *)d,(uint64_t *)b, (uint64_t *)a);
    }
  }
}
	  ...
	  uint64_t swap = 0;
          ...
          for (i = (uint32_t)0U; i < (uint32_t)256U; i = i + (uint32_t)1U)
          {
            ...
            bit =
              ...
              & (uint64_t)1U;
	    swap ^= bit;
//            Hacl_Impl_Curve25519_Generic_cswap_64(swap, p0, p1);
	    cswap(swap,p0,p1);
	    cswap(swap,p0+4,p1+4);
	    swap = bit;
