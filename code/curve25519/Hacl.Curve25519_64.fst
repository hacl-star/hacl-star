...
let point_add_and_double =
  addanddouble_point_add_and_double_higher #M64 C.fmul C.fsqr2 C.fmul_scalar C.fmul2 C.fsub C.fadd
let point_double =
  addanddouble_point_double_higher #M64 C.fmul2 C.fmul_scalar C.fsqr2 C.fsub C.fadd
...
// that generic aspect.)
let store_felem = fields_store_felem_higher #M64 C.add_scalar
