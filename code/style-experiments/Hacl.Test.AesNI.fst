...
[
  ...
  Hacl.Impl.Aes.NI.aes128_encrypt comp0 input0 (size 32) key0 iv0 (size 1);
  TestLib.compare_and_print (C.String.of_literal "AES-CBC encryption 0") cip0 comp0 32ul;
