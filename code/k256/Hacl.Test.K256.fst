...
let pk_x1: b:glbuffer uint8 32ul{ recallable b } =
  [@ inline_let]
  let l:list uint8 =
    normalize_term (List.Tot.map u8 [
      0xb8; 0x38; 0xff; 0x44; 0xe5; 0xbc; 0x17; 0x7b; 0xf2; 0x11; 0x89; 0xd0; 0x76; 0x60; 0x82; 0xfc;
      0x9d; 0x84; 0x32; 0x26; 0x88; 0x7f; 0xc9; 0x76; 0x03; 0x71; 0x10; 0x0b; 0x7e; 0xe2; 0x0a; 0x6f ]) in
  assert_norm (List.Tot.length l == 32);
  createL_global l


let pk_y1: b:glbuffer uint8 32ul{ recallable b } =
  [@ inline_let]
  let l:list uint8 =
    normalize_term (List.Tot.map u8 [
...
let pk_x2: b:glbuffer uint8 32ul{ recallable b } =
  [@ inline_let]
  let l:list uint8 =
    normalize_term (List.Tot.map u8 [
      0x77; 0x9d; 0xd1; 0x97; 0xa5; 0xdf; 0x97; 0x7e; 0xd2; 0xcf; 0x6c; 0xb3; 0x1d; 0x82; 0xd4; 0x33;
      0x28; 0xb7; 0x90; 0xdc; 0x6b; 0x3b; 0x7d; 0x44; 0x37; 0xa4; 0x27; 0xbd; 0x58; 0x47; 0xdf; 0xcd ]) in
  assert_norm (List.Tot.length l == 32);
  createL_global l


let pk_y2: b:glbuffer uint8 32ul{ recallable b } =
  [@ inline_let]
  let l:list uint8 =
    normalize_term (List.Tot.map u8 [
...
let test_verify () = admit();
  let b = K256.ecdsa_verify_sha256 6ul
    ...
    (const_to_buffer #uint8 pk_x1)
    (const_to_buffer #uint8 pk_y1)
...
let test_sign_and_verify () = admit();
  ...
  let b = K256.ecdsa_verify_hashed_msg
    (const_to_buffer #uint8 m2)
    (const_to_buffer #uint8 pk_x2)
    (const_to_buffer #uint8 pk_y2)
