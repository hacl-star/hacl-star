...
val lemma_mod_mul_distr (a b:nat) (n:pos) : Lemma (a * b % n = (a % n) * (b % n) % n)
let lemma_mod_mul_distr a b n =
  Math.Lemmas.lemma_mod_mul_distr_l a b n;
  Math.Lemmas.lemma_mod_mul_distr_r (a % n) b n


val lemma_mod_sub_distr (a b:nat) (n:pos) : Lemma ((a - b) % n = (a % n - b % n) % n)
...
val lemma_distr_eucl (a b:nat) : Lemma ((a / pow2 52 + b) * pow2 52 + a % pow2 52 = a + b * pow2 52)
let lemma_distr_eucl a b =
  calc (==) {
    (a / pow2 52 + b) * pow2 52 + a % pow2 52;
    (==) { Math.Lemmas.distributivity_add_left (a / pow2 52) b (pow2 52) }
    a / pow2 52 * pow2 52 + b * pow2 52 + a % pow2 52;
    (==) { Math.Lemmas.euclidean_division_definition a (pow2 52) }
    a + b * pow2 52;
    }


val lemma_distr_pow (a b c d:nat) : Lemma ((a + b * pow2 c) * pow2 d = a * pow2 d + b * pow2 (c + d))
...
val lemma_distr_pow_pow (a b c d e:nat) : Lemma ((a * pow2 b + c * pow2 d) * pow2 e = a * pow2 (b + e) + c * pow2 (d + e))
...
val lemma_distr_eucl_mul (r a:nat) (b:pos) : Lemma (r * (a % b) + r * (a / b) * b = r * a)
...
val lemma_distr_eucl_mul_add (r a c:nat) (b:pos) : Lemma (r * (a % b) + r * (a / b + c) * b = r * a + r * c * b)
...
val lemma_swap_mul3 (a b c:nat) : Lemma (a * b * c == a * c * b)
...
val lemma_as_nat64_horner (r0 r1 r2 r3:nat) :
...
let lemma_as_nat64_horner r0 r1 r2 r3 =
  calc (==) {
    ...
    (==) { Math.Lemmas.distributivity_add_right (pow2 64) r2 (pow2 64 * r3) }
    r0 + pow2 64 * (r1 + pow2 64 * r2 + pow2 64 * (pow2 64 * r3));
    (==) { Math.Lemmas.paren_mul_right (pow2 64) (pow2 64) r3; Math.Lemmas.pow2_plus 64 64 }
    r0 + pow2 64 * (r1 + pow2 64 * r2 + pow2 128 * r3);
    (==) { Math.Lemmas.distributivity_add_right (pow2 64) r1 (pow2 64 * r2 + pow2 128 * r3) }
    r0 + pow2 64 * r1 + pow2 64 * (pow2 64 * r2 + pow2 128 * r3);
    (==) { Math.Lemmas.distributivity_add_right (pow2 64) (pow2 64 * r2) (pow2 128 * r3) }
    r0 + pow2 64 * r1 + pow2 64 * (pow2 64 * r2) + pow2 64 * (pow2 128 * r3);
    (==) { Math.Lemmas.paren_mul_right (pow2 64) (pow2 64) r2; Math.Lemmas.pow2_plus 64 64 }
    r0 + pow2 64 * r1 + pow2 128 * r2 + pow2 64 * (pow2 128 * r3);
    (==) { Math.Lemmas.paren_mul_right (pow2 64) (pow2 128) r3; Math.Lemmas.pow2_plus 128 64 }
    r0 + pow2 64 * r1 + pow2 128 * r2 + pow2 192 * r3;
    }
...
let lemma_distr5_pow52 a b0 b1 b2 b3 b4 =
  ...
  calc (==) {
    a * b_sum;
    (==) { Math.Lemmas.swap_mul a b_sum; lemma_distr5 b0 (b1 * pow2 52) (b2 * pow2 104) (b3 * pow2 156) (b4 * pow2 208) a }
...
val lemma_distr5_pow52_sub (a0 a1 a2 a3 a4 b0 b1 b2 b3 b4 c:nat) : Lemma
...
let lemma_simplify_carry_round t0 t1 t2 t3 t4 =
  ...
  calc (==) {
    ...
    (c % pow2 52) * pow2 156 + d * pow2 208;
    (==) {
      Math.Lemmas.distributivity_add_left t1 (t0 / pow2 52) (pow2 52);
      Math.Lemmas.euclidean_division_definition t0 (pow2 52) }
