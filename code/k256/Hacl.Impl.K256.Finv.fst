...
(* HACL-RS *)
inline_for_extraction noextract
val sqr_mod_a : BE.lsqr_st U64 5ul 0ul mk_to_k256_prime_comm_monoid
let sqr_mod_a ctx x xx =
  push_frame();
  let x_copy = create nlimb (u64 0) in
  copy x_copy x;
  sqr_mod ctx x_copy xx;
  pop_frame()
...
let fexp_223_23 out x2 f =
  ...
  fmul_a out out x22; // out = r = S.fmul (fsquare_times x223 23) x22
  let h4 = ST.get () in
...
let fsqrt out f =
  ...
  fmul_a out out x2; // out = r = S.fmul (fsquare_times r 6) x2
  let h2 = ST.get () in
