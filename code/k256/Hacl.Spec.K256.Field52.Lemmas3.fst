...
let lemma_add_four_mul64_wide md d a1 a2 a3 a4 b1 b2 b3 b4 =
  lemma_bound_mul64_wide 8 8 max52 max48 a1 b4;
  lemma_bound_mul64_wide 8 8 max52 max52 a2 b3;
  lemma_bound_mul64_wide 8 8 max52 max52 a3 b2;
  lemma_bound_mul64_wide 8 8 max48 max52 a4 b1;
  assert (v d + v a1 * v b4 + v a2 * v b3 + v a3 * v b2 + v a4 * v b1 <=
    md * max52 + 128 * (max52 * max48) + 128 * (max52 * max52));
  lemma_128_max52_max48 ();
  assert_norm (md * max52 + 128 * (max52 * max48) + 128 * (max52 * max52) <= 144 * (max52 * max52));
  assert_norm (144 * (max52 * max52) < pow2 128);
...
val lemma_four_sqr64_wide (a0 a1 a2 a3:uint64) : Lemma
  (requires
    felem_fits1 a0 8 /\ felem_fits1 a1 8 /\
    felem_fits1 a2 8 /\ felem_fits1 a3 8)
  (ensures
...
let lemma_four_sqr64_wide a0 a1 a2 a3 =
  lemma_mul_by2 8 max52 a0;
  lemma_mul_by2 8 max52 a1;
  lemma_bound_mul64_wide 16 8 max52 max52 (a0 *. u64 2) a3;
  lemma_bound_mul64_wide 16 8 max52 max52 (a1 *. u64 2) a2;
  assert (v a0 * 2 * v a3 + v a1 * 2 * v a2 <= 256 * (max52 * max52));
  assert_norm (256 * (max52 * max52) < pow2 128);
...
let lemma_add_five_sqr64_wide md d a0 a1 a2 a3 a4 =
  ...
  lemma_mul_by2 8 max48 a4;
  lemma_mul_by2 8 max52 a1;

  lemma_bound_mul64_wide 8 16 max52 max48 a0 (a4 *. u64 2);
  lemma_bound_mul64_wide 16 8 max52 max52 (a1 *. u64 2) a3;
  lemma_bound_mul64_wide 8 8 max52 max52 a2 a2;
  //Math.Lemmas.swap_mul max52 max48;
...
val lemma_add_four_sqr64_wide (md:nat) (d:uint128) (a1 a2 a3 a4:uint64) : Lemma
  (requires
    v d <= md * max52 /\ md <= 321 /\
    felem_fits1 a1 8 /\ felem_fits1 a2 8 /\
    felem_fits1 a3 8 /\ felem_fits_last1 a4 8)
  (ensures
...
let lemma_add_four_sqr64_wide md d a1 a2 a3 a4 =
  assert_norm (max48 < max52);
  lemma_mul_by2 8 max48 a4;
  lemma_mul_by2 8 max52 a2;

  lemma_bound_mul64_wide 8 16 max52 max48 a1 (a4 *. u64 2);
  lemma_bound_mul64_wide 16 8 max52 max52 (a2 *. u64 2) a3;
...
let lemma_add_two_sqr64_wide52 md d a0 a1 =
  lemma_mul_by2 8 max52 a0;
  lemma_bound_mul64_wide 16 8 max52 max52 (a0 *. u64 2) a1;
  assert (v d + v a0 * 2 * v a1 <= md * max52 + 128 * (max52 * max52));
  assert_norm (md * max52 + 128 * (max52 * max52) <= 129 * (max52 * max52));
  assert_norm (md * max52 + 128 * (max52 * max52) < pow2 128);
...
let lemma_add_three_sqr64_wide md d a2 a3 a4 =
  ...
  lemma_bound_mul64_wide 8 16 max52 max48 a2 (a4 *. u64 2);
  lemma_bound_mul64_wide 8 8 max52 max52 a3 a3;
...
let lemma_add_three_sqr64_wide52 md d a0 a1 a2 =
  ...
  lemma_bound_mul64_wide 16 8 max52 max52 (a0 *. u64 2) a2;
  lemma_bound_mul64_wide 8 8 max52 max52 a1 a1;
  assert (v d + v a0 * v a2 + v a1 * v a1 + v a2 * v a0 <= md * max52 + 192 * (max52 * max52));
  assert_norm (md * max52 + 192 * (max52 * max52) <= 193 * (max52 * max52));
  assert_norm (193 * (max52 * max52) < pow2 128);
...
let lemma_add_two_sqr64_wide md d a3 a4 =
  ...
  lemma_bound_mul64_wide 8 16 max52 max48 a3 (a4 *. u64 2);
  assert (v d + v a3 * (v a4 * 2) <= md * max52 + 128 * (max52 * max48));
  lemma_128_max52_max48 ();
  assert_norm (md * max52 + 128 * (max52 * max48) <= 9 * (max52 * max52));
  assert_norm (9 * (max52 * max52) < pow2 128);
...
let fsqr5_lemma a =
  ...
  lemma_bound_mul64_wide 8 8 max48 max48 a4 a4;
  ...
  let d3 = d2
       ...
       +. mul64_wide a2 a2 in
  lemma_add_five_sqr64_wide 257 d2 a0 a1 a2 a3 a4;
  ...
  lemma_bound_mul64_wide 8 8 max52 max52 a0 a0;
  ...
  lemma_add_four_sqr64_wide 202 d5 a1 a2 a3 a4;
  ...
  lemma_add_two_sqr64_wide52 65 c4 a0 a1;
  ...
  let d8 = d7
       ...
       +. mul64_wide a3 a3 in
  lemma_add_three_sqr64_wide 320 d7 a2 a3 a4;
  ...
  let c8 = c7
       ...
       +. mul64_wide a1 a1 in
  lemma_add_three_sqr64_wide52 130 c7 a0 a1 a2;
  assert (v c8 == v c7 + v a0 * v a2 + v a1 * v a1 + v a2 * v a0);
  assert (v c8 <= 193 * (max52 * max52));

  let d10 = d9
       +. mul64_wide a3 (a4 *. u64 2) in
  lemma_add_two_sqr64_wide 129 d9 a3 a4;
