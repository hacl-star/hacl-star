...
let repeat_gen_blocks_multi #inp_t blocksize n inp a f acc0 =
  Loops.repeat_gen n a (repeat_gen_blocks_f blocksize n inp a f) acc0


let lemma_repeat_gen_blocks_multi #inp_t blocksize n inp a f acc0 = ()
...
let repeat_gen_blocks_multi_extensionality #inp_t blocksize n inp a_f a_g f g acc0 =
  let f_rep = repeat_gen_blocks_f #inp_t blocksize n inp a_f f in
  let g_rep = repeat_gen_blocks_f #inp_t blocksize n inp a_g g in

  calc (==) {
    repeat_gen_blocks_multi #inp_t blocksize n inp a_f f acc0;
    (==) { }
    Loops.repeat_gen n a_f f_rep acc0;
    (==) { Loops.repeat_gen_def n a_f f_rep acc0 }
    Loops.repeat_right 0 n a_f f_rep acc0;
    (==) { repeat_gen_right_extensionality n 0 n a_f a_g f_rep g_rep acc0 }
    Loops.repeat_right 0 n a_g g_rep acc0;
    (==) { Loops.repeat_gen_def n a_g g_rep acc0 }
    Loops.repeat_gen n a_g g_rep acc0;
    (==) { }
...
let repeat_blocks_multi_is_repeat_gen_blocks_multi #a #b blocksize inp f acc0 =
  ...
  let f_gen = repeat_gen_blocks_f blocksize n inp (Loops.fixed_a b) (Loops.fixed_i f) in
  ...
  calc (==) {
    ...
    Loops.repeat_gen n (Loops.fixed_a b) f_gen acc0;
    }
...
let repeat_blocks_is_repeat_gen_blocks #a #b #c blocksize inp f l acc0 =
  ...
  calc (==) {
    ...
    repeat_gen_blocks_multi blocksize nb blocks (Loops.fixed_a b) (Loops.fixed_i f) acc0;
  }
...
let map_blocks_multi_is_repeat_gen_blocks_multi #a blocksize n inp f =
  ...
  let f_gen = repeat_gen_blocks_f blocksize n inp a_f f_g in
  ...
  calc (==) {
    ...
    (==) { Classical.forall_intro_2 aux;
           repeat_gen_right_extensionality n 0 n a_f a_f f_map f_gen acc0 }
    Loops.repeat_right 0 n a_f f_gen acc0;
    (==) { Loops.repeat_gen_def n a_f f_gen acc0 }
    Loops.repeat_gen n a_f f_gen acc0;
    (==) { }
    repeat_gen_blocks_multi #a blocksize n inp a_f f_g acc0;
    }
...
val aux_repeat_bf_s0:
  ...
  Lemma
   (let len = length inp in
    ...
    let repeat_bf_s0 = repeat_gen_blocks_f blocksize n0 t0 a f in
    let repeat_bf_t  = repeat_gen_blocks_f blocksize n inp a f in

    repeat_bf_s0 i acc == repeat_bf_t i acc)

let aux_repeat_bf_s0 #inp_t blocksize len0 n inp a f i acc =
  let len = length inp in
  let n0 = len0 / blocksize in
  Math.Lemmas.cancel_mul_div n blocksize;
  len0_div_bs blocksize len len0;
...
val aux_repeat_bf_s1:
  ...
  Lemma
   (let len = length inp in
    ...
    let repeat_bf_s1 = repeat_gen_blocks_f blocksize n1 t1 a1 f1 in
    let repeat_bf_t  = repeat_gen_blocks_f blocksize n inp a f in
...
let repeat_gen_blocks_multi_split #inp_t blocksize len0 n inp a f acc0 =
  let len = length inp in
  let len1 = len - len0 in
  let n0 = len0 / blocksize in
  let n1 = len1 / blocksize in
  ...
  let acc2 = repeat_gen_blocks_multi blocksize n1 t1 a1 f1 acc1 in
  ...
  calc (==) {
    ...
    (==) { Classical.forall_intro_2 (aux_repeat_bf_s0 #inp_t blocksize len0 n inp a f);
  ...
  assert (acc2 == repeat_gen_blocks_multi blocksize n inp a f acc0)
...
let repeat_blocks_multi_split #a #b blocksize len0 inp f acc0 =
  ...
  let t0 = Seq.slice inp 0 len0 in
  let t1 = Seq.slice inp len0 len in
  let acc1 = repeat_gen_blocks_multi blocksize n0 t0 (Loops.fixed_a b) (Loops.fixed_i f) acc0 in

  calc (==) {
    repeat_blocks_multi blocksize inp f acc0;
    (==) { repeat_blocks_multi_is_repeat_gen_blocks_multi #a #b blocksize inp f acc0 }
    repeat_gen_blocks_multi blocksize n inp (Loops.fixed_a b) (Loops.fixed_i f) acc0;
    (==) { repeat_gen_blocks_multi_split #a blocksize len0 n inp (Loops.fixed_a b) (Loops.fixed_i f) acc0 }
    repeat_gen_blocks_multi blocksize n1 t1 a1 f1 acc1;
    (==) { repeat_gen_blocks_multi_extensionality blocksize n1 t1 (Loops.fixed_a b) a1 (Loops.fixed_i f) f1 acc1 }
    repeat_gen_blocks_multi blocksize n1 t1 (Loops.fixed_a b) (Loops.fixed_i f) acc1;
