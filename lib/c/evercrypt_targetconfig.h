...
#if (TARGET_ARCHITECTURE != TARGET_ARCHITECTURE_ID_X64) && EVERCRYPT_CAN_COMPILE_VEC128
  return true;
#else
  return false;
#endif
...
#if (TARGET_ARCHITECTURE != TARGET_ARCHITECTURE_ID_X64) && EVERCRYPT_CAN_COMPILE_VEC256
  return true;
#else
  return false;
#endif
