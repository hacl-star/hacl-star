...
#define Lib_IntVector_Intrinsics_vec128_rotate_right_lanes32(x0, x1)    \
  ((vector128)(vec_perm((vector128)x0, (vector128){}, (vector128_8){    \
        (x1%4)*8+0,(x1%4)*8+1,(x1%4)*8+2,(x1%4)*8+3,                    \
          ((x1+1)%4)*8+0,((x1+1)%4)*8+1,((x1+1)%4)*8+2,((x1+1)%4)*8+3,  \
          ((x1+2)%4)*8+0,((x1+2)%4)*8+1,((x1+2)%4)*8+2,((x1+2)%4)*8+3,  \
          ((x1+3)%4)*8+0,((x1+3)%4)*8+1,((x1+3)%4)*8+2,((x1+3)%4)*8+3})))
//(x1+2)%4, (x1+3)%4}))
