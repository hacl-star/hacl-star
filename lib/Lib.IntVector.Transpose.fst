...
inline_for_extraction noextract
val transpose8x8_uint64: #t:v_inttype{t == U64} -> vec_t8 t -> vec_t8 t
let transpose8x8_uint64 #t vs0 =
  transpose8x8_012 #t vs0
...
val transpose16x16_lseq_is_transposewxw_uint32: vs:lseq (vec_t U32 16) 16 ->
  Lemma
   (let r = transposewxw_lseq 4 vs in
...
let transpose16x16_lseq_is_transposewxw_uint32 vs0 =
  let n = 4 in
  Loops.unfold_repeati n (transposewxw_f #16 n) vs0 3;
  Loops.unfold_repeati n (transposewxw_f #16 n) vs0 2;
  Loops.unfold_repeati n (transposewxw_f #16 n) vs0 1;
  Loops.unfold_repeati n (transposewxw_f #16 n) vs0 0;
  Loops.eq_repeati0 n (transposewxw_f #16 n) vs0;
  let r = transposewxw_lseq n vs0 in
  ...
  let res3 = transposewxw_f n 3 res2 in
...
val transpose8x8_lemma_uint64_ij: vs:lseq (vec_t U64 8) 8 -> i:nat{i < 8} -> j:nat{j < 8} ->
  Lemma ((vec_v (transpose8x8_lseq #U64 vs).[i]).[j] == (vec_v vs.[j]).[i])

let transpose8x8_lemma_uint64_ij vs0 i j =
  transpose8x8_lseq_is_transposewxw vs0;
  let n = 3 in
  Loops.unfold_repeati n (transposewxw_f #8 n) vs0 2;
  Loops.unfold_repeati n (transposewxw_f #8 n) vs0 1;
  ...
  vec_interleave_low_n_lemma_uint64_8_4 res1.[0] res1.[4];
  vec_interleave_low_n_lemma_uint64_8_4 res1.[1] res1.[5];
  vec_interleave_low_n_lemma_uint64_8_4 res1.[2] res1.[6];
  vec_interleave_low_n_lemma_uint64_8_4 res1.[3] res1.[7];
  vec_interleave_high_n_lemma_uint64_8_4 res1.[0] res1.[4];
  vec_interleave_high_n_lemma_uint64_8_4 res1.[1] res1.[5];
  vec_interleave_high_n_lemma_uint64_8_4 res1.[2] res1.[6];
  vec_interleave_high_n_lemma_uint64_8_4 res1.[3] res1.[7];

  vec_interleave_low_n_lemma_uint64_8_2 res0.[0] res0.[2];
  vec_interleave_low_n_lemma_uint64_8_2 res0.[1] res0.[3];
  vec_interleave_low_n_lemma_uint64_8_2 res0.[4] res0.[6];
  vec_interleave_low_n_lemma_uint64_8_2 res0.[5] res0.[7];
  vec_interleave_high_n_lemma_uint64_8_2 res0.[0] res0.[2];
  vec_interleave_high_n_lemma_uint64_8_2 res0.[1] res0.[3];
  vec_interleave_high_n_lemma_uint64_8_2 res0.[4] res0.[6];
  vec_interleave_high_n_lemma_uint64_8_2 res0.[5] res0.[7];

  vec_interleave_low_lemma_uint64_8 vs0.[0] vs0.[1];
  vec_interleave_low_lemma_uint64_8 vs0.[2] vs0.[3];
  vec_interleave_low_lemma_uint64_8 vs0.[4] vs0.[5];
  vec_interleave_low_lemma_uint64_8 vs0.[6] vs0.[7];
  vec_interleave_high_lemma_uint64_8 vs0.[0] vs0.[1];
  vec_interleave_high_lemma_uint64_8 vs0.[2] vs0.[3];
  vec_interleave_high_lemma_uint64_8 vs0.[4] vs0.[5];
  vec_interleave_high_lemma_uint64_8 vs0.[6] vs0.[7]
...
let transpose16x16_lemma_ij vs0 i j =
  ...
  Loops.unfold_repeati 4 (transposewxw_f 4) vs0 3;
  Loops.unfold_repeati 4 (transposewxw_f 4) vs0 2;
  Loops.unfold_repeati 4 (transposewxw_f 4) vs0 1;
  Loops.unfold_repeati 4 (transposewxw_f 4) vs0 0;
  Loops.eq_repeati0 4 (transposewxw_f 4) vs0;

  let res0 = transposewxw_f 4 0 vs0 in
