...
static uint64_t Hacl_Hash_SHA2_512_u32_to_u64(uint32_t x)
{
  return (uint64_t )x;
}

static uint32_t Hacl_Hash_SHA2_512_u64_to_u32(uint64_t x)
{
  return (uint32_t )x;
}
...
static void Hacl_Hash_SHA2_512_update_last(uint64_t *state, uint8_t *data, uint64_t len1)
{
  ...
  if (len1 < (uint64_t )112)
    ...
    final_blocks = blocks;
  memcpy(final_blocks, data, Hacl_Hash_SHA2_512_u64_to_u32(len1) * sizeof data[0]);
  uint64_t n1 = state[168];
  uint8_t *padding = final_blocks + Hacl_Hash_SHA2_512_u64_to_u32(len1);
  FStar_UInt128_t
  encodedlen =
  ...
  uint32_t
  pad0len =
    ((uint32_t )256 - (Hacl_Hash_SHA2_512_u64_to_u32(len1) + (uint32_t )16 + (uint32_t )1))
    % (uint32_t )128;
...
static void Hacl_Hash_SHA2_512_hash(uint8_t *hash1, uint8_t *input, uint32_t len1)
{
  ...
  Hacl_Hash_SHA2_512_update_last(state, input_last, Hacl_Hash_SHA2_512_u32_to_u64(r));
