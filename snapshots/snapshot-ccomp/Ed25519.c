...
Hacl_Bignum_Fproduct_copy_from_wide_(uint64_t *output, FStar_UInt128_uint128 *input)
{
  ...
  {
    FStar_UInt128_uint128 uu____429 = input[3];
    uint64_t uu____428 = FStar_Int_Cast_Full_uint128_to_uint64(&uu____429);
    output[3] = uu____428;
  }
  {
    FStar_UInt128_uint128 uu____429 = input[4];
    uint64_t uu____428 = FStar_Int_Cast_Full_uint128_to_uint64(&uu____429);
    output[4] = uu____428;
  }
}
...
)
{
  ...
  {
    FStar_UInt128_uint128 uu____871 = output[3];
  ...
  {
    FStar_UInt128_uint128 uu____871 = output[4];
...
inline static void Hacl_Bignum_Fmul_fmul_(uint64_t *output, uint64_t *input, uint64_t *input21)
{
  ...
  FStar_Int_Cast_Full_uint64_to_uint128((uint64_t )0, &ret0);
  KRML_CHECK_SIZE(ret0, (uint32_t )5);
  FStar_UInt128_uint128 t[5];
  for (uintmax_t _i = 0; _i < (uint32_t )5; ++_i)
    t[_i] = ret0;
  Hacl_Bignum_Fmul_mul_shift_reduce_(t, input, input21);
  Hacl_Bignum_Fproduct_carry_wide_(t);
  FStar_UInt128_uint128 b4 = t[4];
  FStar_UInt128_uint128 b0 = t[0];
  FStar_UInt128_uint128 mask;
  FStar_UInt128_uint128 ret1;
  FStar_Int_Cast_Full_uint64_to_uint128((uint64_t )1, &ret1);
  FStar_UInt128_uint128 s1 = ret1;
  FStar_UInt128_uint128 ret2;
  FStar_UInt128_uint128 ret3;
  FStar_Int_Cast_Full_uint64_to_uint128((uint64_t )1, &ret3);
  ...
  FStar_UInt128_uint128 s01 = ret;
  FStar_UInt128_mul_wide((uint64_t )19, FStar_Int_Cast_Full_uint128_to_uint64(&s01), &ret4);
  FStar_UInt128_uint128 s10 = ret4;
...
inline static void Hacl_Bignum_Fsquare_fsquare_(FStar_UInt128_uint128 *tmp, uint64_t *output)
{
  ...
  FStar_UInt128_uint128 b4 = tmp[4];
  FStar_UInt128_uint128 b0 = tmp[0];
  FStar_UInt128_uint128 mask;
  FStar_UInt128_uint128 ret0;
  FStar_Int_Cast_Full_uint64_to_uint128((uint64_t )1, &ret0);
  FStar_UInt128_uint128 s1 = ret0;
  FStar_UInt128_uint128 ret1;
  FStar_UInt128_uint128 ret2;
  FStar_Int_Cast_Full_uint64_to_uint128((uint64_t )1, &ret2);
  FStar_UInt128_uint128 s0 = ret2;
  FStar_UInt128_shift_left(&s0, (uint32_t )51, &ret1);
  FStar_UInt128_uint128 s00 = ret1;
  FStar_UInt128_sub(&s00, &s1, &mask);
  FStar_UInt128_uint128 b4_;
  FStar_UInt128_logand(&b4, &mask, &b4_);
  FStar_UInt128_uint128 b0_;
  ...
  FStar_UInt128_shift_right(&b4, (uint32_t )51, &ret);
  FStar_UInt128_uint128 s01 = ret;
  FStar_UInt128_mul_wide((uint64_t )19, FStar_Int_Cast_Full_uint128_to_uint64(&s01), &ret3);
...
static void Hacl_Hash_SHA2_512_update(uint64_t *state, uint8_t *data)
{
  ...
  {
    uint64_t uu____871 = hash_w[0];
    uint64_t uu____874 = hash_0[0];
    uint64_t uu____870 = uu____871 + uu____874;
    hash_w[0] = uu____870;
  }
  {
    uint64_t uu____871 = hash_w[1];
    uint64_t uu____874 = hash_0[1];
    uint64_t uu____870 = uu____871 + uu____874;
    hash_w[1] = uu____870;
  }
  {
    uint64_t uu____871 = hash_w[2];
    uint64_t uu____874 = hash_0[2];
    uint64_t uu____870 = uu____871 + uu____874;
    hash_w[2] = uu____870;
  }
  {
    uint64_t uu____871 = hash_w[3];
    uint64_t uu____874 = hash_0[3];
    uint64_t uu____870 = uu____871 + uu____874;
    hash_w[3] = uu____870;
  }
  {
    uint64_t uu____871 = hash_w[4];
    uint64_t uu____874 = hash_0[4];
    uint64_t uu____870 = uu____871 + uu____874;
    hash_w[4] = uu____870;
  }
  {
    uint64_t uu____871 = hash_w[5];
    uint64_t uu____874 = hash_0[5];
    uint64_t uu____870 = uu____871 + uu____874;
    hash_w[5] = uu____870;
  }
  {
    uint64_t uu____871 = hash_w[6];
    uint64_t uu____874 = hash_0[6];
    uint64_t uu____870 = uu____871 + uu____874;
    hash_w[6] = uu____870;
  }
  {
    uint64_t uu____871 = hash_w[7];
    uint64_t uu____874 = hash_0[7];
    uint64_t uu____870 = uu____871 + uu____874;
    hash_w[7] = uu____870;
  }
...
static void Hacl_Impl_BignumQ_Mul_low_mul_5(uint64_t *z, uint64_t *x, uint64_t *y)
{
  ...
  FStar_UInt128_uint128 s03 = ret4;
  FStar_UInt128_add(&s03, &xy30, &ret3);
  FStar_UInt128_uint128 s04 = ret3;
  ...
  FStar_UInt128_uint128 s06 = ret9;
  FStar_UInt128_add(&s06, &xy31, &ret8);
  FStar_UInt128_uint128 s07 = ret8;
  FStar_UInt128_add(&s07, &xy40, &ret7);
  FStar_UInt128_uint128 s08 = ret7;
  FStar_UInt128_add(&s08, &carry4, &ret6);
  FStar_UInt128_uint128 s09 = ret6;
  uint64_t t4 = FStar_Int_Cast_Full_uint128_to_uint64(&s09) & (uint64_t )0xffffffffff;
...
{
  FStar_UInt128_uint128 z0 = z[0];
  FStar_UInt128_uint128 z1 = z[1];
  FStar_UInt128_uint128 z2 = z[2];
  FStar_UInt128_uint128 z3 = z[3];
  FStar_UInt128_uint128 z4 = z[4];
  FStar_UInt128_uint128 z5 = z[5];
  FStar_UInt128_uint128 z6 = z[6];
  FStar_UInt128_uint128 z7 = z[7];
  FStar_UInt128_uint128 z8 = z[8];
  ...
  FStar_Int_Cast_Full_uint64_to_uint128((uint64_t )0, &y8);
