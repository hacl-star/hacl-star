...
static void Hacl_Hash_SHA2_256_update(uint32_t *state, uint8_t *data)
{
  ...
  {
    uint32_t uu____795 = hash_w[0];
    uint32_t uu____798 = hash_0[0];
    uint32_t uu____794 = uu____795 + uu____798;
    hash_w[0] = uu____794;
  }
  {
    uint32_t uu____795 = hash_w[1];
    uint32_t uu____798 = hash_0[1];
    uint32_t uu____794 = uu____795 + uu____798;
    hash_w[1] = uu____794;
  }
  {
    uint32_t uu____795 = hash_w[2];
    uint32_t uu____798 = hash_0[2];
    uint32_t uu____794 = uu____795 + uu____798;
    hash_w[2] = uu____794;
  }
  {
    uint32_t uu____795 = hash_w[3];
    uint32_t uu____798 = hash_0[3];
    uint32_t uu____794 = uu____795 + uu____798;
    hash_w[3] = uu____794;
  }
  {
    uint32_t uu____795 = hash_w[4];
    uint32_t uu____798 = hash_0[4];
    uint32_t uu____794 = uu____795 + uu____798;
    hash_w[4] = uu____794;
  }
  {
    uint32_t uu____795 = hash_w[5];
    uint32_t uu____798 = hash_0[5];
    uint32_t uu____794 = uu____795 + uu____798;
    hash_w[5] = uu____794;
  }
  {
    uint32_t uu____795 = hash_w[6];
    uint32_t uu____798 = hash_0[6];
    uint32_t uu____794 = uu____795 + uu____798;
    hash_w[6] = uu____794;
  }
  {
    uint32_t uu____795 = hash_w[7];
    uint32_t uu____798 = hash_0[7];
    uint32_t uu____794 = uu____795 + uu____798;
    hash_w[7] = uu____794;
  }
...
static void Hacl_Hash_SHA2_256_update_last(uint32_t *state, uint8_t *data, uint32_t len)
{
  ...
  K___uint32_t_uint8_t_ uu____1971;
  if (len < (uint32_t )56)
    uu____1971 = ((K___uint32_t_uint8_t_ ){ .fst = (uint32_t )1, .snd = blocks + (uint32_t )64 });
  else
    uu____1971 = ((K___uint32_t_uint8_t_ ){ .fst = (uint32_t )2, .snd = blocks });
  K___uint32_t_uint8_t_ scrut = uu____1971;
