...
| _11_85 -> begin
(let _11_86 = (let _52_27 = (index s ctr)
in (upd cpy ctr _52_27))
in (copy_aux s cpy (ctr + 1)))
end))

let copy = (fun s -> (let cpy = (let _52_30 = (length s)
in (let _52_29 = (index s 0)
in (create _52_30 _52_29)))
...
| _11_120 -> begin
(let _11_121 = (let _52_37 = (index s (s_idx + ctr))
in (upd t (t_idx + ctr) _52_37))
in (blit_aux s s_idx t t_idx len (ctr + 1)))
end))

let rec blit = (fun s s_idx t t_idx len -> (blit_aux s s_idx t t_idx len 0))

let sub = (fun s idx len -> (let t = (let _52_46 = (index s 0)
in (create len _52_46))
