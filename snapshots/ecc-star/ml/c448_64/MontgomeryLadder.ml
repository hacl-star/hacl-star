...
in (let _41_45 = (ConcretePoint.copy2 pp ppq p pq)
...
in (let _41_311 = ()
in (let _41_313 = (ConcretePoint.swap_conditional p pq mask)
in (let h = (FStar_ST.get ())
in (let _41_316 = ()
in (let _41_318 = ()
in (let _41_320 = (DoubleAndAdd.double_and_add pp ppq p pq q)
in (let h2 = (FStar_ST.get ())
in (let _41_323 = (ConcretePoint.swap_conditional pp ppq mask)
in (let _41_325 = ()
in (let h1 = (FStar_ST.get ())
in ())))))))))))))))))
...
(let h0 = (FStar_ST.get ())
in (let _41_485 = ()
in (let _41_487 = (small_step_core pp ppq p pq q () ctr b (Obj.magic (())))
in (let h1 = (FStar_ST.get ())
in (let bit = (nth_bit b ctr)
in (let _41_491 = ()
in (let _41_493 = ()
...
in (let _41_497 = ()
in (let _41_499 = ()
in (let _41_501 = (ConcretePoint.swap_both pp ppq p pq)
in (let h2 = (FStar_ST.get ())
in (let _41_504 = ()
in (let _41_506 = ()
in (let _41_508 = ()
in (let _41_510 = ()
in (let _41_512 = (small_step pp ppq p pq q () (ctr + 1) b (Obj.magic (())))
...
in (let m = ()
in (let _41_707 = ()
in (let _41_709 = (small_step pp ppq p pq q () 0 byte (Obj.magic (())))
in (let h1 = (FStar_ST.get ())
in (let _41_712 = ()
in (let _41_714 = (big_step n pp ppq p pq q (ctr + 1))
in (let h2 = (FStar_ST.get ())
in ())))))))))
end)))
...
in (let _41_801 = (ConcretePoint.copy p q)
in (let h1 = (FStar_ST.get ())
in (let _41_804 = ()
in (let _41_806 = ()
in (let _41_808 = ()
in (let _41_810 = ()
in (let _41_812 = (Bigint.upd_limb (ConcretePoint.get_x inf) 0 UInt.one_limb)
in (let h2 = (FStar_ST.get ())
in ()))))))))))
...
in (let _41_893 = ()
in (let _41_895 = ()
in (let _41_897 = (init_points two_p two_p_plus_q p inf q)
in (let h2 = (FStar_ST.get ())
in (let _41_900 = ()
in (let _41_902 = ()
in (let _41_904 = ()
in (let _41_906 = (big_step n two_p two_p_plus_q inf p q 0)
in (let h3 = (FStar_ST.get ())
in (let _41_909 = ()
