...
uint32_t Hacl_Hash_SHA2_256_size_word = (uint32_t )4;

uint32_t Hacl_Hash_SHA2_256_size_hash_w = (uint32_t )8;

uint32_t Hacl_Hash_SHA2_256_size_block_w = (uint32_t )16;

uint32_t Hacl_Hash_SHA2_256_size_hash = (uint32_t )32;

uint32_t Hacl_Hash_SHA2_256_size_block = (uint32_t )64;

uint64_t Hacl_Hash_SHA2_256_max_input_len = (uint64_t )2305843009213693952;

uint32_t Hacl_Hash_SHA2_256_size_k_w = (uint32_t )64;

uint32_t Hacl_Hash_SHA2_256_size_ws_w = (uint32_t )64;

uint32_t Hacl_Hash_SHA2_256_size_whash_w = (uint32_t )8;

uint32_t Hacl_Hash_SHA2_256_size_count_w = (uint32_t )1;

uint32_t Hacl_Hash_SHA2_256_size_len_8 = (uint32_t )8;

uint32_t Hacl_Hash_SHA2_256_size_state = (uint32_t )137;

uint32_t Hacl_Hash_SHA2_256_pos_k_w = (uint32_t )0;

uint32_t Hacl_Hash_SHA2_256_pos_ws_w = (uint32_t )64;

uint32_t Hacl_Hash_SHA2_256_pos_whash_w = (uint32_t )128;

uint32_t Hacl_Hash_SHA2_256_pos_count_w = (uint32_t )136;
...
{
  uint32_t *p1 = hash1;
  uint32_t *p2 = hash1 + (uint32_t )4;
  p1[0] = (uint32_t )0x6a09e667;
  p1[1] = (uint32_t )0xbb67ae85;
  p1[2] = (uint32_t )0x3c6ef372;
  p1[3] = (uint32_t )0xa54ff53a;
...
{
  return ((uint32_t )64 - (len + (uint32_t )8 + (uint32_t )1) % (uint32_t )64) % (uint32_t )64;
}

uint64_t Hacl_Hash_SHA2_256_encode_length(uint32_t count1, uint32_t len)
{
  return
    ((uint64_t )count1 * (uint64_t )(uint32_t )64 + (uint64_t )len)
    * (uint64_t )(uint32_t )8;
}
