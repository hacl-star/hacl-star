...
static void Hacl_Bignum_Modulo_carry_top(uint64_t *b)
{
  ...
  b0 = b[0];
  uint64_t
  b4_ = b4 & (uint64_t )0x7ffffffffffff;
  uint64_t
  b0_ = b0 + (uint64_t )19 * (b4 >> (uint32_t )51);
  b[4] = b4_;
  b[0] = b0_;
...
{
  {
    ...
    tctr = tmp[ctr];
    FStar_UInt128_t
    tctrp1 = tmp[ctr + (uint32_t )1];
    uint64_t
    r0 = FStar_Int_Cast_Full_uint128_to_uint64(tctr) & Hacl_Bignum_Parameters_mask_51;
    FStar_UInt128_t
    c = FStar_UInt128_shift_right(tctr, (uint32_t )51);
...
inline static void Hacl_Bignum_Fmul_shift_reduce(uint64_t *output)
{
  ...
  {
    uint32_t
    ctr = (uint32_t )5 - (uint32_t )0 - (uint32_t )1;
    uint64_t
    z = output[ctr - (uint32_t )1];
    output[ctr] = z;
    
  }
  {
    uint32_t
    ctr = (uint32_t )5 - (uint32_t )1 - (uint32_t )1;
    uint64_t
    z = output[ctr - (uint32_t )1];
    output[ctr] = z;
  ...
  {
    uint32_t
    ctr = (uint32_t )5 - (uint32_t )2 - (uint32_t )1;
    uint64_t
    z = output[ctr - (uint32_t )1];
    output[ctr] = z;
  ...
  {
    uint32_t
    ctr = (uint32_t )5 - (uint32_t )3 - (uint32_t )1;
    uint64_t
    z = output[ctr - (uint32_t )1];
    output[ctr] = z;
...
static void Hacl_EC_Format_fexpand(uint64_t *output, uint8_t *input)
{
  ...
  i0 = load64_le(input);
  uint8_t
  *x00 = input + (uint32_t )6;
  uint64_t
  i1 = load64_le(x00);
  uint8_t
  *x01 = input + (uint32_t )12;
  uint64_t
  i2 = load64_le(x01);
  uint8_t
  *x02 = input + (uint32_t )19;
  uint64_t
  i3 = load64_le(x02);
  uint8_t
  *x0 = input + (uint32_t )24;
  uint64_t
  i4 = load64_le(x0);
  uint64_t
  output0 = i0 & Hacl_Bignum_Parameters_mask_51;
  uint64_t
  output1 = i1 >> (uint32_t )3 & Hacl_Bignum_Parameters_mask_51;
  uint64_t
  output2 = i2 >> (uint32_t )6 & Hacl_Bignum_Parameters_mask_51;
  uint64_t
  output3 = i3 >> (uint32_t )1 & Hacl_Bignum_Parameters_mask_51;
  uint64_t
  output4 = i4 >> (uint32_t )12 & Hacl_Bignum_Parameters_mask_51;
  output[0] = output0;
  output[1] = output1;
  output[2] = output2;
  output[3] = output3;
...
static void Hacl_EC_Format_fcontract_first_carry_pass(uint64_t *input)
{
  ...
  t4 = input[4];
  uint64_t
  t1_ = t1 + (t0 >> (uint32_t )51);
  uint64_t
  t0_ = t0 & (uint64_t )0x7ffffffffffff;
  uint64_t
  t2_ = t2 + (t1_ >> (uint32_t )51);
  uint64_t
  t1__ = t1_ & (uint64_t )0x7ffffffffffff;
  uint64_t
  t3_ = t3 + (t2_ >> (uint32_t )51);
  uint64_t
  t2__ = t2_ & (uint64_t )0x7ffffffffffff;
  uint64_t
  t4_ = t4 + (t3_ >> (uint32_t )51);
  uint64_t
  t3__ = t3_ & (uint64_t )0x7ffffffffffff;
  input[0] = t0_;
  input[1] = t1__;
  input[2] = t2__;
  input[3] = t3__;
...
static void Hacl_EC_Format_fcontract_trim(uint64_t *input)
{
  ...
  a4 = input[4];
  uint64_t
  mask0 = FStar_UInt64_gte_mask(a0, (uint64_t )0x7ffffffffffed);
  uint64_t
  mask1 = FStar_UInt64_eq_mask(a1, (uint64_t )0x7ffffffffffff);
  uint64_t
  mask2 = FStar_UInt64_eq_mask(a2, (uint64_t )0x7ffffffffffff);
  uint64_t
  mask3 = FStar_UInt64_eq_mask(a3, (uint64_t )0x7ffffffffffff);
  uint64_t
  mask4 = FStar_UInt64_eq_mask(a4, (uint64_t )0x7ffffffffffff);
  uint64_t
  mask = mask0 & mask1 & mask2 & mask3 & mask4;
  uint64_t
  a0_ = a0 - ((uint64_t )0x7ffffffffffed & mask);
  uint64_t
  a1_ = a1 - ((uint64_t )0x7ffffffffffff & mask);
  uint64_t
  a2_ = a2 - ((uint64_t )0x7ffffffffffff & mask);
  uint64_t
  a3_ = a3 - ((uint64_t )0x7ffffffffffff & mask);
  uint64_t
  a4_ = a4 - ((uint64_t )0x7ffffffffffff & mask);
  input[0] = a0_;
  input[1] = a1_;
  input[2] = a2_;
  input[3] = a3_;
...
{
  uint64_t
  *gx = Hacl_Impl_Ed25519_ExtPoint_getx(g1);
  uint64_t
  *gy = Hacl_Impl_Ed25519_ExtPoint_gety(g1);
  uint64_t
  *gz = Hacl_Impl_Ed25519_ExtPoint_getz(g1);
  uint64_t
  *gt1 = Hacl_Impl_Ed25519_ExtPoint_gett(g1);
...
static void Hacl_Impl_Store51_store_51_(uint8_t *output, uint64_t *input)
{
  ...
  t4 = input[4];
  uint64_t
  o0 = t1 << (uint32_t )51 | t0;
  uint64_t
  o1 = t2 << (uint32_t )38 | t1 >> (uint32_t )13;
  uint64_t
  o2 = t3 << (uint32_t )25 | t2 >> (uint32_t )26;
  uint64_t
  o3 = t4 << (uint32_t )12 | t3 >> (uint32_t )39;
  uint8_t
  *b0 = output;
  uint8_t
  *b1 = output + (uint32_t )8;
  uint8_t
  *b2 = output + (uint32_t )16;
  uint8_t
  *b3 = output + (uint32_t )24;
  store64_le(b0, o0);
  store64_le(b1, o1);
  store64_le(b2, o2);
  store64_le(b3, o3);
...
static void Hacl_Impl_Ed25519_PointCompress_point_compress(uint8_t *z, uint64_t *p)
{
  ...
  *out = tmp + (uint32_t )10;
  uint64_t
  *px = Hacl_Impl_Ed25519_ExtPoint_getx(p);
  uint64_t
  *py = Hacl_Impl_Ed25519_ExtPoint_gety(p);
  uint64_t
  *pz = Hacl_Impl_Ed25519_ExtPoint_getz(p);
...
static void Hacl_Impl_Ed25519_PointAdd_point_add(uint64_t *out, uint64_t *p, uint64_t *q1)
{
  ...
  *tmp1 = tmp;
  uint64_t
  *tmp20 = tmp + (uint32_t )5;
  uint64_t
  *tmp30 = tmp + (uint32_t )10;
  uint64_t
  *tmp40 = tmp + (uint32_t )15;
  uint64_t
  *x1 = Hacl_Impl_Ed25519_ExtPoint_getx(p);
  uint64_t
  *y1 = Hacl_Impl_Ed25519_ExtPoint_gety(p);
  uint64_t
  *x2 = Hacl_Impl_Ed25519_ExtPoint_getx(q1);
  uint64_t
  *y2 = Hacl_Impl_Ed25519_ExtPoint_gety(q1);
...
static void Hacl_Impl_Ed25519_PointDouble_point_double_step_1(uint64_t *p, uint64_t *tmp)
{
  ...
  *tmp2 = tmp + (uint32_t )5;
  uint64_t
  *tmp3 = tmp + (uint32_t )10;
  uint64_t
  *tmp4 = tmp + (uint32_t )15;
  uint64_t
  *x1 = Hacl_Impl_Ed25519_ExtPoint_getx(p);
  uint64_t
  *y1 = Hacl_Impl_Ed25519_ExtPoint_gety(p);
  uint64_t
  *z1 = Hacl_Impl_Ed25519_ExtPoint_getz(p);
...
static void Hacl_Impl_Ed25519_PointDouble_point_double_step_2(uint64_t *p, uint64_t *tmp)
{
  ...
  *tmp4 = tmp + (uint32_t )15;
  uint64_t
  *tmp5 = tmp + (uint32_t )20;
  uint64_t
  *tmp6 = tmp + (uint32_t )25;
  uint64_t
  *x1 = Hacl_Impl_Ed25519_ExtPoint_getx(p);
  uint64_t
  *y1 = Hacl_Impl_Ed25519_ExtPoint_gety(p);
...
{
  uint8_t
  bit = Hacl_Impl_Ed25519_Ladder_Step_ith_bit(k1, ctr);
...
static void Hacl_Hash_SHA2_512_update(uint64_t *state, uint8_t *data)
{
  ...
  {
    uint64_t
    t16 = ws_w[i - (uint32_t )16];
    uint64_t
    t15 = ws_w[i - (uint32_t )15];
    uint64_t
    t7 = ws_w[i - (uint32_t )7];
    uint64_t
    t2 = ws_w[i - (uint32_t )2];
    ws_w[i] =
...
static bool Hacl_Impl_Ed25519_PointEqual_eq(uint64_t *a, uint64_t *b)
{
  ...
  b4 = b[4];
  bool
  z = a0 == b0 && a1 == b1 && a2 == b2 && a3 == b3 && a4 == b4;
  return z;
...
{
  uint64_t
  *pyqz = tmp + (uint32_t )10;
  uint64_t
  *qypz = tmp + (uint32_t )15;
...
{
  bool
  b = Hacl_Impl_Ed25519_PointEqual_point_equal_1(p, q1, tmp);
  if (b == true)
...
static bool Hacl_Impl_Ed25519_PointEqual_point_equal(uint64_t *p, uint64_t *q1)
{
  ...
  tmp[20] = { 0 };
  bool
  res = Hacl_Impl_Ed25519_PointEqual_point_equal_(p, q1, tmp);
  return res;
...
static void Hacl_Impl_Load56_load_64_bytes(uint64_t *out, uint8_t *b)
{
  ...
  *b80 = b;
  ...
  z = load64_le(b80);
  uint64_t
  z_ = z & (uint64_t )0xffffffffffffff;
  uint64_t
  b0 = z_;
  uint8_t
  *b81 = b + (uint32_t )7;
  ...
  z0 = load64_le(b81);
  uint64_t
  z_0 = z0 & (uint64_t )0xffffffffffffff;
  uint64_t
  b1 = z_0;
  uint8_t
  *b82 = b + (uint32_t )14;
  ...
  z1 = load64_le(b82);
  uint64_t
  z_1 = z1 & (uint64_t )0xffffffffffffff;
  uint64_t
  b2 = z_1;
  uint8_t
  *b83 = b + (uint32_t )21;
  ...
  z2 = load64_le(b83);
  uint64_t
  z_2 = z2 & (uint64_t )0xffffffffffffff;
  uint64_t
  b3 = z_2;
  uint8_t
  *b84 = b + (uint32_t )28;
  ...
  z3 = load64_le(b84);
  uint64_t
  z_3 = z3 & (uint64_t )0xffffffffffffff;
  uint64_t
  b4 = z_3;
  uint8_t
  *b85 = b + (uint32_t )35;
  ...
  z4 = load64_le(b85);
  uint64_t
  z_4 = z4 & (uint64_t )0xffffffffffffff;
  uint64_t
  b5 = z_4;
  uint8_t
  *b86 = b + (uint32_t )42;
  ...
  z5 = load64_le(b86);
  uint64_t
  z_5 = z5 & (uint64_t )0xffffffffffffff;
  uint64_t
  b6 = z_5;
  uint8_t
  *b87 = b + (uint32_t )49;
  ...
  z6 = load64_le(b87);
  uint64_t
  z_6 = z6 & (uint64_t )0xffffffffffffff;
  uint64_t
  b7 = z_6;
  uint8_t
  *b8 = b + (uint32_t )56;
  ...
  z7 = load64_le(b8);
  uint64_t
  z_7 = z7 & (uint64_t )0xffffffffffffff;
  uint64_t
  b88 = z_7;
  uint8_t
  b63 = b[63];
...
Hacl_Impl_Ed25519_RecoverX_recover_x_(uint64_t *x, uint64_t *y, uint64_t sign1, uint64_t *tmp)
{
  ...
  *x20 = tmp;
  ...
  else
  {
    ...
    *y2 = tmp0 + (uint32_t )5;
    uint64_t
    *dyyi = tmp0 + (uint32_t )10;
    uint64_t
    *dyy = tmp0 + (uint32_t )15;
    uint64_t
    zero10 = (uint64_t )0;
    uint64_t
    one1 = (uint64_t )1;
...
static bool Hacl_Impl_Ed25519_RecoverX_recover_x(uint64_t *x, uint64_t *y, uint64_t sign1)
{
  ...
  tmp[20] = { 0 };
  bool
  res = Hacl_Impl_Ed25519_RecoverX_recover_x_(x, y, sign1, tmp);
  return res;
...
static bool Hacl_Impl_Ed25519_PointDecompress_point_decompress(uint64_t *out, uint8_t *s)
{
  ...
  *x = tmp + (uint32_t )5;
  ...
  {
    uint64_t
    *outx = Hacl_Impl_Ed25519_ExtPoint_getx(out);
    uint64_t
    *outy = Hacl_Impl_Ed25519_ExtPoint_gety(out);
    uint64_t
    *outz = Hacl_Impl_Ed25519_ExtPoint_getz(out);
    uint64_t
    *outt = Hacl_Impl_Ed25519_ExtPoint_gett(out);
...
{
  uint32_t
  nblocks = len1 >> (uint32_t )7;
  uint64_t
  rest = (uint64_t )(len1 & (uint32_t )127);
  uint64_t
  st[169] = { 0 };
...
static void Hacl_Impl_BignumQ_Mul_low_mul_5(uint64_t *z, uint64_t *x, uint64_t *y)
{
  ...
  y4 = y[4];
  FStar_UInt128_t
  xy00 = FStar_UInt128_mul_wide(x0, y0);
  FStar_UInt128_t
  xy01 = FStar_UInt128_mul_wide(x0, y1);
  FStar_UInt128_t
  xy02 = FStar_UInt128_mul_wide(x0, y2);
  FStar_UInt128_t
  xy03 = FStar_UInt128_mul_wide(x0, y3);
  FStar_UInt128_t
  xy04 = FStar_UInt128_mul_wide(x0, y4);
  FStar_UInt128_t
  xy10 = FStar_UInt128_mul_wide(x1, y0);
  FStar_UInt128_t
  xy11 = FStar_UInt128_mul_wide(x1, y1);
  FStar_UInt128_t
  xy12 = FStar_UInt128_mul_wide(x1, y2);
  FStar_UInt128_t
  xy13 = FStar_UInt128_mul_wide(x1, y3);
  FStar_UInt128_t
  xy20 = FStar_UInt128_mul_wide(x2, y0);
  FStar_UInt128_t
  xy21 = FStar_UInt128_mul_wide(x2, y1);
  FStar_UInt128_t
  xy22 = FStar_UInt128_mul_wide(x2, y2);
  FStar_UInt128_t
  xy30 = FStar_UInt128_mul_wide(x3, y0);
  FStar_UInt128_t
  xy31 = FStar_UInt128_mul_wide(x3, y1);
  FStar_UInt128_t
  xy40 = FStar_UInt128_mul_wide(x4, y0);
  FStar_UInt128_t
  x5 = xy00;
  FStar_UInt128_t
  carry1 = FStar_UInt128_shift_right(x5, (uint32_t )56);
  uint64_t
  t = FStar_Int_Cast_Full_uint128_to_uint64(x5) & (uint64_t )0xffffffffffffff;
  uint64_t
  t0 = t;
  FStar_UInt128_t
  x6 = FStar_UInt128_add(FStar_UInt128_add(xy01, xy10), carry1);
  FStar_UInt128_t
  carry2 = FStar_UInt128_shift_right(x6, (uint32_t )56);
  uint64_t
  t1 = FStar_Int_Cast_Full_uint128_to_uint64(x6) & (uint64_t )0xffffffffffffff;
  uint64_t
  t11 = t1;
  FStar_UInt128_t
  x7 = FStar_UInt128_add(FStar_UInt128_add(FStar_UInt128_add(xy02, xy11), xy20), carry2);
  FStar_UInt128_t
  carry3 = FStar_UInt128_shift_right(x7, (uint32_t )56);
  uint64_t
  t2 = FStar_Int_Cast_Full_uint128_to_uint64(x7) & (uint64_t )0xffffffffffffff;
  uint64_t
  t21 = t2;
  FStar_UInt128_t
  x8 =
    FStar_UInt128_add(FStar_UInt128_add(FStar_UInt128_add(FStar_UInt128_add(xy03, xy12), xy21),
      ...
      carry3);
  FStar_UInt128_t
  carry4 = FStar_UInt128_shift_right(x8, (uint32_t )56);
  uint64_t
  t3 = FStar_Int_Cast_Full_uint128_to_uint64(x8) & (uint64_t )0xffffffffffffff;
  uint64_t
  t31 = t3;
  uint64_t
  t4 =
...
static void Hacl_Impl_BignumQ_Mul_mul_5(FStar_UInt128_t *z, uint64_t *x, uint64_t *y)
{
  ...
  xy13 = FStar_UInt128_mul_wide(x1, y3);
  FStar_UInt128_t
  xy14 = FStar_UInt128_mul_wide(x1, y4);
  FStar_UInt128_t
  xy20 = FStar_UInt128_mul_wide(x2, y0);
  FStar_UInt128_t
  xy21 = FStar_UInt128_mul_wide(x2, y1);
  ...
  xy22 = FStar_UInt128_mul_wide(x2, y2);
  FStar_UInt128_t
  xy23 = FStar_UInt128_mul_wide(x2, y3);
  FStar_UInt128_t
  xy24 = FStar_UInt128_mul_wide(x2, y4);
  FStar_UInt128_t
  xy30 = FStar_UInt128_mul_wide(x3, y0);
  FStar_UInt128_t
  xy31 = FStar_UInt128_mul_wide(x3, y1);
  FStar_UInt128_t
  xy32 = FStar_UInt128_mul_wide(x3, y2);
  FStar_UInt128_t
  xy33 = FStar_UInt128_mul_wide(x3, y3);
  FStar_UInt128_t
  xy34 = FStar_UInt128_mul_wide(x3, y4);
  FStar_UInt128_t
  xy40 = FStar_UInt128_mul_wide(x4, y0);
  FStar_UInt128_t
  xy41 = FStar_UInt128_mul_wide(x4, y1);
  FStar_UInt128_t
  xy42 = FStar_UInt128_mul_wide(x4, y2);
  FStar_UInt128_t
  xy43 = FStar_UInt128_mul_wide(x4, y3);
  FStar_UInt128_t
  xy44 = FStar_UInt128_mul_wide(x4, y4);
  FStar_UInt128_t
  z0 = xy00;
  FStar_UInt128_t
  z1 = FStar_UInt128_add(xy01, xy10);
  FStar_UInt128_t
  z2 = FStar_UInt128_add(FStar_UInt128_add(xy02, xy11), xy20);
  FStar_UInt128_t
  ...
  FStar_UInt128_t
  z6 = FStar_UInt128_add(FStar_UInt128_add(xy24, xy33), xy42);
  FStar_UInt128_t
  z7 = FStar_UInt128_add(xy34, xy43);
  FStar_UInt128_t
  z8 = xy44;
...
static void Hacl_Impl_BignumQ_Mul_carry(uint64_t *out, FStar_UInt128_t *z)
{
  ...
  y = z1;
  FStar_UInt128_t
  carry1 = FStar_UInt128_shift_right(x, (uint32_t )56);
  uint64_t
  t = FStar_Int_Cast_Full_uint128_to_uint64(x) & (uint64_t )0xffffffffffffff;
  uint64_t
  x0 = t;
  FStar_UInt128_t
  z1_ = FStar_UInt128_add(y, carry1);
  FStar_UInt128_t
  x1 = z1_;
  FStar_UInt128_t
  y1 = z2;
  FStar_UInt128_t
  carry2 = FStar_UInt128_shift_right(x1, (uint32_t )56);
  uint64_t
  t1 = FStar_Int_Cast_Full_uint128_to_uint64(x1) & (uint64_t )0xffffffffffffff;
  uint64_t
  x11 = t1;
  FStar_UInt128_t
  z2_ = FStar_UInt128_add(y1, carry2);
  FStar_UInt128_t
  x2 = z2_;
  FStar_UInt128_t
  y2 = z3;
  FStar_UInt128_t
  carry3 = FStar_UInt128_shift_right(x2, (uint32_t )56);
  uint64_t
  t2 = FStar_Int_Cast_Full_uint128_to_uint64(x2) & (uint64_t )0xffffffffffffff;
  uint64_t
  x21 = t2;
  FStar_UInt128_t
  z3_ = FStar_UInt128_add(y2, carry3);
  FStar_UInt128_t
  x3 = z3_;
  FStar_UInt128_t
  y3 = z4;
  FStar_UInt128_t
  carry4 = FStar_UInt128_shift_right(x3, (uint32_t )56);
  uint64_t
  t3 = FStar_Int_Cast_Full_uint128_to_uint64(x3) & (uint64_t )0xffffffffffffff;
  uint64_t
  x31 = t3;
  FStar_UInt128_t
  z4_ = FStar_UInt128_add(y3, carry4);
  FStar_UInt128_t
  x4 = z4_;
  FStar_UInt128_t
  y4 = z5;
  FStar_UInt128_t
  carry5 = FStar_UInt128_shift_right(x4, (uint32_t )56);
  uint64_t
  t4 = FStar_Int_Cast_Full_uint128_to_uint64(x4) & (uint64_t )0xffffffffffffff;
  uint64_t
  x41 = t4;
  FStar_UInt128_t
  z5_ = FStar_UInt128_add(y4, carry5);
  FStar_UInt128_t
  x5 = z5_;
  FStar_UInt128_t
  y5 = z6;
  FStar_UInt128_t
  carry6 = FStar_UInt128_shift_right(x5, (uint32_t )56);
  uint64_t
  t5 = FStar_Int_Cast_Full_uint128_to_uint64(x5) & (uint64_t )0xffffffffffffff;
  uint64_t
  x51 = t5;
  FStar_UInt128_t
  z6_ = FStar_UInt128_add(y5, carry6);
  FStar_UInt128_t
  x6 = z6_;
  FStar_UInt128_t
  y6 = z7;
  FStar_UInt128_t
  carry7 = FStar_UInt128_shift_right(x6, (uint32_t )56);
  uint64_t
  t6 = FStar_Int_Cast_Full_uint128_to_uint64(x6) & (uint64_t )0xffffffffffffff;
  uint64_t
  x61 = t6;
  FStar_UInt128_t
  z7_ = FStar_UInt128_add(y6, carry7);
  FStar_UInt128_t
  x7 = z7_;
  FStar_UInt128_t
  y7 = z8;
  FStar_UInt128_t
  carry8 = FStar_UInt128_shift_right(x7, (uint32_t )56);
  uint64_t
  t7 = FStar_Int_Cast_Full_uint128_to_uint64(x7) & (uint64_t )0xffffffffffffff;
  uint64_t
  x71 = t7;
  FStar_UInt128_t
  z8_ = FStar_UInt128_add(y7, carry8);
  FStar_UInt128_t
  x8 = z8_;
  FStar_UInt128_t
  y8 = FStar_Int_Cast_Full_uint64_to_uint128((uint64_t )0);
  FStar_UInt128_t
  carry9 = FStar_UInt128_shift_right(x8, (uint32_t )56);
  uint64_t
  t8 = FStar_Int_Cast_Full_uint128_to_uint64(x8) & (uint64_t )0xffffffffffffff;
  uint64_t
  x81 = t8;
  FStar_UInt128_t
  z9_ = FStar_UInt128_add(y8, carry9);
  uint64_t
  x9 = FStar_Int_Cast_Full_uint128_to_uint64(z9_);
...
static void Hacl_Impl_BignumQ_Mul_div_248(uint64_t *out, uint64_t *t)
{
  ...
  x9 = t[9];
  uint64_t
  z0 = (x5 & (uint64_t )0xffffff) << (uint32_t )32 | x4 >> (uint32_t )24;
  uint64_t
  z1 = (x6 & (uint64_t )0xffffff) << (uint32_t )32 | x5 >> (uint32_t )24;
  uint64_t
  z2 = (x7 & (uint64_t )0xffffff) << (uint32_t )32 | x6 >> (uint32_t )24;
  uint64_t
  z3 = (x8 & (uint64_t )0xffffff) << (uint32_t )32 | x7 >> (uint32_t )24;
  uint64_t
  z4 = (x9 & (uint64_t )0xffffff) << (uint32_t )32 | x8 >> (uint32_t )24;
...
static void Hacl_Impl_BignumQ_Mul_div_264(uint64_t *out, uint64_t *t)
{
  ...
  x9 = t[9];
  uint64_t
  z0 = (x5 & (uint64_t )0xffffffffff) << (uint32_t )16 | x4 >> (uint32_t )40;
  uint64_t
  z1 = (x6 & (uint64_t )0xffffffffff) << (uint32_t )16 | x5 >> (uint32_t )40;
  uint64_t
  z2 = (x7 & (uint64_t )0xffffffffff) << (uint32_t )16 | x6 >> (uint32_t )40;
  uint64_t
  z3 = (x8 & (uint64_t )0xffffffffff) << (uint32_t )16 | x7 >> (uint32_t )40;
  uint64_t
  z4 = (x9 & (uint64_t )0xffffffffff) << (uint32_t )16 | x8 >> (uint32_t )40;
  Hacl_Lib_Create64_make_h64_5(out, z0, z1, z2, z3, z4);
...
)
{
  ...
  *q1 = tmp;
  uint64_t
  *qmu_ = tmp + (uint32_t )10;
  uint64_t
  *qmu_264 = tmp + (uint32_t )20;
...
static void Hacl_Impl_BignumQ_Mul_add_modq_(uint64_t *out, uint64_t *x, uint64_t *y)
{
  ...
  y5 = z1;
  uint64_t
  carry1 = x5 >> (uint32_t )56;
  uint64_t
  t = x5 & (uint64_t )0xffffffffffffff;
  uint64_t
  x01 = t;
  uint64_t
  z1_ = y5 + carry1;
  ...
  y6 = z2;
  uint64_t
  carry2 = x6 >> (uint32_t )56;
  uint64_t
  t1 = x6 & (uint64_t )0xffffffffffffff;
  uint64_t
  x11 = t1;
  uint64_t
  z2_ = y6 + carry2;
  ...
  y7 = z3;
  uint64_t
  carry3 = x7 >> (uint32_t )56;
  uint64_t
  t2 = x7 & (uint64_t )0xffffffffffffff;
  uint64_t
  x21 = t2;
  uint64_t
  z3_ = y7 + carry3;
  ...
  y8 = z4;
  uint64_t
  carry4 = x8 >> (uint32_t )56;
  uint64_t
  t3 = x8 & (uint64_t )0xffffffffffffff;
  uint64_t
  x31 = t3;
  uint64_t
  x41 = y8 + carry4;
...
static bool Hacl_Impl_Ed25519_Verify_Steps_verify_step_1(uint64_t *r_, uint8_t *signature)
{
  ...
  *rs = signature;
  bool
  b_ = Hacl_Impl_Ed25519_PointDecompress_point_decompress(r_, rs);
  return b_;
...
)
{
  ...
  *h_ = tmp_;
  bool
  b = Hacl_Impl_Ed25519_PointDecompress_point_decompress(a_, public);
  bool
  res;
  if (b)
  {
    ...
    *rs = signature;
    bool
    b_ = Hacl_Impl_Ed25519_Verify_Steps_verify_step_1(r_, signature);
    bool
    ite0;
    if (b_)
    {
...
)
{
  ...
  tmp_[32] = { 0 };
  bool
  res = Hacl_Impl_Ed25519_Verify_verify__(public, msg, len1, signature, tmp, tmp_);
  return res;
...
{
  uint8_t
  *a__ = tmp_bytes + (uint32_t )96;
  uint8_t
  *apre = tmp_bytes + (uint32_t )224;
  uint8_t
  *a = apre;
...
{
  uint64_t
  *r = tmp_ints + (uint32_t )20;
  uint8_t
  *apre = tmp_bytes + (uint32_t )224;
  uint8_t
  *prefix = apre + (uint32_t )32;
...
{
  uint64_t
  *h = tmp_ints + (uint32_t )60;
  uint8_t
  *a__ = tmp_bytes + (uint32_t )96;
  uint8_t
  *rs_ = tmp_bytes + (uint32_t )160;
  uint8_t
  *apre = tmp_bytes + (uint32_t )224;
...
static void Hacl_Impl_Ed25519_Sign_Steps_sign_step_5(uint8_t *tmp_bytes, uint64_t *tmp_ints)
{
  ...
  *r = tmp_ints + (uint32_t )20;
  uint64_t
  *aq = tmp_ints + (uint32_t )45;
  uint64_t
  *ha = tmp_ints + (uint32_t )50;
  uint64_t
  *s = tmp_ints + (uint32_t )55;
  uint64_t
  *h = tmp_ints + (uint32_t )60;
  uint8_t
  *s_ = tmp_bytes + (uint32_t )192;
  uint8_t
  *apre = tmp_bytes + (uint32_t )224;
  uint8_t
  *a = apre;
