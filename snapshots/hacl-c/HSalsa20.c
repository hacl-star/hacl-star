...
static inline uint32_t Hacl_Symmetric_HSalsa20_rotate(uint32_t a, uint32_t s)
{
  return a << s | a >> (uint32_t )32 - s;
}

static inline uint32_t Hacl_Symmetric_HSalsa20_load32_le(uint8_t *k)
{
  return le32toh(load32(k));
}

static inline void Hacl_Symmetric_HSalsa20_store32_le(uint8_t *k, uint32_t x)
{
  store32(k,htole32(x));
}
...
Hacl_Symmetric_HSalsa20_crypto_core_hsalsa20(uint8_t *output, uint8_t *input, uint8_t *key)
{
  ...
  uint32_t x16 = load32_le(key + (uint32_t )0);
  uint32_t x20 = load32_le(key + (uint32_t )4);
  uint32_t x30 = load32_le(key + (uint32_t )8);
  uint32_t x40 = load32_le(key + (uint32_t )12);
  uint32_t x110 = load32_le(key + (uint32_t )16);
  uint32_t x120 = load32_le(key + (uint32_t )20);
  uint32_t x130 = load32_le(key + (uint32_t )24);
  uint32_t x140 = load32_le(key + (uint32_t )28);
  uint32_t x60 = load32_le(input + (uint32_t )0);
  uint32_t x70 = load32_le(input + (uint32_t )4);
  uint32_t x80 = load32_le(input + (uint32_t )8);
  uint32_t x90 = load32_le(input + (uint32_t )12);
  ...
  store32_le(output, x019);
  store32_le(output + (uint32_t )4, x519);
  store32_le(output + (uint32_t )8, x10);
  store32_le(output + (uint32_t )12, x1519);
  store32_le(output + (uint32_t )16, x6);
  store32_le(output + (uint32_t )20, x7);
  store32_le(output + (uint32_t )24, x8);
  store32_le(output + (uint32_t )28, x9);
  return;
}
