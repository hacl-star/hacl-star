...
int32_t test_chacha()
{
  ...
  crypto_stream_xor_ic(ciphertext, plaintext, len, nonce, key,1);
...
int32_t perf_chacha() {
  ...
  for (int i = 0; i < ROUNDS; i++){
    crypto_stream_xor_ic(plain, plain, len, nonce, key,1);
  }
  b = TestLib_cpucycles_end();
  t2 = clock();
  print_results("vec128 ChaCha20 speed", (double)t2-t1,
