...
static uint64_t Hacl_Bignum_Modulo_mask_2_42_limb = (uint64_t )0x3ffffffffff;
...
inline static void Hacl_Bignum_Modulo_carry_top(uint64_t *b)
{
  ...
  b0 = b[0];
  uint64_t
  b2_42 = b2 >> (uint32_t )42;
  b[2] = b2 & Hacl_Bignum_Modulo_mask_2_42_limb;
...
inline static void Hacl_Bignum_Modulo_carry_top_wide(FStar_UInt128_t *b)
{
  ...
  FStar_UInt128_t
  b2_ =
    FStar_UInt128_logand(b2,
      FStar_Int_Cast_Full_uint64_to_uint128(Hacl_Bignum_Modulo_mask_2_42_limb));
  uint64_t
...
inline static void Hacl_Bignum_Fproduct_carry_wide_(FStar_UInt128_t *tmp)
{
  for (uint32_t i = (uint32_t )0; i < (uint32_t )2; i = i + (uint32_t )1)
  {
    ...
    uint64_t
    r0 = FStar_Int_Cast_Full_uint128_to_uint64(tctr) & (uint64_t )0xfffffffffff;
    FStar_UInt128_t
    c = FStar_UInt128_shift_right(tctr, (uint32_t )44);
...
inline static void Hacl_Bignum_Fproduct_carry_limb_(uint64_t *tmp)
{
  for (uint32_t i = (uint32_t )0; i < (uint32_t )2; i = i + (uint32_t )1)
  {
    ...
    tctrp1 = tmp[ctr + (uint32_t )1];
    uint64_t
    r0 = tctr & (uint64_t )0xfffffffffff;
    uint64_t
    c = tctr >> (uint32_t )44;
    tmp[ctr] = r0;
...
)
{
  ...
  *r3 = r;
  ...
  m0 = load128_le(m);
  uint64_t
  r0 = FStar_Int_Cast_Full_uint128_to_uint64(m0) & (uint64_t )0xfffffffffff;
  uint64_t
  r1 =
...
)
{
  ...
  *x0 = r;
  ...
  uint64_t
  r0 = FStar_Int_Cast_Full_uint128_to_uint64(k_clamped) & (uint64_t )0xfffffffffff;
  uint64_t
  r1 =
...
)
{
  ...
  *kr = k1;
  uint64_t
  len16 = len1 >> (uint32_t )4;
  uint64_t
  rem16 = len1 & (uint64_t )0xf;
  uint8_t
  *part_input = m;
  uint8_t
  *last_block = m + (uint32_t )((uint64_t )16 * len16);
...
)
{
  ...
  *h = buf + (uint32_t )3;
  Hacl_Impl_Poly1305_64_State_poly1305_state
  st = Hacl_Impl_Poly1305_64_mk_state(r, h);
  uint8_t
  *key_s = k1 + (uint32_t )16;
