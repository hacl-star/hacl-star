...
force_inline static uint32_t Hacl_Impl_Chacha20_rotate_left(uint32_t a, uint32_t s)
{
...
)
{
  ...
  {
    uint8_t
    *b = plain + (uint32_t )64 * i;
    uint8_t
    *o = output + (uint32_t )64 * i;
