...
val double_and_add: 
  two_p:point -> two_p_plus_q:point -> p:point -> p_plus_q:point -> q:point -> STStack unit
    ...
    (ensures (fun h0 _ h1 -> live h1 two_p /\ live h1 two_p_plus_q /\ live h1 p /\ live h1 p_plus_q
      /\ modifies_bufs_and_refs (refs two_p +++ refs two_p_plus_q +++ refs p +++ refs p_plus_q) TSet.empty h0 h1))
