...
cl *.c /I ../kremlin/include /I . /I ../kremlin/kremlib/dist/minimal /c /DEVERCRYPT_CAN_COMPILE_INTRINSICS /DEVERCRYPT_CAN_COMPILE_VALE /DEVERCRYPT_CAN_COMPILE_VEC128 /DEVERCRYPT_CAN_COMPILE_VEC256 || goto :error
