...
[@"opaque_to_smt"]
let le_bytes_to_nat64 (b:seq nat8) : Pure nat64 (requires length b == 8) (ensures fun _ -> True) =
  two_to_nat 32 (seq_to_two_LE (seq_nat8_to_seq_nat32_LE b))

[@"opaque_to_smt"]
let le_nat64_to_bytes (b:nat64) : Pure (seq nat8) (requires True) (ensures fun s -> length s == 8) =
  seq_nat32_to_seq_nat8_LE (two_to_seq_LE (nat_to_two 32 b))

[@"opaque_to_smt"]
let le_bytes_to_quad32 (b:seq nat8) : Pure quad32 (requires length b == 16) (ensures fun _ -> True) =
  seq_to_four_LE (seq_map (four_to_nat 8) (seq_to_seq_four_LE b))

[@"opaque_to_smt"]
let be_bytes_to_quad32 (b:seq nat8) : Pure quad32 (requires length b == 16) (ensures fun _ -> True) =
...
[@"opaque_to_smt"]
let reverse_bytes_nat64 (n:nat64) : nat64 =
