...
let gcm_encrypt_LE_fst_helper iv_enc iv_BE plain auth cipher alg key =
...
let gcm_encrypt_LE_snd_helper iv_BE length_quad32 hash mac plain auth cipher alg key =
...
let gcm_blocks_helper_simplified
    alg key a128 a_bytes p128x6 p128 p_bytes c128x6 c128 c_bytes p_num_bytes a_num_bytes
    iv_BE h enc_hash length_quad
  =
...
let lemma_gcm_encrypt_decrypt_equiv alg key iv_BE plain cipher auth alleged_tag =
...
let gcm_blocks_helper_dec_simplified
    alg key p128x6 p128 p_bytes c128x6 c128 c_bytes auth_bytes alleged_tag p_num_bytes iv_BE
  =
...
let decrypt_helper alg key iv cipher auth rax alleged_tag_quad computed_tag =
