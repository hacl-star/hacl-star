let _ =
  CmdLineParser.parse_cmdline [
      ...
      ("gctr128_bytes",            (fun win -> X64_GCTR.va_code_gctr_bytes_stdcall win AES_s.AES_128));
      ("gctr256_bytes",            (fun win -> X64_GCTR.va_code_gctr_bytes_stdcall win AES_s.AES_256));
