...
let lemma_sub3
  ...
  assert (a_minus_b == pow2int_three (a0 - b0) (a1 - b1) (a2 - b2)) by (int_canon ());
  let a_two = pow2_two a0 a1 in
  let b_two = pow2_two b0 b1 in
  let a2_minus_b2 = a_two - b_two in
  assert_by_tactic (a2_minus_b2 == pow2int_two (a0 - b0) (a1 - b1)) int_canon;
  //lemma_pow2_int_34 (a0 - b0) (a1 - b1) (a2 - b2) (a3 - b3);
  assert (pow2int_three (a0 - b0) (a1 - b1) (a2 - b2) == pow2int_two (a0 - b0) (a1 - b1) + (a2 - b2) * pow2_128); 
  assert (a_minus_b == a2_minus_b2 + (a2 - b2) * pow2_128);
  let s1', c1 = sub_carry a0 b0 0 in
  let s2', c2 = sub_carry a1 b1 c1 in
  let s3', c3 = sub_carry a2 b2 c2 in
  lemma_sub2 a_two a0 a1
             b_two b0 b1
             s1 s2 c2;
  assert (a2_minus_b2 = pow2_two s1 s2 - c2 * pow2_128);
  assert (a_minus_b == pow2_two s1 s2 + (a2 - b2 - c2) * pow2_128);
  assert_by_tactic ((a2 - b2 - c2) * pow2_128 == s3 * pow2_128 - c * pow2_192) int_canon;
  assert (a_minus_b == pow2_two s1 s2 + s3 * pow2_128 - c * pow2_192);
