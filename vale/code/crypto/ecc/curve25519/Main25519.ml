let _ =
  CmdLineParser.parse_cmdline [
      ...
      ("add1", (fun win -> Vale_Curve25519_X64_FastUtil.va_code_fast_add1_stdcall win), 3);
      ...
      ("fadd_", (fun win -> Vale_Curve25519_X64_FastHybrid.va_code_fadd_stdcall win), 3);
      ("fsub_", (fun win -> Vale_Curve25519_X64_FastHybrid.va_code_fsub_stdcall win), 3);
      ("fmul1", (fun win -> Vale_Curve25519_X64_FastHybrid.va_code_fmul1_stdcall win), 3);
      (*("carry_wide", (fun win -> Vale_Curve25519_X64_FastHybrid.va_code_carry_wide_stdcall win));*)
      ("fmul_",  (fun win -> Vale_Curve25519_X64_FastWide.va_code_fmul_stdcall win), 4);
      ("fmul2", (fun win -> Vale_Curve25519_X64_FastWide.va_code_fmul2_stdcall win), 4);
      ("fsqr",  (fun win -> Vale_Curve25519_X64_FastWide.va_code_fsqr_stdcall win), 3);
      ("fsqr2", (fun win -> Vale_Curve25519_X64_FastWide.va_code_fsqr2_stdcall win), 3);
      ...
      ("cswap2", (fun win -> Vale_Curve25519_X64_FastUtil.va_code_cswap2_stdcall win), 3);
    ]
