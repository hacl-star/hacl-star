...
#reset-options "--max_fuel 0 --max_ifuel 0 --using_facts_from '* -FStar.Tactics -FStar.Reflection -CanonCommSemiring'"
...
#reset-options "--z3rlimit 10 --max_fuel 0 --max_ifuel 0 --using_facts_from 'FStar.Pervasives Fast_defs'"
