...
let lemma_hash_init h0 h1 ctx_b is_zero =
  ...
  calc (==) {
    ...
    == {UV.get_sel h0 ctx_vb 0; Opaque_s.reveal_opaque Views.get64_def}
  ...
  calc (==) {
    ...
    == {UV.get_sel h0 ctx_vb 1; Opaque_s.reveal_opaque Views.get64_def}
  ...
  calc (==) {
    ...
    == {UV.get_sel h0 ctx_vb 2; Opaque_s.reveal_opaque Views.get64_def}
  ...
  calc (==) {
    ...
    == {UV.get_sel h1 ctx_vb 2; Opaque_s.reveal_opaque Views.get64_def}
  ...
  if is_zero then
    calc (==) {
      ...
      == {Opaque_s.reveal_opaque PM.lowerUpper128; Opaque_s.reveal_opaque PM.lowerUpper192}
      0;
    }
