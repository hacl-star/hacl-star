...
val lemma_valid_buf_maddr64 (h:vale_heap) (layout:vale_heap_layout) (b:buffer64) (i:int) (t:taint) : Lemma
  (requires valid_buffer_read h b i /\ valid_taint_buf64 b h layout.vl_taint t)
  (ensures valid_buf_maddr64 (buffer_addr b h + 8 * i) h layout b i t)
  [SMTPat (valid_buffer_read h b i); SMTPat (valid_taint_buf64 b h layout.vl_taint t)]

val lemma_valid_buf_maddr128 (h:vale_heap) (layout:vale_heap_layout) (b:buffer128) (i:int) (t:taint) : Lemma
  (requires valid_buffer_read h b i /\ valid_taint_buf128 b h layout.vl_taint t)
  (ensures valid_buf_maddr128 (buffer_addr b h + 16 * i) h layout b i t)
  [SMTPat (valid_buffer_read h b i); SMTPat (valid_taint_buf128 b h layout.vl_taint t)]

//val lemma_valid_taint64_operand (m:maddr) (t:taint) (s:va_state) : Lemma
//  (requires valid_operand (OMem (m, t)) s)
//  (ensures taint_at (full_heap_taint s.vs_heap) (eval_maddr m s) == t)
