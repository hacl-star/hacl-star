...
let pre_cond (h:HS.mem) (output_b:s8) (input_b:s8) (key:Ghost.erased (aes_key_LE AES_128)) (keys_b:s8) = 
  ...
  B.length keys_b == (nr AES_128 + 1) `op_Multiply` 16 /\
...
val aes_EncryptBlockStdcall: output_b:s8 -> input_b:s8 -> key:Ghost.erased (aes_key_LE AES_128) -> keys_b:s8 -> Stack unit
