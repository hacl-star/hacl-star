...
val check_if_ins_consumes_fixed_time (ins:X64.Bytes_Semantics_s.ins) (ts:analysis_taints)
  : (res:(bool & analysis_taints){ins_consumes_fixed_time ins ts res})
  
val lemma_ins_leakage_free (ts:analysis_taints) (ins:X64.Bytes_Semantics_s.ins) : Lemma
