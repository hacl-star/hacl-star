...
unfold let wp_sound_code_pre (#a:Type0) (#c:code) (qc:quickCode a c) (s0:vale_state) (k:(s0':vale_state{s0 == s0'}) -> vale_state -> a -> Type0) : Type0 =
  forall (ok:bool) (regs:Regs.t) (flags:Flags.t) (mem:vale_heap_impl) (memory:vale_memory) (stack:vale_stack) (memTaint:memtaint) (stackTaint:memtaint).
    let s0' = {vs_ok = ok; vs_regs = regs; vs_flags = flags; vs_heap = mem; vs_memory = memory; vs_stack = stack; vs_memTaint = memTaint; vs_stackTaint = stackTaint} in
