...
[@va_qattr] unfold let va_eval_hpls         (s:va_state) (hp:nat)             : GTot vale_heap = eval_hpls hp s
...
[@va_qattr] let va_upd_hpls (hp:nat) (h:vale_heap) (s:vale_state) : vale_state = update_hpls hp h s
...
[@va_qattr] unfold let va_update_hpls (hp:nat) (sM:va_state) (sK:va_state) : va_state = va_upd_hpls hp (eval_hpls hp sM) sK
