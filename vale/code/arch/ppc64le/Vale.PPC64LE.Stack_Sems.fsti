...
val lemma_stack_to_from (s:machine_stack) : Lemma
...
val free_stack_same_load (start:int) (finish:int) (ptr:int) (h:machine_stack) : Lemma
...
val equiv_init_r1 (h:vale_stack) : Lemma
  (init_r1 h == (stack_to_s h).initial_r1)
  [SMTPat (init_r1 h)]
...
val free_stack_same_load128 (start:int) (finish:int) (ptr:int) (h:machine_stack) : Lemma
